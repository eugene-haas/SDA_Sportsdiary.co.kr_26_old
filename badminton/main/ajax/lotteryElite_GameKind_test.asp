...
'############################################
   ...
   ' 사용예 ex) http://badmintonadmin.sportsdiary.co.kr/Ajax/GameTitleMenu/lotteryElite_GameKind_test.asp?test=t  
	If request("test") = "t" Then 
        strReq = "{""CMD"":1,""ENCTIDX"":""641C3E25232AB482B6128F60C8E7957D""}"
   End if
