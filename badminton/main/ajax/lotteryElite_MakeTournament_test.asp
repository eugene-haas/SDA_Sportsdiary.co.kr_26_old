...
'############################################
   ...
   ' 사용예 ex) http://badmintonadmin.sportsdiary.co.kr/Ajax/GameTitleMenu/lotteryElite_MakeTournament_test.asp?test=t  
	If request("test") = "t" Then 
		strReq = "{""CMD"":40,""TIDX"":""1778"",""LVIDX"":""13788"",""QFINAL"":0,""POSINFO"":""4323,0,4328,4333,4325,4331,4335,4330,4326,4322,4334,4329,4327,4324,0,4332"",""QPOSINFO"":"""",""GAMENO"":""0,1,2,3,4,5,6,0,7,8,9,10,11,12,13"",""QGAMENO"":"""",""ROUND"":16,""QGROUP"":0}"        
