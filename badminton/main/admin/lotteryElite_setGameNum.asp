...
/* ==================================================================================
   ...
   {    
      ...
      var nQPerPage = 6, nScale = 1, nBlockHeight = 48
      var strQInfo;
      ...
      for(i = 0; i< nQGroup; i++)
      {
         ...
         {
            nBlockHeight = 48;
            tournamentQ = makeTournamentDouble(id_divQ, nScale, nBlockHeight);
         }
         else 
         {
            nBlockHeight = 24;
            tournamentQ = makeTournamentSingle(id_divQ, nScale, nBlockHeight);
         }
...
/* ==================================================================================
   ...
   function createTournament(rAryPos) 
   {
      ...
      var f_tournament, strInfo, cntUser, nScale = 1, nBlockHeight = 48;
      aryData = new Array();      
      ...
      if(IsDblPlay == 1) 
      {
         ...
         f_tournament = makeTournamentDouble("div_FTournament", nScale, nBlockHeight);
      }
      else 
      {
         nBlockHeight = 24; 
         ...
         f_tournament = makeTournamentSingle("div_FTournament", nScale, nBlockHeight);
      }
...
================================================================================== */   
function makeTournamentDouble(id_div, nScale, nBlockHeight)
{
...
function makeTournamentSingle(id_div, nScale, nBlockHeight)
{
   var tournament = new Tournament();
   tournament.setOption({
      blockBoardWidth: 220, // integer board 너비
