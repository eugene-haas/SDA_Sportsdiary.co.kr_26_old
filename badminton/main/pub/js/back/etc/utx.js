...
/* =================================================================================== 
    ...
    utx.printObj = function (obj, strTitle = "") {
        ...
        if(strTitle == "") strTitle = obj.toString();
   ...
   /* =================================================================================== 
       ...
       =================================================================================== */
       utx.appendZero = function(str, limit=2)      
       {
            var len, gap, strZero = "";
...
/*  =================================================================================== 
   ...
   /* =================================================================================== 
       ...
       utx.uAry = function() {
           ...
           =================================================================================== */
           utx.uAry.prototype.init = function(size = 100, initVal = 0) {
...
/*  =================================================================================== 
    ...
    {      
        ...
        else if( r == undefined || r == "")   // l값을 기준으로 strSrc.Right값을 구한다. 
        {
            ...
            pos = lpos + len1;
            strData = strSrc.substring(pos, rpos);
        }   
