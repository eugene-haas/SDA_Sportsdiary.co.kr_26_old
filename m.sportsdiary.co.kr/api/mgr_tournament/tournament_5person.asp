...
<%
' http://sdmain.sportsdiary.co.kr/app/api/mgr_tournament/tournament_5person.asp
%>
   ...
   '================================================================================= 
	Function getSqlGameList(gameLevelIdx)
		...
		If( err_no <> 1 ) Then 
         ...
         strSql = strSql & "    Case When GameNum = 1 Then 11  "
         strSql = strSql & "          When GameNum In (2, 3, 4) Then 12  "
         strSql = strSql & "          When GameNum = 5 Then 13 "
         strSql = strSql & "          When GameNum = 6 Then 14 End As DISPLAY_POS,  "
   ...
   '================================================================================= 
	Function getSqlGroupGameList(gameLevelIdx)
		...
		If( err_no <> 1 ) Then 
         ...
         strSql = strSql & "    Case When NowRoundNM Is Null Then dbo.fn_strRound(6570, [round]) Else NowRoundNM End As NowRoundNM,  "
         ...
         '  DISPLAY_POS : 11:좌측 토너먼트, 12:우측 리그, 13:결승, 14:3,4위전 "
         strSql = strSql & "    Select I.PlayerResultIdx, I.RGameLevelidx, I.NowRoundNM, I.NowRound, I.GroupGameNum, I.GameNum, "
         strSql = strSql & "    Case When GroupGameNum = 1 Then 11  "
         strSql = strSql & "       When GroupGameNum In (2, 3, 4) Then 12  "
         strSql = strSql & "       When GroupGameNum = 5 Then 13 "
         strSql = strSql & "       When GroupGameNum = 6 Then 14 End As DISPLAY_POS,  "
   ...
   gameLevelIdx 	= InjectionChk(JsonObj.get("gameLevelIdx"))
	...
	If( err_no <> 1 ) Then 		
      ...
      '  ----------------------------------------------------
         ...
         '  ----------------------------------------------------
         ' Player List - GameType : sd043004	5인(토너먼트+리그) 개인전 (sd040001)
         ...
         '  ----------------------------------------------------
         ' Game List :  대회 리스트 - GameType : sd043004	5인(토너먼트+리그) 개인전 (sd040001)
      ...
      '  ----------------------------------------------------
         ...
         '  ----------------------------------------------------
         ' Player List - GameType : sd043004	5인(토너먼트+리그) 단체전 (sd040002)
         ...
         '  ----------------------------------------------------
         ' Game List :  대회 리스트 - GameType : sd043004	5인(토너먼트+리그) 단체전 (sd040002)
