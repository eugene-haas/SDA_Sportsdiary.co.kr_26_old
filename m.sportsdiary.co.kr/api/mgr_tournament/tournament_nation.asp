...
<%
' http://sdmain.sportsdiary.co.kr/app/api/mgr_tournament/tournament_nation.asp
%>
   ...
   '================================================================================= 
	Function getSqlGameList(gameLevelIdx)
		...
		If( err_no <> 1 ) Then 
         ...
         strSql = strSql & "    Case When I.GameNum In ('1', '2', '3', '4', '5', '6', '7') Then 21 "
         strSql = strSql & "          When I.GameNum In ('8', '9', '10', '11', '12') Then 22 "
         strSql = strSql & "          When I.GameNum In ('13') Then 23 "
         strSql = strSql & "          When I.GameNum In ('14') Then 24 "
         strSql = strSql & "          When I.GameNum In ('15') Then 25 "
...
DBOpen()
   ...
   gameLevelIdx 	= InjectionChk(JsonObj.get("gameLevelIdx"))
	...
	If( err_no <> 1 ) Then 		
      ...
      '  ----------------------------------------------------
      ' Player List - GameType : sd043005	국가대표최종평가전 개인전 (sd040001)
      ...
      '  ----------------------------------------------------
      ' Game List :  대회 리스트 - GameType : sd043005	국가대표최종평가전 개인전 (sd040001)
