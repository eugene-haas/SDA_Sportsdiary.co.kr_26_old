...
<%
' http://sdmain.sportsdiary.co.kr/app/api/mgr_tournament/tournament.asp
%>
   ...
   '================================================================================= 
	Function getSqlGameList(gameLevelIdx)
		...
		If( err_no <> 1 ) Then 
         ...
         '  DISPLAY_POS: 1: 토너먼트  "
         strSql = strSql & " Select I.PlayerResultIdx, I.RGameLevelidx, I.NowRoundNM, I.NowRound, I.GroupGameNum, I.GameNum, 1 As DISPLAY_POS,  "
   ...
   '================================================================================= 
	Function getSqlGroupGameList(gameLevelIdx)
		...
		If( err_no <> 1 ) Then 
         ...
         '  경기 정보를 구한다.  "
         strSql = strSql & " , cte_info As ( "
         strSql = strSql & "    Select PlayerResultIdx, RGameLevelidx, [round],  "
         strSql = strSql & "    Case When NowRoundNM Is Null Then dbo.fn_strRound(9252, [round]) Else NowRoundNM End As NowRoundNM,  "
         ...
         '  경기 정보 + 출전 선수 정보를 Display한다 . "
         '  DISPLAY_POS: 1: 토너먼트  "
         strSql = strSql & " Select I.PlayerResultIdx, I.RGameLevelidx, I.NowRoundNM, I.GroupGameNum, I.GameNum, I.[round], 1 As DISPLAY_POS,  "
   ...
   gameLevelIdx 	= InjectionChk(JsonObj.get("gameLevelIdx"))
	...
	If( err_no <> 1 ) Then 		
      ...
      '  ----------------------------------------------------
         ...
         '  ----------------------------------------------------
         ' Player List - GameType : sd043002	토너먼트 개인전 (sd040001)
         ...
         '  ----------------------------------------------------
         ' Game List :  대회 리스트 - GameType : sd043002	토너먼트 개인전 (sd040001)
      ...
      '  ----------------------------------------------------
         ...
         '  ----------------------------------------------------
         ' Player List - GameType : sd043002	토너먼트 단체전 (sd040002)
         ...
         '  ----------------------------------------------------
         ' Game List :  대회 리스트 - GameType : sd043002	토너먼트 단체전 (sd040002)
