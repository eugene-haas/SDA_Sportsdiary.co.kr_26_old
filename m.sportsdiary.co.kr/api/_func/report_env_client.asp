...
'   ===============================================================================
	...
	Function envLog(strLog)
		...
		'DIR_SYSINFO					= sys_sprintf("{0}syslog/training_center/sysInfo/", Array(physicalPath) )
		DIR_SYSINFO					= "D:/log_dev/sitelog/knsu/"
...
<%
	...
	Function TraceSysInfo(strReq, req)
		...
		If(user_id = "") Then user_id = SI_MEMBER_ID End If 
