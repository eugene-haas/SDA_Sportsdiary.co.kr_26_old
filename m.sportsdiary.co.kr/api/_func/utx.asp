			...
			If(ub2 = kub2) Then 
				For Idx = 0 To ub				
					For k = 0 To ub2
						...
						If(k = pos_ary) Then 
							If(k = 0) Then 
								strData = utx_sprintf(" ""{0}"": [", Array(key))
							Else 
								strData = utx_sprintf("{0},""{1}"": [", Array(strData, key))
							End If 
						ElseIf(k = ub2) Then 
							strData = utx_sprintf("{0} {1}", Array(strData, val))
...
'   ===============================================================================
  ...
  '=================================================================================
	...
	' 임시 PW를 얻는다. 
	'===============================================================================
	Function GettempPasswd(keyLen)
		Dim arySrc(2), aryLen(2), max, r1, r2, i, j, ul, len1
   ...
   '   \r\n 혹은 \n으로 구분된 문자열을 받아 Chr(10)으로 구분된 문자열로 변환한다.
	'=================================================================================
    Function getSMSStr(strContent)
        strContent   = Replace(strContent, "\r\n", Chr(10))       ' 개행 문자열 변환
        strContent   = Replace(strContent, "\n", Chr(10))         ' 개행 문자열 변환
        getSMSStr = strContent
    End Function
