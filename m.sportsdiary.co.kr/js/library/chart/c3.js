...
(function (global, factory) {
  ...
  ChartInternal.prototype.getArcTitleStr = function () {
	var $$ = this;
	return $$.hasType('donut') ? $$.config.donut_InnerStr : "";
 };
  ...
  ChartInternal.prototype.initArc = function () {
    ...
    $$.arcs.append('text').attr('class', CLASS.chartArcsTitle+ ' t_title').style("text-anchor", "middle").text($$.getArcTitleStr());
  ...
  ChartInternal.prototype.updateLegend = function (targetIds, options, transitions) {
    ...
    function updatePositions(textElement, id, index) {
      var reset = index === 0,
          ...
          itemWidth = box.width + tileWidth + paddingRight + config.legend_padding,
          // itemWidth = box.width + tileWidth + (isLast && !($$.isLegendRight || $$.isLegendInset) ? 0 : paddingRight) + config.legend_padding,
          // 마지막도 똑같이 패딩주기 2020-10-13 chansoo
          itemHeight = box.height + paddingTop,
          itemLength = $$.isLegendRight || $$.isLegendInset ? itemHeight : itemWidth,
          areaLength = $$.isLegendRight || $$.isLegendInset ? $$.getLegendHeight() : $$.getLegendWidth(),
          margin,
          maxLength; // MEMO: care about condifion of step, totalLength
          console.log(box.width, tileWidth, paddingRight, config.legend_padding)
