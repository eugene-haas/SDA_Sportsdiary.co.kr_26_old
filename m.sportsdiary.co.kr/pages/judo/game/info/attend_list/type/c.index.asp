...
<div class="m_tabs" :class="{
   ...
   <a href="/pages/judo/game/info/attend_list/type/index.asp" class="m_tabs__tab m_tabs__tab--active">종목별</a>
   <a href="/pages/judo/game/info/attend_list/group/index.asp" class="m_tabs__tab">단체별</a>
</div>
<div v-if="sel_info === null" class="m_search m_search--box">
   <h2 class="ir">종목별 참가자 명단 검색</h2>
   <!-- <h2 class="ir">대회 네비게이션</h2> -->
   <div class="m_space">
      ...
      <div class="m_select-box m_space__flex-3">
         <select>
...
<div v-else class="m_card">
   <div class="m_card__header">
      ...
      <h2 class="m_card__header__title">출전</h2>
      <span class="m_card__header__text">23 팀</span>
   </div>
   <div class="m_tbl">
      <table class="m_tbl__table">
         <thead>
            <tr class="m_tbl__table__thead-tr">
               ...
               <th class="m_tbl__table__thead-th">소속</th>
         ...
         <tbody>
            <tr class="m_tbl__table__tbody-tr">
               ...
               <td class="m_tbl__table__tbody-td">공주대학교</td>
