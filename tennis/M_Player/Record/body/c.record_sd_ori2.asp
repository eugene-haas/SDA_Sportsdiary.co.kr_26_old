...
<!-- #include virtual = "/pub/query/mobile/q.record.asp" --><%'리스트, ajax 에서 같이 사용%>
 	...
 	<div id="drowarea" class="l_content m_scroll [ _content _scroll ]">
		<!-- #include virtual = "/pub/html/RookieTennis/html.mobile.searchrecordlist.asp" --><%'리스트, ajax 에서 같이 사용%>
    ...
    <div class="l_upLayer__contBox m_searching__area [ _overLayer__box ]">
      ...
      <div class="l_upLayer__wrapCont m_searchPopup__cont [ _overLayer__wrap ]">
        <div class="m_searchPopup__control">
            ...
            <input type="text" placeholder="선수명을 입력해주세요." value="" class="m_searchPopup__input s_ignore [ _searchingInput ] " id="SF1" onInput="tm.searchPlayer('searchplayerlist')">
        ...
        <div class="m_searchPopup__panelWrap [ _sliderWrap ] s_filtering">
          ...
          <div class="m_searchPopup__panel">
            ...
            <div class="m_searchPopup__checkWrap">
              <div class="m_searchPopup__checkGroup">
                <input type="radio" name="search_div_sd" id="search_div_sd0" value="20101"  hidden checked>
			        	<label for="search_div_sd0" onmousedown="tm.searchRecord('drowarea','','20101','')">여자부★ (1스타)</label>
                <input type="radio" name="search_div_sd" id="search_div_sd1" value="20102"  hidden>
			        	<label for="search_div_sd1" onmousedown="tm.searchRecord('drowarea','','20102','')">여자부★★ (2스타)</label>
              </div>
              <div class="m_searchPopup__checkGroup">
                <input type="radio" name="search_div_sd" id="search_div_sd2" value="20104"  hidden>
                <label for="search_div_sd2" onmousedown="tm.searchRecord('drowarea','','20104','')">남자부★ (1스타)</label>
                <input type="radio" name="search_div_sd" id="search_div_sd3" value="20105"  hidden>
				        <label for="search_div_sd3" onmousedown="tm.searchRecord('drowarea','','20105','')">남자부★★ (2스타)</label>
              </div>
            </div>
          </div>
  ...
  <style>
    ...
    .m_searchPopup__cont{position:relative;height:calc(100vh - 2.5rem);overflow:hidden;}
      ...
      .m_searchPopup__control{background-color:#f2f2f2; display:table;width:100%;height:4.25rem;padding:1.45rem 0.7rem 0.7rem 0.7rem;border-radius:0.92rem 0.92rem 0 0;overflow:hidden;}
        ...
        .m_searchPopup__input.s_ignore.on{width:calc(100% - 6.7rem);background-color:#fff;box-shadow: 0 0 0.7rem #ccc;}

        .m_searchPopup__input.s_ignore:focus, .m_searchPopup__input:focus{}
  ...
  <script>
    ...
    $('._filterBtn').on('click', function(){
      ...
      $('._sliderWrap').addClass('s_searching');
		...
		$('._searching').on('click', function(evt){
			search_layer.close();
		});
