...
<script type="text/javascript">
  ...
  function fn_itable() {
    ...
    //iMHtml = iMHtml + '<span class="medal_rank_txt">(순위:총 메달 수)</span>';
    ...
    var strAjaxUrl = "../Ajax/record-medal-total.asp";
...
<form name="s_frm" method="post">
  ...
  <div class="record-menu">
    ...
    <div class="mid-cat">
      <ul class="rank-mid menu-list clearfix">
        ...
        <li><a href="javascript:onSubmit('record-medal-total.asp');" class="on">랭킹순위</a></li>
      </ul>
    </div>
  ...
  <!-- S: skill-state -->
  <div class="medal-total state-cont" style="display: none;" id="iTotal_Main">
    <h2 id="iMain_Title"><!--<span>2016년</span> / <span>개인전</span> / <span>여자고등부</span> / <span>-52kg</span>--></h2>
    <!-- S: match-list -->
    <div class="match-list" id="iTotal_Main_Contents">
