...
<script type="text/javascript">
  ...
  function fn_ipointtype() {

    var strAjaxUrl = "../Ajax/Record-Search-PointTypeGubun.asp";
  ...
  function fn_itable() {
    ...
    var strAjaxUrl = "../Ajax/record-rank.asp";
...
<body class="lack-bg">
  ...
  <div class="record-menu">
    <div class="menu-list big-cat flex">
      <a href="record-srch-win.asp" class="btn">성적조회</a>
      <a href="record-rank.asp" class="btn on">순위</a>
    </div>
    <div class="menu-list mid-cat">
      ...
      <ul class="rank-mid clearfix" style="display: block;">
        <li><a href="record-rank.asp" class="on">점수득점</a></li>
  ...
  <div class="record-input bg-ipt" id="sbox">
    ...
    <div class="sel-list">
      ...
      <dl class="srch-inpt clearfix">
        <dt>점수</dt>
        <dd>
          <select name="ipointtype" id="ipointtype">
  ...
  <!-- S: rank-state -->
  <div class="rank-state state-cont" style="display: none;" id="iTotal_Main">

  </div>
  <!-- E: rank-state -->

  <!-- S: Modal -->
  <!-- #include file= "./record-rank-sub.asp" -->
  <!-- E: Modal -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <label class="img-replace" onClick="inputExc($(this));">
            <input id="chk_day_RRANK" type="checkbox" />
            <span>오늘 하루 보지 않기</span> </label>
          <button type="button" class="btn btn-default" data-dismiss="modal" onClick="closePop('RRANK');">닫기</button>
        </div>
        <script>
