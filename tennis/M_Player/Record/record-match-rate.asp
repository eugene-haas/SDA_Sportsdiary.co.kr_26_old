...
<script type="text/javascript">
  ...
  function fn_iteamgb() {
    ...
    var strAjaxUrl = "../Ajax/Record-Search-TeamGubun_ts.asp";
  ...
  function fn_itable() {
    ...
    iMHtml = iMHtml + '<span>' + sub_iSDate.substring(0, 4) + '년</span> / <span>' + sub_iteamgbNm + '</span>';
    ...
    var strAjaxUrl = "../Ajax/record-match-rate.asp";
...
<form name="s_frm" method="post">
  ...
  <div class="record-menu">
    ...
    <div class="mid-cat">
      <ul class="rank-mid menu-list  clearfix">
        ...
        <li><a href="javascript:onSubmit('record-match-rate.asp');" class="on">경기승률</a></li>
        <li><a href="javascript:onSubmit('record-medal-rank.asp');">메달순위</a></li>
        <li><a href="javascript:onSubmit('record-medal-total.asp');">랭킹순위</a></li>
      </ul>
    </div>
  </div>
  <!-- E: record-menu -->
  ...
  <!-- S: skill-state -->
  <div class="match-rate state-cont" style="display: none;" id="iTotal_Main">
    <h2 id="iMain_Title"><!--<span>2016년</span> / <span>여자고등부</span> / <span>-52kg</span>--></h2>

    <!-- S: match-list -->
    <div class="match-list match-rate" id="iTotal_Main_Contents">
  ...
  <!-- S: profile-pop -->
  <!-- #include file="../include/Profile-main.asp" -->
  <!-- E: profile-pop -->
