...
<%
 ...
 '2017-06-26 추가 
  ...
  If Not (LRs.Eof Or LRs.Bof) Then
    ...
    '해당그래프 클리시 말풍선값
    retext = retext&"""plotTooltext"": ""$label<br> $datavalue일"","
    ...
    Do Until LRs.Eof
        ...
        'LRsCnt1 = LRsCnt1 + 1
        'retext = retext&"{""label"": """&LRs("PubName")&""",""value"": """&LRs("TTrailHour")&"""},"
        retext = retext&"{""link"":""JavaScript:chart_sub('"&LRs("TraiFistCd")&"','"&LRs("TraiFistNm")&"')"",""label"": """&LRs("TraiFistNm")&""",""value"": """&LRs("TTrailDay")&"""},"
