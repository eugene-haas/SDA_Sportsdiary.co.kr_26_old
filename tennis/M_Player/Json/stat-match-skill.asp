...
<%
 ...
 '2017-06-26 추가 
  ...
  LSQL = "EXEC Stat_Match_Skill_Search '" & iType & "','" & iSportsGb & "','" & iPlayerIDX & "','" & SDate & "','" & EDate & "','" & GameTitleIDX & "'"
  ...
  If Not (LRs.Eof Or LRs.Bof) Then
    ...
    Do Until LRs.Eof
        ...
        'If (Rname1 <> LRs("SpecialtyDtlName")) Then
          retext = retext&"{""label"": """&LRs("SpecialtyDtlName")&"""},"
        'End if
  ...
  retext = retext&"""data"": ["
    ...
    Do Until LRs.Eof
        'LRsCnt2 = LRsCnt2 + 1
        'If (Rname2 <> LRs("SpecialtyDtlName")) Then
          retext = retext&"{""value"": """&LRs("Jumsu")&"""},"
        'End if
        'Rname2 = LRs("SpecialtyDtlName")
      LRs.MoveNext
    Loop
  ...
  retext = retext&"""data"": ["
    ...
    Do Until LRs.Eof
        'LRsCnt3 = LRsCnt3 + 1
        'If (Rname3 <> LRs("SpecialtyDtlName")) Then
          retext = retext&"{""value"": """&LRs("Jumsu")&"""},"
        'End if
        'Rname3 = LRs("SpecialtyDtlName")
      LRs.MoveNext
    Loop
