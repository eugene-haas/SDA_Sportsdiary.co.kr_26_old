...
function editscore(objbtn) {
    ...
    if (localStorage.getItem("GroupGameGb") == "sd040001") {
        ...
        if (localStorage.getItem("MediaLink") == "") {
            ...
            $('#player_Ifram_MediaLink').attr('src',localStorage.getItem("MediaLink").replace("https://youtube.com","https://www.youtube.com")+"&enablejsapi=1&autoplay=1&fs=1&vq=hd720&loop=1");
        }
        ...
        if (localStorage.getItem("MediaLink") == "") {
            ...
            player = new YT.Player('group_Ifram_MediaLink', {  });
       
           $('#group_Ifram_MediaLink').attr('src',localStorage.getItem("MediaLink").replace("https://youtube.com","https://www.youtube.com")+"&enablejsapi=1&autoplay=1&fs=1&vq=hd720&loop=1");
        }
...
function changegroup_btn() {
    ...
    if ($("#btn_groupmovie").css("display") == "none") {
        ...
        $("#btnrewind_Group").hide();
        $("#btnfastforward_Group").hide();
    }
    else {
        ...
        $("#btnrewind_Group").show();
        $("#btnfastforward_Group").show();
