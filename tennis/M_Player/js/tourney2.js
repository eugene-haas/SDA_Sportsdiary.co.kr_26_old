...
function change_btn() {
    ...
    if ($("#btn_movie").css("display") == "none") {
        ...
        */
        ...
        var strYoutubeLink = "<iframe id='playerytt' name='playerytt' width=100%  src='" + localStorage.getItem("MediaLink") + "?showinfo=0&autoplay=1&modestbranding=0&fs=1&vq=hd720&loop=1&playlist=&enablejsapi=1&version=3" + localStorage.getItem("MediaLink").replace("https://www.youtube.com/embed/", "") + "&rel=0&enablejsapi=1&version=3' frameborder='0' allowfullscreen></iframe>"
        ...
        */
		...
		$("#btn").html("<button id='btnF'>Foword</button><button id='btnP'>Preview</button>");
...
//            alert("등록된 영상이 없습니다.");
        ...
        */
        ...
        var strYoutubeLink = "<iframe width=100%  src='" + localStorage.getItem("MediaLink") + "?showinfo=0&autoplay=1&modestbranding=0&fs=1&vq=hd720&loop=1&playlist=&enablejsapi=1&version=3" + localStorage.getItem("MediaLink").replace("https://www.youtube.com/embed/", "") + "' frameborder='0' allowfullscreen></iframe>"
