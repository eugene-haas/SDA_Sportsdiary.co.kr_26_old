  ...
  <div class="sub">
    ...
    <div class="main stat-record">
      ...
      <section class="stat-film group">
        <div class="div-title">
          <h4>단체전 [8강]</h4>
          <p class="list-info"><span>고등부</span><span>남자</span><span>무차별</span></p>
        </div>
        <!-- S: container -->
        <div class="container">
          <ul class="stat-list">
            <li class="clearfix">
              ...
              <span class="record-total">4승 2패 1무</span>
              <p class="record-detail clearfix">
                <span class="school">중앙여자고등학교</span>
                <span>VS</span>
                <span class="school">울산스포츠과학고등학교</span>
                <span>(승/25점)</span>
              </p>
