...
<script type="text/javascript">
  ...
  var strJsonUrl = "../Json/stat-training-noattand.asp?SDate=" + SDate + "&EDate=" + EDate + "&MemberIDX=" + iMemberIDX;
  //json통신 url parameter
...
<div class="record-menu stat-menu">
  ...
  <div class="menu-list mid-cat">
    <ul class="record-mid clearfix" style="display: block;">
      <li><a href="javascript:onSubmit('../Stats/stat-training-attand.asp');">훈련참석</a></li>
      <li><a href="javascript:onSubmit('../Stats/stat-training-noattand.asp');" class="on">훈련불참</a></li>
    </ul>
  </div>
