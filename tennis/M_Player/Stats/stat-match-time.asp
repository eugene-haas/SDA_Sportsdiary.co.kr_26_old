...
<script type="text/javascript">
  ...
  function table_ajax() {
    ...
    var strAjaxUrl = "../Ajax/stat-match-time.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
  ...
  function chart_view() {
    ...
    if (isearch_val() == false) {
      ...
      var strJsonUrl = "../Json/stat-match-time.asp?SDate=" + iSDate + "&EDate=" + iEDate + "&iPlayerIDX=" + iPlayerIDX + "&GameTitleIDX=" + iGameTitleIDX.value;
...
<div class="record-menu stat-menu">
  ...
  <div class="mid-cat">
    <ul class="rank-mid menu-list clearfix">
      ...
      <li><a href="javascript:onSubmitStat('../Stats/stat-match-time.asp');" class="on">시간대별</a></li>
    </ul>
  </div>
</div>
<!-- E: record-menu -->
...
<div class="state-cont" id="chart_view" style="display:none;">
  <!-- S: stat-chart -->
  <div class="chart-tab tab-2 container clearfix"> <a href="javascript:click_tab('totalpoint');" class="on" id="itotalpoint">전체 득실점</a> <a href="javascript:click_tab('skillpoint');" id="iskillpoint">시간대별 기술구사</a> </div>
  <div id="ichart">
  ...
  <div id="itable">
    <section class="stat-chart">
      ...
      <div class="skill-part-chart">
        ...
        <!-- S: time-part-table -->
        <div class="time-part-table container" id="sub_table1"> </div>
