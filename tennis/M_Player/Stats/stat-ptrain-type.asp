...
// 훈련유형 분포
  ...
  var strJsonUrl = "../Json/stat-ptrain-type.asp?SDate=" + SDate + "&EDate=" + EDate + "&MemberIDX=" + iMemberIDX;
  ...
  $('#during_date').html($('#SDate').val()+"~"+$('#EDate').val());
	...
	function chart_sub(iTraiFistCd, iTraiFistNm) {
	  ...
	  var strJsonUrl = "../Json/stat-ptrain-type-sub.asp?SDate=" + SDate + "&EDate=" + EDate + "&MemberIDX=" + iMemberIDX + "&TraiFistCd=" + iTraiFistCd;
...
<div class="record-menu stat-menu">
  ...
  <div class="mid-cat">
    <ul class="rank-mid menu-list clearfix">
      <li><a href="javascript:onSubmit('../Stats/stat-ptrain-place.asp');">훈련장소</a></li>
      <li><a href="javascript:onSubmit('../Stats/stat-ptrain-time.asp');">훈련시간</a></li>
      <li><a href="javascript:onSubmit('../Stats/stat-ptrain-type.asp');" class="on">훈련종류</a></li>
    </ul>
  </div>
</div>
<!-- E: record-menu -->
