...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    var strJsonUrl = "../Json/stat-strain-type.asp?SDate=" + SDate + "&EDate=" + EDate + "&MemberIDX=" + iMemberIDX;
  ...
  function chart_sub(iTraiFistCd, iTraiFistNm) {
    ...
    var strJsonUrl = "../Json/stat-strain-type-sub.asp?SDate=" + SDate + "&EDate=" + EDate + "&MemberIDX=" + iMemberIDX + "&TraiFistCd=" + iTraiFistCd;
    ...
    var sub_title_name = iTraiFistNm + " 종류";
...
<div class="record-menu stat-menu">
  <div class="big-cat">
    <ul class="menu-list clearfix">
      ...
      <li> <a href="javascript:onSubmit('../Stats/stat-strain-place.asp');" class="btn badth on">개인훈련</a> </li>
  ...
  <div class="mid-cat">
    <ul class="rank-mid menu-list clearfix">
      <li><a href="javascript:onSubmit('../Stats/stat-strain-place.asp');">훈련장소</a></li>
      <li><a href="javascript:onSubmit('../Stats/stat-strain-time.asp');">훈련시간</a></li>
      <li><a href="javascript:onSubmit('../Stats/stat-strain-type.asp');" class="on">훈련종류</a></li>
    </ul>
  </div>
</div>
<!-- E: record-menu -->
...
<form name="s_frm" method="post">
  ...
  <div class="record-input bg-ipt" id="sbox">
    ...
    <!-- E: sel-list -->
    <div class="btn-list"> <a href="#" class="btn-left btn btn-close">닫기</a> <a href="javascript:chart_view('fitness','s');" class="btn-right btn">조회</a> </div>
  </div>
</form>
<!-- E: record-input -->
<!-- S: tail -->
...
<div class="state-cont" id="chart_view" style="display:none;">
  ...
  <section class="stat-chart train-place">
    ...
    <!--하위차트생성-->
    <div id="sub_chart_total" class="no-border detail-table table-1 point-table">
      <div class="chart-title">
        <h3 id="sub_chart_title" style="display:block;">체력훈련 종류</h3>
        <!--<h3 id="sub_chart_title" style="display:none;">도복훈련 종류</h3>-->
        <p id="sub_during_date" class="chart-date pb20" style="display:none;">2016-07-27~2016-08-03</p>
      </div>
