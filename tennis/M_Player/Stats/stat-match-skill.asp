...
<script type="text/javascript">
  ...
  function table_ajax() {
    ...
    var strAjaxUrl = "../Ajax/stat-match-skill.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
  ...
  function chart_view() {
    ...
    if (isearch_val() == false) {
      ...
      var strJsonUrl = "../Json/stat-match-skill.asp?SDate=" + iSDate + "&EDate=" + iEDate + "&iPlayerIDX=" + iPlayerIDX + "&GameTitleIDX=" + iGameTitleIDX.value;
...
<div class="record-menu stat-menu">
  ...
  <div class="mid-cat">
    <ul class="rank-mid menu-list clearfix">
      <li><a href="javascript:onSubmitStat('../Stats/stat-match-point.asp');">점수별</a></li>
      <li><a href="javascript:onSubmitStat('../Stats/stat-match-skill.asp');" class="on">기술별</a></li>
...
<div class="state-cont" id="chart_view" style="display:none;">
  <div class="chart-tab tab-2 container clearfix"> <a href="javascript:click_tab('totalpoint');" class="on" id="itotalpoint">전체 득실점</a> <a href="javascript:click_tab('skillpoint');" id="iskillpoint">좌우기술별 득실점</a> </div>
  <!-- S: 전체득실점 차트  -->
  <div id="ichart">
  ...
  <div id="itable">
    <section class="stat-chart train-place">
      <div class="skill-part-chart">
        ...
        <div class="skill-part-table container" id="sub_table1"> </div>
        <p class="no-apply-txt">※누르기,조르기,꺽기,되치기 기술은 좌우측 방향과 무관하므로 좌우기술별 득실점 횟수에는 반영되지 않습니다.</p>
      </div>
    </section>
  </div>
  <!-- E: 좌우기술별득실점 -->
