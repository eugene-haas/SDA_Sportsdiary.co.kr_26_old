...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    var strJsonUrl = "../Json/stat-injury-dist.asp?SDate=" + SDate + "&EDate=" + EDate + "&MemberIDX=" + iMemberIDX;
...
<div class="record-menu stat-menu">
  ...
  <div class="mid-cat">
    <ul class="rank-mid menu-list clearfix">
      <li><a href="javascript:onSubmit('../Stats/stat-injury-dist.asp');" class="on">부상분포</a></li>
