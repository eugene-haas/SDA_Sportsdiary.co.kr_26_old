...
function chart_view() {
  ...
  var strJsonUrl = "../Json/stat-strain-place.asp?SDate=" + SDate + "&EDate=" + EDate + "&MemberIDX=" + iMemberIDX;
...
<div class="record-menu stat-menu">
  ...
  <div class="mid-cat">
    <ul class="rank-mid menu-list clearfix">
      <li><a href="javascript:onSubmit('../Stats/stat-strain-place.asp');" class="on">훈련장소</a></li>
