...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    if (isearch_val() == false) {
      ...
      var strJsonUrl = "../Json/stat-relativity-lost.asp?SDate=" + iSDate + "&EDate=" + iEDate + "&iPlayerIDX=" + iPlayerIDX + "&GameTitleIDX=" + iGameTitleIDX.value;
  ...
  function chart_sub(sub_type) {
    ...
    var strAjaxUrl = "../Ajax/stat-relativity-lost.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
...
<div class="record-menu stat-menu">
  ...
  <div class="mid-cat">
    <ul class="rank-mid menu-list clearfix">
      <li><a href="javascript:onSubmitStat('../Stats/stat-relativity-get.asp');">좌우기술 득점</a></li>
      <li><a href="javascript:onSubmitStat('../Stats/stat-relativity-lost.asp');" class="on">좌우기술 실점</a></li>
    </ul>
  </div>
</div>
<!-- E: record-menu -->
