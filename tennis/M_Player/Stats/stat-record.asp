...
<%
  ...
  'SportsGb = "tennis"
  'PlayerIDX = encode("7010",0)

%>
<!-- S: profile-script -->
<!-- #include file="../include/Profile-sub.asp" -->
<!-- E: profile-script -->
<!-- google chart -->
...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    if (isearch_val() == false) {
      ...
      var tSportsGb = iSportsGb;
      var iSDate = "";
      var iEDate = "";
      var iGameTitleIDX = "";
      var iSelPlayerIDX = iPlayerIDX;
      var iSelType = "1^2^3^4" // "1|2|3"

      //alert(iSelPlayerIDX + ", " + tSportsGb);

      iMainTotal(tSportsGb, iSDate, iEDate, iGameTitleIDX, iSelPlayerIDX, iSelType);
...
<body>
  ...
  <!-- S: record-menu -->
  <div class="record-menu stat-menu temp">
    <div class="big-cat">
...
<!--        <li><a href="../Stats/stat-win.asp">입상현황</a></li>
  ...
  <div class="main stat-record" id="maincontents">
      ...
      <div id="maincontents_5">

      </div>
      <div id="maincontents_6">

      </div>
      <div id="maincontents_7">
