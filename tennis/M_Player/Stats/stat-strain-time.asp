...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    var SDate = $('#SDate').val();
    var EDate = $('#EDate').val();
    var strJsonUrl = "../Json/stat-strain-time.asp?SDate=" + SDate + "&EDate=" + EDate + "&MemberIDX=" + iMemberIDX;
...
<div class="record-menu stat-menu">
  ...
  <div class="mid-cat">
    <ul class="rank-mid menu-list clearfix">
      ...
      <li><a href="javascript:onSubmit('../Stats/stat-strain-time.asp');" class="on">훈련시간</a></li>
      <li><a href="javascript:onSubmit('../Stats/stat-strain-type.asp');">훈련종류</a></li>
    </ul>
  </div>
</div>
<!-- E: record-menu -->
...
<div class="state-cont" id="chart_view" style="display:none;">
  ...
  <section class="stat-chart train-place">
    ...
    <p class="train-time" id="train-time">총 훈련시간 <span>180시간 30분</span></p>
