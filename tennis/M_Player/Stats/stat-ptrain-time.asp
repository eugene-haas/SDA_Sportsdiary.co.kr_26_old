...
function chart_view(){
  ...
  var strJsonUrl = "../Json/stat-ptrain-time.asp?SDate=" + SDate + "&EDate=" + EDate + "&MemberIDX=" + iMemberIDX;
  ...
  //총훈련시간 Ajax 처리
  var strAjaxUrl = "../Ajax/stat-ptrain-time.asp";
...
<div class="record-menu stat-menu">
  ...
  <div class="mid-cat">
    <ul class="rank-mid menu-list clearfix">
      ...
      <li><a href="javascript:onSubmit('../Stats/stat-ptrain-time.asp');" class="on">훈련시간</a></li>
