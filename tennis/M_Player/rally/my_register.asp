    ...
    <div class="srch_result_list">
      ...
      <ul class="ctr_list">
        <li class="clearfix">
          ...
          <!-- S: ctr_btn -->
          <div class="ctr_btn clearfix">
            <!-- S: btn_box btn_mod_del -->
            <div class="btn_box btn_mod_del">
              <a href="#" class="btn btn_empty">수정</a>
              <a href="#" class="btn btn_empty">삭제</a>
            </div>
            <!-- E: btn_box btn_mod_del -->

            <!-- S: btn_box  -->
            <div class="btn_box switch_box">
      ...
      <ul>
        <li class="clearfix">
          ...
          <!-- S: ctr_btn -->
          <div class="ctr_btn v_ctr_btn clearfix">
            <!-- S: btn_box btn_mod_del -->
            <div class="btn_box btn_mod_del">
              <a href="#" class="btn btn_empty">수정</a>
              <a href="#" class="btn btn_empty">삭제</a>
