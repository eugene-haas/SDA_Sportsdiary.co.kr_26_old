  ...
  <!-- <div class="gnb-box"> -->
    ...
    <ul class="navi-list type1 non flex">
      ...
      <li>
        ...
        <a href="javascript:chk_TeamNotice();"><span class="img-box"><img src="http://img.sportsdiary.co.kr/sdapp/gnb/icon_plan_off@3x.png" alt></span><span class="menu-txt">팀 공지사항<span id="GNBTNOTICE" style="display:none" class="ic-new">N</span></span></a>
      </li>
    </ul>
    <!-- E: navi-list 2 -->
