  ...
  <!-- <div class="gnb-box"> -->
    ...
    <ul class="navi-list type1 non flex">
      ...
      <li>
        ...
        <!--
        <a href="javascript:chk_LogMenuProc('MATCH_DIARY');"><span class="img-box"><img src="../images/include/gnb/icon_match_off@3x.png" alt></span><span class="menu-txt">대회일지<span id="GNBGAME" style="display:none" class="ic-new">N</span></span></a>
        -->
      </li>
    </ul>
    <!-- E: navi-list 1 -->
    ...
    <ul class="navi-list type1 non flex">
      ...
      <li>
         ...
         <a href="javascript:chk_LogMenuProc(); chk_TeamNotice();"><span class="img-box"><img src="../images/include/gnb/icon_plan_off@3x.png" alt></span><span class="menu-txt">팀 공지사항<span id="GNBTNOTICE" style="display:none" class="ic-new">N</span></span></a>
         -->

        <a href="javascript:chk_LogMenuProc('TEAM_NOTICE','MONO');"><span class="img-box"><img src="http://img.sportsdiary.co.kr/sdapp/gnb/icon_plan_off@3x.png" alt></span><span class="menu-txt">팀 공지사항<span id="GNBTNOTICE" style="display:none" class="ic-new">N</span></span></a>
      </li>
    </ul>
    <!-- E: navi-list 2 -->
    <ul class="navi-list type2 flex">
      ...
      <li class="">
        <a href="javascript:chk_LogMenuProc('COUNSEL','MONO');">
    ...
    <div class="cate-list">
      ...
      <dl class="type3 clearfix">
        ...
        <dd class="no-bdb clearfix"><a href="javascript:chk_LogMenuProc('COUNSEL','MONO');"><span class="menu-txt">지도자 상담</span></a><span class="ic-wrap clearfix"><span id="GNBCOUNCEL" style="display:none" class="ic-new">N</span><span id="GNBCOUNCELRE" style="display:none" class="ic-re">Re</span></span></dd>
      </dl>
      <!-- E: 나의 정보 -->
      <!-- S: 대회 정보 -->
      <dl class="clearfix">
