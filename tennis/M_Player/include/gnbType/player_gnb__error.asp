...
<div class="gnb <%=Type_Class%>" id="gnb">
  <!-- <div class="gnb-box"> -->
    ...
    <ul class="navi-list type2 flex">
      ...
      <li class="">
        <a href="javascript:chk_LogMenuProc('COUNSEL','PLAYER');">
    ...
    <div class="cate-list">
      ...
      <dl class="type3 clearfix">
        ...
        <dd class="non-type2 non-type3"><a href="../Schedule/sche-calendar.asp">나의 훈련 일정</a></dd>
        <dd class="non-type2 non-type3"><a href="../Stats/stat-training-attand.asp">나의 통계</a></dd>
        <dd class="non non-type3 clearfix"><a href="../Memory/memory-estimate.asp"><span class="menu-txt">메모리</span></a><span class="ic-wrap clearfix"><span id="GNBCOUNCEL" style="display:none" class="ic-new">N</span><span id="GNBCOUNCELRE" style="display:none" class="ic-re">Re</span></span></dd>
        ...
        <dd class="clearfix"><a href="javascript:chk_LogMenuProc('COUNSEL','PLAYER');"><span class="menu-txt">지도자 상담</span></a><span class="ic-wrap clearfix"><span id="GNBCOUNCEL" style="display:none" class="ic-new">N</span><span id="GNBCOUNCELRE" style="display:none" class="ic-re">Re</span></span></dd>
      </dl>
      <!-- E: 나의 정보 -->
      <!-- S: 대회 정보 -->
      <dl class="clearfix">
      ...
      <dl class="clearfix">
        <dt>미디어</dt>
        <dd><a href="../Board/notice-list.asp"><span class="menu-txt">뉴스<span id="GNBMEDIA" style="display:none;" class="ic-new">N</span></span></a></dd>
        <dd><a href="../Board/qa_board.asp">동영상</a></dd>
        <dd><a href="#">칼럼</a></dd>
        <dd><a href="#">애널리스트</a></dd>
      ...
      <dl class="clearfix">
        ...
        <dd><a href="../partner/pt_srch.asp">파트너 찾기</a></dd>
        <dd><a href="../lesson/register.asp">레슨 코트 찾기</a></dd>
        <dd><a href="../rally/register.asp">난타 모집</a></dd>
        <!-- <dd><a href="#">생활체육 소식</a></dd> -->
      </dl>
      <!-- E: 커뮤니티 -->

      <!-- S: ㅋㅋ몰 광고 -->
      <dl class="ad_pack clearfix">
        <dt>ㅋㅋ몰</dt>
        <div class="banner banner_sm">
          <!-- <img src="http://lorempixel.com/320/80/" alt="ㅋㅋ몰 바로가기"> -->
        </div>
      </dl>
      <!-- E: ㅋㅋ몰 광고 -->
    </div>
    ...
    <div class="gnb-footer">
      ...
      <h3>
        <img src="../images/include/footer/bottom-logo@3x.png" alt="스포츠다이어리">
      </h3>
    </div>
  </div>
  <!-- E: gnb-box -->