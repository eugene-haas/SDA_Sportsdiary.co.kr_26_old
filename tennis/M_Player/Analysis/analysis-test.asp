...
<script type="text/javascript">
  ...
  function iUser() {
    ...
    if (itextno > 0) {
      var strAjaxUrl = "../Ajax/analysis-Search-UserName_Sch.asp";
      $.ajax({
        url: strAjaxUrl,
        type: 'POST',
        dataType: 'html',
...
<body class="lack-bg">
  ...
  <!--<div class="tail short-tail">-->
    <a href="#"><img src="../images/record/close-tail@3x.png" id="click_open" style="display:none;" alt="열기"></a>
    <a href="#" ><img src="../images/record/open-tail@3x.png" id="click_close" alt="닫기"></a>
  </div>
  <!-- E: tail -->
