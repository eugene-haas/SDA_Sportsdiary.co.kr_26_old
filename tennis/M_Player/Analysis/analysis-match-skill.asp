...
<script type="text/javascript">
  ...
  function table_ajax(sub_type) {
    ...
    var strAjaxUrl = "../Ajax/analysis-match-skill.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
  ...
  function chart_view() {
    ...
    if (isearch_val() == false) {
      ...
      var strJsonUrl = "../Json/analysis-match-skill.asp?SDate=" + iSDate + "&EDate=" + iEDate + "&GameTitleIDX=" + iGameTitleIDX.value + "&PlayerIDX=" + iPlayerIDX;
      //alert(strJsonUrl);
...
<body class="lack-bg">
  ...
  <div class="record-menu analysis-menu">
    ...
    <div class="menu-list mid-cat">
      <ul class="record-mid clearfix" style="display: block;">
        ...
        <li><a href="javascript:onSubmitStat('./analysis-match-skill.asp');" class="on">기술별</a></li>
  ...
  <div class="state-cont" id="chart_view" style="display:none;">
    <div class="chart-tab tab-2 container clearfix">
      ...
      <a href="javascript:click_tab('skillpoint');" id="iskillpoint">좌우기술별 득실점</a>
    </div>
    ...
    <div id="itable">
      ...
      <div class="skill-part-chart">
        ...
        <div class="skill-part-table container" id="sub_table1">
        </div>
