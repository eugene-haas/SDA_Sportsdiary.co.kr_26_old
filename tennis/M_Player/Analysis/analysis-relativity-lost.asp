...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    if (isearch_val() == false) {
      ...
      var strJsonUrl = "../Json/analysis-relativity-lost.asp?SDate=" + iSDate + "&EDate=" + iEDate + "&PlayerIDX=" + iPlayerIDX + "&GameTitleIDX=" + iGameTitleIDX.value
  ...
  function chart_sub(sub_type) {
    ...
    var strAjaxUrl = "../Ajax/analysis-relativity-lost.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
...
<div class="record-menu analysis-menu">
  ...
  <div class="menu-list mid-cat">
    <ul class="rank-mid clearfix" style="display: block;">
      <li><a href="javascript:onSubmitStat('./analysis-relativity-get.asp');">좌우기술 득점</a></li>
      <li><a href="javascript:onSubmitStat('./analysis-relativity-lost.asp');" class="on">좌우기술 실점</a></li>
    </ul>
  </div>
</div>
<!-- E: record-menu -->
...
<div class="state-cont relativity" id="chart_view" style="display:none;">
  ...
  <section class="stat-chart train-place">
    ...
    <!-- E: 좌우기술 실점-->
    <!-- S: 좌우기술 실점 서브 테이블 -->
    <div class="detail-table table-2 point-table lost" id="sub_chart_total">
