...
<script type="text/javascript">
  ...
  function view_keyword() {
    ...
    var strAjaxUrl = "../Ajax/analysis-Search-UserName.asp";
  ...
  function table_ajax() {
    ...
    var strAjaxUrl = "../Ajax/analysis-match-time.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
  ...
  function chart_view() {
    ...
    if (isearch_val() == false) {
      ...
      var strJsonUrl = "../Json/analysis-match-time.asp?SDate=" + iSDate + "&EDate=" + iEDate + "&GameTitleIDX=" + iGameTitleIDX.value + "&PlayerIDX=" + iPlayerIDX;
...
<body class="lack-bg">
  ...
  <div class="record-menu analysis-menu">
    ...
    <div class="menu-list mid-cat">
      <ul class="record-mid clearfix" style="display: block;">
        <li><a href="javascript:onSubmitStat('./analysis-match-point.asp');">점수별</a></li>
        <li><a href="javascript:onSubmitStat('./analysis-match-skill.asp');">기술별</a></li>
        <li><a href="javascript:onSubmitStat('./analysis-match-time.asp');" class="on">시간대별</a></li>
      </ul>
    </div>
  </div>
  <!-- E: record-menu -->
  ...
  <div class="state-cont" id="chart_view" style="display: none;">
    <div class="chart-tab tab-2 container clearfix">
      <a href="javascript:click_tab('totalpoint');" class="on" id="itotalpoint">전체 득실점</a>
      <a href="javascript:click_tab('skillpoint');" id="iskillpoint">시간대별 기술구사</a>
    </div>
    ...
    <div id="itable">
      ...
      <div class="skill-part-chart">
        ...
        <!-- S: time-part-table -->
        <div class="time-part-table container" id="sub_table1">
        </div>
        <p class="no-apply-txt">※지도는 기술구사가 없어 점수에 반영되지 않습니다.</p>
      </div>
      </section>
    </div>
    <!-- E: 시간대별 기술구사 -->
