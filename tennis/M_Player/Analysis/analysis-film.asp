...
<script type="text/javascript">
  ...
  var iLoginPlayerIDX = '<%=PlayerIDX%>';
  var iLoginMemberIDX = '<%=MemberIDX%>';
  ...
  function table_ajax() {
    ...
    var strAjaxUrl = "../Ajax/analysis-film-sub.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
      data: {
        ...
        GameTitleIDX: iGameTitleIDX.value,
        iLoginPlayerIDX: iLoginPlayerIDX
      },
      success: function (retDATA) {
        if (retDATA) {
        ...
        $("#sub_table1").iconFavo("#sub_table1");
      },  error: function(xhr, status, error){
          if(error!=""){
				alert ("오류발생! - 시스템관리자에게 문의하십시오!");
				return;
...
<div class="record-menu analysis-menu">
  ...
  <div class="menu-list mid-cat">
    <ul class="rank-mid clearfix" style="display: block;">
      ...
      <li><a href="javascript:onSubmitStat('./analysis-film.asp');" class="on">대회영상모음</a></li>
...
<form name="s_frm" method="post">
  ...
  <div class="record-input bg-ipt" id="sbox">
    ...
    <!-- E: sel-list -->
    <div class="btn-list"> <a href="javascript:;" class="btn-left btn btn-close">닫기</a> <a href="javascript:chart_view();" class="btn-right btn">조회</a> </div>
  </div>
</form>
<!-- E: record-input -->
<!-- S: tail -->
<div class="tail bg-tail">
  ...
  <a href="javascript:click_open();"><img src="http://img.sportsdiary.co.kr/sdapp/record/close-tail@3x.png" id="click_open" style="display:none;" alt="열기"></a> <a href="javascript:;" ><img src="http://img.sportsdiary.co.kr/sdapp/record/open-tail@3x.png" id="click_close" alt="닫기"></a> </div>
<!-- E: tail -->
<!-- S: main stat-record -->
