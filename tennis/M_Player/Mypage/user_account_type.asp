...
' Check_Login()
  ...
  SELECT CASE SportsType
    ...
    CASE "judo"
      ...
      LSQL = LSQL & "         WHEN 'T' THEN '엘리트-지도자('+ISNULL(SportsDiary.dbo.FN_PubName('sd03900' + LeaderType),'')+')<br>'+ISNULL(SportsDiary.dbo.FN_TeamNm2('"&SportsType&"', M.Team),'')"
      ...
      LSQL = LSQL & "         WHEN 'T' THEN '생활체육-지도자('+ISNULL(SportsDiary.dbo.FN_PubName('sd03900' + LeaderType),'')+')<br>'+ISNULL(SportsDiary.dbo.FN_TeamNm2('"&SportsType&"', M.Team),'')"
      LSQL = LSQL & "         WHEN 'D' THEN '일반' "
      LSQL = LSQL & "       END "
      LSQL = LSQL & "   ELSE '국가대표' "
