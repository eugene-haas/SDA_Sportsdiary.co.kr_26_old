...
<%
 ...
 '2017-06-26 추가
  ...
  LSQL = "EXEC Analysis_Detail_Score_Game_Search '" & iType & "','" & iSportsGb & "','" & iPlayerIDX & "','" & iGameScoreIDX & "','','','','',''"
  ...
  LSQL = "EXEC Analysis_Detail_Score_Game_Search '" & iType & "','" & iSportsGb & "','" & iPlayerIDX & "','" & iGameScoreIDX & "','" & iRGameLevelidx & "','" & iGameTitleIDX & "','" & iGroupGameGb & "','" & iGroupGameNum & "','" & iGameNum & "'"
	'response.Write "LSQL="&LSQL&"<br>"
  'response.End
  ...
  <div class="modal-content">
    <div class="modal-header clearfix">
      ...
      <a href="#" data-dismiss="modal">
        <!-- <img src="../images/stats/x@3x.png" alt="닫기"> -->&times;</a>
    </div>
    <!-- E: modal-content -->
    <!-- S: modal-body -->
