...
<%
  ...
  Dim LRsCnt1, iAdtMyDiay, iAdtMyDiayCklYn, iWriteDate, iWriteDatea, iGameRerdIDX, iGameTitleIDX
  LRsCnt1 = 0

  iType = "22"
  iSportsGb = "judo"
  enciType = encode(22,0)
...
<div class="panel panel-default">
  <div class="panel-heading" role="tab">
   ...
   <p class="panel-ic-q sw-chara"><span onclick="javascript:iFavLink('<%=enciType %>','<%=enciGameRerdIDX %>','');" class="img-icon icon-<%=iAdtMyDiayCklYn %>-favorite">★</span></p>
