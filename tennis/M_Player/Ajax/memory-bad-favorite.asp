...
<%
  ...
  Dim LRsCnt1, iAdtNotWell, iWriteDate, iWriteDatea, iGameRerdIDX, iTrRerdIDX, iGameTitleIDX, iTrRerdDate, iMemoryType, enciRerdIDX, enciType
  LRsCnt1 = 0

  iType = "13"
  iSportsGb = "judo"
  enciType = encode(13,0)
...
<div class="panel panel-default">
  <div class="panel-heading" role="tab">
   ...
   <p class="panel-ic-q sw-chara"><span onclick="javascript:iFavLink('<%=enciType %>','<%=enciRerdIDX %>','<%=iMemoryType %>');" class="img-icon icon-on-favorite"><!-- <img src="../images/memory/favorite-star-on@3x.png" alt="" /> -->★</span></p>
