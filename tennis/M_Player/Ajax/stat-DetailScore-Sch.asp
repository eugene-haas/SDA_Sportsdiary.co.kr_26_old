...
<%
 ...
 '2017-06-26 추가
  ...
  LSQL = "EXEC Stat_Detail_Score_Search '" & iType & "','" & iSportsGb & "','" & iPlayerIDX & "','" & iGameScoreIDX & "','','','','',''"
  ...
  LSQL = "EXEC Stat_Detail_Score_Search '" & iType & "','" & iSportsGb & "','" & iPlayerIDX & "','" & iGameScoreIDX & "','" & iRGameLevelidx & "','" & iGameTitleIDX & "','" & iGroupGameGb & "','" & iGroupGameNum & "','" & iGameNum & "'"
	'response.Write "LSQL="&LSQL&"<br>"
  'response.End
  ...
  <div class="modal-content">
    <div class="modal-header clearfix">
      ...
      <a href="#" data-dismiss="modal">
        <img src="http://img.sportsdiary.co.kr/sdapp/stats/x@3x.png" alt="닫기"></a>
    </div>
    <!-- E: modal-content -->
    <!-- S: modal-body -->
  ...
  <div class="modal-footer">
    ...
    <div class="btn-list flex">
      <button type="button" class="btn btn-orange btn-film <%IF iMediaLink="" Then response.Write "off" End IF%>" onclick="changeDet('OPEN','<%=iMediaLink %>');" style="display: block;">
		...
		Else
			response.write "<span class=""ic-deco""> <img src=""http://img.sportsdiary.co.kr/sdapp/stats/x@3x.png"" alt=""""></span>"
			response.Write "영상보기"
		End IF
		%></button>
