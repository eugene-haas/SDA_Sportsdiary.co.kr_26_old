...
'		response.Write LSQL
		...
		IF Not(LRs.Eof Or LRs.Bof) Then 
			...
			IF PlayerReln = "A" OR PlayerReln = "B" OR PlayerReln = "Z" Then
				...
				CSQL = CSQL & "		,a.Auth_YN "  	
				CSQL = CSQL & "		,CASE WHEN a.PlayerReln IS NULL OR a.PlayerReln = '' THEN 'R' ELSE a.PlayerReln END PlayerReln " 		
				...
				CSQL = CSQL & "		AND (a.PlayerReln IS NULL OR a.PlayerReln = '' OR a.PlayerReln = 'R' OR a.PlayerReln = 'K' OR a.PlayerReln = 'S')"
