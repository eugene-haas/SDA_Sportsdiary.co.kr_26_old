...
<%
  ...
  Dim LRsCnt1, iAdtNotWell, iAdtNotWellCkYn, iWriteDate, iWriteDatea, iTrRerdIDX, iTrRerdDate, enciTrRerdIDX, enciType
  LRsCnt1 = 0

  iType = "11"
  iSportsGb = "judo"
  enciType = encode(11,0)
...
<div class="panel panel-default">
  <div class="panel-heading" role="tab">
   ...
   <p class="panel-ic-q sw-chara"><span onclick="javascript:iFavLink('<%=enciType %>','<%=enciTrRerdIDX %>','');" class="img-icon icon-<%=iAdtNotWellCkYn %>-favorite">★</span></p>
