...
<%
 ...
 '2017-06-26 추가 
  ...
  LSQL = "EXEC Analysis_Relativity_Search '" & iType & "','" & iSportsGb & "','" & PlayerIDX & "','" & SDate & "','" & EDate & "','" & GameTitleIDX & "','" & Sub_Type & "'"
  ...
  If Not (LRs.Eof Or LRs.Bof) Then
    ...
    'retext = retext&"		<tr>"
	  ...
	  'retext = retext&"			<td class=""big-gain"">57</td>"
	  'retext = retext&"			<td class=""big-gain"">30</td>"
	  'retext = retext&"			<td class=""big-gain"">27</td>"
	  'retext = retext&"		</tr>"
	  'retext = retext&"		<tr>"
