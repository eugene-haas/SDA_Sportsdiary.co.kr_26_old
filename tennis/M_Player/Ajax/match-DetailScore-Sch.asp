...
<%
  ...
  LSQL = "EXEC MatchPlayer_TM_Match_Detail_Score_Search '" & iType & "','" & iSportsGb & "','" & iPlayerIDX & "','" & iGameScoreIDX & "','','','','',''"
  ...
  LSQL = "EXEC MatchPlayer_TM_Match_Detail_Score_Search '" & iType & "','" & iSportsGb & "','" & iPlayerIDX & "','" & iGameScoreIDX & "','" & iRGameLevelidx & "','" & iGameTitleIDX & "','" & iGroupGameGb & "','" & iGroupGameNum & "','" & iGameNum & "'"
	'response.Write "LSQL="&LSQL&"<br>"
  'response.End
  ...
  <div class="modal-content">
    ...
    <div class="container">
      ...
      <div class="film-box panel" style="display: none;">
        ...
        <!-- E: guide-txt -->
        <iframe id="iframeMov" width="100%" height="260" src="" frameborder="0" allowfullscreen></iframe>
      </div>
      <!-- E: 영상보기 film-box -->
    </div>
  ...
  <div class="modal-content">
    ...
    <div class="container">
      ...
      <div class="record-box panel" id="modal_container" style="display: block;">
        <!-- S: guide-txt -->
        <div class="guide-txt">
          ※상세 기술의 경우 현장 기록관의 주관적인 판단에 의해 기록되므로 약간의 오차가 있을 수 있습니다. <br>
          ※ 당일 촬영장비 혹은 체육관 환경에 따라 서비스 제공이 불가할 수 있습니다.
        </div>
        <!-- E: guide-txt -->
        <h3>득실기록</h3>
