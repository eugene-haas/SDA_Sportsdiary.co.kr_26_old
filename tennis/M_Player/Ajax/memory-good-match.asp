...
<%
  ...
  Dim LRsCnt1, iAdtWell, iAdtWellCkYn, iWriteDate, iWriteDatea, iGameRerdIDX, iGameTitleIDX, enciGameRerdIDX, enciType
  LRsCnt1 = 0
...
<div class="panel panel-default">
  <div class="panel-heading" role="tab">
   ...
   <p class="panel-ic-q sw-chara"><span onclick="javascript:iFavLink('<%=enciType %>','<%=enciGameRerdIDX %>','');" class="img-icon icon-<%=iAdtWellCkYn %>-favorite">★</span></p>
