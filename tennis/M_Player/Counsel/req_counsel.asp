...
<script type="text/javascript">
  ...
  function chk_Submit(typeURL, CIDX, chkPage){
    ...
    var strAjaxUrl = "../Ajax/counsel_list.asp";
    var SDate = $("#SDate").val();
    var EDate = $("#EDate").val();
  ...
  /*
    //Default Board Contents
    var strAjaxUrl = "/M_Parents/Ajax/counsel_list.asp";
    var currPage = $("#currPage").val();
    var SDate = $("#SDate").val();
    var EDate = $("#EDate").val();
    var search_date = $("select[name=search_date]").val();
...
<div class="record-menu">
  <div class="big-cat">
    <ul class="menu-list flex">
      <li><a href="./req_counsel.asp?typeMenu=req_counsel" class="btn on">상담요청하기</a></li>
...
<form name="frm" method="post">
  ...
  <div class="record-input bg-ipt" id="sbox">
    ...
    <div class="top-counsel write clearfix">
      <h3>지도자에게 자유롭게 상담해보세요</h3>
      <a href="./counsel_write.asp?typeMenu=<%=typeMenu%>" class="btn btn-or">글쓰기</a> </div>
    <!-- E: top-counsel -->
  </div>
</form>
<!-- E: record-input -->
<!-- S: tail -->
<div class="tail bg-tail bd-bg"> <a href="javascript:;"><img src="http://img.sportsdiary.co.kr/sdapp/record/close-tail@3x.png" id="click_open" alt="열기"></a> <a href="javascript:;" ><img src="http://img.sportsdiary.co.kr/sdapp/record/open-tail@3x.png" id="click_close" style="display:none;" alt="닫기"></a> </div>
<!-- E: tail -->
<!-- S: state-cont -->
