...
<script type="text/javascript">
  ...
  function chk_Submit(typeURL, CIDX, chkPage){
    ...
    var strAjaxUrl = "../Ajax/favorite_counsel.asp";
    var SDate = $("#SDate").val();
    var EDate = $("#EDate").val();
  ...
  $(document).ready(function(){
	...
	/*
    //Default Board Contents
    var strAjaxUrl = "/M_Parents/Ajax/favorite_counsel.asp";
    var currPage = $("#currPage").val();
    var SDate = $("#SDate").val();
    var EDate = $("#EDate").val();
    var search_date = $("select[name=search_date]").val();
  ...
  function SET_Favorite(CIDX, strType){
    ...
    var strAjaxUrl = "../Ajax/favorite_counsel_set.asp";
    var SDate = $("#SDate").val();
    var EDate = $("#EDate").val();
    var search_date = $("select[name=search_date]").val();
    var currPage = $("#currPage").val();
  ...
  //검색 작성자선택 조회
  //make_box("search_user","fnd_user","","counsel_User");
</script>
<body class="board-bg lack-bg">
...
<div class="record-menu">
  <div class="big-cat">
    <ul class="menu-list flex">
      ...
      <li><a href="./from_manager.asp?typeMenu=from_manager" class="btn">상담받기</a></li>
      <li><a href="./favorite_counsel.asp?typeMenu=favorite_counsel" class="btn on">즐겨찾기</a></li>
    </ul>
  </div>
</div>
<!-- E: record-menu -->
<!-- S: record-bg -->
<!-- #include file = "./intro-bg-up2.asp" -->
<!-- E: record-bg -->
<!-- S: record-input -->
...
<!-- E: record-input -->
<!-- S: tail -->
<div class="tail bg-tail"> <a href="javascript:;"><img src="http://img.sportsdiary.co.kr/sdapp/record/close-tail@3x.png" id="click_open" alt="열기"></a> <a href="javascript:;" ><img src="http://img.sportsdiary.co.kr/sdapp/record/open-tail@3x.png" id="click_close" style="display:none;" alt="닫기"></a> </div>
<!-- E: tail -->
<!-- S: state-cont -->
<div class="state-cont">
  <!-- S: top-counsel -->
  <div class="top-counsel write clearfix">
    <h3>중요한 상담내용을 저장하고 관리하세요.</h3>
  </div>
  <!-- E: top-counsel -->
  <!-- S: sub sub-main -->
