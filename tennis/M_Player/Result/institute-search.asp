  ...
  <script type="text/javascript">
	...
	function modalSetting(id,obj,url) {
        ...
        List.done(function () {
            ...
            for (var i = 0; i < jsondata.length; i++) {
				...
				var tcode = jsondata[i].tcode; //요강때문에 넣음.
				g_tcode = tcode;
    ...
    function btnLink(BtnId) {
        ...
        switch (BtnId) {
			...
			case "summary" :
			if (g_tcode == 64){
			url = "http://tennis.sportsdiary.co.kr/tennis/m_player/result/rookieTennis_info2.asp";$(location).attr('href', url);
			}
			else
			{
			url = "../result/rookieTennis_info.asp";$(location).attr('href', url);
			}
			break;
