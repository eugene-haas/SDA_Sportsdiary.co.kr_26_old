           ...
           <%
                ...
                <%'END IF %>
                 <div id="<%=officialtrainwrap %>" class="official-train-wrap"  name="<%=officialtrainwrap %>-<%=classonof %>" >
                    ...
                    <li>
                        <select id="TrailHour<%=i %>"  class="<%=team_class %>" <%=disabledSTR %>>
                            <%
            ...
            %> 
                <ul id="memory" class="memory" >
                  <li>
                    ...
                    <p><textarea id="AdtWell" placeholder="잘된점을 입력하세요"><%= p_AdtWell  %></textarea></p>
                  </li>
                  <li>
                   <%
                        CLASSNAME ="icon-off-favorite"
                    ...
                    <p><textarea id="AdtNotWell" placeholder="보완점을 입력하세요."><%= p_AdtNotWell  %></textarea></p>
                  </li>
                  <li>
                   <%
                        CLASSNAME ="icon-off-favorite"
                    ...
                    <p><textarea id="AdtMyDiay" placeholder="나만의 일기를 작성해 보세요. (비공개)"><%= p_AdtMyDiay  %></textarea></p>
                  </li>
                  <li>
                   <%
                        CLASSNAME ="icon-off-favorite"
                    ...
                    <p><textarea id="AdtAdvice" placeholder="코치님 또는 감독님에게 하고 싶은 말을 입력하세요."><%= p_AdtAdvice  %></textarea></p>
                  </li>
                  <li>
                   <%
                        CLASSNAME ="icon-off-favorite"
