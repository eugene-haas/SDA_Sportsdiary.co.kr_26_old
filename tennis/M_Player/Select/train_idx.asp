...
Else 
    ...
    <%
        ...
        Do Until LRs.Eof 
            ...
            p_AdtWell	    = ReplaceTagReText(LRs("AdtWell"))
            p_AdtNotWell    = ReplaceTagReText(LRs("AdtNotWell"))	
            p_AdtMyDiay     = ReplaceTagReText(LRs("AdtMyDiay"))	
            p_AdtAdvice	    = ReplaceTagReText(LRs("AdtAdvice"))
            p_AdtAdviceRe	= ReplaceTagReText(LRs("AdtAdviceRe"))
