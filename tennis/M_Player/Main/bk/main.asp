...
<script type="text/javascript">
  ...
  //종목메인 계정 설정 체크
  // sdmain/index.asp
  // tennis/main/main.asp
  function chk_JoinUser(obj){
    switch(obj) {
      case 'judo'   : $(location).attr('href', 'http://judo.sportsdiary.co.kr/M_Player/Main/login.asp?valSDMAIN=<%=valSDMAIN%>'); break;
      case 'tennis' : $(location).attr('href', 'http://tennis.sportsdiary.co.kr/tennis/m_player/main/main.asp');
      //default:
    }


    //베타오픈시 주석처리, 정식오픈때 주석해제합니다.
    /*
  ...
  <body>
    ...
    <div class="part_main tennis_part">
      ...
      <div class="main gray_bg">
        ...
        <div class="main_menu">
          <ul class="clearfix">
            <li><a href="javascript:chk_JoinUser('judo');"><span>유도</span></a></li>
            <!--<li class="ready"><a href="#"><span>레슬링</span></a></li>-->
            <li><a href="javascript:chk_JoinUser('tennis');" class="on"><span>테니스</span></a></li>
            <!--<li class="ready"><a href="#"><span>배드민턴</span></a></li>
            <li class="ready"><a href="#"><span>검도</span></a></li>
            <li class="ready"><a href="#"><span>싸이클</span></a></li>
            -->
          </ul>
        </div>
        <!-- E: main_menu -->
        ...
        <div class="margin_pack">
          ...
          <div class="list main_list match_list">
            <a href="../Result/institute-search.asp" class="btn_more">
              <span class="img_deco">
                <img src="http://img.sportsdiary.co.kr/sdapp/public/btn_more@3x.png" alt="더보기">
              </span>
            </a>
            <ul id="match_list">
			<!--
        ...
        <!-- S: main_list news_list list -->
         <div class="main_list news_list list">
          <a href="../Media/list.asp" class="btn_more">
            <span class="img_deco">
              <img src="http://img.sportsdiary.co.kr/sdapp/public/btn_more@3x.png" alt="더보기">
            </span>
          </a>
      ...
      -->
        ...
        <div class="notice_list list">
          <h3 class='list_tit'>공지사항</h3>
            <a href="../Board/notice-list.asp" class="btn_more">
              <span class="img_deco">
                <img src="http://img.sportsdiary.co.kr/sdapp/public/btn_more@3x.png" alt="더보기">
              </span>
            </a>
    ...
    -->
        ...
        <div class="kk_mall mall">
          ...
          <div class="banner banner_md" style="background-color: #000">
            ...
            <div class="banner_area">
              <a href="#" >
                <img src="/ad_banner/kkmall/kkmall_banner.jpg" alt>
              </a>
            </div>
            <!-- E: banner_area -->
          </div>
