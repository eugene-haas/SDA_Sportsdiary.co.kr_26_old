...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#tourney_title").html(localStorage.getItem("GameTitleName") + " 예선 ");
        score.settingSearch();
  ...
  <div class="sub sub-main tourney h-fix">
    ...
    <div class="tourney-sel">
      <ul class="clearfix">
        ...
        <li>
          <button type="button" id="search" class="btn btn-gray btn-search" onmousedown="score.gameSearch(0)">조 회</button>
        </li>
    ...
    <!-- S: tourney-mode -->
    <div class="tourney-main" id="scoregametable"> </div>
