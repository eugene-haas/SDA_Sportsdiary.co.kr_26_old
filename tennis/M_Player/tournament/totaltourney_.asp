...
<!-- E: config --> 
<style type="text/css">
.sub.tourney .tourney{overflow:inherit;}
</style>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#SexLevel").on("change", function () { score.gameSearch($("#H_GameType").val()); console.log(" SexLevel change"); });
...
<body id="AppBody">
  ...
  <div class="sub sub-main tourney h-fix">
    ...
    <div class="tourney-sel">
      <ul class="clearfix">
        ...
        <li>
          <button type="button" id="search" class="btn btn-warning btn-search" onmousedown='score.gameSearch($("#H_GameType").val())'>조 회</button>
        </li>
  ...
  <!-- S: 테니스 상세스코어 모달 -->
  <!-- #include file="../include/modal/tn_score_record_.asp" -->
  <!-- E: 테니스 상세스코어 모달 -->
