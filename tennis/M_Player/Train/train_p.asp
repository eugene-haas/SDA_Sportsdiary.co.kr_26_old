...
<form name="frm" id="frmSave" method="post">
    ...
    <input type="hidden" name="F1_AdtAdviceRe"id="F1_AdtAdviceRe">
</form>
  ...
  <div class="sub train strength">
    ...
    <div class="navyline-top-list clearfix">
      ...
      <div id="train-div01" class="clearfix">
        ...
        <select id="train-check01-select" name="train-check01-select" class="train-select"> </select>
      </div>
      <!-- E : 훈련참석 > 정상참석, 일부참석 선택시 -->
      <!-- S : 훈련불참 선택시 -->
      <div id="train-div02" class="clearfix">
        <select id="train-check02-select" name="train-check02-select"class="train-select"> </select>
      </div>
      <!-- E : 훈련불참 선택시 -->
    ...
    <ul id="train-goal-list"class="train-goal-list"></ul>
    <!-- E : 훈련목표(중복선택가능) -->
    <!-- S: 공식훈련 내용 제목 -->
