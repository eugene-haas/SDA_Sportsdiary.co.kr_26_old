...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    var strAjaxUrl = "../Ajax/memory-councel-favorite.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
...
<div class="record-menu memory-menu">
  ...
  <div class="menu-list mid-cat flex">
    ...
    <ul class="rank-mid goodth clearfix" style="display: block;">
      ...
      <li><a href="javascript:onSubmit('../Memory/memory-councel-match.asp');">대회일지 <span id="SUBCOUNCELGAME" style="display:none" class="ic-new">N</span></a></li>
      <li><a href="javascript:onSubmit('../Memory/memory-councel-favorite.asp');" class="favorite on">즐겨찾기<span class="icon-on-favorite">
