...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    var strAjaxUrl = "../Ajax/memory-councel-match.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
...
<div class="record-menu memory-menu">
  <div class="big-cat">
    <ul class="menu-list clearfix">
      ...
      <li> <a href="javascript:onSubmit('../Memory/memory-councel.asp');" class="btn on">지도자상담 모아보기 <span id="SUBCOUNCEL" style="display:none" class="ic-new">N</span></a></li>
    </ul>
  </div>
  <!-- S: 나의 평가표 서브메뉴 -->
  <div class="menu-list mid-cat flex">
    ...
    <ul class="rank-mid goodth clearfix" style="display: block;">
      <li><a href="javascript:onSubmit('../Memory/memory-councel.asp');">훈련일지 <span id="SUBCOUNCELTRAIN" style="display:none" class="ic-new">N</span></a></li>
      <li><a href="javascript:onSubmit('../Memory/memory-councel-match.asp');" class="on">대회일지 <span id="SUBCOUNCELGAME" style="display:none" class="ic-new">N</span></a></li>
      <li><a href="javascript:onSubmit('../Memory/memory-councel-favorite.asp');" class="favorite">즐겨찾기<span class="icon-on-favorite">
...
<!-- E: record-input -->
<!-- S: tail -->
<div class="tail bg-tail"> <a href="javascript:click_open();"><img src="../images/record/close-tail@3x.png" id="click_open" style="display:none;" alt="열기"></a> <a href="#" ><img src="../images/record/open-tail@3x.png" id="click_close" alt="닫기"></a> </div>
<!-- E: tail -->
<!-- S: 부트스트랩 아코디언 -->
<div class="memory-councel divn" id="chart_view" style="display:none;">
  <section class="good-list">
    <h2><span class="img-icon"><img src="../images/memory/icon-good@3x.png"></span><span id="during_date">2017-02-14~2017-02-20</span></h2>
  </section>
