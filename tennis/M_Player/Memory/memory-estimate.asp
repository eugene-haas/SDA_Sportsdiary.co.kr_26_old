...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    var SDate = $('#SDate').val();
    var EDate = $('#EDate').val();
    var strJsonUrl = "../Json/memory-estimate.asp?SDate=" + SDate + "&EDate=" + EDate + "&iPlayerIDX=" + iMemberIDX;
  ...
  function chart_sub(date, tridx) {
    ...
    var strAjaxUrl = "../Ajax/memory-estimate.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
...
<div class="record-menu memory-menu">
  ...
  <div class="menu-list mid-cat flex">
    <ul class="rank-mid clearfix" style="display: block;">
      <li><a href="javascript:onSubmit('../Memory/memory-estimate.asp');" class="on">훈련평가표</a></li>
      <li><a href="javascript:onSubmit('../Memory/memory-match-estimate.asp');">대회평가표</a></li>
    </ul>
    <!-- S: 잘된점 모아보기 서브메뉴 -->
...
<!-- E: record-input -->
<!-- S: tail -->
<div class="tail bg-tail"> <a href="#"><img src="http://img.sportsdiary.co.kr/sdapp/record/close-tail@3x.png" id="click_open" style="display:none;" alt="열기"></a> <a href="#"><img src="http://img.sportsdiary.co.kr/sdapp/record/open-tail@3x.png" id="click_close" alt="닫기"></a> </div>
<!-- E: tail -->
<!-- S: estimate -->
