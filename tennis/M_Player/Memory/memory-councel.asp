...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    var strAjaxUrl = "../Ajax/memory-councel.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
...
<div class="record-menu memory-menu">
  <div class="big-cat">
    <ul class="menu-list clearfix">
      ...
      <li> <a href="javascript:onSubmit('../Memory/memory-councel.asp');" class="btn on">지도자상담 모아보기</a> <span id="SUBCOUNCEL" style="display:none" class="ic-new">N</span></li>
    </ul>
  </div>
  <div class="menu-list mid-cat flex">
    <!-- S: 지도자상담 모아보기 서브메뉴 -->
    <ul class="rank-mid councel clearfix" style="display: block;">
      <li><a href="javascript:onSubmit('../Memory/memory-councel.asp');" class="on">훈련일지 <span id="SUBCOUNCELTRAIN" style="display:none" class="ic-new">N</span></a></li>
...
<div class="memory-councel divn" id="chart_view" style="display:none;">
  <section class="good-list">
    <h2><span class="img-icon"><img src="http://img.sportsdiary.co.kr/sdapp/memory/icon-good@3x.png"></span><span id="during_date">2017-02-14~2017-02-20</span></h2>
  </section>
