...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    var strAjaxUrl = "../Ajax/memory-bad-match.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
...
<div class="record-menu memory-menu">
  <div class="big-cat">
    <ul class="menu-list clearfix">
      ...
      <li> <a href="javascript:onSubmit('../Memory/memory-bad.asp');" class="btn on">보완점 모아보기</a> </li>
  ...
  <div class="menu-list mid-cat flex">
    ...
    <ul class="rank-mid goodth clearfix" style="display: block;">
      <li><a href="javascript:onSubmit('../Memory/memory-bad.asp');">훈련일지</a></li>
      <li><a href="javascript:onSubmit('../Memory/memory-bad-match.asp');" class="on">대회일지</a></li>
      <li><a href="javascript:onSubmit('../Memory/memory-bad-favorite.asp');" class="favorite">즐겨찾기<span class="icon-on-favorite">
