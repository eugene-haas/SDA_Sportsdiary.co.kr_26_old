...
<script type="text/javascript">
  ...
  function chart_view() {
    ...
    var strAjaxUrl = "../Ajax/memory-good.asp";
    $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
...
<div class="record-menu memory-menu">
  ...
  <div class="menu-list mid-cat flex">
    ...
    <ul class="rank-mid goodth clearfix" style="display: block;">
      <li><a href="javascript:onSubmit('../Memory/memory-good.asp');" class="on">훈련일지</a></li>
      <li><a href="javascript:onSubmit('../Memory/memory-good-match.asp');">대회일지</a></li>
      <li><a href="javascript:onSubmit('../Memory/memory-good-favorite.asp');" class="favorite">즐겨찾기<span class="icon-on-favorite">
