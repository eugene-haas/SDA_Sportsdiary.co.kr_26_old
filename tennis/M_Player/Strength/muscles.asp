...
<form name="frm" id="frm" method="post">
  ...
  <div class="sub train strength">
    <div class="top-icon-menu">
      <ul class="flex">
        <li>
          <a href="../train/train.asp"><img src="http://img.sportsdiary.co.kr/sdapp/train/icon_pract_off@3x.png" alt="훈련일지" /></a>
        </li>
        <li>
          <a href="../MatchDiary/match-diary.asp"><img src="http://img.sportsdiary.co.kr/sdapp/train/icon_match_off@3x.png" alt="대회일지" /></a>
        </li>
        <li>
          <a href="../Strength/index.asp"><img src="http://img.sportsdiary.co.kr/sdapp/train/icon_physi_on@3x.png" alt="체력측정" /></a>
        </li>
        <li>
          <a href="javascript:chk_TeamNotice();" role="button" alt="팀공지사항"><img src="http://img.sportsdiary.co.kr/sdapp/train/icon_notice_off@3x.png" alt="팀 공지사항" /></a>
        </li>
      </ul>
    ...
    <div id="guide-tip" class="navyline-top-list guide-tip clearfix">
      ...
      <div class="tip-cont container collapse">
        ...
        <h4 class="muscle-sub-title"><img src="http://img.sportsdiary.co.kr/sdapp/strength/muscle-sub-title@3x.png" alt="벤치프레스 측정기준"></h4>
        <!-- S: muscle-way -->
...
<!--           <ul class="way-list">
          ...
          <!-- <img src="../images/strength/muscles-way@3x.png" alt=""> -->
        </div>
        <!-- E: muscle-way -->
        <!-- S: know-detail -->
    ...
    <div class="exc-list">
      <ul id ="exc-list" >
        ...
        <li class="clearfix">
          <div class="event-img">
            <img src="http://img.sportsdiary.co.kr/sdapp/strength/icon-squart@3x.png" alt>
          </div>
          <div class="exc-cont">
            <p class="exc-title">스쿼트</p>
            <p class="exc-exp">1회 들어올릴 수 있는 최대 무게</p>
          </div>
          <div class="exc-count">
            <label>
        ...
        <li class="clearfix">
          <div class="event-img">
            <img src="http://img.sportsdiary.co.kr/sdapp/strength/icon-bench@3x.png" alt>
          </div>
          <div class="exc-cont">
            <p class="exc-title">벤치프레스</p>
            <p class="exc-exp">1회 들어올릴 수 있는 최대 무게</p>
          </div>
          <div class="exc-count">
            <label>
              <input type="text" value="26">kg
            </label>
          </div>
        </li>
      </ul>
