...
<%
 'Controller ################################################################################################
	...
	strFieldName = " PlayerIDX,UserName,UserPhone,Birthday,Sex,PersonCode,team,teamNm,team2,team2Nm,userLevel,WriteDate,belongBoo,rankboo         ,titlecode,dblrnk,levelup,openrnkboo  "
...
'	Response.write "<th><span >부(신인,오픈,베테 : 개나리,국화)</th>"
	Response.write "<th><span >오픈부점수반영위치</th>"
	%><th>승급자 <a href="javascript:mx.resetUPMember()" class="btn_a" style="color:orange;">전년도초기화</a> (Y/N)</th><%
