		...
		<div class="top-navi-inner">
			...
			<div class="top-navi-btm">
				...
				<div class="navi-tp-table-wrap"  id="gameinput_area">
					<!-- #include virtual = "/pub/html/tennisAdmin/operator/html.operatorForm.asp" -->
				</div>
...
<%
	...
	Response.write "<table class=""table-list"" id=""playerlist"">"
	...
	Response.write "<thead><th>번호</th><th>대상</th><th>아이디</th><th>패스워드</th><th>등록일</th></thead>"
	...
	Do Until rs.eof
		...
		admin_pwd = rs("WritePwd") 
		writeday = Left(rs("writedate"),10)
		%><!-- #include virtual = "/pub/html/tennisAdmin/operator/html.operatorList.asp" --><%
	rs.movenext
	Loop
