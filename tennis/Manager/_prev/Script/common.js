...
/*박스 생성S*/
function make_box(element,attname,code,action_type, sportsgb){
  ...
  }else if(action_type=="TeamGbMatch"){
    var strAjaxUrl = "/Manager/Select/TeamGbMatch_Select_Change.asp";      
  ...
  }else if (action_type=="GameTitle_Year_change3"){
    var strAjaxUrl = "/Manager/Select/GameTitle_Select_Year_change3.asp";
  ...
  }else if (action_type=="GameDay_change"){
    var strAjaxUrl = "/Manager/Select/GameDay_Select.asp";    	
  }else if (action_type=="GameTitleMatch"){
    var strAjaxUrl = "/Manager/Select/GameTitle_Select_Change.asp";	
  }
  ...
  $.ajax({
      ...
      type: 'POST',
      dataType: 'html',
      data: { element: element ,attname:attname ,code:code, sportsgb:sportsgb },
      success: function(retDATA) {
        if(retDATA){  
			console.log(action_type + ":" + retDATA);
...
/*박스 생성E*/
function make_box2(element,attname,code,action_type,gametitleidx){
	if(action_type=="TeamGbMatch"){
    var strAjaxUrl = "/Manager/Select/TeamGbMatch_Select_Change.asp";      
	}
  $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
      data: { element: element ,attname:attname ,code:code ,gametitleidx:gametitleidx },
      success: function(retDATA) {
        if(retDATA){  
            document.getElementById(element).innerHTML = retDATA  
        }     
...
function make_box_level2(element,attname,code,action_type,teamgb,gametitleidx){
  //alert(action_type)
    var strAjaxUrl = "/Manager/Select/Level_Select_Check2.asp";
  $.ajax({
      url: strAjaxUrl,
      type: 'POST',
      dataType: 'html',
      data: { element: element ,attname:attname ,code:code ,teamgb:teamgb,gametitleidx:gametitleidx},
      success: function(retDATA) {
        if(retDATA){  
            document.getElementById(element).innerHTML = retDATA  
        }     
