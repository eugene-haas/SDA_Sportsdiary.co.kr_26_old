...
Do Until GRs.Eof 
    ...
    if GroupGameGb="sd040001" then
        ...
        HostNm =roundRs("HostNm")
        HostCode =roundRs("HostCode")
...
<head>
    ...
    <script type="text/javascript">
            ...
            for (var i = 0; i < $a4.length; i++) {
                html2canvas($a4[i], {
                    onrendered: function (canvas) {
                        ...
                        opener.document.getElementById("Enter_Score_Print_new").innerHTML = opener.document.getElementById("Enter_Score_Print_new").innerHTML+ Enter_Score_Print_data_str;
                    }
                });
            }
        }
        ...
        function printC() {
         var strFeature = "";
			strFeature += "width=600, height=300, all=no";
			var objWin = window.open('', 'print', strFeature);
			objWin.document.write('<html><head> <title>' + C_GameTitleName + "_" + C_GroupGameGbNm + "_" + C_TeamGbNm + "_" + C_LevelNm + "_" + s_StadiumNumber + "경기장_" + s_GameNum + '경기</title></head><body>');
			objWin.document.write($("#Enter_Score_Print").html());
