...
<body>
      ...
      <div class="input-select ent-sel row">
        ...
        <div class="enter-type tab-menu">
          <ul class="clearfix">
            ...
            <li class="game-type">
              <label ><span><img src="../tablet/images/tournerment/tourney/icon-private@3x.png" alt width="18" height="18"></span><span class="type-text">개인전</span><input type="radio" name="GameType" <%If GameType = SportsCode&"040001" Then %>checked<%End If%> value="<%=SportsCode%>040001" ></label>
            </li>
            <li class="game-type">
              <label ><span><img src="../tablet/images/tournerment/tourney/icon-group@3x.png" alt width="16" height="21"></span><span class="type-text">단체전</span><input type="radio" name="GameType" <%If GameType = SportsCode&"040002" Then %>checked<%End If%> value="<%=SportsCode%>040002"></label>
            </li>
    ...
    <div class="tourney-main hidden-main">
      ...
      <!-- E: tourney-->
			...
			%>
				<input type="text" name="GameNum" value="<%=strGameNum%>">
			</form>
		<%
			Else 
		%>
