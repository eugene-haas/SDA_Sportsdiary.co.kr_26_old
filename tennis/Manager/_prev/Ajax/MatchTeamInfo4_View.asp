						...
						<table border="0" height="100%">
							...
							<tr>
								...
								<%
									...
									End If
									'&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
								If TotGameCnt = "4" Then 
									'4강경기일경우=====================================================================================================
										If (i Mod 2 = 1) Then 
											spanstyle = "display: block; border-top: 1px solid #000; border-right: 1px solid #000; height: 162px; margin-top: 162px;"
										ElseIf TotGameCnt <> "2" And (i Mod 2 = 0) Then 
											spanstyle = "display: block; border-bottom: 1px solid #000; border-right: 1px solid #000; height: 162px; margin-top: -162px;"
										End If 
								%>
								<td width="40%"><span style="<%=spanstyle%>"></span></td>
								<%
									If i=1 Then 
								%>
								<td width="40%" rowspan="2"><span style="display: block; border-bottom: 1px solid #000;  height: 8px; margin-top: -8px;"></span></td>
								<%
									End If 
									'4강경기일경우=====================================================================================================
								%>
						...
						<table border="0" height="100%">
							...
							<tr>								
								...
								<%
									...
									'4강경기일경우=====================================================================================================
										If (i Mod 2 = 1) Then 
											spanstyle = "display: block; border-top: 1px solid #000; border-left: 1px solid #000; height: 162px; margin-top: 162px;"
										ElseIf TotGameCnt <> "2" And (i Mod 2 = 0) Then 
											spanstyle = "display: block; border-bottom: 1px solid #000; border-left: 1px solid #000; height: 162px; margin-top: -162px;"
										End If 
								%>
								<td width="40%"><span style="<%=spanstyle%>"></span></td>
								<%
