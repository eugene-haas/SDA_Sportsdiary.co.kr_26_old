							...
							<tr>
								...
								<%
									...
									'16강경기일경우=====================================================================================================
										...
										End If 
								%>
								<td width="16%"><span style="<%=spanstyle%>"></span></td>
								<%
									'2Depth Line*********************************************8
									If i= 1 Or i = 5 Or i = 9 Or i = 13 Then 
								%>
								<td width="16%" rowspan="2"><span style="display: block; border-top: 1px solid #000; border-right: 1px solid #000;  height: 83px; margin-top: 83px;"></span></td>
								<%
									ElseIf i = 3 Or i = 7 Or i = 11 Or i = 15 Then 
								%>
								<td width="16%" rowspan="2"><span style="display: block; border-bottom: 1px solid #000; border-right: 1px solid #000;  height: 83px; margin-top: -83px;"></span></td>
								<%
									End If 								
									'2Depth Line*********************************************8
								%>								
								<%
									...
									If i = 1 Or i = 9 Then 
								%>
								<td width="16%" rowspan="4"><span style="display: block; border-top: 1px solid #000; border-right: 1px solid #000; height: 162px; margin-top: 162px;"></span></td>								
								<%
									ElseIf i =5 Or i = 13 Then 
								%>
								<td width="16%" rowspan="4"><span style="display: block; border-bottom: 1px solid #000; border-right: 1px solid #000; height: 162px; margin-top: -162px;"></span></td>								
								<%
									End If 
									'3Depth*****************************
								%>
								<%
									...
									If i = 1 Then 
								%>
								<td width="16%" rowspan="8"><span style="display: block; border-top: 1px solid #000; border-right: 1px solid #000; height: 324px; margin-top: 324px;"></span></td>
								<%
									ElseIf i = 9 Then 
								%>
								<td width="16%" rowspan="8"><span style="display: block; border-bottom: 1px solid #000; border-right: 1px solid #000; height: 324px; margin-top: -324px;"></span></td>
								<%
									End If 
									'4Depth$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
								...
								<%
									...
									If i = 1 Then 
								%>
								<td width="16%" rowspan="16"><span style="display: block; border-bottom: 1px solid #000;  height: 162px; margin-top: -162px;"></span></td>								
								<%
									End If 
									'5Depth$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
						...
						<table border="0" height="100%">
							...
							<tr>
								...
								<%
									...
									If i = 1 Then 
								%>
								<td width="16%" rowspan="8"><span style="display: block; border-top: 1px solid #000; border-left: 1px solid #000; height: 324px; margin-top: 324px;"></span></td>
								<%
									ElseIf i = 9 Then 
								%>
								<td width="16%" rowspan="8"><span style="display: block; border-bottom: 1px solid #000; border-left: 1px solid #000; height: 324px; margin-top: -324px;"></span></td>
								<%
									End If 
									'4Depth$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
								%>
								<%
									...
									If i = 1 Or i = 9 Then 
								%>
								<td width="16%" rowspan="4"><span style="display: block; border-top: 1px solid #000; border-left: 1px solid #000; height: 162px; margin-top: 162px;"></span></td>								
								<%
									ElseIf i =5 Or i = 13 Then 
								%>
								<td width="16%" rowspan="4"><span style="display: block; border-bottom: 1px solid #000; border-left: 1px solid #000; height: 162px; margin-top: -162px;"></span></td>								
								<%
									End If 
									'3Depth*****************************
								%>					
								<%
									...
									If i= 1 Or i = 5 Or i = 9 Or i = 13 Then 
								%>
								<td width="16%" rowspan="2"><span style="display: block; border-top: 1px solid #000; border-left: 1px solid #000;  height: 83px; margin-top: 83px;"></span></td>
								<%
									ElseIf i = 3 Or i = 7 Or i = 11 Or i = 15 Then 
								%>
								<td width="16%" rowspan="2"><span style="display: block; border-bottom: 1px solid #000; border-left: 1px solid #000;  height: 83px; margin-top: -83px;"></span></td>
								<%
									End If 								
									'2Depth Line*********************************************8
								%>								
