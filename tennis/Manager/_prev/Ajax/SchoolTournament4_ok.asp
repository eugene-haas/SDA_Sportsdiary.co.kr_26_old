...
<%
	...
	If Hidden_Data1 <> "" And Hidden_Data2 <> "" Then 
		...
		InSQL = InSQL&" VALUES "
		InSQL = InSQL&"('"&Request.Cookies("SportsGb")&"','"&GameTitleIDX&"','"&RGameLevelIDX&"','"&TeamGb&"','"&Sex&"','"&Hidden_Data1&"','"&Player1&"','101','"&SportsCode&"042001','"&SportsCode&"030001','"&R1_Num1&"','"&R2_Num1&"','','','','','','" & hidden_data_TeamDtl1 & "')"
		...
		InSQL = "Insert Into tblRGameGroupSchool (SportsGb,GameTitleIDX,RGameLevelidx,TeamGb,Sex,Team,SchoolName,SchNum,UnearnWin,LeftRightGb,Game1R,Game2R,Game3R,Game4R,Game5R,Game6R,Game7R,TeamDtl)"
		InSQL = InSQL&" VALUES "
		InSQL = InSQL&"('"&Request.Cookies("SportsGb")&"','"&GameTitleIDX&"','"&RGameLevelIDX&"','"&TeamGb&"','"&Sex&"','"&Hidden_Data2&"','"&Player2&"','102','"&SportsCode&"042001','"&SportsCode&"030001','"&R1_Num1&"','"&R2_Num1&"','','','','','','" & hidden_data_TeamDtl2 & "')"
		Dbcon.Execute(InSQL)
	Else
		'부전승
		InSQL = "Insert Into tblRGameGroupSchool (SportsGb,GameTitleIDX,RGameLevelidx,TeamGb,Sex,Team,SchoolName,SchNum,UnearnWin,LeftRightGb,Game1R,Game2R,Game3R,Game4R,Game5R,Game6R,Game7R,TeamDtl)"
		InSQL = InSQL&" VALUES "
		InSQL = InSQL&"('"&Request.Cookies("SportsGb")&"','"&GameTitleIDX&"','"&RGameLevelIDX&"','"&TeamGb&"','"&Sex&"','"&Hidden_Data1&"','"&Player1&"','101','"&SportsCode&"042002','"&SportsCode&"030001','"&R1_Num1&"','"&R2_Num1&"','','','','','','" & hidden_data_TeamDtl1 & "')"
		Dbcon.Execute(InSQL)
	End If 
    ...
    InSQL = "Insert Into tblRGameGroupSchool (SportsGb,GameTitleIDX,RGameLevelidx,TeamGb,Sex,Team,SchoolName,SchNum,UnearnWin,LeftRightGb,Game1R,Game2R,Game3R,Game4R,Game5R,Game6R,Game7R,TeamDtl)"
		InSQL = InSQL&" VALUES "
		InSQL = InSQL&"('"&Request.Cookies("SportsGb")&"','"&GameTitleIDX&"','"&RGameLevelIDX&"','"&TeamGb&"','"&Sex&"','"&Hidden_Data3&"','"&Player3&"','103','"&SportsCode&"042001','"&SportsCode&"030002','"&R1_Num2&"','"&R2_Num1&"','','','','','','" & hidden_data_TeamDtl3 & "')"

		Dbcon.Execute(InSQL)

		InSQL = "Insert Into tblRGameGroupSchool (SportsGb,GameTitleIDX,RGameLevelidx,TeamGb,Sex,Team,SchoolName,SchNum,UnearnWin,LeftRightGb,Game1R,Game2R,Game3R,Game4R,Game5R,Game6R,Game7R,TeamDtl)"
		InSQL = InSQL&" VALUES "
		InSQL = InSQL&"('"&Request.Cookies("SportsGb")&"','"&GameTitleIDX&"','"&RGameLevelIDX&"','"&TeamGb&"','"&Sex&"','"&Hidden_Data4&"','"&Player4&"','104','"&SportsCode&"042001','"&SportsCode&"030002','"&R1_Num2&"','"&R2_Num1&"','','','','','','" & hidden_data_TeamDtl4 & "')"
		Dbcon.Execute(InSQL)
	Else
		'부전승
		InSQL = "Insert Into tblRGameGroupSchool (SportsGb,GameTitleIDX,RGameLevelidx,TeamGb,Sex,Team,SchoolName,SchNum,UnearnWin,LeftRightGb,Game1R,Game2R,Game3R,Game4R,Game5R,Game6R,Game7R,TeamDtl)"
		InSQL = InSQL&" VALUES "
		InSQL = InSQL&"('"&Request.Cookies("SportsGb")&"','"&GameTitleIDX&"','"&RGameLevelIDX&"','"&TeamGb&"','"&Sex&"','"&Hidden_Data3&"','"&Player3&"','103','"&SportsCode&"042002','"&SportsCode&"030002','"&R1_Num2&"','"&R2_Num1&"','','','','','','" & hidden_data_TeamDtl3 & "')"
		Dbcon.Execute(InSQL)
	End If 
...
<script>
 ...
 window.open('/Manager/Ajax/Match4_View.asp?GameTitleIDX=<%=GameTitleIDX%>&TeamGb=<%=TeamGb%>&Level=<%=Level%>&GroupGameGb=<%=SportsCode%>040002','_blank'); 
