...
function update_frm(seq){		
	...
	if(confirm("동영상 URL을 저장하시겠습니까?")){
		var strAjaxUrl = "/Manager_wres/Ajax/Championshipoperate_Update.asp";
...
function assign_Cheif(){
	...
	var strAjaxUrl="/Manager_wres/ajax/Cheif_assign.asp";
	$.ajax({
			url: strAjaxUrl,
			type: 'POST',
			dataType: 'html',
...
//저지페이퍼출력
function print_judgepaper(playerresultidx){	
	window.open('/Manager/View/judgepaper.asp?playerresultidx='+playerresultidx,'_blank');
	...
	<section>
		<div id="content">
			...
			<div class="btn-right-list">
				<a href="javascript:assign_Cheif();" class="btn" id="btnview" accesskey="s">심판배정</a>
			</div>
			<div class="btn-right-list">
