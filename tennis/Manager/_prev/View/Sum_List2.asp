...
%>
<script>
function down_excel(gametitleidx){
	
	location.href="Sum_List2_Excel.asp?GameTitleIDX="+gametitleidx;

}
</script>
<!-- S: btn -->
<div class="btn-excel-save">
  <a href="javascript:down_excel('<%=GameTitleIDX%>');">엑셀로 저장</a>
</div>
<!-- E: btn -->
<!--대회 타이틀 S-->
...
<table class="match_stat_table" style="width: 99%;margin: 0 auto; border: 1px solid #333;">
  ...
  <tr class="stat_total_last" style="border-bottom: none;">
    <td colspan="11" align="right" style="padding-top: 10px; padding-bottom: 10px; padding-right: 10px;"><%=SumCnt%>팀</td>    
  </tr>
  <!-- 총합계-->
</table>
