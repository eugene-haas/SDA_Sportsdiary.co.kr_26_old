...
<%
 ...
 'SQL = SQL&" OR  B.RResult <> 'sd019021' or B.RResult <> 'sd019006' or B.LResult <> 'sd019022')"
'	SQL = SQL&" ( B.RResult <> 'sd019006' AND B.LResult <> 'sd019006' AND B.RResult <> 'sd019021' AND B.LResult <> 'sd019021' AND B.RResult <> 'sd019022' AND B.LResult <> 'sd019022'  )"
...
function chk_save(objno){
	...
	<section>
		<div id="content">
		<form method="post" name="search_frm" id="search_frm" action="Matchupload_wres.asp"> 
