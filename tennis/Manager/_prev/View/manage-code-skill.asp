					...
					<table class="sch-table">
						...
						<tbody>
							<tr>
								...
								<td>
									<select>
										<option value="op1">굳히기</option>
										<option value="op2">누으며메치기</option>
										<option value="op3">되치기</option>
									</select>
								</td>
								<th></th>
								<td></td>
				...
				<table class="table-list">
					...
					<tbody>
						<tr>
							...
							<td>judo</td>
							<td>sp006004</td>
							<td class="left">되치기</td>
							<td class="left">기타되치기</td>
							<td>sp006</td>
							<td>4</td>
						</tr>
						<tr>
							...
							<td>judo</td>
							<td>sp006004</td>
							<td class="left">누으며메치기</td>
							<td class="left">기타누으며메치기</td>
							<td>sp006</td>
							<td>3</td>
						</tr>
						<tr>
