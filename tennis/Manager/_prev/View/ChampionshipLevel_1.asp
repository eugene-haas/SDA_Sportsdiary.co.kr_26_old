...
function view_frm(tp){
	...
	var strAjaxUrl="/Manager/ajax/ChampionshipLevel_View_1.asp";
	$.ajax({
			url: strAjaxUrl,
			type: 'POST',
			dataType: 'html',
...
//대진표결과보기
function tourney_view(GameTitleIDX,GameTitleName,TeamGb,Level,GroupGameGb,Sex,EnterType){
	var f = document.match_frm;
	    f.GameTitleIDX.value = GameTitleIDX;
	    f.GameTitleName.value = GameTitleName;
	    f.TeamGb.value = TeamGb;
	    f.Level.value = Level;
	    f.GroupGameGb.value = GroupGameGb;
	    f.EnterType.value = EnterType;
	    f.Sex.value = Sex;
        f.action = "/Manager/tourney/tourney.asp"
        f.target = "_blank"
        f.submit()
}
...
<input type="hidden" name="GameTitleName" id="GameTitleName" value="">
...
<input type="hidden" name="EnterType" id="EnterType" value="">
</form>