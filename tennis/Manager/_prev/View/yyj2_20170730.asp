...
<script>
//대진표 입력관련 스크립트
function chk_player(obj,obj2,no,team){
  //참가선수수
...
//대진표리스트->입력데이터 이동
function input_data(obj,obj2,team){
	//alert(team);
              ...
              <div class="player-info" tabindex="0">
                <div class="player-input-wrap">
                  ...
                  <%
                    ...
                    Next
                  %>
                  <span class="player-name-input"><input type="text" name="Player<%=i%>" id="Player<%=i%>" <%=css_disabled%> readonly onclick="input_data(this,'hidden_data<%=i%>','Team<%=i%>')" /></span>
                  <span class="player-name-input"><input type="text" name="Team<%=i%>" id="Team<%=i%>" <%=css_disabled%> readonly onclick="input_data(this,'hidden_data<%=i%>','Team<%=i%>')" /></span>									
          ...
          <%
            ...
            If GameType = SportsCode&"040001" Then 
              If RGameLevelIDX <> "" Then 
                LSQL = "select PlayerIDX,UserName,SportsDiary.dbo.FN_TeamCodeReturnTeamNm('"&Request.Cookies("SportsGb")&"',Team) AS TeamNm from Sportsdiary.dbo.tblRplayerMaster  where GameTitleidx='"&GameTitleIDX&"' and RgameLevelIDX='"&RGameLevelIDX&"' AND DelYN='N' Order By TeamNm" 'TeamNm" 'UserName
                'Response.Write LSQL
                'Response.End
            ...
            <div class="inner">
              ...
              %>
                <dl id="No<%=k%>" class="clearfix">
                  ...
                  <dd onclick="chk_player('<%=LRs("UserName")%>','<%=LRs("PlayerIDX")%>','<%=k%>','<%=LRs("TeamNm")%>')"><%=LRs("UserName")%></dd>
                  <dd onclick="chk_player('<%=LRs("UserName")%>','<%=LRs("PlayerIDX")%>','<%=k%>','<%=LRs("TeamNm")%>')"><%=LRs("TeamNm")%></dd>
                </dl>
              <%
                      k = k + 1
											pcnt = pcnt + 1
              ...
              <div class="inner">
                ...
                %>
                  <dl id="No<%=k%>" class="">
                    ...
                    <dd onclick="chk_player('<%=LRs("SchoolName")%>','<%=LRs("Team")%>','<%=k%>','<%=LRs("SchoolName")%>')"><%=LRs("SchoolName")%></dd>
                  </dl>
                <%
                        k = k + 1
												pcnt = pcnt + 1
              ...
              <div class="player-info" tabindex="0">
                <div class="player-input-wrap">
                  ...
                  <%                    
                    ...
                    Next                  
                  %>
                  <span class="player-name-input"><input type="text" name="Player<%=k%>" id="Player<%=k%>" <%=css_diabled%> readonly onclick="input_data(this,'hidden_data<%=k%>','Team<%=k%>')" /></span>
									<span class="player-name-input"><input type="text" name="Team<%=k%>" id="Team<%=k%>"  <%=css_diabled%> readonly onclick="input_data(this,'hidden_data<%=k%>','Team<%=k%>')" /></span>
