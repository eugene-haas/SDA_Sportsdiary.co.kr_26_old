...
<%	
	...
	LSQL = LSQL&" ,ISNULL(Sportsdiary.dbo.Fn_TeamNm2('"&Request.Cookies("SportsGb")&"',PR.LTeam),'') As LTeamNm "
	LSQL = LSQL&" ,ISNULL(Sportsdiary.dbo.Fn_TeamNm2('"&Request.Cookies("SportsGb")&"',PR.RTeam),'') As RTeamNm "
