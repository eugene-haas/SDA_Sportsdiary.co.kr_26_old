...
Search_UserNm   = fInject(request("Search_UserNm"))
...
<script type="text/javascript">
    ...
    function select_data(KeyValue, seq) {
        ...
        var Search_UserNm = f.Search_UserNm.value;
        ...
        if (seq==1) {
            ...
            Search_UserNm = f.Search_UserNm.value;
		...
		<div id="content">
			...
			<div class="top-navi">
				<div class="top-navi-inner">
					                ...
					                <table class="sch-table">
						                ...
						                <tbody>
							                <tr>
								                ...
								                <th scope="row">검색</th>
								                <td id="sel_Search"> <input type="text" name="Search_Search" id="Search_Search" /> </td>
                                                <th></th>
                                                <td></td>
                                                <th></th>
                                                <td></td>
                    ...
                    <div class="top-navi-btm" id="input_Player">
						<div class="navi-tp-table-wrap">
                        <h4 class="sub-tit">선수프로필</h4>
					...
					<div class="top-navi-btm" id="input_area">
						...
						<div class="navi-tp-table-wrap">
                        <h4 class="sub-tit">소속팀정보</h4>
							<table class="navi-tp-table">
								<tbody>									
									<tr>
										<th scope="row"><label for="player-code">팀코드</th>
										<td>
                                            <input type=text name="Team" id="Team"  class="input-small" readonly />
                                             <a href="javascript:Postcode();"  class="btn-sch-pop" > 소속팀변경</a>
                                        </td>
										<!-- 종목구분S -->
										<th scope="row"><label for="sports-kind">팀명칭</label></th>
                                        <td>
                                            <input type="text" name="TeamNm" id="TeamNm" readonly/>
                                        </td>
										<!-- 종목구분E -->
										<!-- 회원구분S -->
