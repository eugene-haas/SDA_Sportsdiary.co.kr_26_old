...
<script type="text/javascript">
  function PagingLink(i2) {
     post_to_url('./Player_Inter_Judge.asp', { 'i2':i2, 'i3': "<%=ReqLocalVal%>",'i4': "<%=ReqOptionVal%>", 'i5':"<%=ReqSearchVal%>"});
  }
  ...
  function fn_selSearch()
  {
    ...
    post_to_url('./Player_Inter_Judge.asp', { 'i2': 1 , 'i3': selectLocalVal,'i4': selectTypeOptionVal,'i5': txtSearchVal});
  }

  function ViewPagingLink(i1, i2){
		post_to_url('./Player_Inter_Judge_write.asp', { 'i1':i1 ,'i2':i2, 'i3': "<%=ReqLocalVal%>",'i4': "<%=ReqOptionVal%>", 'i5':"<%=ReqSearchVal%>", 'i6' : 2});
	}

  function WriteLink(i2) {
     post_to_url('./Player_Inter_Judge_write.asp', { 'i2':i2, 'i3': "<%=ReqLocalVal%>",'i4': "<%=ReqOptionVal%>", 'i5':"<%=ReqSearchVal%>", 'i6' : 1});
  }
