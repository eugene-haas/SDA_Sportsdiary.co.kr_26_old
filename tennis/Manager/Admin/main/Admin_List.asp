...
%>
  ...
  <script type="text/javascript">
   ...
   <section>
    ...
    <!-- E : 내용 시작 -->
    <div class="btn_list right">
			<a href="javascript:;" onclick="gtag('event','버튼클릭',{'event_category':'어드민관리','event_label':'어드민등록'});javascript:WriteLink('<%=NowPage %>');" class="btn_skyblue"><span class="icon_pen">어드민 등록</span></a>
		</div>
		<% end if %>
