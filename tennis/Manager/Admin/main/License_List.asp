...
<script type="text/javascript">
  ...
  function PagingLink(i2) {
     post_to_url('./License_List.asp', { 'i2':i2 , 'i3':"<%=iSearchCol%>",'i4': "<%=iSearchText%>",'i5': "<%=iStatus%>",'i6':"<%=iStartDate%>",'i7':"<%=iEndDate%>" });
  }
  ...
  function fn_selSearch()
  {
    ...
    post_to_url('./License_List.asp', { 'i2': 1 ,'i3': txtSearchVal,'i4': selectTypeOptionVal,'i5':startDateVal,'i6':endDateVal});
  }

  function ViewPagingLink(i1, i2){
		post_to_url('./License_write.asp', {'i1':i1, 'i2':i2 , 'i3':"<%=iSearchCol%>",'i4': "<%=iSearchText%>",'i5': "<%=iStatus%>",'i6':"<%=iStartDate%>",'i7':"<%=iEndDate%>",'i8' : 2 });
	}

  function WriteLink(i2) {
     post_to_url('./License_write.asp', { 'i2':i2, 'i3':"<%=ReqOptionVal%>",'i4': "<%=ReqTextSearchVal%>",'i5': "<%=ReqWeightVal%>",'i6':"<%=iYear%>",'i8':1});
  }

  function fn_selSearchXls() {
    post_to_url('./License_List_Xls.asp', { 'i2': 1 ,'i3': txtSearchVal,'i4': selectTypeOptionVal,'i5':startDateVal,'i6':endDateVal});
  }
