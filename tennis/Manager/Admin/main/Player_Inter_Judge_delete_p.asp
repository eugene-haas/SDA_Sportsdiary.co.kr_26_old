...
<%
  ...
  If LoginIDYN = "N" Then
    JudoKorea_DBClose()
    response.Write "<script type='text/javascript'>alert('잘못된 접근 입니다.');location.href='./Player_Inter_Judge.asp';</script>"
  ...
  ELSE
    ...
    LRs.close
    JudoKorea_DBClose()
    response.Write "<script type='text/javascript'>location.href='./Player_Inter_Judge.asp';</script>"
    response.End
