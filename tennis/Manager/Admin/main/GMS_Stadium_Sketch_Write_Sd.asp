...
<script type="text/javascript">
  ...
  function CancelLink()
  {
		$('form[name=form1]').attr('action',"./GMS_Stadium_Sketch_Sd.asp");		
  ...
  function Sketch_Result(sk_gubun,sketch_idx, idx)
  {
	  if(confirm("해당 사진을 삭제하시겠습니까?")){
		var strAjaxUrl="GMS_Stadium_Sketch_Result_Sd.asp?sk_gubun="+sk_gubun+ "&sketch_idx=" + sketch_idx + "&idx="+idx;
					...
					if(retDATA)
						{
							...
							{	
								...
								{
									var strAjaxUrl="GMS_Stadium_Sketch_ajax_Sd.asp?sketch_idx="+sketch_idx
									//location.href=strAjaxUrl
									//alert(strAjaxUrl);
										var retDATA="";
										//alert(strAjaxUrl);
...
<section>
	<div id="content">
		...
		<div class="contents">
			...
			<!-- E: 네비게이션 -->
			<form id="form1" name="form1" action="./GMS_Stadium_Sketch_Write_p_Sd.asp" method="post" ENCTYPE="multipart/form-data">
