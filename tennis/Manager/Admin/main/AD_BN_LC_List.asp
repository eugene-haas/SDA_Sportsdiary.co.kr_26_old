...
<%
  ...
  selSearch12 = fInject(Request("selSearch12"))
	selSearch13 = fInject(Request("selSearch13"))
  ...
  if(Len(selSearch12) = 0) Then selSearch12 = ""
	if(Len(selSearch13) = 0) Then selSearch13 = ""
  ...
  LSQL = "EXEC AD_tblADLocate_Main_S '" & NowPage & "','" & PagePerData & "','" & BlockPage & "','" & iType & "','" & iDivision & "','" & iSportsGb & "','" & iCateLocate1 & "','" & iCateLocate2 & "','" & iCateLocate3 & "','" & iCateLocate4 & "','" & iViewYN & "','" & iSearchCol & "','" & iSearchText & "','" & iSearchCol1 & "','" & selSearch12 & "','" & selSearch13 & "','','',''"
...
<script type="text/javascript">
  ...
  var selSearchValue12 = "<%=selSearch12%>";
  var selSearchValue13 = "<%=selSearch13%>";


	function WriteLink(i2) {
		post_to_url('./AD_BN_LC_Write.asp', { 'i2': i2, 'iType': '1', 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue, 'iViewYN': selSearchValue6, 'iCateLocate1': selSearchValue8, 'iCateLocate2': selSearchValue9, 'iCateLocate3': selSearchValue10, 'iCateLocate4': selSearchValue11, 'selSearch12': selSearchValue12, 'selSearch13': selSearchValue13 });
	}

	function ReadLink(i1, i2) {
		post_to_url('./AD_BN_LC_Write.asp', { 'i1': i1, 'i2': i2, 'iType': '2', 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue, 'iViewYN': selSearchValue6, 'iCateLocate1': selSearchValue8, 'iCateLocate2': selSearchValue9, 'iCateLocate3': selSearchValue10, 'iCateLocate4': selSearchValue11, 'selSearch12': selSearchValue12, 'selSearch13': selSearchValue13 });
	}
    ...
    selSearchValue13 = document.getElementById('selSearch13').value;
    selSearchValue12 = document.getElementById('selSearch12').value;
		...
		post_to_url('./AD_BN_LC_List.asp', { 'i2': 1, 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue, 'iViewYN': selSearchValue6, 'iCateLocate1': selSearchValue8, 'iCateLocate2': selSearchValue9, 'iCateLocate3': selSearchValue10, 'iCateLocate4': selSearchValue11, 'selSearch12': selSearchValue12, 'selSearch13': selSearchValue13 });
	}
   ...
   <section>
        ...
        <tbody>
          <tr>
            ...
            <td>
							...
							<select id="selSearch12" name="selSearch12" class="title_select">
                <%
								  ' 리스트 조회
                  jNowPage = "1"
                  jPagePerData = "1"
            ...
            <td>
							...
							<select id="selSearch13" name="selSearch13" class="title_select">
                <%
								  ' 리스트 조회
                  jNowPage = "1"
                  jPagePerData = "1"
          ...
          <tr>
            <td>
              ...
              <select id="selSearch" name="selSearch" class="title_select">
                ...
                <option value="LCGN">지면가격종류</option>
                <option value="LCN">지면가격</option>
								<option value="MM">메모사항</option>
              </select>
            </td>
            <td colspan="3">
    ...
    <table class="table-list news_notice_list">
      ...
      <thead>
        <tr>
          ...
          <th scope="col">노출방식</th>
					<th scope="col">지면크기</th>
					<th scope="col">지면가격(주간)</th>
					<th scope="col">지면가격(월간)</th>
          <th scope="col">지면가격(연간)</th>
        ...
        <%
          ...
          If Not (LRs.Eof Or LRs.Bof) Then
            Do Until LRs.Eof
                LCnt = LCnt + 1
        %>
        <tr  style="cursor:pointer" onclick="javascript:ReadLink('<%=encode(LRs("LocateIDX"),0) %>','<%=NowPage %>');">
          <td><%=LRs("Num") %></td>
					<td>
						<%=LRs("CateLocate1Nm") %>
					</td>
          ...
          <td><%=LRs("TypeOutputNm") %></td>
          <td><%=LRs("LocateGbNm") %></td>
					<td><%=LRs("LocateCashW") %></td>
					<td><%=LRs("LocateCashM") %></td>
          <td><%=LRs("LocateCashY") %></td>
          <td>
    ...
    <div class="board-btm-list">
      ...
      <!-- E : 내용 시작 -->
      <div class="btn_list right" style="display:none;">
  ...
  <section>
    ...
    <script type="text/javascript">
      ...
      $("#selSearch12").val(selSearchValue12);
      $("#selSearch13").val(selSearchValue13);
