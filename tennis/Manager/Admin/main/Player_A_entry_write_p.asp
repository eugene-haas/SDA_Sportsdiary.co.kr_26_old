...
<%
 ...
 End If
  ...
  Next
  IF ( iType = 1 ) THEN
  response.Write "<script type='text/javascript'>alert('정상적으로 등록되었습니다.');location.href='./Player_A_entry.asp';</script>"
  response.End
  ELSEIF  ( iType = 2 ) THEN
  response.Write "<script type='text/javascript'>alert('정상적으로 수정되었습니다.');location.href='./Player_A_entry.asp';</script>"
  response.End
  ELSE
  response.Write "<script type='text/javascript'>alert('오류가 발생했습니다.');location.href='./Player_A_entry.asp';</script>"
  response.End
  END IF
Else
  response.Write "<script type='text/javascript'>alert('오류가 발생했습니다.');location.href='./Player_A_entry.asp';</script>"
