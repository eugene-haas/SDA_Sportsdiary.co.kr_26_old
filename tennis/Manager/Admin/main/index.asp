   ...
   <div class="wrap">
      ...
      <header>
        <div id="header">
          <div class="top-tp">
            <div class="logo">
              <h1><a href="View/Main.asp"  target="fPage"><img src="../Images/sportsdiary_judo_B.png" alt="스포츠 다이어리" width="145" height="45"/></a></h1>
            </div>
      ...
      <div id="container">
        ...
        <nav>
          <div id="left-navi">
            ...
            <div class="depth">
              <h2><a href="#">경기관리</a></h2>
                <ul>
                  ...
                  <li class="depth-2"><a href="/Manager/View/ChampionshipOperate.asp" target="fPage">대회진행현황</a></li>
            ...
            <div class="depth">
              <h2><a href="javascript:;">커뮤니티</a></h2>
              <ul class="depth-2">
                <li class="depth-2">
