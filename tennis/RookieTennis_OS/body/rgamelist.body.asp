	<div class="main main-operating container-fluid score-ipt"><!--main-check-->
          ...
          <ul class="clearfix">
            <li class="game-type" id="_s1menu1">
              <label >
                ...
                <span><input type="radio" name="game-type" id="game-typeA" value="<%=CONST_CODE_PERSON%>" checked></span>
              </label>
            </li>
            ...
            <li class="type-sel">
                <select id="TeamGb"  onchange="score.settingSearch();" data-native-menu="false">
            ...
            <li class="btn-list">
              <button type="button" id="search" class="btn btn-warning btn-search" onmousedown="score.gameSearch(0)">조 회</button>
            </li>
          </ul>
        </div>
        <!-- E: tab-menu -->
