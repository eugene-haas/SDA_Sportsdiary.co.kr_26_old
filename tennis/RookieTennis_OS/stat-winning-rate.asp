...
<!--
	...
	score.gradeSearch = function(pn){
		...
		if (pn == 1){ //시작 페이지
			...
			var parmobj = {'CMD':mx.CMD_RANKINGRATE,'S1':searchstr1,'S2':searchstr2,'S3':searchstr3,'S4':searchstr4,'PN':pn };
			parmobj.T1 = title1;
			parmobj.T2 = title2;
			parmobj.T3 = title3;
			...
			var parmobj = {'CMD':mx.CMD_RANKINGRATEAPPEND,'S1':searchstr1,'S2':searchstr2,'S3':searchstr3,'S4':searchstr4,'PN':nextpn };
			parmobj.T1 = title1;
			parmobj.T2 = title2;
			parmobj.T3 = title3;
...
<div class="main container-fluid">
	<!-- #include file = "./body/statrate.body.asp" -->
</div>
 <!-- E: main -->
