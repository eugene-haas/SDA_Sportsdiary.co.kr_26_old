...
'	dim RequestGroupNum   : RequestGroupNum   = fInject(decode(Request("RequestGroupNum"), 0))   '참가신청 그룹번호  
	...
	Else
		...
		IF act = "MOD" Then
			...
			'대회참가신청정보 조회
			CSQL =      "   SELECT * " 
			CSQL = CSQL & " 	,CASE WHEN UserPhone IS NOT NULL THEN replace(UserPhone, '-', '') ELSE '' END UserPhone " 
			CSQL = CSQL & " 	,CASE WHEN P1_UserPhone IS NOT NULL THEN replace(P1_UserPhone, '-', '') ELSE '' END P1_UserPhone " 
			CSQL = CSQL & " 	,CASE WHEN P2_UserPhone IS NOT NULL THEN replace(P2_UserPhone, '-', '') ELSE '' END P2_UserPhone " 
				...
				if(retDATA){
					...
					if(strcut[0]=="TRUE"){
						...
						if(!$('#P1_PlayerIDX').val() || !$('#P1_UserName').val()){
							alert("참가자 정보가 KATA에 등록되어 있지 않습니다.\n먼저 KATA에 참가자 정보를 등록하시기 바랍니다.\n☎0505-555-0055");
							chk_Submit = 2;
							return;
						}
						/*
...
//						$('form[name=s_frm]').submit();           
	...
	$(document).ready(function(){
		...
		*/
		...
		//참가자, 파트너 조회를 통한 정보입력 - 조회되지 않을시 협회 연락하여 선수정보, 팀정보 등록 후 참가신청서 작성
		//form전송시 disabled 사용시 데이터 값 전송이 안됨 
		//P1_Player
		$('#P1_TeamNmOne_1').prop('readonly', true);
		$('#P1_TeamNmTwo_1').prop('readonly', true);
		$('#P1_UserPhone1').prop('readonly', true);
		$('#P1_UserPhone2').prop('readonly', true);
		$('#P1_UserPhone3').prop('readonly', true);
		//P2_Player
		$('#P2_TeamNmOne_1').prop('readonly', true);
		$('#P2_TeamNmTwo_1').prop('readonly', true);
		$('#P2_UserPhone1').prop('readonly', true);
		$('#P2_UserPhone2').prop('readonly', true);
		$('#P2_UserPhone3').prop('readonly', true);
                ...
                <li id="div_Entry<%=cnt%>" class="entry el_2">
                  ...
                  <ul class="party col_1">
                    ...
                    <li class="phone_line el_3">
                      ...
                      <input type="number" class="ipt col_1" id="P1_UserPhone1" name="P1_UserPhone1" value="<%=P1_UserPhone1%>" />
                        <!--
                  ...
                  <ul class="party col_1">
                    ...
                    <li class="phone_line el_3">
                      <label> <span class="title">휴대폰</span>
                      <input type="number" class="ipt col_1" id="P2_UserPhone1" name="P2_UserPhone1" value="<%=P2_UserPhone1%>" />
                       <!--
                  ...
                  <input type="hidden" id="P1_SEX" name="P1_SEX" value="<%=P1_SEX%>" />
        ...
        %>
                <li class="entry el_2">
                  ...
                  <ul class="party col_1">
                    ...
                    <li class="phone_line el_3">
                      <label> <span class="title">핸드폰</span>
                        <input type="number" class="ipt col_1" id="P1_UserPhone1" name="P1_UserPhone1" />
                        <!--
                        <select class="ipt col_1" id="P1_UserPhone1" name="P1_UserPhone1">
                  ...
                  <ul class="party col_1">
                    ...
                    <li class="phone_line el_3">
                      <label> <span class="title">핸드폰</span>
                        <input type="number" class="ipt col_1" id="P2_UserPhone1" name="P2_UserPhone1" />
                        <!--
                        <select class="ipt col_1" id="P2_UserPhone1" name="P2_UserPhone1">
                          <option value="010">010</option>
                          <option value="011">011</option>
