...
<%
 'Controller ################################################################################################
	...
	paysql = " (select top 1 VACCT_NO from TB_RVAS_LIST where CUST_CD = '"&Left(sitecode,2)&"' + Cast(a.RequestIDX as varchar) ) as payok "
	vaccsql = " (select top 1 VACCT_NO from TB_RVAS_MAST where CUST_CD = '"&Left(sitecode,2)&"' + Cast(a.RequestIDX as varchar)) as vno "		
...
<div class="admin_content">
	...
	<div class="search_top">
		<!-- #include virtual = "/pub/html/RookietennisAdmin/attmemberform.asp" -->
	</div>
	<!-- e: 정보 검색 -->
...
<%
	...
	Do Until rs.eof
		...
		<!-- #include virtual = "/pub/html/RookietennisAdmin/findgameInfoPlayerList.asp" -->
	<%
	no = no - 1
	rs.movenext
	Loop
