...
'Response.end
	...
	strFieldName = strFieldName & " ,P2_PlayerIDX,P2_UserName,P2_UserLevel,P2_TeamNm,P2_TeamNm2,P2_UserPhone,P2_Birthday,P2_SEX,P1_rpoint,P2_rpoint, username,userphone,txtMemo,paymentNm,PaymentType ,UserPass, "& accsql &"," & paysql & "," & vaccsql & ", P1_id, P2_id "
...
<a name="contenttop"></a>
		...
		<div class="top-navi-inner">
			...
			<div class="top-navi-btm">
				<div class="navi-tp-table-wrap"  id="gameinput_area">
					<!-- #include virtual = "/pub/html/RookietennisAdmin/gameInfoPlayerForm.asp" -->
				</div>
		...
		<div class="btn-left-list">
				...
				<a href="#" id="btnsave" class="btn" onclick="mx.auto_frm('<%=teamnm%>(<%=levelnm%>)');" accesskey="A">자동생성(A)</a>&nbsp;&nbsp;
				<%End if%>
