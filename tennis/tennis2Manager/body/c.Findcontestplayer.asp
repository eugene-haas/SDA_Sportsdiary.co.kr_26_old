...
<%
 'Controller ################################################################################################
	...
	strFieldName = strFieldName & " ,P2_PlayerIDX,P2_UserName,P2_UserLevel,P2_TeamNm,P2_TeamNm2,P2_UserPhone,P2_Birthday,P2_SEX,P1_rpoint,P2_rpoint, username,userphone,txtMemo,paymentNm,PaymentType ,UserPass ,a.lastupdate"
...
<div class="admin_content">
	...
	<div class="search_top">
		<!-- #include virtual = "/pub/html/tennisadmin/attmemberform.asp" -->
	</div>
	<!-- e: 정보 검색 -->
...
'End if
		...
		<!-- #include virtual = "/pub/html/tennisAdmin/findgameInfoPlayerList.asp" -->
	<%
	no = no - 1
	rs.movenext
	Loop
