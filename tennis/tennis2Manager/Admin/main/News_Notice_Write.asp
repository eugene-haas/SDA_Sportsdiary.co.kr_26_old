...
<script type="text/javascript">
  ...
  function Del_Link(i1, i2) {
    if (confirm("해당 글을 삭제 하시겠습니까?") == true) {
    	post_to_url('./News_Notice_Delete_p.asp', { 'i1': i1, 'i2': i2 });
    }
    else {
    }
  }
...
<section>
	<div id="content">
      ...
      <!-- E: 네비게이션 -->
      <form id="form1" name="form1" action="./News_Notice_Write_p.asp" method="post" ENCTYPE="multipart/form-data">
          ...
          <tr>
            ...
            <th>공지 유/무</th>
              ...
              <span class="existence">※공지는 최상위 3개만 상단에 노출됩니다.</span>
						</td>
					</tr>
