...
%>
  ...
  <script type="text/javascript">
    ...
    function WriteLink(i2) {
    	...
    	post_to_url('./Admin_Column_Approval_Write.asp', { 'i2': i2, 'iType': '1' });
    ...
    function ReadLink(i1, i2) {
      ...
      //alert(i1 + " , " + i2);
    	post_to_url('./Admin_Column_Approval_Write.asp', { 'i1': i1, 'i2': i2, 'iType': '3' });
    }

    function PagingLink(i2) {

      //location.href = 'cmList.asp?i2=' + i2;
    	post_to_url('./Admin_Column_Approval_List.asp', { 'i2': i2, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue });
    }
    ...
    function fn_selSearch() {
      ...
      post_to_url('./Admin_Column_Approval_List.asp', { 'i2': 1, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue });
    }
