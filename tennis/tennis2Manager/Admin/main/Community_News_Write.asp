...
<script type="text/javascript">
  ...
  function Del_Link(i1, i2) {
    if (confirm("해당 글을 삭제 하시겠습니까?") == true) {
    	post_to_url('./Community_News_Delete_p.asp', { 'i1': i1, 'i2': i2 });
    }
    else {
    }
  }
  	...
  	if (cTKnsid != "") {
  		...
  		if (confirm("해당 글을 저장 하시겠습니까?") == true) {
  			try {
  				...
  				theForm.action = "./Community_News_Write_p.asp";
  				theForm.submit();
...
<section>
  <div id="content">
    ...
    <div class="contents">
      ...
      <!-- E: 네비게이션 -->
      <form id="form1" name="form1" action="./Community_News_Write_p.asp" method="post" ENCTYPE="multipart/form-data">
          ...
          <tr>
            ...
            <td colspan="2">
              <span class="right_con">
								<% if TKnsid <> "" then %>
								<span class="regist_date"><%=Subject %></span><br />
								<% else %>
            ...
            <td colspan="2">
              <span class="right_con">
								<% if TKnsid <> "" then %>
								<span class="regist_date"><%=Source %></span><br />
								<% else %>
          ...
          <tr>
            ...
            <td colspan="2">
              <span class="right_con edit_box">
								<% if TKnsid <> "" then %>
								<span class="regist_date"><%=Contents %></span><br />
								<% else %>
        ...
        <div class="btn_list">
          ...
          <input type="hidden" id="iFilecnt" name="iFilecnt" value="0" />
					<input type="hidden" id="iTKnsid" name="iTKnsid" value="<%=icTKnsid %>" />
        </div>
