...
<%
  ...
  If iType = "2" Then
    ...
    LSQL = "EXEC Community_tblColumnistG_R '" & NowPage & "','" & MSeq & "','" & iLoginID & "'"
...
<script type="text/javascript">
  ...
  var iFileNum = 1;
  var iFileLimitDf = Number("1"); // 첨부파일 가능 갯수
  ...
  function FN_iFileDivP() {
    ...
    if (iFileNum < iFileLimitNum) {
      ...
      iHtmlPC = iHtmlPC + '<span id="sFile_' + iFileNum + '"><input type="file" id="iFile_' + iFileNum + '" name="iFile" class="csfile" onchange="javascript:Checkfiles_Img3(&#39;iFile_' + iFileNum + '&#39;);" /><span id="FN_iFile_' + iFileNum + '" class="btn_icon">&nbsp;<a href="javascript:;" onclick="javascript:FN_iFileDivP();">+</a>&nbsp;<a href="javascript:;" onclick="javascript:FN_iFileDivM(' + iFileNum + ');">-</a></span><br /></span>';
  ...
  function Del_Link(i1, i2) {
    if (confirm("해당 글을 삭제 하시겠습니까?") == true) {
    	post_to_url('./Community_ColumnGroup_Delete_p.asp', { 'i1': i1, 'i2': i2 });
    }
    else {
    }
  }
  ...
  function CancelLink(i2) {
  	post_to_url('./Community_ColumnGroup_List.asp', { 'i2': i2, 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue });
  }
...
<section>
  <div id="content">
    ...
    <div class="contents">
      ...
      <!-- E: 네비게이션 -->
      <form id="form1" name="form1" action="./Community_ColumnGroup_Write_p.asp" method="post" ENCTYPE="multipart/form-data">
            ...
            <td colspan="2">
              <span class="right_con">
                <div id="iFileDiv" name="iFileDiv">
                  <span id="sFile_1"><input type="file" id="iFile_1" name="iFile" class="csfile" onchange="javascript:Checkfiles_Img3('iFile_1');" />
