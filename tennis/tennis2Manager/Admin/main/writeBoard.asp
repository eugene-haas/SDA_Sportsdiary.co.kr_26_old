  ...
  <!-- S: main container -->
    ...
    <table class="Community_wtite_box">
      ...
      <tbody>
		...
		<tr>
          <th>노출구분</th>
          <td><input type="radio" id="ViewYN" name="ViewYN" value="Y" <%IF ViewYN = "Y" Then response.Write "checked" End IF%> />출력
			  <input type="radio" id="ViewYN" name="ViewYN" value="N" <%IF ViewYN = "N" Then response.Write "checked" End IF%> />출력안함</td>
        </tr>
      </tbody>
    </table>
    <!-- E: basic-view -->
