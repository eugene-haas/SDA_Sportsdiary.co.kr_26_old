...
<script type="text/javascript">
  ...
  function Del_Link(i1, i2) 
  {
    if (confirm("해당 글을 삭제 하시겠습니까?") == true) {
    	post_to_url('./Player_A_entry_delete_p.asp', { 'i1': i1, 'i2': i2 });
    }
    else {
    }
  }
  ...
  function CancelLink(i1) {
  	post_to_url('./Player_A_entry.asp', { 'i1': i1 });
  }
...
<section>
	<div id="content">
      ...
      <!-- E: 네비게이션 -->
      <form id="form1" name="form1" action="./Player_A_entry_write_p.asp" method="post" ENCTYPE="multipart/form-data">
