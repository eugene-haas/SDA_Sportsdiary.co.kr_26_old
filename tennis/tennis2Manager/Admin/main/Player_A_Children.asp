...
<script type="text/javascript">
  ...
  function PagingLink(i2) {
     post_to_url('./Player_A_Children.asp', { 'i2':i2 , 'i3':"<%=ReqOptionVal%>",'i4': "<%=ReqTextSearchVal%>",'i5': "<%=ReqWeightVal%>",'i6':"<%=iYear%>" });
  }
  ...
  function fn_selSearch()
  {
    ...
    post_to_url('./Player_A_Children.asp', { 'i2': 1 ,'i3': selectTypeOptionVal,'i4': txtSearchVal,'i5': selectOptionWeightVal,'i6':selectYearVal});
  }

  function ViewPagingLink(i1, i2){
		post_to_url('./Player_A_Children_write.asp', {'i1':i1, 'i2':i2, 'i3':"<%=ReqOptionVal%>",'i4': "<%=ReqTextSearchVal%>",'i5': "<%=ReqWeightVal%>",'i6':"<%=iYear%>",'i7':2});
	}

  function WriteLink(i2) {
     post_to_url('./Player_A_Children_write.asp', { 'i2':i2, 'i3':"<%=ReqOptionVal%>",'i4': "<%=ReqTextSearchVal%>",'i5': "<%=ReqWeightVal%>",'i6':"<%=iYear%>",'i7':1});
  }
</script>
