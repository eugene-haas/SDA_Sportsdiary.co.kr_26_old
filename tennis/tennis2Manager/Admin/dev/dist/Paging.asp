...
<ul class="pagination">
		<%
			...
			If iTemp = 1 Then
					Response.Write "<li class=""prev""><a href='javascript:;' ></a></li>"
			Else 
					Response.Write"<li class=""prev""><a href='javascript:;'  onClick = 'javascript:PagingLink(" & iTemp - BlockPage & ")' ></a></li>"
			End If
			...
			If iTemp > iTotalPage Then
					Response.Write "<li class=""next""><a href='javascript:;'></a></li>"
			...
			Else
					Response.Write "<li class=""next""><a href='javascript:;' onClick='javascript:PagingLink(" & iTemp & ")'></a></li>"
