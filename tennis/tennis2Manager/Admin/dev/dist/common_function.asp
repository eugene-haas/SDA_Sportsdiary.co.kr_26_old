<%
  ...
  SportsGb = "tennis"
	...
	global_HP = "KATA"
	global_domain = "ikata.sportsdiary.co.kr"
...
'=========================================================================================================================================================
	...
	Function Check_AdminLogin()
		If Request.Cookies("UserID") = "" or Request.Cookies("AdminYN") <> encode("Y",0) Then 
			Response.Write "<script>alert('어드민 로그인이 필요 합니다.');location.href='http://tennisadmin.sportsdiary.co.kr/admin/main/admin_Login.asp';</script>"
			Response.End
		End If 
	End Function 
