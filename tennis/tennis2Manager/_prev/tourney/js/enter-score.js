      ...
      var onLoad = function () {
          ...
          if (GroupGameGb != "") {
              localStorage.setItem("TeamGb", GroupGameGb);
          } else {
              localStorage.setItem("GroupGameGb", $('#game-type').val());
          }
      ...
      $(document).ready(function () {
          ...
          */
          ...
          $("#search").click(function () {
              ...
              /*인쇄 헤더 설정*/
              //구분//소속//체급
              var Cresult = "<span class=''>" + $("#GameTitleIDX option:selected").text() + "</span>";
              Cresult += "<span class=''>  [" + $("#game-type option:selected").text() + "]</span>";
              Cresult += "<span class=''>  [" + $("#TeamGb option:selected").text() + "]</span>";

              if ($("#game-type option:selected").text() == "단체전") {
                  if ($("#SexLevel option:selected").text() == "::체급::") {
                      Cresult += "<span class=''>  [무차별]</span>";
                  } else {
                      Cresult += "<span class=''>  [" + $("#SexLevel option:selected").text() + "]</span>";
                  }
              } else {
                  if ($("#SexLevel option:selected").text() != "::체급::") {
                      Cresult += "<span class=''>  [" + $("#SexLevel option:selected").text() + "]</span>";
