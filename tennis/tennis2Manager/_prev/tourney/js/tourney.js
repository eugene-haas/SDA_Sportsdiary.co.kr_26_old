                      ...
                      strhtml += "<td class='write'>";
	                    ...
	                    //  strhtml += "<p class='player-name'>" + myArr[i].UserName + " vs " + myArr[j].UserName + "</p>";
											...
											//else{
											  ...
											  strhtml += "<p class='player-name'>";


												if(myArr[i].WeightFailYN == "Y"){
													strhtml += "<strike>" + myArr[i].UserName + "</strike>";
												}
												else{
													strhtml += myArr[i].UserName;
												}

												strhtml += " <span class='vs'>vs</span> ";

												if(myArr[j].WeightFailYN == "Y"){
													strhtml += "<strike>" + myArr[j].UserName + "</strike>";
												}
												else{
													strhtml += myArr[j].UserName;
												}
                      ...
                      if(i < j){
                            ...
                            if(intRound == Number(resultArr[k].GameNum)){
                              ...
                              //if(localStorage.getItem("GroupGameGb") == "sd040001"){
                                ...
                                if(resultArr[k].LPlayerResult != "" || resultArr[k].RPlayerResult != "")
                                {
                                  ...
                                  {
                                      varBtnHTML = "<a href='#' class='btn btn-write' onclick='editscore(this);' data-id='"+intRound+"' data-whatever='01' style='background: linear-gradient(to bottom, #fdfdfd 0%,#2E6EA8 100%);'>경기완료</a>";                                          
                                  }
                                  else
                                  {
                                    //양측 불참,부전패,무승부라면..
                                    ...
                                    {
                                      varBtnHTML = "<a href='#' class='btn btn-write' onclick='editscore(this);' data-id='"+intRound+"' data-whatever='01' style='background: linear-gradient(to bottom, #fdfdfd 0%,#BB0000 100%);'>경기완료</a>";      
                                    }
                                    //경기종료
                                    else{
                                      varBtnHTML = "<a href='#' class='btn btn-write' onclick='editscore(this);' data-id='"+intRound+"' data-whatever='01' style='background: linear-gradient(to bottom, #fdfdfd 0%,#A8622E 100%);'>경기완료</a>";                                  
                                    }
                                  }
                                ...
                                {
                                  varBtnHTML = "<a href='#' class='btn btn-write' onclick='mov_enterscore(this);' data-id='"+intRound+"' data-whatever='01'>미완료</a>";
                                }
                              //}
                              /*
                              else
                        ...
                        if (varBtnHTML == "")
                        {
                          if(localStorage.getItem("GroupGameGb") == "sd040001")
                          {
                            ...
                            //개인전 진행중 이라면 진행중 색깔표시
                            if(vargamestatus == "sd050001"){
                              varBtnHTML = "<a href='#' class='btn btn-write' onclick='mov_enterscore(this);' data-id='"+intRound+"' data-whatever='01' style='background: linear-gradient(to bottom, #fdfdfd 0%,#2F9C9D 100%);'>스코어입력</a>";            
                            }
                          }
                          else{
                            //단체전 선수등록된 Count
