					...
					<td valign="middle" width="48%">
						...
						<table border="0" height="100%">
							<%	
									...
									LSQL = LSQL&" ,Left(SportsDiary.dbo.Fn_TeamNm('judo',TeamGb,Team),3) As TeamNm"
									LSQL = LSQL&" ,UnearnWin"
							...
							<tr>
								...
								If TotGameCnt = "8" Then 
									'8강경기일경우=====================================================================================================
										If (i Mod 2 = 1) Then 
											spanstyle = "display: block; border-top: 1px solid #000; border-right: 1px solid #000; height: 83px; margin-top: 81px;"
										ElseIf TotGameCnt <> "2" And (i Mod 2 = 0) Then 
											spanstyle = "display: block; border-bottom: 1px solid #000; border-right: 1px solid #000; height: 83px; margin-top: -81px;"
										End If 
								%>
								<td width="26%"><span style="<%=spanstyle%>"></span></td>
								<%
									If i=1 Then 
								%>
								<td width="26%" rowspan="2"><span style="display: block; border-top: 1px solid #000; border-right: 1px solid #000;  height: 162px; margin-top: 162px;"></span></td>
								<%
									ElseIf i=3 Then 
								%>
								<td width="26%" rowspan="2"><span style="display: block; border-bottom: 1px solid #000; border-right: 1px solid #000;  height: 162px; margin-top: -162px;"></span></td>
								<%
									End If 								
								%>								
									<%
										...
										If i =1 Then 
									%>
									<td width="26%" rowspan="4"><span style="display: block; border-bottom: 1px solid #000; height: 162px; margin-top: -162px;"></span></td>								
									<%
										End If 
										'3Depth*****************************
									End If 
					...
					<td valign="middle" width="48%">
						...
						<table border="0" height="100%">
							<%
									...
									RSQL = RSQL&" ,Left(SportsDiary.dbo.Fn_TeamNm('judo',TeamGb,Team),3) As TeamNm"
									RSQL = RSQL&" ,UnearnWin"
							...
							<%
									...
									If (i Mod 2 = 1) Then 
										spanstyle = "display: block; border-top: 1px solid #000; border-left: 1px solid #000; height: 83px; margin-top: 81px;"
									ElseIf TotGameCnt <> "2" And (i Mod 2 = 0) Then 
										spanstyle = "display: block; border-bottom: 1px solid #000; border-left: 1px solid #000; height: 83px; margin-top: -81px;"
									End If 
							%>
							<tr>
								<%
								...
								<%
									If i=1 Then 
								%>
								<td width="26%" rowspan="2"><span style="display: block; border-top: 1px solid #000; border-left: 1px solid #000;  height: 162px; margin-top: 162px;"></span></td>
								<%
									ElseIf i=3 Then 
								%>
								<td width="26%" rowspan="2"><span style="display: block; border-bottom: 1px solid #000; border-left: 1px solid #000;  height: 162px; margin-top: -162px;"></span></td>
								<%
									End If 								
								%>
								<%
