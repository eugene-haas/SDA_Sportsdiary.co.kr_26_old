        ...
        <tr>
          <td valign="middle" width="48%">
            ...
            <table border="0" height="100%">
              ...
              %>
              <tr class="arr">
                <td height="<%=playerHeight%>" width="300px" style="font-size:16px; text-align: right;"><%=TeamNm%></td>
                <td width="50%" ><span style="display: block; border-bottom: 1px solid #000;  height: 8px; margin-top: -8px;"></span></td>
              </tr>             
            </table>
            <!-- 좌측 구분 선수 E -->
          </td>
          ...
          <td valign="middle" width="48%" align="right">
            ...
            <table border="0" height="100%">
               <%
                  ...
                  RSQL = RSQL&" order by RGameGroupSchoolIDX DESC "                 
              ...
              <tr>                                
                <td width="50%" ><span style="display: block; border-bottom: 1px solid #000;  height: 8px; margin-top: -8px;"></span></td>
                <td height="<%=playerHeight%>" width="300px"  style="font-size:16px;"><%=TeamNm%></td>                      
              </tr>
            </table>
            <!-- 우측 구분 선수 E -->
          </td>
