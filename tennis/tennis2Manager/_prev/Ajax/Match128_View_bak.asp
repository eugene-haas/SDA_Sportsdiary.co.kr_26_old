...
<body>
  ...
  <!-- E: header -->
  <!-- S: main -->
  <div class="main clearfix match128">
    <!-- S: left_side -->
    <div class="left_side">
      <%
        '&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
      ...
      <%
        Else 
          If x Mod 2 = 0 Then 
            Response.Write "<table class='print_player'>"
          End If 
      %>
        <tr>
          <td><span class="player_school"><%=LRs("TeamNm") & LRs("TeamDtlNM")%></span> <%=LRs("UserName")%> </td>
