      ...
      <div class="input-select ent-sel row">
        ...
        <div class="enter-type tab-menu">
          <ul class="clearfix">
            ...
            <li class="game-type">
              <label ><span><img src="../tablet/images/tournerment/tourney/icon-private@3x.png" alt width="18" height="18"></span><span class="type-text">개인전</span><input type="radio" name="GameType" <%If GameType = "sd040001" Then %>checked<%End If%> value="sd040001"  onclick="chk_gamegb();"></label>
            </li>
            <li class="game-type">
              <label ><span><img src="../tablet/images/tournerment/tourney/icon-group@3x.png" alt width="16" height="21"></span><span class="type-text">단체전</span><input type="radio" name="GameType" <%If GameType = "sd040002" Then %>checked<%End If%> value="sd040002" onclick="chk_gamegb();"></label>
            </li>
          ...
          <%
            ...
            If GameType = "sd040001" Then 
              If RGameLevelIDX <> "" Then 
                LSQL = "select PlayerIDX,UserName,SportsDiary.dbo.FN_TeamCodeReturnTeamNm('judo',Team) AS TeamNm from Sportsdiary.dbo.tblRplayerMaster  where GameTitleidx='"&GameTitleIDX&"' and RgameLevelIDX='"&RGameLevelIDX&"' AND DelYN='N' Order By TeamNm" 'TeamNm" 'UserName
                'Response.Write LSQL
                'Response.End
