...
function chk_GameTitle(obj){
	make_box("sel_Search_GameTitle","Search_GameTitleIDX","2017","GameTitle_Year_change3")	
}
...
function groupgamegb_excel(type){

		if($("#Search_GameTitleIDX").val() == ""){
			alert("대회명을 선택하세요.");
			return;
		}

		var gametitleidx = $("#Search_GameTitleIDX").val();
	...
	<section>
		<div id="content">
			...
			<div class="btn-right-list">
				<a href="javascript:groupgamegb_excel('1');" class="btn" id="btnview" >개인전 전체 신청명단(Excel)</a>
				<a href="javascript:groupgamegb_excel('2');" class="btn" id="btnview" >단체전 전체 신청명단(Excel)</a>
				...
				<table class="table-list">
					...
					<thead>
						<tr>							
							...
							<th scope="col">종별</th>
							<th scope="col">성별</th>
							<th scope="col">최종참자가수(팀수)</th>
							<th scope="col">소속별참가신청내역(PDF출력)</th>
