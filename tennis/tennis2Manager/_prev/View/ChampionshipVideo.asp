...
function update_frm(seq){		
	...
	if(confirm("동영상 URL을 저장하시겠습니까?")){
		var strAjaxUrl = "/Manager/Ajax/ChampionshipVideo_Update.asp";
...
function view_frm(tp){
	...
	var strAjaxUrl="/Manager/ajax/ChampionshipVideo_View.asp";
	$.ajax({
			url: strAjaxUrl,
			type: 'POST',
			dataType: 'html',
				...
				<table class="table-list">
					...
					<thead>
						<tr>							
							...
							<th scope="col">성별</th>
							<th scope="col">체급</th>
							<th scope="col">대진선수</th>
							<th scope="col">라운드</th>
							<th scope="col">경기(강)</th>
							<th scope="col">경기장번호</th>
							<th scope="col">동영상경로</th>
							<th scope="col">버튼</th>
							<th scope="col">버튼</th>
							<th scope="col">버튼</th>							
						</tr>
