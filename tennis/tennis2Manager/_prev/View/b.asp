...
<%
  ...
  End If 
	...
	LSQL = LSQL & " WHERE A.GameTitleIDX = '" & Search_GameTitleIDX & "' "
	LSQL = LSQL & " AND A.GroupGameGb = 'sd040001' AND A.DelYN = 'N'"
	LSQL = LSQL & " ORDER BY TeamGb, Sportsdiary.dbo.FN_TeamNm(A.SportsGb, A.TeamGb, A.Team), Level ASC"
