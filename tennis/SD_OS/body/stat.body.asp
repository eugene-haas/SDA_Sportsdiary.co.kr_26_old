      ...
      <div class="stat-select row">
        <div class="stat-type-wrap">
          ...
          <div class="stat-type">
            ...
            <ul class="stat-list clearfix">
              ...
              <li>
                <a href="stat-winning-rate.asp" class="medal-btn medal"><span class="tab-img"><img src="images/tournerment/stat/icon-medal-off.png"></span><span>순위</span></a>
              </li>
            </ul>
            <!-- E: tab-list -->
          </div>
        ...
        <div class="grade-tab stat-result-menu">
          ...
          <ul class="grade-list clearfix">
            <li>
              <a href="stat-winner-state.asp" class="result-search-list winner-state on">입상현황</a>
            </li>
            <li>
              <a href="stat-grade-state-before.asp" class="result-search-list grade-state">입상자(단체)조회</a>
            </li>
          </ul>
          <!-- E: stat-result-menu -->
        </div>
          ...
          <div class="stat-select-group select-group clearfix">
            ...
            <ul class="select-list">
              ...
              <li>
                <!-- S: btn-box -->
                <div class="btn-box">
                  <a onclick="javascript:score.gradeSearch('s')" role="submit" class="btn btn-state">조회</a>
                </div>
                <!-- E: btn-box -->
              </li>
            </ul>
