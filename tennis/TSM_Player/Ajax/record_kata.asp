...
<head>
  ...
  <script type="text/javascript">
    ...
    function fn_list2(arg) {
      ...
      var Search_NewTeamGbName = $('input[name="search_div_kata"]:checked').val();
      ...
      $.ajax({
        ...
        data: {
          i2: ipagenum,
          Search_NewTeamGbName: Search_NewTeamGbName,
        ...
        success: function (retDATA, Search_NewTeamGbName2) {
         ...
         var strcut = retDATA.split("^");
           ...
           // alert( $('#ipagenum').html(strcut[1]););
            $('#gametitlelist').append(strcut[0]); // HTTP 요청이 성공하면 요청한 데이터가 전달됨.
            ipagenum = Number(ipagenum) + 1;
            Search_NewTeamGbName2 = Search_NewTeamGbName
            ...
            $('p#Search_NewTeamGbName_Select').html(Search_NewTeamGbName2);
          } else {
          }
        ...
        <div class="l_recordList__wrap">
         ...
         <input type="hidden" id="ipagenum" /> 
				...
				<div id="plusTab" class="m_listMore">
					<a href="javascript:;" class="m_listMore__btn" onclick="javascript:fn_list2();"><span class="m_listMore__btnTxt s_more">더보기</span></a>
				</div>
    ...
    <div class="l_upLayer__contBox m_searching__area [ _overLayer__box ]">
      ...
      <div class="l_upLayer__wrapCont m_searchPopup__cont [ _overLayer__wrap ]">
        <div class="m_searchPopup__control">
			...
			<!--<input type="hidden" name="fnd_keyWord2" id="fnd_keyWord2">--> 
          ...
          <div class="m_searchPopup__panel">
            ...
            <div class="m_searchPopup__checkWrap" id="Search_NewTeamGbName" >
              <div class="m_searchPopup__checkGroup"  >
                <input type="radio" name="search_div_kata" id="search_div_kata0"  value="20102"  hidden checked><label for="search_div_kata0">국화부</label>
              ...
              <div class="m_searchPopup__checkGroup" >
                <input type="radio" name="search_div_kata" id="search_div_kata3" value="20104" hidden><label for="search_div_kata3">신인부</label>
