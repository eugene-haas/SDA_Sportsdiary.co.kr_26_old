        ...
        <div class="major_banner">
          <div class="banner banner_md carousel">
            <div class="bxslider">
              ...
              <div style="background-color:rgb(250, 249, 247);"><a href="http://sportsdiary.co.kr/sdcontent/woncar/woncar.asp"><img src="http://img.sportsdiary.co.kr/images/etc/banner/woncar_md.jpg" /></a></div>
              <div style="background-color:rgb(43, 57, 24);"><a href="http://tennis.sportsdiary.co.kr/tennis/M_Player/Ad/songdo.asp"><img src="http://img.sportsdiary.co.kr/images/etc/banner/songdo_md.jpg" /></a></div>
              <div style="background-color:#fff;"><a href="http://tennis.sportsdiary.co.kr/tennis/M_Player/AD/chuncheon.asp?path=1"><img src="http://img.sportsdiary.co.kr/images/etc/banner/chuncheon_md.jpg" /></a></div>
              <div style="background-color:#f5fafe;"><a><img src="http://img.sportsdiary.co.kr/images/etc/banner/babolat_md.jpg" /></a></div>
              <div style="background-color:rgb(215, 204, 182);"><a><img src="http://img.sportsdiary.co.kr/images/etc/banner/leehoon_md.jpg" /></a></div>
              <div style="background-color:#fff;"><a><img src="http://img.sportsdiary.co.kr/images/etc/banner/naum_md.jpg" /></a></div>
              <div style="background-color:rgb(164, 228, 227);"><a><img src="http://img.sportsdiary.co.kr/images/etc/banner/applerind_md.jpg" /></a></div>
