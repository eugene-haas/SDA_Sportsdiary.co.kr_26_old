    ...
    <div class="entryCompetitionList sd-scroll [ _sd-scroll ]">
        ...
        <div class="major_banner">
      	  <div class="banner banner_md carousel">
              ...
              <div style="background-color:rgb(43, 57, 24);"><a href="http://tennis.sportsdiary.co.kr/tennis/TSM_Player/Ad/songdo.asp"><img src="http://img.sportsdiary.co.kr/images/etc/banner/songdo_md.jpg" /></a></div>
              <div style="background-color:#fff;"><a href="http://tennis.sportsdiary.co.kr/tennis/TSM_Player/AD/chuncheon.asp?path=1"><img src="http://img.sportsdiary.co.kr/images/etc/banner/chuncheon_md.jpg" /></a></div>
              <div style="background-color:rgb(1, 3, 2);"><a><img src="http://img.sportsdiary.co.kr/images/etc/banner/babolat_md.jpg" /></a></div>
