...
<%
  Set db = new clsDBHelper
	...
	FUNCTION CHK_GameRequest_Entry(GTitle, GLevel)				
		...
		CSQL = CSQL & "	FROM sd_TennisTitle G"
		CSQL = CSQL & "		left join tblRGameLevel R on G.GameTitleIDX = R.GameTitleIDX"
		CSQL = CSQL & "			AND R.Level = '"&GLevel&"'"
		CSQL = CSQL & "		left join tblLevelInfo L on R.Level = L.Level"
	...
	Else
		...
		IF Not(LRs.Eof OR LRs.Bof) Then
			...
			Set crs = db.ExecSQLReturnRS(CQL , null, ConStr)			
