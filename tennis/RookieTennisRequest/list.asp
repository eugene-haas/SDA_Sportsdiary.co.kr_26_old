...
'	Response.write URL_HOST
  ...
  <script src="js/common.js"></script>
    <script src="/pub/js/rookietennis/tennis_Request.js<%=CONST_JSVER%>1" type="text/javascript"></script>
...
<!--  <div class="major_banner">
	<div class="banner banner_md carousel">
		<div class="bx-wrapper" style="margin: 0px auto; max-width: 100%;"><div class="bx-viewport" style="width: 100%; height: 120px; overflow: hidden; position: relative;"><div class="bxslider" style="width: 615%; position: relative; transform: translate3d(-2301px, 0px, 0px); transition-duration: 0.5s;"><div class="bx-clone" style="list-style: none; width: 767px; float: left; position: relative; background-color: rgb(245, 250, 254);"> <a class="banner_area" onclick="javascript:location.href='http://www.sdamall.co.kr/mobile/brand/brand_list.asp?brandSEQ=28'" href="javascript:;"  target="_blank"> <img alt="" src="http://tennis.sportsdiary.co.kr/ADImgR/tennis/바볼랏공인구중배너.jpg"> </a> </div>
	
				  <div style="list-style: none; width: 767px; float: left; position: relative; background-color: rgb(216, 206, 181);"> <a class="banner_area" onclick="javascript:location.href='http://www.sdamall.co.kr/mobile/brand/brand_list.asp?brandSEQ=27'" href="javascript:;" target="_blank"> <img alt="" src="http://tennis.sportsdiary.co.kr/ADImgR/tennis/이훈-중배너2.jpg"> </a> </div>
				  
				  <div style="list-style: none; width: 767px; float: left; position: relative; background-color: rgb(169, 227, 228);"> <a class="banner_area" onclick="javascript:location.href='http://www.sdamall.co.kr/mobile/brand/brand_list.asp?brandSEQ=26'" href="javascript:;" target="_blank"> <img alt="" src="http://tennis.sportsdiary.co.kr/ADImgR/tennis/애플라인드_중_1.jpg"> </a> </div>
				  
				  <div style="list-style: none; width: 767px; float: left; position: relative; background-color: rgb(255, 255, 255);"> <a class="banner_area" onclick="javascript:location.href='http://www.sdamall.co.kr/mobile/brand/brand_list.asp?brandSEQ=20'" href="javascript:;" target="_blank"> <img alt="" src="http://tennis.sportsdiary.co.kr/ADImgR/tennis/나음케어_중_1.jpg"> </a> </div>
				  
				  <div style="list-style: none; width: 767px; float: left; position: relative; background-color: rgb(245, 250, 254);"> <a class="banner_area" onclick="javascript:location.href='http://www.sdamall.co.kr/mobile/brand/brand_list.asp?brandSEQ=28'" href="javascript:;" target="_blank"> <img alt="" src="http://tennis.sportsdiary.co.kr/ADImgR/tennis/바볼랏공인구중배너.jpg"> </a> </div>
				  
		<div class="bx-clone" style="list-style: none; width: 767px; float: left; position: relative; background-color: rgb(216, 206, 181);"> <a class="banner_area" onclick="javascript:fn_ADLOG('tennis','333035','','');javascript:fn_mclicklink('72','196');" href="javascript:;"> <img alt="" src="http://tennis.sportsdiary.co.kr/ADImgR/tennis/이훈-중배너2.jpg"> </a> </div></div></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev" href="javascript:alert('준비중입니다');">Prev</a><a class="bx-next" href="javascript:alert('준비중입니다');">Next</a></div></div></div>
	  </div>
  </div>-->
  <!-- 여기까지 추가했습니다 -->
        ...
        <div class="">
            ...
            <ul class="competitionList">
                ...
                <% if YRs("ViewYN") ="Y"  then   %>
                    ...
                    %>
                    <li>
                        <p class="competitionList__tit" style="background:#E2E2E3;color:#000000;"><!-- [<%=gamegrade %>] --> <%=YRs("GameTitleName") %> 
                        ...
                        <div class="competitionList__btnWrap" style="height:60px;padding-top:6px;">
							...
							<!-- <a href="http://tennis.sportsdiary.co.kr/tennis/M_Player/result/rookietennis_info_detail.asp" class="competitionList__btn s_summary sm_btn yellow_btn">요강보기</a> -->
							

							<%If  YRs("GameTitleIDX") = "142" then%>
							<a href="http://tennis.sportsdiary.co.kr/tennis/m_player/result/rookieTennis_info2.asp" class="competitionList__btn s_summary sm_btn yellow_btn">헤드컵 요강</a>
							<%else%>
							<a href="http://tennis.sportsdiary.co.kr/tennis/m_player/result/rookieTennis_info.asp" class="competitionList__btn s_summary sm_btn yellow_btn">SD 요강</a>
							<%End if%>
    ...
    <%End if%>
        ...
        <div class="te_reqBtnWrap">
            <%if InStr(sUserAgent,"ANDROID") >0 or InStr(sUserAgent,"IPHONE") >0 then%>
				...
				-->
				<a href="http://tennis.sportsdiary.co.kr/tennis/M_Player/Result/institute-search.asp" class="te_reqBtnWrap__btn s_schedule">대회일정</a>
            <%else%>
                <a href="http://tennis.sportsdiary.co.kr/tennis/M_Player/Result/institute-search.asp" class="te_reqBtnWrap__btn s_schedule">대회일정</a>
            <%end if%>
        ...
        <div class="entryInfo">
            ...
            <p class="entryInfo__txt s_indent"> <span>*SD랭킹 루키테니스챔피언십 대회참가신청은 스포츠다이어리 회원가입이 필수입니다.</span> </p>
            ...
            <p class="entryInfo__txt s_indent"> <span>*참가비 입금후 신청취소를 할 경우 취소일부터 10일이내로 환불처리됩니다.</span> </p>
