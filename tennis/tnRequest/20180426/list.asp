                        ...
                        <ul>  
                            <li>
                                ...
                                <span class="r_con" style="text-align:right;padding-right:10px;">
                                    ...
                                    <a href="javascript:chk_frm('4','<%=YRs("GameTitleIDX") %>');" class="sm_btn yellow_btn">신청내역</a>   <%' if Cdbl(ch_reqc) >0 then  %>  <%' end if  %>
                        ...
                        <ul>  
                            <li>
                                ...
                                <span class="r_con" style="text-align:right;padding-right:10px;">
                                    ...
                                    <a href="javascript:chk_frm('4','25');" class="sm_btn yellow_btn">신청내역</a>
                                    <% if InStr(sUserAgent,"ANDROID") >0 or InStr(sUserAgent,"IPHONE") >0 then  %>
                                    <a href="http://m.ikata.org/bbs/board.php?bo_table=apply_modi" class="sm_btn red_btn">변경요청</a>
                                    <%else%>
                                    <a href="http://ikata.org/board/bbs/board.php?bo_table=apply_modi" class="sm_btn red_btn">변경요청</a>
                        ...
                        <div class="list_box">
                            <ul>  
                                <li>
                                    ...
                                    <a href="javascript:chk_frm('6','');" class="big_btn red_btn">전체신청내역보기</a>
                                    </span>
                                </li> 
                            </ul>
                        </div>
                    ...
                    <ul> 
                        <li>
                            <div class="text_box match_change_list">
                                <h3> 대회참가신청 변경안내 </h3> 
                                <p> <span></span> </p> 
                                <p> <span>*참가신청 페이지가 새롭게 바뀌었습니다.</span> </p> 
                                <p> <span>*기존 참가신청내역 확인시 신청자 휴대폰번호 뒤4자리 입력 후 확인바랍니다.</span> </p> 
                                <p> <span>*신청내역이 확인안되는 선수는 아래의 연락처로 문의바랍니다.</span> </p> 
                                <p> <span></span> </p> 
                                <p class="phone_call mt_10"> <span><문의전화></span> </p> 
                                <p class="phone_call"> <span>운영센터 : 02-704-0282</span> </p> 
                                <p class="phone_call"> <span>운영시간 : 평일 9:00 ~ 18:00</span> </p> 
                                <p class="phone_call"> <span>(점심시간 12:00 ~ 13:00)</span> </p> 
                            </div>
                        </li>
                        </ul>
                    </div>
