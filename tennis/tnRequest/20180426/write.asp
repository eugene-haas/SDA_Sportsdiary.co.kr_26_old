...
<script src="/pub/js/tennis_Request.js?ver=13" type="text/javascript"></script>
...
//            if (confirm( $("#levelno option:selected").text() +"부 에 참가하시겠습니까? " )) {
...
<div class="l_apply">
	        ...
	        <!-- s: 중요문구 -->
	            <div class="text_box">
		            <p class="red_font">
                        ...
                        <span>  참가자 이름을 검색하고 해당 클럽의 이름을 선택해주세요.(참가자 핸드폰번호 뒷자리 확인) </span>
                     </p>
                    <p class="">
                        <i class="fa fa-exclamation-circle" aria-hidden="true"></i>
                        <span>  만약 조회된 이름이 없으면 '신규등록'을 클릭하여 이름입력을 완성해주세요.  </span>
                    </p>
                    <p class="red_font">
                        <i class="fa fa-exclamation-circle" aria-hidden="true"></i>
	...
	<!-- <div class="top_title_box" > -->
		...
		<!-- <p class="d_date"> -->
            <%
            SQL = " select  GameTitleName,convert(date,GameS)GameS,convert(date,GameE)GameE,titleGrade from sd_TennisTitle  where DelYN='N' and GameTitleIDX= '"&GameTitleIDX&"' "
            Set Rs = Dbcon.Execute(SQL)
					...
					<ul> 
						<li>
							...
							<span class="r_con">
								...
								<input type="text" class="ipt input_1" id="p1name" name="p1name" autocomplete="off" placeholder=":: 이름을 입력하세요 ::" 
                                 
                                 onkeyup="fnkeyup(this);"  value="<%=P1_UserName %>" />
