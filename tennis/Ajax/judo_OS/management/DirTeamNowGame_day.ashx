    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            if (obj != null)
            {
                ...
                string strGameDay = obj.GameDay;
                string strGroupGameGb = obj.GroupGameGb;
                ...
                string strSql = "SELECT A.SportsGb, A.TeamGb, SportsDiary.dbo.FN_TeamGbNm(A.SportsGb, A.TeamGb) AS TeamGbNm"
                    ...
                    + " left JOIN tblRGameResult C ON A.SportsGb = C.SportsGb AND A.RGameLevelidx=C.RGameLevelidx"
                    + " WHERE A.DelYN = 'N'"
                    + " AND B.DelYN = 'N'"
                    + " AND A.SportsGb = '" + strSportsGb + "'"
                    + " AND A.GameTitleIDX = '" + strGameTitleIDX + "'"
                    + " AND B.EnterType = '" + strEnterType + "'"
                    + " AND (isnull('" + strGroupGameGb + "','')='' or '" + strGroupGameGb + "' is null or A.GroupGameGb = '" + strGroupGameGb + "')"
                    + " AND (isnull('" + strGameDay + "','')='' or '" + strGameDay + "' is null or A.GameDay = '" + strGameDay + "')"
