...
<%
' http://eval.sportsdiary.co.kr/api/ajax/mgr_viewer/compare/compare_init.asp
%>
...
DBOpen()
   ...
   Dim aryKey, strKeys
	Dim cnt_list, list_info, cnt_group, group_info
	...
	If( err_no <> 1 ) Then 	
      ...
      End If
		...
		JsonStr = utxAryToJsonStr(Array("state", "errorcode", "cnt_list", "list_info", "cnt_group", "group_info"), Array("true", "SUCCESS", cnt_list, list_info, cnt_group, group_info))
	Else
