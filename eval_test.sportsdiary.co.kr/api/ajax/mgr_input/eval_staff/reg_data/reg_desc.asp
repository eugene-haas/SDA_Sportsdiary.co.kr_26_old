...
<%
' http://eval_test.sportsdiary.co.kr/api/ajax/mgr_input/eval_staff/reg_data/reg_desc.asp
%>
...
ENC_DBOpen()
   ...
   Dim aryKey, strKeys
   Dim eval_table_idx, association_idx, eval_member_idx, eval_descs, item_idxs, rsp_err
