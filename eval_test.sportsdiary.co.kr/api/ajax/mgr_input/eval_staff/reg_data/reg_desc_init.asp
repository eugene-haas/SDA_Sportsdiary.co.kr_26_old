...
<% 	
	'=================================================================================
	'  Purpose  : 	혁신평가입력 - 평가의견 입력 - 초기화  - 평가위원
	'  Date     : 	2021.09.06
	'  Author   : 															By Aramdry
	'================================================================================= 
%>
...
<%
' http://eval_test.sportsdiary.co.kr/api/ajax/mgr_input/eval_staff/reg_data/reg_desc_init.asp
%>
...
ENC_DBOpen()
   ...
   Dim cnt_eval_title, eval_title_info, cnt_member_item, member_item_info , cnt_desc, desc_info
   ...
   eval_member_idx		   = InjectionChk(JsonObj.get("eval_member_idx"))
	...
	If( err_no <> 1 ) Then 		
      ...
      If(IsArray(RS_DATA)) Then
         strKeys = "idx, eval_member_idx, item_type_idx, eval_desc"
         aryKey = Split(strKeys, ",")
