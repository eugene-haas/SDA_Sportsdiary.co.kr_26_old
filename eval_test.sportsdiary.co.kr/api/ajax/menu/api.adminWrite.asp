		...
		<div class="modal-body " id="Modaltestbody">
			<div id="w_form" class="container-fluid">
					...
					<div class="form-group">
						...
						<input type='password' id="ad_pwd" class="form-control" style="ime-mode:inactive;"  placeholder="패스워드"  value="<%=a_rpwd%>" autocomplete="new-password"><!-- 한글사용불가 -->
						<input type='text' id="ad_name" class="form-control" placeholder="이름"  value="<%=a_rname%>">
						<input type='text' id="ad_birth" class="form-control" placeholder="생년월일"  value="">
						<input type='text' id="ad_phone" class="form-control" placeholder="전화번호"  value="">												
					</div>
