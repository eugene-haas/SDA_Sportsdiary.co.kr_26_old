<%
     '=================================================================================
	'null인경우 default 값 리턴 by bsh
     '=================================================================================
	Function isNullDefault(ByVal sVal, ByVal dVal)
		If isNull(sVal) Then
			isNullDefault = dVal
		Else
			isNullDefault = sVal
	...
	End function
     ...
     '=================================================================================
	'	Format String ex) strVal = StringFormat("this {0} a tes{1} string containing {2} values", Array("is","t","some"))
	'================================================================================= 
