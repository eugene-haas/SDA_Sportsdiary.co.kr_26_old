...
<script>
   ...
   if (g_user_info === null) {
      alert('로그인해주세요.')
      window.location = '/innovation_test/index.asp'
   }
</script>
<header id="header" class="l_header" v-clock>
   <a v-show="g_page_props.hideBack !== true" class="l_header__btn-back" href="javascript:window.location.replace('/innovation_test/index.asp');">
      뒤로가기
   </a>
...
<script src="/innovation_test/js/include/header.js<%=INCLUDE_HEADER_VER%>"></script>
