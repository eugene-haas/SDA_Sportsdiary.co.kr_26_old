  <!-- S: etc-judge -->
  <div class="modal fade etc-judge">
    <!-- S: modal-dialog -->
    <div class="modal-dialog">
      <!-- S: modal-content -->
      <div class="modal-content" id="DP_GroupAnotherResult">
        <!-- S: modal-body -->
        <div class="modal-body">
          ...
          <div class="sel-content">
            ...
            <div class="sel-list">
              ...
              <ul>
                <li>
                  <a href="#" class="btn btn-judge on">
                    <span class="txt">최보라 (강원) / 이준희 (강원)</span>
                    <span class="ic-deco">
                      <img src="http://badmintonadmin.sportsdiary.co.kr/images/modal/ic-chk-judge.png" alt>
                    </span>
                  </a>
                </li>
                <li>
                  <a href="#" class="btn btn-judge">
                    <span class="txt">박선영, 김가희</span>
                    <span class="ic-deco">
                      <img src="http://badmintonadmin.sportsdiary.co.kr/images/modal/ic-chk-judge.png" alt>
                    </span>
                  </a>
          ...
          <div class="btn-list">
            <ul class="clearfix">
              ...
              <li>
                <a href="#" class="btn btn-red">등록완료</a>
              </li>
            </ul>
          </div>
          <!-- E: btn-list -->
