...
{ 
  Url = "/bmlive/Ajax/OnGameTitleChanged.asp"
  var packet = {};
...
{ 
  for (var i = 1; i <= 2; i++) {
      if (i == parseInt(str)) {
          if ($("#DP_IMGAnthCheck_" + str).attr("src") == "http://badmintonadmin.sportsdiary.co.kr/include/modal/img/btn_icon1.png") {
            
              $("#DP_A_AnthCheck_" + str).attr("class", "red_btn");
              $("#DP_IMGAnthCheck_" + str).attr("src", "http://badmintonadmin.sportsdiary.co.kr/include/modal/img/btn_icon2.png");
              if (str == "1") {
            ...
            $("#DP_A_AnthCheck_" + str).attr("class", "whith_btn");
              $("#DP_IMGAnthCheck_" + str).attr("src", "http://badmintonadmin.sportsdiary.co.kr//include/modal/img/btn_icon1.png");
              if (str == "1") {
...
function OnGroupResultBtnClick(gameleveldtlidx, teamgamenum, gamenum){
  ...
  Url = "/bmlive/Ajax/Popup_GroupGameURL.asp"
...
function onUrlInputBtnClick(gameleveldtlidx, teamgamenum, gamenum, idurl){
  ...
  Url = "/bmlive/Ajax/GameURLUpdate.asp"
...
function onYoutubeUrlInputBtnClick(gameleveldtlidx, teamgamenum, gamenum, idurl){
  ...
  Url = "/bmlive/Ajax/GameYouTubeURLUpdate.asp"
...
{ 
  ...
  Url = "/bmlive/Ajax/Select_GameOrder.asp"
...
function OnSearchClick(liveSearch = false){
    ...
    Url = "/bmlive/Ajax/GameURL_Operate.asp"
...
function popup_GameOrder_Group(gameleveldtlidx, teamgamenum, gamenum){
  ...
  Url = "/bmlive/Ajax/Popup_GameOrderGroup.asp"
...
function selTeamTemp(gameleveldtlidx, teamgamenum){
  ...
  Url = "/bmlive/Ajax/selTourneyTeamTemp.asp"
  ...
  $( "#strGameTtitle" ).autocomplete({
    source : function( request, response ) {
      $.ajax(
        {
            type: 'post',
            url: "../../bmlive/Ajax/searchGameTitle.asp",
            dataType: "json",
