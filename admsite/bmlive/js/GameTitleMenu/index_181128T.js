...
function SelGameTitle(tIDX,NowPage) {
  //암호화해야하는 URL
  Url ="/Ajax/GameTitleMenu/selGameTitleMenuInfo_181128T.asp"
  var packet = {};
...
function SelGameTitleList() {
  //암호화해야하는 URL
  Url ="/Ajax/GameTitleMenu/selGameTitleMenuList_181128T.asp"
  var packet = {};
...
inputGameTitle_frm = function(NowPage) {
    //암호화해야하는 URL
    Url ="/Ajax/GameTitleMenu/inputGameTitle_frm_181128T.asp";
...
delGameTitle_frm = function (NowPage) {
  ...
  Url ="/Ajax/GameTitleMenu/delGameTitle_frm_181128T.asp";
  var packet = {};
...
searchGameTitle = function (packet, IsGetCtrlData) {
  //alert("하이")
  Url ="/Ajax/GameTitleMenu/schGameTitle_181128T.asp";
...
updateGameTitle_frm = function (packet) {
 ...
 MedalGang  = $("#MedalGang").val();  // 실적적용강수 
  ...
  Url ="/Ajax/GameTitleMenu/updateGameTitle_frm_181128T.asp";
