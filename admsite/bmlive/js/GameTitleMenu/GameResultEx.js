...
function OnSearchClick(){
    ...
    Url = "/Ajax/GameTitleMenu/GameResult_OperateEx.asp"
...
function PrintOneGame(gametitleidx, gameleveldtlidx, teamgamenum, gamenum, stadiumNum, tempNum, listnum, entertype, groupgamegb){
  ...
  if(entertype == "E"){
   // var strOpenName = newWindowName(listnum);
   var strOpenName = "_blank";
    ...
    if(groupgamegb =="B0030001" || groupgamegb == "F9A43D4DE4191C125B08095CC465CD4B"){
      ...
      //   Url = "/Main/GameTitleMenu/scorepage_excel_inter2.asp?"; 
        Url = "/Main/GameTitleMenu/score_page_prev.asp?";
        Url += "GameLevelDtlIDX=" + gameleveldtlidx;
        Url += "&TeamGameNum=" + teamgamenum;
        Url += "&GameNum=" + gamenum;
        Url += "&StadiumNum=" + stadiumNum;
        Url += "&TempNum=" + tempNum;
        Url += "&ListNum=" + listnum; 
        Url += "&IsPrint=0";
      }
      ...
      //   Url = "/Main/GameTitleMenu/scorepage_excel_interpage.asp?"              
         Url = "/Main/GameTitleMenu/score_page.asp?";       
         Url += "GameLevelDtlIDX=" + gameleveldtlidx;
         Url += "&TeamGameNum=" + teamgamenum;
         Url += "&GameNum=" + gamenum;
         Url += "&StadiumNum=" + stadiumNum;
      ...
      var openNewWindow = window.open("about:blank");
      openNewWindow.location.href = Url;   
      console.log("In PrintOneGame Url = " + Url);
      ...
      // var openNewWindow = window.open("about:blank");
      // openNewWindow.location.href = Url;   
      window.open(Url, strOpenName); 

      console.log("In PrintOneGame strOpenName = " + strOpenName);
...
function OnPrintChanged(gameleveldtlidx,teamgamenum, gamenum, strnum, printbtncolor){
  ...
  console.log("OnPrintChanged gameleveldtlidx = " + gameleveldtlidx + " ,teamgamenum = " + teamgamenum + " , gamenum = " + gamenum + " , listnum = " + strnum + "printbtncolor = " + printbtncolor); 
    ...
    source : function( request, response ) {
            ...
            success: function(data) {
                ...
                $.map(data, function(item) {
                  ...
                  if(item.EnterType == "A"){
                    ...
                    $("#div_elit_print").css("display","none");
                    $("#div_ama_print").css("display","");
                  }
                  else if(item.EnterType == "E"){
                    $("#DP_Print_Ama").css("display","none");
                    $("#DP_Print_Elite").css("display","");
                    $("#div_elit_print").css("display","");
                    $("#div_ama_print").css("display","none");
                  }
      ...
      select: function( event, ui ) {
        ...
        $("#selGameTitleIdx").val(obj.crypt_tIdx);
         ...
         console.log("on sel change enter type = " + ui.item.EnterType);
        OnSearchClick();
      }
  });
}
