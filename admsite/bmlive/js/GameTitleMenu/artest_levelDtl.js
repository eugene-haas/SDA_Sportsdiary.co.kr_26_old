...
function inputGameLevelDtl_frm(packet){
  ...
  Url = "/Ajax/GameTitleMenu/artest_inputGameLevelDtl_frm.asp"
...
function delGameLevelDtl_frm(packet) {
  Url = "/Ajax/GameTitleMenu/artest_delGameLevelDtl_frm.asp"
  var tGameLevelDtlIDX = $( "#selGameLeveDtlIIdx" ).val(); 
  var tGameIdx = $( "#selGameIdx" ).val(); 
  var tGameLevelIdx = $( "#selGameLevelIdx" ).val(); 
...
href_LotteryPublic = function (tIdx,tGameLevelDtlIdx) {
  post_to_url('./Lottery_PublicTest.asp', { 'tIdx': tIdx, 'tGameLevelDtlIdx': tGameLevelDtlIdx});
};
