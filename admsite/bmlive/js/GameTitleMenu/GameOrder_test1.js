...
function OnReceiveAjax(CMD, dataType, htmldata, jsondata) {
  ...
  switch(CMD) {
    ...
    { 
      ...
      if("F9A43D4DE4191C125B08095CC465CD4B" == jsondata.GroupGameGb){
        OnSearchClick();
      }
    ...
    { 
      if(jsondata.before_CMD == CMD_EDITRESULT){
        ...
        //개인전
        if(jsondata.groupgamegb == "F9A43D4DE4191C125B08095CC465CD4B"){
...
function OnSearchClick(liveSearch = false){
    ...
    Url = "/Ajax/GameTitleMenu/GameOrder_Operate_test1.asp"
...
function OnGroupResultDtlBtnExcelClick_elite(gameleveldtlidx, teamgamenum, gamenum, setnum, tourneygroupidx){
  GameLevelDtlIDX = gameleveldtlidx;
  TeamGameNum = teamgamenum;
  GameNum = gamenum;
  SetNum = setnum;
...
function PrintOneGame(gameleveldtlidx, teamgamenum, gamenum, stadiumNum, tempNum, listnum, entertype, groupgamegb){
