...
function SelGameTitle(tIDX,NowPage) {
  //암호화해야하는 URL
  Url ="/Ajax/GameTitleMenu/selGameTitleMenuInfo_test2.asp"
  var packet = {};
...
function selEntertypeChanged(obj){
  ...
  inputGameTitle_frm = function(NowPage) {
      //암호화해야하는 URL
      Url ="/Ajax/GameTitleMenu/inputGameTitle_frm_test2.asp";
...
updateGameTitle_frm = function (packet) {
 ...
 MedalGang  = $("#MedalGang").val();  // 실적적용강수
  ...
  Url ="/Ajax/GameTitleMenu/updateGameTitle_frm_test2.asp";
