...
function OnReceiveAjax(CMD, dataType, htmldata, jsondata) {
  ...
  switch(CMD) {
    ...
    { 
      //싸인저장
      prc_Signature(jsondata.GameLevelDtlIDX, jsondata.TeamGameNum, jsondata.GameNum, jsondata.WIN_TourneyGroupIDX, CMD_EDITRESULT);
...
function onEditResultClick(gameleveldtlidx, teamgamenum, gamenum){
...
function prc_Signature(gameleveldtlidx, teamgamenum, gamenum, tourneygroupidx, before_CMD) {
