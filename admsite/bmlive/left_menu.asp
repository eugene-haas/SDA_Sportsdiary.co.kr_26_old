...
%>
	<!-- 18. 12. 05 SEH 백소장님 요청 사항 -->
	<% If Request.ServerVariables("REMOTE_ADDR") = "118.33.86.240"  Then %>
		<div style="padding-left:15px"><br><br><br>
			<a href="http://badmintonadmin.sportsdiary.co.kr/Main/dbwork/tablehelp.asp" style="color:#FFFF00" target="_blank" title="[도움말]내부IP일 경우에 만, 표시 됩니다." >&nbsp;&nbsp;* 테이블 정보</a>
		</div>
	<% end if %>
</div>
<!-- E : left-navi -->
