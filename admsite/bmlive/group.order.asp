<!-- S: modal group-order -->
<div class="modal fade group-order">
  <!-- S: modal-dialog -->
  <div class="modal-dialog">
    <!-- S: modal-content -->
    <div class="modal-content" id="DP_GroupOrder_Popup">
      <!-- S: modal-body -->
      <div class="modal-body">
        ...
        <div class="order-header clearfix">
          ...
          <!-- S: vs -->
          <div class="vs">
            <img src="http://badmintonadmin.sportsdiary.co.kr/images/modal/vs_img.png" alt="vs">
          </div>
          <!-- E: vs -->
              ...
              <table class="table table-body">
                <tbody>
                  <tr>
                    <td>최보라</td>
                    <td>
                      <a href="#" class="btn btn-red-empty">삭제</a>
                    </td>
                  </tr>
                  <tr>
                    <td>이준희</td>
                  ...
                  <tr>
                    <td>조은비</td>
                    <td>
                      <a href="#" class="btn btn-gray">선택</a>
                    </td>
                  </tr>
                  <tr class="selected">
                    <td>이미숙</td>
                    <td>
                      <a href="#" class="btn btn-red">선택</a>
                    </td>
                  </tr>
                  <tr>
                    <td>구자현</td>
              ...
              <table class="table">
                <tbody>
                  ...
                  <tr>
                    <td>4</td>
                    <td>
                      <img src="http://badmintonadmin.sportsdiary.co.kr/images/modal/ic_check.png" alt>
                    </td>
                    <td>
                      <img src="http://badmintonadmin.sportsdiary.co.kr/images/modal/ic_check.png" alt>
                    </td>
        ...
        <div class="order-footer">
          <ul class="btn-list clearfix">
            ...
            <li><a href="#" class="btn btn-red" onclick="OnTeamTempCompleteClick('<%=GameLevelDtlIDX%>','<%=TeamGameNum%>');">등록완료</a></li>
          </ul>
        </div>
        <!-- E: order-footer -->
      </div>
