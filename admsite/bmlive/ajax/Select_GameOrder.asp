...
<%
  ...
  REQ = Request("Req")
  'REQ = "{""CMD"":4,""tGameTitleIDX"":""0B5EB9CEFAF1E107711072C78C2E36F8"",""tGameDay"":""2018-03-31"",""tStadiumIDX"":"""",""tStadiumNumber"":"""",""tSearchName"":""""}"
  ...
  If GameDay = "" Then
    GameDay = Year(Now) & "-" & Addzero(Month(now)) & "-" & Addzero(Day(now))
  End If  
