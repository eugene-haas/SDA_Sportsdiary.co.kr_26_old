...
<%
   ...
   initscriptstr = initscriptstr & "const g_search_obj = JSON.parse(('" & search_obj & "')?'" & search_obj & "':'{}'); // 검색 조건 obj" & vbCrlf
   initscriptstr = initscriptstr & "const g_etc_obj = JSON.parse(('" & etc_obj & "')?'" & etc_obj & "':'{}'); // 기타 params"
%>
