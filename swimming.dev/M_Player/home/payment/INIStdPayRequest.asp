...
' 여기에 설정된 값은 Form 필드에 동일한 값으로 설정
	maid				= "swsportsdi"										' 가맹점 ID(가맹점 수정후 고정)					
	
'인증
	signKey			    = "Z1NGZDJSd0M2T3RXVzdZayt0SDA1UT09"				' 가맹점에 제공된 웹 표준 사인키(가맹점 수정후 고정)
	...
	siteDomain = "http://sw.sportsdiary.co.kr/home/page/" '가맹점 도메인 입력
%>
									...
									<td style="text-align:left;">
										<form id="SendPayForm_id" name="" method="POST" >
											...
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
												...
												<br/>KWPY_TYPE(0):KWPY_VAT(10|0) 기타 옵션 정보 및 설명은 연동정의보 참조 구분자 ":" 실물결제 2
												<br/><input style="width:100%;" name="acceptmethod" value="CARDPOINT:HPP(2):no_receipt:va_receipt:vbanknoreg(0):below1000" >
											</div>
