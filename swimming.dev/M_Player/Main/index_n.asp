  ...
  <div class="l_content m_scroll indexpage [ _content _scroll ] ">
    ...
    <div class="m_board">
       ...
       <div class="m_board__con">
          ...
          <button type="button">신기록 보기</button>
       </div>
       <!-- 검색어 영역, 검색 버튼 -->
       <!-- <div class="m_searchTags" style="margin:10px;">
          <div class="m_searchTags__infoBox">
             <p class="m_searchTags__infoTxt" v-if="search_txt!=''">{{search_txt}}</p>
             <button class="m_searchTags__btn" @click="openSearching('.searchPopup')">
                <div class="m_img"><img src="http://img.sportsdiary.co.kr/images/SD/icon/search_@3x.png" alt=""></div>
             </button>
          </div>
       </div> -->
    </div>
