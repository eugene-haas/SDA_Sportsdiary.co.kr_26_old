...
<div id="app" class="l m_bg_f2f2f2 matchSch" v-cloak>
  ...
  <div class="l_header">
    <div class="m_header s_sub">
      <a href="./index.asp" class="m_header__backBtn">이전</a>
  ...
  <div class="l_content m_scroll [ _content _scroll ]" style="margin-top:10px;">
...
<%
	...
	<%If ari = 0 then%>
		  <table class="table_player_history">
            <thead>
              <tr>
                <th colspan="2"><%=l_titlename%></th>
              </tr>
            </thead>
            <tbody>
	...
	<%End if%>
              ...
              <tr>
                <th class="clear">
                  <span id="tabHisDate"><%=l_gamedate%></span>
                  <span id="tabHisDistance"><%=l_cdcnm%></span>
                  <span id="tabHisTour"><%=l_cdcnm%></span><br>
                  <span id="tabHisPart"><%=l_cdbnm%></span>
                  <span id="tabHisLocation"><%=l_teamnm%></span>
                </th>
                <td>
                  <span id="tabHisTime"><%Call SetRC(l_gameresult)%></span><br>
                  <span id="tabHisRank"><%=l_gameorder%>위</span>
                  <span id="tabHisRecord"><%If l_rctype <> "" then%>[<%=l_rctype%>]<%End if%></span>
                </td>
              </tr>
