<!-- #include virtual = "/pub/header.sample.asp" -->
...
<head>
	<!-- #include virtual = "/pub/html/sample/html.head.lte.asp" -->
...
<div class="wrapper">
  ...
  <!-- #include virtual = "/pub/html/sample/html.header.lte.asp" -->


  <%pagename = "contest.asp"%>
  <!-- #include virtual = "/pub/html/sample/html.left.lte.asp" -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">대회정보관리</li>
      </ol>
    </section>

    <section class="content">
			<!-- #include file = "./sample/c.contestlevel.asp" -->
    </section>
  </div>


  <!-- #include virtual = "/pub/html/sample/html.footer.lte.asp" -->
