...
'where T.delyn = 'N' 
	...
	strWhere = " DelYN = 'N'   and GameS >= '2020-01-01' and GameTitleIDX = (select top 1 GameTitleIDX from tblRgameLevel where GameTitleIDX = a.GameTitleIDX and DelYN='N' and cda = 'D2')   " '2020년도 부터 시작한거니까 경영만 
	F1 = "D2"
...
<%If ADGRADE > 500 then%>
			<td>
				  <a href="javascript:px.goSubmit({'TIDX':<%=l_idx%>},'/awardbest_view.asp')" class="btn btn-primary">다관왕조회</a>
			</td>			
<%End if%>
		</tr>
