<%
    ...
    Sub userPaginglinkBike (ByVal total_page, ByVal block_size, ByVal page, ByVal function_name)
		...
		If min_page > block_size Then
			response.write "<a href="" class=""icon-btn"" javascript:"" onclick=""" & function_name & "("& min_page-1 & ")""><i class=""fas fa-angle-left""></i></a>" & vbcrlf
		Else
			response.write "<a href="" class=""icon-btn"" javascript:alert('첫 페이지 입니다.');""><i class=""fas fa-angle-left""></i></a>" & vbcrlf
		End if
		...
		If max_page < total_page Then
			response.write "<a href="" class=""icon-btn"" javascript:"" onclick=""" & function_name & "(" & max_page + 1 & ")""><i class=""fas fa-angle-right""></i></a>" & vbcrlf
		Else
			response.write "<a href="" class=""icon-btn"" javascript:alert('마지막 페이지 입니다.');""><i class=""fas fa-angle-right""></i></a>" & vbcrlf
		End If
