...
////////////////////////////////////////
	...
	mx.CMD_INSERTTEMP = 201; //임시저장테이블에 참가신청저장 및 설정
    mx.CMD_INSERTMEMBER = 301;
    mx.CMD_RESETDATA = 401;
////////////////////////////////////////
...
//응답##################################################################
	...
	//파일업로드 , 참가신청밀어넣기
	//////////////////////////////////////////////////////////
	mx.insertTemp = function(tidx,sendpre){
		var obj = {};
	...
	mx.resetData = function(tidx,sendpre){
	...
	mx.insertRequest = function(tidx,sendpre){
		var obj = {};
	...
	mx.fileUpload = function(){
		...
		case "1":
			...
			var fileext = getExtensionOfFilename(form.upfile.value);

			//console.log(fileext);		
			if (fileext != ".jpg" && fileext != ".hwp" &&  fileext != ".pdf" &&  fileext != ".doc" &&  fileext != ".xls" )	{
				alert("허용되는 파일이 아닙니다.")
				return;
			}
		break;
