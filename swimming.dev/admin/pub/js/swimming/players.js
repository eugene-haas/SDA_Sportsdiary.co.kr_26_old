...
////////////////////////////////////////
  ...
  mx.CMD_TEAMFIND = 40001;
////////////////////////////////////////



mx.ajaxurl = "/pub/ajax/swimming/reqPlayer.asp";
mx.ajaxtype = "POST";
mx.dataType = "text";
...
//요청##################################################################
   ...
   mx.deleteMessageMember = function(pidx){
	...
	mx.input_frm = function(lastno){
		...
		passarrno[7] = 1;
		passarrno[13] = 1;
		obj.ENTERTYPE = $('#entertype').val(); //엘리트 동호인구분 21.3.11 추가
		obj.NOWYEAR = $('#nowyear').val(); //등록년도 21.3.11 추가
		...
		$( "#mk_g11" ).autocomplete({
			source : function( request, response ) {
				 ...
				 $.ajax({
						...
						url: mx.ajaxurl,
						dataType: "json",
						data: { "REQ" : JSON.stringify({"CMD":mx.CMD_FINDTEAM, "SVAL":request.term, "ENTERTYPE": $('#entertype').val()})  },
