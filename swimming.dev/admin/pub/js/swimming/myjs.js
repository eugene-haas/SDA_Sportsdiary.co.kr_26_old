...
mx.SendPacket = function( sender, packet){
	...
	var url = "/pub/ajax/" +location.hostname.split(".")[0].toLowerCase().replace('admin','ming') + "/reqAjax.asp";
...
mx.ReceivePacket = function( reqcmd, data, sender ){// data는 response string
	...
	case mx.CMD_BOARD:	this.OnBoardList( reqcmd, jsondata, htmldata, sender );		break;
	case mx.CMD_BOARDWRITE:	this.OnBoardWrite( reqcmd, jsondata, htmldata, sender );		break;
...
mx.OnBoardList =  function(cmd, packet, html, sender){
	document.getElementById("axcontents").innerHTML = html;
};

mx.OnBoardWrite =  function(cmd, packet, html, sender){
	document.getElementById("axcontents").innerHTML = html;
