...
<%'  <link rel="stylesheet" href="http://swimming.sportsdiary.co.kr/dist/css/AdminLTE.min.css">%>
    ...
    <link rel="stylesheet" href="http://img.sportsdiary.co.kr/css/Player_info.css?ver=0.0.6">
  ...
  <link rel="stylesheet" href="http://img.sportsdiary.co.kr/SD/sd-common.css?0.1" />


  <link href="/css/jquery-ui.min.css" rel="stylesheet" type="text/css" />

  <link href="http://swimming.sportsdiary.co.kr/plugins/JQueryUI/jquery-ui.min.css" rel="stylesheet" type="text/css" />
  ...
  <link rel="stylesheet" href="../css/sw_style.min.css?9">
...
<%'<script src="http://swimming.sportsdiary.co.kr/plugins/JQueryUI/jquery-ui.min.js"></script>%>
