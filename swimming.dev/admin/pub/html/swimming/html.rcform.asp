						...
						<div class="row">
							<div class="col-md-6" style="width:47%;padding-left:10px;padding-right:0px;">
								  <div class="form-group">
									...
									<input type="hidden" id="mk_g19" value="<%=e_sido%>" ><!-- 시도  -->
									<input type="hidden" id="mk_g20" value="<%=e_sidocode%>" ><!-- 시도코드  -->
						...
						<div class="row">
							<div class="col-md-6" style="width:100%;">
								  <div class="form-group" style="text-align:right;">
										...
										<a href="#" class="btn btn-primary" id="btnsave" onclick="mx.input_frm(21);" accesskey="i">등록<span>(I)</span></a>
										<a href="#" class="btn btn-primary" id="btnupdate" onclick="mx.update_frm(21);" accesskey="e">수정<span>(E)</span></a>
