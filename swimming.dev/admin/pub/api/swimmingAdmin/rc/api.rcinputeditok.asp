...
'#############################################
	...
	Set db = new clsDBHelper 
		...
		updatefield = " titleCode,titlename,gamearea,gameDate,UserName,TeamNm,userClass,gameResult,gameOrder,rctype,CDA,CDANM, gubun,  CDB,CDBNM,CDC,CDCNM ,kskey,Team, playerIDX, Sex,sido,sidoCode "
