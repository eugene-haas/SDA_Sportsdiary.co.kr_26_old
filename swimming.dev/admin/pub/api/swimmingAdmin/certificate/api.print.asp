...
End if
	...
	pagesize = 15
	'선수정보
	SQL = "select addr1,addr2, team,teamnm from tblPlayer where playeridx = '"&s_pidx&"' "
	...
	SQL_Order = "Select info1,info2,info3,info4 From tblSwwimingOrderTable "
	SQL_Order = SQL_Order & " Where del_yn = 'N'  and OrderIDx = " & seq
	...
	Else
		info1 = rs(0) '발급용도
		info2 = rs(1) '제출처
		info3 = rs(2) '증명서 종류 1 대회참가확인서 2 선수실적증명서
		info4 = rs(3) ' 대참인경우 대회 tblrecord index 들 
...
%>
         <li class="l_print__page">
            <section class="m_confirmation">
               ...
               <footer class="m_confirmation__footer">
                  <h2>사단법인 대한수영연맹회장</h2>
                  <img src="/home/images/print/print_confirmation-bar.png" alt="">
               </footer>
            </section>
         </li>
