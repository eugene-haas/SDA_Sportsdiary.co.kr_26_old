<%
	...
	If F1 <> "" And F2 <> "" Then
		...
		'strWhere =  " a.delyn = 'N' and b.delyn = 'N'  and b.CDC = '"&cdc&"' and a.gametitleidx <> "&tidx&"  and a.gameS >= '"&sdate&"' and a.gameE < '"&edate&"' "
		'strWhere =  " a.delyn = 'N' and b.delyn = 'N'  and a.gametitleidx <> "&tidx&"  and a.gameS >= '"&sdate&"' and a.gameE < '"&edate&"' "
	...
	'fldA = " a.gametitleidx,a.titlecode,a.gametitlename,a.gameS,a.gameE,a.gamearea,a.kgame,a.gubun "
	'fldB = " ,b.RGameLevelidx, b.cda,b.cdanm,b.cdb,b.cdbnm,b.cdc,b.cdcnm "
	'strSql = "SELECT "&fldA &  fldB & "  FROM sd_gameTitle as a inner JOIN tblRgameLevel as b ON a.gametitleidx = b.gametitleidx  WHERE " &strwhere
	'Set rs = db.ExecSQLReturnRS(strSQL , null, ConStr)

	'ldA = " a.gametitleidx,a.titlecode,a.gametitlename,a.gameS,a.gameE,a.gamearea,a.kgame,a.gubun "
	'fldB = " ,b.RGameLevelidx, b.cda,b.cdanm,b.cdb,b.cdbnm,b.cdc,b.cdcnm "
...
<div class="modal-dialog modal-xl">
  <div class="modal-content">
    ...
    <div class='modal-header game-ctr'>
      ...
      <h4 class="modal-title" id="myModalLabel">기준기록조회 (조회선택없을시 1년이내 기록조회)</button></h4>
    </div>
							...
							<div class="col-md-6" style="width:15%;padding-left:20px;padding-right:0px;text-align:left;">
								  <div class="form-group">
									...
									<div class="input-group date">
										...
										<div class="input-group-addon" onmousedown="mx.gameSearchList( <%=tidx%>,<%=gbidx%>,'<%=cdc%>', $('#F1').val() , $('#F2').val()  )">
	...
	<%'#######################################################%>
  	...
  	<div class="modal-footer">
		<a href="javascript:mx.setBestRecord(<%=tidx%>,<%=gbidx%>,'<%=cdc%>')" class="btn btn-primary" >기준기록업데이트</a>
