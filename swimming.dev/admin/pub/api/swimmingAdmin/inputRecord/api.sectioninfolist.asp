	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<div style="width:100%;padding-right:50px;padding-right:0px;text-align:right;">
				<a href="javascript:mx.delSectionRecord('<%=del_midx%>')" class="btn btn-danger"><i class="fa fa-fw fa-print"></i>구간기록삭제</a>
				&nbsp;&nbsp;&nbsp;&nbsp;
				
				
				<a href="javascript:$('#swtable').printThis({importCSS: false,loadCSS: 'http://rhttp://swimming.sportsdiary.co.kr/pub/js/print/print_swim.css',header: '<h1>서울시 대회</h1>'});" class="btn btn-danger"><i class="fa fa-fw fa-print"></i>구간기록출력</a>
			</div>
