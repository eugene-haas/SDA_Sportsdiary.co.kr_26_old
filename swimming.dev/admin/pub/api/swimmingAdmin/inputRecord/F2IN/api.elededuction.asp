...
'#############################################
    ...
    If btnstate = "default" then
			SQL = "Update sd_gameMember_roundRecord set a_elededuction = 5 where  midx  = "&midx&"  and gameround = "&roundno&"  "
		Else
			SQL = "Update sd_gameMember_roundRecord set a_elededuction = 0 where  midx  = "&midx&"  and gameround = "&roundno&"  "
		End If
