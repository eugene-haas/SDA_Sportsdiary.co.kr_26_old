...
'#############################################
	...
	Set db = new clsDBHelper
		...
		If btnstate = "default" then
			SQL = "Update sd_gameMember_roundRecord set a_tktotaldeduction = 5 where  midx  = "&midx&" "
		Else
			SQL = "Update sd_gameMember_roundRecord set a_tktotaldeduction = 0 where  midx  = "&midx&" "
		End If
