...
<%
  'request 처리##############
	...
	'예선만 가져오면됨... 오전이든 오후든....
	gametitlenm = " (select gametitlename from sd_gametitle where gametitleidx = a.gametitleidx and delyn='N' ) as titlenm "
	...
	SQL = "Select " & fld & " from tblRGameLevel as a where RGameLevelidx =  '"&idx&"'  and cda = 'D2' and delyn = 'N' "
	...
	<div class="tbl-match"  >
      <div class="tbl-match__con">
        ...
        <table class="tbl-match__con__tbl">
          <caption><%=gno%>-<%=jno%> <%=l_CDBNM%> <%=l_CDCNM%> 예</caption>
          <thead>
            <tr>
              <th>레인</th>
              <th>성명</th>
