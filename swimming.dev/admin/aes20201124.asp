...
<%
	...
	Const sconKey = "sportsnatplayer1"
	Const sconIV = "sportsnatplayer1"

	
	Function senc(ByVal word)
		
		If chkBlank(word) Then Exit Function
		Set objEncrypter = Server.CreateObject("Ryeol.StringEncrypter")
 		objEncrypter.Key = sconKey
		objEncrypter.IV = sconIV
		...
		' 문자열 암호화
		senc =objEncrypter.Encrypt(word)
		Set objEncrypter = Nothing
	End Function

	Function sdec(ByVal cipher_word)
		...
		' 문자열 복호화
		sdec = objEncrypter.Decrypt(cipher_word)
		Set objEncrypter = Nothing
	End Function
...
'aKey = "sportsnatplayer1"
'aIV = "sportsnatplayer1"
'
'' 인스턴스 만들기
'Set objEncrypter = Server.CreateObject("Ryeol.StringEncrypter")
...
encNo = senc("19280815")
encM = senc("M")
Response.write "최영권 : " & encNm  & "<br>"
Response.write "19280815 : " & encNo  & "<br>"
Response.write "M : " & encM  & "<br>"
...
<br><br>
JSP소스상에 보면<br>
	Cipher c = Cipher.getInstance("AES/CBC/PKCS5Padding");    >> PKCS7Padding <br>

<br><br>구조 : <br>
<img src="https://t1.daumcdn.net/cfile/tistory/0167024B50C4CDE301"><%



%>
<br><br>
참조URL 읽어보세요.  https://stackoverrun.com/ko/q/7116438
<%
