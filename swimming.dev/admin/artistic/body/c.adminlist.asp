...
<%
 'Controller ################################################################################################
	...
	If F1 <> "" And F2 <> "" Then
		strWhere =  " SiteCode = '"&SiteCode&"' and " & F1 & " like '%" & F2 & "%'  and Kind_code = 'F2' "
	else
		strWhere = " SiteCode = '"&SiteCode&"'     and   Kind_code = 'F2' "
	End if
			...
			<div class="info_serch" id="gameinput_area">
				<div id="ul_1" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-1">
							<a href="javascript:mn.writePop('modalS',2)" class="btn btn-primary">심판등록</a>
						</div>
                ...
                <tbody id="tblbody">
						...
						%>
								<tr style="text-align:center;">
									...
									<td><span><a href="javascript:mn.writePop('modalS',2, <%=rs(0)%>)" class="btn btn-primary"> 수정 </a></span></td>
								</tr>
