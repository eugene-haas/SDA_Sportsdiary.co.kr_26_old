...
<head>
	...
	<script type="text/javascript" src="/pub/js/<%=CONST_PATH%>/dsetrecord3.js<%=CONST_JSVER%>8"></script>
</head>
<body <%=CONST_BODY%>>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
			<!-- #include file = "./body/c.DsetRecord3.asp" -->
    </section>
  </div>
