...
<%'View ####################################################################################################%>
      <div class="box box-primary <%If pageYN="N" then%>collapsed-box<%End if%>">
        <div class="box-header with-border">
          <h3 class="box-title">2020 탁구 디비전 T4 리그</h3>
		...
		<div class="box-body" id="gameinput_area">
			...
			<!-- s: 등록화면 -->
			  <!-- #include virtual = "/pub/html/sample/gameinfolevelform.asp" -->
			<!-- e: 등록 화면 -->
			<%End if%>
        </div>
...
goo = array("마포구","강서구","동작구","강남구","종로구","은평구","노원구","강동구","강북구","영등포구","여의도","양천구","서초구","송파구","서대문구","노원구","도봉구","광진구","중구","성동구","동작구","관악구","금천구","성동구","동대문구","마포구","강서구","동작구","강남구","종로구","은평구","노원구","강동구","강북구","영등포구","여의도","양천구","서초구","송파구","서대문구","노원구","도봉구","광진구","중구","성동구","동작구","관악구","금천구","성동구","동대문구")
n =0
...
End if
			...
			%><!-- #include virtual = "/pub/html/sample/gameinfolevellist.asp" --><%
