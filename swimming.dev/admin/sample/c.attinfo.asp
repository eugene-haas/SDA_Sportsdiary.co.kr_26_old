...
<%'View ####################################################################################################%>
	  ...
	  <div class="box-body" id="gameinput_area">
			  <!-- #include virtual = "/pub/html/sample/gameRecordForm.asp" -->
      </div>
	  <%'End if%>
...
<%
	Function ran_name_func()
		...
		ran_name_func = Left(player,3)'Left(player, rnd_value)
	End Function
%>
      ...
      <div class="row">
		...
		<div class="col-xs-12">
          <div class="box">
             <div class="box-header">
              <h3 class="box-title"><b><span style="font-family:time">2020</span> 탁구 디비전 T4 리그</b></h3>
            
				<span style="display:inline;float:right;">
				<a href="" class="btn btn-primary">참가신청 전체승인</a>
				<a href="" class="btn btn-danger">참가신청 전체취소</a>
				</span>
			</div> 
            <!-- /.box-header -->
		...
		<tr id="titlelist_<%=l_idx%>" style="text-align:center;">
			<td><%=ari+1%></td>
			<td>서울</td>
			<td style="text-align:left;">마포구</td></td>
			<td>마포탁구클럽</td>
			<td class="bg-gray">단체전</td>

			
			<td colspan="5" style="padding-bottom:0px;margin:0px;">
              <table  class="table" >			
				<%For x = 1 To 5%>
				<tr>
					<td><%=ran_name_func()%></td>
					...
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;남</td>
					<td>010-1234-1234</td>
					<td><a href="#" class="btn btn-default">미결제</a></td>
				</tr>
				<%next%>
              </table>			
			</td>
