          ...
          <div class="l_popinfo__content">
            ...
            <div class="l_popinfo__wrap">
              ...
              <p class="l_popinfo__cmt">
                <span v-for="(info,key) in popinfo_list.host">{{key=='0'?'':', '}}{{info.name}}</span>
              </p>
            </div>
            <div class="l_popinfo__wrap">
              ...
              <p class="l_popinfo__cmt">
                <span v-for="(info,key) in popinfo_list.superviser">{{key=='0'?'':', '}}{{info.name}}</span>
              </p>
            </div>
            <div class="l_popinfo__wrap">
              ...
              <p class="l_popinfo__cmt">
                <span v-for="(info,key) in popinfo_list.sponsor">{{key=='0'?'':', '}}{{info.name}}</span>
              </p>
            </div>
            <div class="l_popinfo__wrap">
