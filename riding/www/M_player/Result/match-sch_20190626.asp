                  ...
                  <div class="recordTable">
                    <table>
                      ...
                      <tbody>
                        ...
                        <tr v-if="player.tabletype=='MA' || player.tabletype=='MB' || player.tabletype=='SUM'">
                          <td colspan="2" v-bind:class="{s_gray2: sumriding, s_gray3: !sumriding}">총비율</td>
                          <td v-if="!sumriding">{{player.tableinfo[0].judgeall}}</td>
                          <td v-else>{{player.tableinfo[0].judgeall}}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
