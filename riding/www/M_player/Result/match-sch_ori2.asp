    ...
    <div class="l_upLayer__contBox m_searching__area [ _overLayer__box ]">
      ...
      <div class="l_upLayer__wrapCont m_searchPopup__cont [ _overLayer__wrap ]">
        <div class="m_searchPopup__control">
          <input type="text" placeholder="선수명, 마명을 입력하세요." class="m_searchPopup__input s_only [ _searchingInput ]" v-model="keyword" v-on:input="keyword=$event.target.value" @keyup="inputKeyup">
