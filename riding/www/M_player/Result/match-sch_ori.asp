    ...
    <div class="l_upLayer__contBox m_searching__area [ _overLayer__box ]">
      ...
      <div class="l_upLayer__wrapCont m_searchPopup__cont [ _overLayer__wrap ]">
        <div class="m_searchPopup__control">
          <input type="text" placeholder="선수명, 마명을 입력하세요." class="m_searchPopup__input s_only [ _searchingInput ]" v-model="keyword" v-on:input="keyword=$event.target.value" v-on:keyup="inputKeyup">
      ...
      <div class="l_upLayer__wrapCont popupContent [ _overLayer__wrap ]">
        ...
        <div class="l_popinfo__content">
          ...
          <div class="m_layerBtns">
            <button class="m_layerBtn s_cancel" @click="closePopup">취소</button>
...
<script>
  ...
  let app=new Vue({
    ...
    data:{
      ...
      keyword:"",// 검색어
      nokeyword:false,// 검색어가 없을 떄(true)
      layer:undefined,// 팝업
