...
<div class="admin_content">
	...
	<!-- s: 페이지 타이틀 -->
	<div class="page_title"><h1>참가신청관리 - 참가신청현황</h1></div>
	<!-- e: 페이지 타이틀 -->
...
<pre>
	대회명 : ㄹ어마ㅣ렁ㄴㅁ					실인원(명)  (중복제외) | 참가말 (중복제외) | 신청인원 (중복포함) |참가비 
	신청기간 : 러아링ㄴ						50 55 82 1,300,000	
	신청상태 : 진행중   												
</pre>
...
<!-- 					<td>톱밥신청포수</td> -->
					<td>참가비</td>
					<td>명단</td>
					<td><a href="./findcontestdetail.asp" class="btn btn-primary">상세보기</a></td>
				</tr>
