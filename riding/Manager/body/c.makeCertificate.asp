 ...
 'Controller ################################################################################################
	...
	If tidx = "" Then
		%>
		<script>px.goSubmit( {'F1':[0,1,2],'F2':['<%=year(date)-1%>','',''],'F3':[]} , 'makecertificate.asp');</script>
		<%
...
<%If ddd = "퍼블" Then '333333333333333333333333333333333333333333333333333333333333333333333333333333333333333%>

			<!-- 10.23 update :: wyn -->
			<div class="admin_content">
				<a name="contenttop"></a>
			
				<div class="page_title"><h1>대회결과관리 > 상장생성</h1></div>
				
				<!-- s: 정보 검색 -->
				<div class="info_serch" id="gameinput_area">
					<div class="form-horizontal" style="display: inline-block; width: 93%;">
						<div class="form-group">
							<label class="control-label col-sm-1">년도</label>
							<div class="col-sm-2">
								<select id="F1_0" class="form-control"><option value="2019">2019</option></select>
							</div>

							<label class="control-label col-sm-1">대회명</label>
							<div class="col-sm-2">
								<select id="F1_1" class="form-control"><option value="">제31회 정기룡장군배 전국승마대회</option></select>
							</div>
				
							<label class="control-label col-sm-1">종목</label>
							<div class="col-sm-2">
								<select id="F1_2" class="form-control"><option>전체</option><option>마장마술</option></select>
							</div>
				
							<label class="control-label col-sm-1">클래스</label>
							<div class="col-sm-2">
								<select id="F1_3" class="form-control"><option>전체</option><option>C Class</option></select>
							</div>
							
						</div>
					</div>
					<div class="btn-group flr" style="width: 5%;">
				...
				<div class="info_serch" id="gameread_area">
					<div class="form-horizontal" style="display: inline-block; width: 93%;">
						<div class="form-group">
							<label class="control-label col-sm-1">상장번호</label>
							<div class="col-sm-2">
								<input id="cert_num" type="text" value="" class="form-control"/>
							</div>

							<label class="control-label col-sm-1">상장종류</label>
							<div class="col-sm-2">
								<input id="cert_category" type="text" value="" class="form-control"/>
							</div>
				
							<label class="control-label col-sm-1">종목</label>
							<div class="col-sm-2">
								<input id="cert_event" type="text" value="" class="form-control"/>
							</div>
				
							<label class="control-label col-sm-1">Class</label>
							<div class="col-sm-2">
								<input id="cert_class" type="text" value="" class="form-control"/>
							</div>

							<label class="control-label col-sm-1">종별</label>
							<div class="col-sm-2">
								<input id="cert_distin" type="text" value="" class="form-control"/>
							</div>

							<label class="control-label col-sm-1">순위</label>
							<div class="col-sm-2">
							<input id="cert_rank" type="text" value="" class="form-control"/>
							</div>
				
							<label class="control-label col-sm-1">수상자</label>
							<div class="col-sm-2">
								<input id="cert_name" type="text" value="" class="form-control"/>
							</div>
				
							<label class="control-label col-sm-1">소속팀</label>
							<div class="col-sm-2">
								<input id="cert_team" type="text" value="" class="form-control"/>
							</div>
							
							<label class="control-label col-sm-1">마명</label>
							<div class="col-sm-2">
								<input id="cert_horse_name" type="text" value="" class="form-control"/>
							</div>

							<label class="control-label col-sm-1">성적</label>
							<div class="col-sm-2">
							<input id="cert_grade" type="text" value="" class="form-control"/>
							</div>
				
							<label class="control-label col-sm-1">수상일자</label>
							<div class="col-sm-2">
								<input id="cert_date" type="text" value="" class="form-control"/>
							</div>
				
							<label class="control-label col-sm-1">협회장</label>
							<div class="col-sm-2">
								<input id="cert_president" type="text" value="" class="form-control"/>
							</div>

							<label class="control-label col-sm-1">상장내용</label>
							<div class="col-sm-11">
								<textarea id="cert_content" type="text" class="form-control" rows="7"></textarea>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="btn-toggle">
					<span><input id="cert_input_num" type="text" value=""/></span>
					<a href="#" class="btn btn-success">상장번호부여</a>
					<div class="btn-group flr">
						<a href="#" title="동일대회적용" class="btn btn-primary">동일대회적용</a>
					</div>
				</div>
				...
				<div class="table-responsive" >
					<table cellspacing="0" cellpadding="0" class="table table-hover" id="resultlist" >
						<thead>
							<tr>
								<th>
									<input id="r_allCheck" type="checkbox" onchange=""/>
								</th>
								<%'For i = 1 To 3%>
								<th>구분</th>
								<th>상장번호</th>
						...
						<tbody id="contest">
							...
							<tr id="" class="gametitle">
								...
								<td>개인</td>
								<td>
									<a href="#" id="r_certNum" class="btn btn-success">2019-102</a>
								</td>
								<td>마장마술</td>
								<td>제31회 정기룡 장군배 전국승마대회</td>
								<td>01</td>
								<td>김은아</td>
								<td>아나스타샤</td>
								<td>우석여자고등학교</td>
				...
				<div class="btn-group flr">
					<a href="#" title="선택인쇄" class="btn btn-primary flr">선택인쇄</a>
				</div>
			</div>
<%End if%>