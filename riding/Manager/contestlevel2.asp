...
<head>
	...
	<script type="text/javascript" src="/pub/js/<%=CONST_PATH%>/tennis_contestlevel_test.js<%=CONST_JSVER%>"></script>
	<%else%>
	<script type="text/javascript" src="/pub/js/<%=CONST_PATH%>/tennis_contestlevel.js<%=CONST_JSVER%>"></script>
	<%End if%>

	<script type="text/javascript" src="/pub/js/<%=CONST_PATH%>/menu1/tennis_contestlevel_result.js<%=CONST_JSVER%>"></script>

	<script src="/pub/js/<%=CONST_PATH%>/html2canvas.min.js"></script>
