...
<head>
	...
	<script type="text/javascript" src="/pub/js/riding/utill.js?v=190820"></script>
	<script type="text/javascript" src="/pub/js/<%=CONST_PATH%>/TeamInfo.js<%=CONST_JSVER%>5"></script>
    ...
    function Postcode() {
        new daum.Postcode({
            oncomplete: function (data) {
                ...
                document.getElementById('mk_g5').value = data.zonecode; //5자리 새우편번호 사용
                document.getElementById('mk_g6').value = fullAddr;
                document.getElementById('mk_g7').focus();
