...
<head>
	...
	<script type="text/javascript" src="/pub/js/<%=CONST_PATH%>/tennis_gamerull3.js<%=CONST_JSVER%>"></script>
</head>
...
<body <%=CONST_BODY%>>
  ...
  <div id="loadingDiv" style="z-index:999;"></div>
	...
	<div id="myModal" class="modal hide fade tourney_admin_modal contest_page" data-backdrop="static"></div>
