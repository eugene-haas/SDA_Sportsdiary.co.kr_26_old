...
<head>
	...
	<script type="text/javascript" src="/pub/js/<%=CONST_PATH%>/judgedetailrelay.js<%=CONST_JSVER%>"></script>
...
<body <%=CONST_BODY%>>
	<div class="t_default">
		...
		<div id="body">
			<aside>
			<%pagename = "judgedetail.asp"%>
			<!-- #include virtual = "/pub/html/riding/html.left.asp" -->
			<%pagename = "judgerelay.asp"%>
			</aside>

			<article id="sc_body">
			<!-- #include file = "./body/c.judgerelay.asp" -->
			</article>
		</div>
