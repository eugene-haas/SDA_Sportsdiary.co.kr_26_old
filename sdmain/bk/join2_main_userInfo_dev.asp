...
<div class="l">
  ...
  <style>
    .m_combineFormList__input.s_id{padding-right:73px;}
    .m_combineFormList__btn{position:absolute;display:inline-block;height:30px;top:0;bottom:0;right:0;margin:auto;padding:5px 11px;border:1px solid #ccc;color:#333;background-color:#fff;font-size:13px;}
    .m_combineFormList__btn.s_id{}
      ...
      <ul class="m_combineFormListB">
        ...
        <li class="m_combineFormListB__item">
          ...
          <div class="m_combineFormListB__inputWrap">
            ...
            <a href="javascript:Chk_SMS();" class="m_combineFormList__btn">인증</a>
          </div>
        ...
        <li class="m_combineFormListB__item" id="CHK_REAUTH" style="display:none;">
          <div class="m_combineFormListB__inputWrap">
            <input type="number" name="Re_Auth_Num" id="Re_Auth_Num" class="m_combineFormListB__input" placeholder="인증번호를 입력해주세요" />
