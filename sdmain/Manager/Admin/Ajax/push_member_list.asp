...
<%
	...
	ELSE
		FndData = FndData & "<tr>"
		FndData = FndData & "	<td colspan=8>앱 알림 수신동의 회원정보가 없습니다.</td>"	
		FndData = FndData & "</tr>"
	End IF	
	...
	If intTemp = 1 Then
        ...
        Else
          CStrPG = CStrPG & "<a href=""javascript:chk_Submit('LIST','',1);""><i class=""fas fa-angle-double-left""></i></a>"
          CStrPG = CStrPG & "<a href=""javascript:chk_Submit('LIST','','"&currPage-1&"');"" class=""icon-btn""><i class=""fas fa-angle-left""></i></a>"
        End IF
	Else 
        CStrPG = CStrPG & "<a href=""javascript:chk_Submit('LIST','',1);"" class=""icon-btn""><i class=""fas fa-angle-double-left""></i></a>"
        CStrPG = CStrPG & "<a href=""javascript:chk_Submit('LIST','','"&intTemp - BlockPage&"');"" class=""icon-btn""><i class=""fas fa-angle-left""></i></a>"
	End If	
	...
	Do Until intLoop > BlockPage Or intTemp > TotalPage
		...
		Else
			CStrPG = CStrPG & "<a href=""javascript:chk_Submit('"&intTemp&"');""><span>"&intTemp&"</span></a>"
		End If
	...
	IF intTemp > TotalPage Then
        IF cint(currPage) < cint(TotalPage) Then
          CStrPG = CStrPG & "<a href=""javascript:chk_Submit('LIST','','"&currPage+1&"');"" class=""icon-btn""><i class=""fas fa-angle-right""></i></a>"
          CStrPG = CStrPG & "<a href=""javascript:chk_Submit('LIST','','"&TotalPage&"');"" class=""icon-btn""><i class=""fas fa-angle-double-right""></i></a>"
        Else
        ...
        End IF
	Else
        CStrPG = CStrPG & "<a href=""javascript:chk_Submit('LIST','','"&intTemp&"');"" class=""icon-btn""><i class=""fas fa-angle-right""></i></a>"
        CStrPG = CStrPG & "<a href=""javascript:chk_Submit('LIST','','"&intTemp&"');"" class=""icon-btn""><i class=""fas fa-angle-double-right""></i></a>"
	End IF	
