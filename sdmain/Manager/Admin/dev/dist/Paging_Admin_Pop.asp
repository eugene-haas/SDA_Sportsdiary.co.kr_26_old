...
<ul class="pagination">
	<div class="paging">
		<%
			...
			If iTemp = 1 Then
					Response.Write "<a href=""javascript:;"" class=""""><i class=""fa fa-caret-left"" aria-hidden=""true""></i></a>"
			Else 
					Response.Write"<a href='javascript:;' onclick = 'javascript:PagingLink(" & iTemp - BlockPage & ")' class=''><i class=""fa fa-caret-left"" aria-hidden=""true""></i></a>"
			End If
			...
			IF( LCnt > 0 ) Then
				Do Until iLoop > BlockPage Or iTemp > iTotalPage
						If iTemp = CInt(NowPage) Then
							...
							Response.Write "<a href='javascript:;' class='on'>" & iTemp &"</a>"
						Else
			...
			If iTemp > iTotalPage Then
					Response.Write "<a href=""javascript:;"" class=""""><i class=""fa fa-caret-right"" aria-hidden=""true""></i></a>"
			...
			Else
					Response.Write "<a href='javascript:;' onClick='javascript:PagingLink(" & iTemp & ")' class=''><i class=""fa fa-caret-right"" aria-hidden=""true""></i></a>"
