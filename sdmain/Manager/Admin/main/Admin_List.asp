...
<div class="content">
  ...
  <%
    ...
    'crypt.EncryptStringENC(iLoginID)
        ...
        <div class="Admin_List">
          ...
          <div class="table-box basic-table-box">
            <table cellspacing="0" cellpadding="0">
              ...
              <tr style="cursor:pointer" onclick="javascript:ReadLink('<%=crypt.EncryptStringENC(AdminMemberIDX) %>','<%=NowPage %>');">
              <% else %>
				      <tr>
				      <% end if %>
                <td>
                ...
                <td>
                  <span><%=LRs("UserID") %></span>
                </td>
                <td>
                  <span><%=LRs("AdminName") %></span>
                </td>
                <td>
                  <span><%=LRs("WriteDateCv") %></span>
                </td>
                <td>
                  <span><%=LRs("UseYNName") %></span>
                </td>
                <td>
                  <span><%=LRs("AuthorityName") %></span>
                </td>
              </tr>
              <%
			              LRs.MoveNext
