...
<!-- #include file="../../include/head.asp" --> 
  <!-- E: head -->
  <% 
    RoleType = "03MEMTENI"	    '테니스 일별 계정가입자 수      
...
<script type="text/javascript">
    $(function(){
        $('select').on('change', function() {
            $('form[name=search_frm]').attr('action','./mem_DayRegistMember_tennis.asp');
  ...
  <div class="content"> 
    ...
    <div class="right-content"> 
      <!-- S: navigation -->
      <div class="navigation"> <i class="fas fa-home"></i> <i class="fas fa-chevron-right"></i> <span>통계관리</span> <i class="fas fa-chevron-right"></i> <span>가입자 회원 통계</span> <i class="fas fa-chevron-right"></i> <span>테니스</span> </div>
      <!-- E: navigation --> 
      <!-- S: pd-15 -->
	...
	TableSql = TableSql & "	WHERE A.delYN='N' AND A.SportsType = 'tennis' AND left(SrtDate, 4) = '"&Years&"'"
	...
	TableSql1 = TableSql1 & "	WHERE A.delYN='N' AND A.SportsType = 'tennis' AND left(SrtDate, 4) = '"&Years&"'"
	...
	TableSql2 = TableSql2 & "	WHERE A.delYN='N' AND A.SportsType = 'tennis' AND left(SrtDate, 4) = '"&Years&"'"
	...
	TableSql3 = TableSql3 & "	WHERE A.delYN='N' AND A.SportsType = 'tennis' AND left(SrtDate, 4) = '"&Years&"'"
