...
<script type="text/javascript">
	...
	if (LCnt1 > 0) {
      ...
      iHtmlSum2 = iHtmlSum2 + '<li><p class="depth-2 on"  id="dp1_' + iRoleDetailGroup1arr[i] + '_' + iRoleDetailGroup2arr[i] + '">' + iRoleDetailGroup2Nmarr[i] + '</p><div class="depth-2-con"  style="display:block"  id="dp2_' + iRoleDetailGroup1arr[i] + '_' + iRoleDetailGroup2arr[i] + '"><ul id="RG2_' + iRoleDetailGroup2arr[i] + '"></ul></div></li>';
