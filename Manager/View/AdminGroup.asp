							...
							<table class="navi-tp-table">
								...
								<tbody>
									<tr>
										...
										<td><input type="text" name="AGName" id="AGName" placeholder="관리자 그룹명을 입력해 주세요." /></td>
										<th scope="row"><label for="competition-name">삭제여부</label></th>
										<td><input type="text" name="GameTitleName" id="GameTitleName" placeholder="대회명을 입력해주세요." />
										</td>
									</tr>
								</tbody>
							</table>
