...
'	response.End()
	...
	'팀소속조회 시 SQL
	IF fnd_Team <> "" Then 
		CSearch7 = "			inner join [SD_Tennis].[dbo].[tblTeamInfo] T on P.Team = T.Team "
	...
	Else
		CSearch7 = CSearch7 & " left join [SD_Tennis].[dbo].[tblTeamInfo] T on P.Team = T.Team "
		CSearch7 = CSearch7 & " 	AND T.DelYN = 'N' "
		CSearch7 = CSearch7 & " 	AND T.SportsGb = '"&Request.Cookies("SportsGb")&"' "
		CSearch7 = CSearch7 & " 	AND T.NowRegYN = 'Y' "
	End IF	
	...
	CSQL = CSQL & " FROM [SD_Tennis].[dbo].[tblPlayer] P " &CSearch7	
	CSQL = CSQL & "	 	left join [SD_Tennis].[dbo].[tblMember] M on P.PlayerIDX = M.PlayerIDX "
	...
	CSQL = CSQL & "		P.TeamNm "
	CSQL = CSQL & "		,P.Team Team "
	CSQL = CSQL & "		,P.Team2Nm "
	CSQL = CSQL & "		,P.Team2 Team2 "
	CSQL = CSQL & "		,T.sido "
	CSQL = CSQL & "		,[SD_Tennis].[dbo].[FN_SidoName] (T.sido, '"&Request.Cookies("SportsGb")&"') SidoNm "
	...
	FndData = FndData & "			<th>랭킹포인트</th>"
	FndData = FndData & "			<th>생년월일</th>"
	FndData = FndData & "			<th>성별</th>"	
	'FndData = FndData & "			<th>지역</th>"
	FndData = FndData & "			<th>소속1</th>"	
	FndData = FndData & "			<th>소속1코드</th>"	
	FndData = FndData & "			<th>소속2</th>"	
	FndData = FndData & "			<th>소속2코드</th>"	
	...
	If Not(CRs.Eof Or CRs.Bof) Then 
		...
		Do Until CRs.eof
			...
			FndData = FndData & "	<td>"&CRs("RankingPoint")&"</td>"
			...
			FndData = FndData & "	<td>"&CRs("Team2Nm")&"</td>"			
			FndData = FndData & "	<td>"&CRs("Team2")&"</td>"
