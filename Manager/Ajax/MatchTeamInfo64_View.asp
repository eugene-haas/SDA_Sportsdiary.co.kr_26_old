						...
						<table border="0" height="100%">
							<%
								'&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
									...
									LSQL = LSQL&" ,Left(SportsDiary.dbo.Fn_TeamNm('judo',TeamGb,Team),8) As TeamNm"
									LSQL = LSQL&" ,UnearnWin"
							...
							<tr>
								...
								<%
									...
									'16강경기일경우=====================================================================================================
										...
										End If 
								%>
								<td width="13%"><span style="<%=spanstyle%>"></span></td>
								<%
									'2Depth Line*********************************************8
									If i= 1 Or i = 5 Or i = 9 Or i = 13 Or i = 17 Or i = 21 Or i = 25 Or i = 29 Then 
								%>
								<td width="13%" rowspan="2"><span style="display: block; border-top: 1px solid #000; border-right: 1px solid #000;  height: 32px; margin-top: 32px;"></span></td>
								<%
									ElseIf i = 3 Or i = 7 Or i = 11 Or i = 15 Or i = 19 Or i = 23 Or i = 27 Or i = 31 Then 
								%>
								<td width="13%" rowspan="2"><span style="display: block; border-bottom: 1px solid #000; border-right: 1px solid #000;  height: 32px; margin-top: -32px;"></span></td>
								<%
									End If 								
									'2Depth Line*********************************************8
								%>								
								<%
									'3Depth*****************************
									If i = 1 Or i = 9 Or i = 17 Or i = 25 Then 
								%>
								<td width="13%" rowspan="4"><span style="display: block; border-top: 1px solid #000; border-right: 1px solid #000; height: 64px; margin-top: 64px;"></span></td>								
								<%
									ElseIf i = 5 Or i = 13 Or i = 21 Or i = 29 Then 
								%>
								<td width="13%" rowspan="4"><span style="display: block; border-bottom: 1px solid #000; border-right: 1px solid #000; height: 64px; margin-top: -64px;"></span></td>								
								<%
									End If 
									'3Depth*****************************
								%>
								<%
									...
									If i = 1 Or i =17 Then 
								%>
								<td width="13%" rowspan="8"><span style="display: block; border-top: 1px solid #000; border-right: 1px solid #000; height: 128px; margin-top: 128px;"></span></td>
								<%
									ElseIf i = 9 Or i = 25 Then 
								%>
								<td width="13%" rowspan="8"><span style="display: block; border-bottom: 1px solid #000; border-right: 1px solid #000; height: 128px; margin-top: -128px;"></span></td>
								<%
									End If 
									'4Depth$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
								%>
								<%
									...
									If i = 1 Then 
								%>
								<td width="13%" rowspan="16"><span style="display: block; border-top: 1px solid #000; border-right: 1px solid #000; height: 256px; margin-top: 256px;"></span></td>
								<%
									ElseIf i = 17 Then 
								%>
								<td width="13%" rowspan="16"><span style="display: block; border-bottom: 1px solid #000; border-right: 1px solid #000; height: 256px; margin-top: -256px;"></span></td>
								<%
									End If 
									'5Depth$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
								...
								<%
									...
									If i = 1 Then 
								%>
								<td width="13%" rowspan="32"><span style="display: block; border-bottom: 1px solid #000;  height: 512px; margin-top: -512px;"></span></td>								
								<%
									End If 
									'6Depth$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
					...
					<td valign="middle" width="48%">
						...
						<table border="0" height="100%">
							<%
									...
									RSQL = RSQL&" ,Left(SportsDiary.dbo.Fn_TeamNm('judo',TeamGb,Team),8) As TeamNm"
									RSQL = RSQL&" ,UnearnWin"
							...
							<tr>
								...
								<%
									...
									If i = 1 Then 
								%>
								<td width="13%" rowspan="16"><span style="display: block; border-top: 1px solid #000; border-left: 1px solid #000; height: 256px; margin-top: 256px;"></span></td>
								<%
									ElseIf i = 17 Then 
								%>
								<td width="13%" rowspan="16"><span style="display: block; border-bottom: 1px solid #000; border-left: 1px solid #000; height: 256px; margin-top: -256px;"></span></td>
								<%
									End If 
									'5Depth$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
								%>								
								<%
									...
									If i = 1 Or i =17 Then 
								%>
								<td width="13%" rowspan="8"><span style="display: block; border-top: 1px solid #000; border-left: 1px solid #000; height: 128px; margin-top: 128px;"></span></td>
								<%
									ElseIf i = 9 Or i = 25 Then 
								%>
								<td width="13%" rowspan="8"><span style="display: block; border-bottom: 1px solid #000; border-left: 1px solid #000; height: 128px; margin-top: -128px;"></span></td>
								<%
									End If 
									'4Depth$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
								%>					
								<%
									...
									If i = 1 Or i = 9 Or i = 17 Or i = 25 Then 
								%>
								<td width="13%" rowspan="4"><span style="display: block; border-top: 1px solid #000; border-left: 1px solid #000; height: 64px; margin-top: 64px;"></span></td>								
								<%
									ElseIf i = 5 Or i = 13 Or i = 21 Or i = 29 Then 
								%>
								<td width="13%" rowspan="4"><span style="display: block; border-bottom: 1px solid #000; border-left: 1px solid #000; height: 64px; margin-top: -64px;"></span></td>								
								<%
									End If 
									'3Depth*****************************
								%>								
								<%
									...
									If i= 1 Or i = 5 Or i = 9 Or i = 13 Or i = 17 Or i = 21 Or i = 25 Or i = 29 Then 
								%>
								<td width="13%" rowspan="2"><span style="display: block; border-top: 1px solid #000; border-left: 1px solid #000;  height: 32px; margin-top: 32px;"></span></td>
								<%
									ElseIf i = 3 Or i = 7 Or i = 11 Or i = 15 Or i = 19 Or i = 23 Or i = 27 Or i = 31 Then 
								%>
								<td width="13%" rowspan="2"><span style="display: block; border-bottom: 1px solid #000; border-left: 1px solid #000;  height: 32px; margin-top: -32px;"></span></td>
								<%
									End If 								
									'2Depth Line*********************************************8
								%>	
