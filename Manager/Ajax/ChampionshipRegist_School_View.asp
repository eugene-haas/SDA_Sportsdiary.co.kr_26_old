...
'	Search_PlayerName  = fInject(Request("Search_PlayerName"))
	...
	End If 
		...
		LSQL = LSQL&" ,Team "		
		LSQL = LSQL&" ,TeamGb"
		LSQL = LSQL&" ,Isnull((select top 1 principal from tblGameRequest  where GameTitleIDX=GameTitleIDX  and GroupGameGb='sd040002' and PlayerCode=playerIDX  and DelYN='N' order by WriteDate desc ),'') AS principal"
