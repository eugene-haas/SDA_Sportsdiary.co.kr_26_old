...
'	Response.Write R6_Cnt&"<br>"
	...
	If Hidden_Data7 <> "" And Hidden_Data8 <> "" Then 
		...
		InSQL = "Insert Into tblRGameGroupSchool (SportsGb,GameTitleIDX,RGameLevelidx,TeamGb,Sex,Team,SchoolName,SchNum,UnearnWin,LeftRightGb,Game1R,Game2R,Game3R,Game4R,Game5R,Game6R,Game7R)"
		InSQL = InSQL&" VALUES "
		InSQL = InSQL&"('judo','"&GameTitleIDX&"','"&RGameLevelIDX&"','"&TeamGb&"','"&Sex&"','"&Hidden_Data8&"','"&Player8&"','108','sd042002','sd030001','"&R1_Num4&"','"&R2_Num2&"','"&R3_Num1&"','"&R4_Num1&"','','','')"
		Dbcon.Execute(InSQL)
	Else
		'부전승
...
<script>
 ...
 window.open('/Manager/Ajax/Match16_View.asp?GameTitleIDX=<%=GameTitleIDX%>&TeamGb=<%=TeamGb%>&Level=<%=Level%>&GroupGameGb=sd040002','_blank'); 
