...
ChkSQL = ChkSQL&" , ISNULL(SportsGb,'') AS SportsCode"     '종목구분
...
'ChkSQL = ChkSQL&" AND SportsGb = 'judo'"
...
If Not(CRs.Eof Or CRs.Bof) Then 
	...
	Response.Cookies("HandPhone")  = Trim(CRs("HandPhone"))
	Response.Cookies("PartName")   = Trim(CRs("PartName"))
	Response.Cookies("SportsName") = Trim(CRs("SportsName"))
	Response.Cookies("SportsCode") = Trim(CRs("SportsCode"))
	Response.Cookies("HostCode")   = Trim(CRs("HostCode"))
