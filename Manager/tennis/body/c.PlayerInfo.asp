...
<%
	...
	Response.Cookies("SportsGb") = "tennis"
...
<script language="javascript">
	...
	function chk_Submit(chkPage){
		...
		//location.href = strAjaxUrl + "?currPage=" + currPage + "&fnd_EnterType=" + fnd_EnterType + "&fnd_SEX=" + fnd_SEX + "&fnd_User=" + fnd_User + "&fnd_PlayerReln=" + fnd_PlayerReln + "&fnd_Team=" + fnd_Team + "&fnd_REG=" + fnd_REG + "&SDate=" + SDate + "&EDate=" + EDate;
		//return;
...
<form name="s_frm" method="post">
  ...
  <section>
    <div id="content">
      <div class="loaction"> <strong>회원관리</strong> &gt; 선수명단</div>
      <!-- S : top-navi -->
      <!-- E : top-navi -->
      <!-- S : sch 검색조건 선택 및 입력 -->
      <div class="sch">
...
<!-- E : container -->
<script src="http://tennis.sportsdiary.co.kr/Manager/js/js.js"></script>
</body>
