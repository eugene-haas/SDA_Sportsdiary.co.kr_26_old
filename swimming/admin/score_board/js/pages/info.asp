         ...
         <main id="app" class="l_main" v-clock>
            ...
            <div class="m_round-info">
               ...
               <div class="m_round-info__con">
                  <span v-show="player_info.orderno" class="m_round-info__con__order"><strong class="m_round-info__con__order__num">{{player_info.orderno}}</strong>번</span>
                  <div class="m_round-info__con__name">
                     <span class="m_round-info__con__name__title">{{player_info.names || '준비중입니다.'}}</span>
               ...
               <div v-show="isBeforeStart === false" class="m_round-info__score">
                  <ul class="m_round-info__score__list-wrap">
                     <li v-for="judge in Number(player_info.judgecnt) || 0" class="m_round-info__score__list">{{Number(player_info["jumsu" + judge]) / 10}}</li>
                  </ul>
                  <div class="m_round-info__score__total">
                     <span v-show="player_info.roundscore !== undefined" class="m_round-info__score__total__text">{{Number(player_info.roundscore || 0) / 100}}</span>
                  </div>
               </div>
            </div>
