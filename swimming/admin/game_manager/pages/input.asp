         ...
         <div class="m_input-score">
            <header v-if="header.user_info && game_info" class="m_input-score__header">
               <div v-if="header.user_info.C_CDA !== 'E2'" class="m_input-score__header__into">
                  <!-- 아티스틱 피겨 솔로 -->
                  <template v-if="Number(header_info.cdc) === E_CDC_CODE_F_S">
                     ...
                     <dl v-if="game_info.isfree === 'N'" class="m_input-score__header__into__con t_col-3">
                        ...
                        <dd class="m_input-score__header__into__con__body t_big">
                           <span ref="difficutyName">
                              {{game_info.arti_difficutynoname}}
                           </span>
                        </dd>
                     </dl>
                     <dl v-if="game_info.isfree === 'N'" class="m_input-score__header__into__con t_col-3">
                     ...
                     <dl class="m_input-score__header__into__con t_col-3">
                        ...
                        <dd v-if="game_info.isfree === 'N'" class="m_input-score__header__into__con__body">{{header.user_info.C_POSITIONNUM}} / {{game_info.jname}}</dd>
                        <dd v-else class="m_input-score__header__into__con__body">{{header.user_info.C_POSITIONNUM}}. {{header_info.fullname}} / {{game_info.jname}}</dd>
                     </dl>
                  </template>
                  <!-- 테크니컬 솔로, 듀엣, 팀 -->
                  <template v-else-if="Number(header_info.cdc) === E_CDC_CODE_T_S ||
                     Number(header_info.cdc) === E_CDC_CODE_T_D ||
                     Number(header_info.cdc) === E_CDC_CODE_T_T"
                     >
                     <dl class="m_input-score__header__into__con t_col-3">
                        <dt class="m_input-score__header__into__con__head">선수정보</dt>
                        <dd class="m_input-score__header__into__con__body t_big">
            ...
            <div class="m_input-score__con" :class="{s_disabled: game_info === null}">
               <div class="m_input-score__con__input">
                  ...
                  <button v-show="input_text" @click="resetInput()" class="m_input-score__con__input__btn-reset" type="button">
                     <img src="/game_manager/images/icon_reset-input.svg" alt="입력 초기화">
                  </button>
               </div>
               <!--
                  밑에 pc용 입력창 따로 있어요
                  mousedown이 모바일에서 touchstart가 아닌 click으로 인식하기에
                  각각 나누었어요 by chansoo
                -->
               <ul v-if="isMobile === true" class="m_input-score__con__keypad">
               ...
               <ul v-else class="m_input-score__con__keypad">
