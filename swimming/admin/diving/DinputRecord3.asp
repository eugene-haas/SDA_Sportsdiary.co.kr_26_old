...
<head>
	...
	<script type="text/javascript" src="/pub/js/<%=CONST_PATH%>/dinputRecordE2.js<%=CONST_JSVER%>8"></script>
</head>
<body <%=CONST_BODY%>>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
			<!-- #include file = "./body/c.DinputRecord3.asp" -->
    </section>
  </div>
