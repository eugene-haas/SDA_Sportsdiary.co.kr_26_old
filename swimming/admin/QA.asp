...
<head>
	...
	<script type="text/javascript" src="/pub/js/<%=CONST_PATH%>/QA.js<%=CONST_JSVER%>"></script>
</head>
<body <%=CONST_BODY%> id="sc_body">
...
<script src="/pub/js/swimming/colresizable-1.6.min.js"></script>
