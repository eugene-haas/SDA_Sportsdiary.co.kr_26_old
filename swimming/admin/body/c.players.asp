...
' response.write PN
	...
	strFieldName = " PlayerIDX,MemberIDX,userID,startyear,nowyear,userType,ksportsno,ksportsnoS,UserName,userNameCn,userNameEn,Birthday,Sex,nation,sidoCode,sido,CDA,CDANM,CDB,CDBNM,UserPhone,ProfileIMG,WriteDate,EnterType,TeamNm,userClass,Team,DelYN ,kskey, chkmsg, email"
...
memoYN = getPageState( "MN0122", "문자관리" ,Cookies_aIDX , db)
%>
...
<%
	...
	%><!-- #include virtual = "/pub/html/swimming/gamePlayersList.asp" --><%
