							...
							<div class="col-md-6" style="width:40%;padding-left:20px;padding-right:0px;text-align:left;">
								  <div class="form-group">
									...
									<div class="input-group date">
										<input type="text" id="F2" placeholder="검색어를 입력해주세요" value="<%=F2%>" class="form-control" onkeydown="if(event.keyCode == 13){px.goSubmit({'F1':$('#F1').val(),'F2':$('#F2').val()},'amteam.asp')}">
										<div class="input-group-addon" onmousedown="px.goSubmit({'F1':$('#F1').val(),'F2':$('#F2').val()},'amteam.asp')">
...
Select Case l_groupnm 
Case "Y" : l_groupnm = "초등부"
Case "Z" : l_groupnm = "중학부"
Case "7" : l_groupnm = "고등부"
Case "8" : l_groupnm = "대학부"
Case "9" : l_groupnm = "일반부"
End select
