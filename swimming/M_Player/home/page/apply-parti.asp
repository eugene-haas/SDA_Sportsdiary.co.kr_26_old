...
<head>
    ...
    <script src="/pub/js/swimming/gameatt.js?v=211102"></script>
</head>
...
<%'##################################################################################%>
				...
				<li class="m_apply-parti__con__list">
				  ...
				  <h2 class="m_apply-parti__con__list__h2">
				  학교폭력처분이력부존재서약서 첨부
                 <span class="m_apply-parti__con__list__h2__noti" style="width:850px;">※ 파일 재 첨부 시 첨부파일 수정이 가능합니다. (잘못된 파일 등록후 신청 시 참가실격이 될 수 있습니다.) <br>
				 
				 <br> 1개의 파일만 첨부가 가능하므로 여러장의 학교폭력처분이력부존저새역사 첨부시 하나의 파일로 압축하여 업로드 하여 주시기 바랍니다.(zip)
				 </span>
				 </h2>
				  ...
				  <div class="m_apply-parti__con__list__file clear">
					...
					<!--<button id="btnInpFileDel" type="reset" name="button">삭제</button> -->
					<p class="m_apply-parti__con__list__file__noti">(업로드 파일형식 : pdf, jpg, png, hwp, zip)</p>
				  </div>
				  <ul class="m_apply-parti__con__list__ul t_w100per clear">
					<li>
					  <h3>첨부파일</h3>
