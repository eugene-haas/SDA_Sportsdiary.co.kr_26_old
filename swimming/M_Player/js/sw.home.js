...
//요청하기#####################
//<button type="button" name="button" onclick="$('#tidx').val(115);$('#NotiModal2').fadeIn(300);"></button>

mx.popup = function(){
$('#NotiModal2').fadeIn(300);
...
$('#NotiModal2').fadeOut(300); $('body').removeClass('s_no-scroll');
