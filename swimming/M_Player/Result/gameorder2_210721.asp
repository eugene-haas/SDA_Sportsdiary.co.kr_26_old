...
<div id="app" class="l contestInfo">
  ...
  <!-- #include file = "../include/gnbapp.asp" -->
    ...
    <div class="m_header s_sub">
	  <a href="/Result/institute-search.asp" class="m_header__backBtn">이전</a>
      ...
      <div class="match-order-con">
        <div class="match-order-con__search clear" action="" method="post">
          ...
          <div class="match-order-con__search__box-input">
            <label for="player_nm" class="hide">선수명 입력</label>
			<input type="text"  placeholder="선수명을 검색하세요" id="player_nm" value="">
...
<!-- 									<a href="javascript:px.goSubmit({'TIDX':<%=tidx%>,'LIDX':'<%=l_idx%>','LNO':'<%=l_levelno%>','JOONO':1,'TABNO':6,'DD':$('#selcMatchDate').val()},'gameorderdetail.asp');" id="linkRecordMatch">기록보기</a> -->
										경기종료
									<%else%>
<!-- 									<a href="javascript:px.goSubmit({'TIDX':<%=tidx%>,'LIDX':'<%=l_idx%>','LNO':'<%=l_levelno%>','JOONO':1,'TABNO':6,'DD':$('#selcMatchDate').val()},'gameorderdetail.asp');" id="linkPlayerMatch">선수보기</a> -->
										대진표
									<%End if%>
								</td>
							  </tr>
