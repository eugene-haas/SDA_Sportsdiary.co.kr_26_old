        ...
        <p class="guideTxt__txt"><span class="guideTxt__emphasis">대기팀</span>으로 등록 되었습니다.</p>
            ...
            <div class="m_noticeDeposit">
                <p class="m_noticeDeposit__txt">
					<span class="m_noticeDeposit__lable"><!-- 가상계좌 번호 -->입금계좌번호</span>
					<span><%'=acct%>12345-XXXXXXXXX&nbsp;<%'=CONST_BANKNM%>궁민은행</span>
				</p>
				<p class="m_noticeDeposit__txt">
           ...
           <!-- S: 참가신청 완료 -->
        	...
        	<div class="m_applicationForm s_outline">
	            ...
	            <ul>
		            ...
		            <li class="m_applicationForm__item">
			            ...
			            <span class="m_applicationForm__inputWrap">
				            <input type="text" class="m_applicationForm__input" id="inbankname" name="inbankname" value="" onfocus="this.select()"  placeholder=":: 이름을 입력하세요 ::"  autocomplete="off">
			            </span>
		            </li>
	            </ul>
                ...
                <ul>
                    <li class="m_applicationForm__item">
                        <textarea id="attask" name="attask" class="m_applicationForm__textarea"></textarea>
                    </li>
                </ul>
        	...
        	<div class="m_reqBtnWrap">
                <a href="javascript:chk_frm('0');" class="m_reqBtnWrap__btn s_viewDetail">신청내역 보기</a>
        		<a href="javascript:chk_frm('10');" class="m_reqBtnWrap__btn s_apply2">신청하기</a>
        	</div>
        	<!-- s: 버튼리스트 -->
