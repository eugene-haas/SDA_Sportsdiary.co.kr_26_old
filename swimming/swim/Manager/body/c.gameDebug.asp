...
<a name="contenttop"></a>
		...
		<div class="top-navi-inner">
			...
			<div class="top-navi-btm">
				...
				<div class="sch">				
				<%'<!-- #include virtual = "/pub/html/swimAdmin/GameSearchForm.asp" -->%>
				</div>

				<div class="navi-tp-table-wrap"  id="gameinput_area">
					<%'<!-- #include virtual = "/pub/html/swimAdmin/gameForm.asp" -->%>
				</div>
...
'	Next
	...
	j = j + 1
		...
		Next
		%>
		<!-- #include virtual = "/pub/html/swimAdmin/GameDebugList.asp" -->
		<%
	rs.movenext
	Loop
