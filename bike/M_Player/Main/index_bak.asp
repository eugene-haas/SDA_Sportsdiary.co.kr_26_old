    ...
    <div class="competition" v-for="title, index in titleList" :class="{s_on: (title == currentTitle)}">
      ...
      <div class="competition__header" :class="{s_on: (title == currentTitle)}">
        ...
        <p class="competition__add">
          ...
          <!--  -->
          <a class="competition__busBtn s_disable" :class="{ s_on: (title == currentTitle) }" v-if="false" @click="alert('참가신청 후 참가비 입금을 완료해야 버스 신청이 가능합니다.')"> 버스신청</a>
          <a class="competition__busBtn" :class="{ s_on: (title == currentTitle) }" :href="'../request/applyBus.asp?HostIDX=' + qs.hostIdx + '&TitleIDX=' + title.titleIdx + '&Title=' + title.title" v-if="false"> 버스신청</a>
      ...
      <transition name="fold">
        <div class="competition__detail" v-if="(title == currentTitle)">
          ...
          <div class="competition__btns">
            ...
            <a class="competition__btn s_applicant s_disable">참가신청</a>
            <!--  -->
        ...
        if(this.currentTitle == title) this.currentTitle = {}
          ...
          .then(()=>{
            ...
            .then(response=>{
              ...
              console.log(this.currentTitle.hasApplication)
