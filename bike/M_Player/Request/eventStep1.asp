...
<div id="app" class="l selectEventStep1" v-clock>
  ...
  <div class="l_content m_scroll [ _content _scroll ]">
    ...
    <div class="eventBtns" v-if="!appliedEventType">
      <a class="eventBtns__btn" v-for="(eventType, index) in competitionInfo.eventTypeList" :class="{s_track: index == 0, s_road: index == 1}" @click="openCautionLayer(eventType.eType)" ><span>{{eventType.eType}} 경기</span></a>
    </div>
    ...
    <div class="eventBtns" v-if="appliedEventType">
      ...
      <a class="eventBtns__btn"
        v-if="appliedEventType === eventType.eType"
    ...
    created() {
      ...
      .then(
        axios.spread((resDetail, resApplyInfo)=>{
          ...
          // !@#
          // this.appliedEventType = undefined
