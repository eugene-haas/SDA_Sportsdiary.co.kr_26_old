  ...
  var vm = new Vue({
    ...
    methods:{
      ...
      next: function(){
        ...
        for(key in parentInfoParams){
          console.log(key)
          console.log(parentInfoParams[key])
        ...
        .then(()=>{
          console.log('======================')
          console.log(this.memberInfo.adultYN);
          console.log(this.parentInfo.agree);
    ...
    created(){
      ...
      .then(response=>{
        console.log(response.data.gift.length)
      ...
      .then(()=>{
        ...
        .then(
          axios.spread((resCompetitionInfo, resSCRP, resInfo)=>{
            ...
            console.log(resInfo.data.SCRPInfo[0])


            // 현대회 신청자 정보가 없으면 이전 대회 정보 불러와서 바인딩
            console.log('현 대회 신청정보')
            ...
            .then(resInfo=>{
              ...
              console.log('memberInfo', resMemberInfo)
              ...
              console.log('moreInfo', resMoreInfo)
              ...
              console.log('parentInfo', resParentInfo)
