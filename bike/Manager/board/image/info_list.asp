...
SQL = SQL & " , title.TitleIdx, title.TitleName, title.WriteDate, ISNULL(iCount.Count, '') Count "
SQL = SQL & " FROM tblBikeTitle title "
SQL = SQL & " LEFT JOIN (SELECT TitleIdx, COUNT(TitleIdx) Count  "
SQL = SQL & " 			FROM tblBikeImage  "
SQL = SQL & " 			GROUP BY TitleIdx) iCount ON title.TitleIdx = iCount.TitleIdx "
