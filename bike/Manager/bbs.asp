...
<div class="t_default">
  ...
  <article>
      ...
      <!-- ================================================================================================ -->
			...
			<div class="page_title"><h1>대회이미지</h1></div>
      ...
      <!-- ================================================================================================ -->
            ...
            <select id="" class="form-control">
              ...
              <option value="">2018</option>
    			...
    			<div class="col-sm-3">
            <select id="" class="form-control">
              <option value="" selected>=대회선택=</option>
              <option value="">2019년 제1회 SD랭킹 Cycle Championship</option>
            </select>
    			</div>
          ...
          <a href="" id="" class="btn btn-primary">등록</a>
			...
			<div class="table-responsive">
                ...
                <div class="btn-group" data-toggle="buttons">
                  <label class="btn btn-primary btn-checkbox">
              ...
              <th>보기</th>
                ...
                <span class="btn-group" data-toggle="buttons">
                  <label class="btn btn-primary btn-checkbox active">
            				<input type="checkbox" autocomplete="off" checked>
            				<span class="glyphicon glyphicon-ok"></span>
            			</label>
                </span>
              ...
              <td><span>제외경기</span></td>
        			<td><span>1일차 2경기장</span></td>
        			<td><span>6</span></td>
        			<td><span>2018-08-30</span></td>
              <td><span>201</span></td>
              <td><span><a class="btn btn-default">상세보기</a></span></td>
        		</tr>
