...
<div class="admin_content">
	...
	<div class="search_top">
		<!-- #include virtual = "/pub/html/bike/checkAgreement/attmemberform.asp" -->
	</div>
	<!-- e: 정보 검색 -->

	<!-- s: 테이블 리스트 -->
	<div class="table_list checkAgreement">
		<table cellspacing="0" cellpadding="0">
			...
			<%
				...
				<% If myageST = "N" Then
					i = i + 1
				%>
				<!-- #include virtual = "/pub/html/bike/checkAgreement/playerlist.asp" -->
				<% End If %>
				<%
					rs.movenext
					Loop
				...
				%>
				<div class="all_page">
					<span class="txt">전체 <span class="number" id="totcnt"><%=i%></span>건</span>
				</div>
				<%
			%>
			</tbody>
