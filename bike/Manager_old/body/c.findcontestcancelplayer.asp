...
<div class="admin_content">
	...
	<div class="page_title">
		<h1>대회정보 <i class="fas fa-angle-right"></i> 대회신청 정보 </h1>
	</div>
	<!-- e: 페이지 타이틀 -->

	<!-- s: 정보 검색 -->
	<div class="search_top">
		<!-- #include virtual = "/pub/html/bike/findcontestcancelplayer/attmemberform.asp" -->
	</div>
	<!-- e: 정보 검색 -->

	<!-- s: 전체 페이지 -->
	<div class="all_page">
		<span class="txt">전체 <span class="number" id="totcnt"><%=totalCount%></span>건</span>
	</div>
	<!-- s: 전체 페이지 -->
	...
	<div class="table_list findcontestplayer">
		<table cellspacing="0" cellpadding="0">
			...
			<tbody id="contest">
				...
				%>
				<!-- #include virtual = "/pub/html/bike/findcontestcancelplayer/findcancelplayerlist.asp" -->
				<%
					rs.movenext
					Loop
				End if
