        ...
        <tbody>
          <tr>
            ...
            <th>
              ...
              <div class="player">
              <%If GroupGameGb = "B0030001" Then%>
                <span class="name"><%=Arr_Player(1,i)%><font style="font-size:16px">(<%=Arr_Player(3,i)%>)</font></span>
              
                <%If Arr_Player(2,i) <> "" AND Not ISNULL(Arr_Player(2,i)) Then%>
            
                <span class="name"><%=Arr_Player(2,i)%><font style="font-size:16px">(<%=Arr_Player(4,i)%>)</font></span>
            ...
            <td>
                  <%If GroupGameGb = "B0030001" Then%>
                    ...
                    <span>
                      <%=Arr_Player(1,j)%>
                      <%
                        If Arr_Player(2,j) <> "" AND Not ISNULL(Arr_Player(2,j)) Then
                          Response.Write "," & Arr_Player(2,j)
                        End If
                      %>                      
                    </span>
                  <%Else%>
