...
<%
  ...
  LSQL = " EXEC tblPlayerMember_Search_VIEW"
  LSQL = LSQL  & "   @MemberIDX  ='"& MemberIDX &"' "
  Response.write LSQL
  ...
  If Not (LRs.Eof Or LRs.Bof) Then
    Do Until LRs.Eof
      ...
      Level   = LRs("Level")
      DelYN   = LRs("DelYN")
      PlayerCode  = LRs("PlayerCode")
      PersonCode  = LRs("PersonCode")
      AthleteCode = LRs("AthleteCode")
      PlayerType  = LRs("PlayerType")
      PlayerGrade = LRs("PlayerGrade")
      ClubCode  = LRs("ClubCode")
      Agrade    = LRs("Agrade")
      Bgrade    = LRs("Bgrade")
      Cgrade    = LRs("Cgrade")
      ...
      RegTp   = LRs("RegTp")
      Photo   = LRs("Photo")
      RegGubun  = LRs("RegGubun")
      NowRegYN  = LRs("NowRegYN")
      DI      = LRs("DI")
      AuthType  = LRs("AuthType")
      sido    = LRs("sido")
...
<script>
  ...
  * left-menu 체크
  */
  var locationStr = "PlayerMenu/PlayerMember";  // 동호인 리스트
  /* left-menu 체크 */
