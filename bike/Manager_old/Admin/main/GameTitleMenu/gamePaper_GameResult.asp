...
<%
  Function GetSQL(ByVal DEC_GameDay, ByVal DEC_GameTitleIDX, ByVal DEC_StadiumIDX, ByVal DEC_StadiumNumber, ByVal DEC_Searchkeyword, ByVal DEC_SearchKey, ByVal DEC_PlayLevelType )
  ...
  Function GetSQLTempNum(ByVal DEC_GameDay, ByVal DEC_GameTitleIDX, ByVal DEC_StadiumIDX, ByVal DEC_StadiumNumber, ByVal DEC_Searchkeyword, ByVal DEC_SearchKey, ByVal Param_TempNum,ByVal DEC_PlayLevelType)
    CSQL = " SELECT CCC.GameTitleIDX, dbo.FN_NameSch(CCC.GameTitleIDX, 'GameTitleIDX') AS GameTitleNM, CCC.GameLevelDtlIDX,  CCC.TourneyIDX, CCC.TeamGameNum, CCC.GameNum, CCC.TeamGb, CCC.Level, CCC.LTourneyGroupIDX , CCC.RTourneyGroupIDX,"
    CSQL = CSQL & " 	CCC.TeamGbNM, CCC.LevelNM, CCC.GameTypeNM,"
    CSQL = CSQL & " 	CCC.Result, CCC.ResultType, CCC.ResultNM, CCC.Jumsu,"
    CSQL = CSQL & " 	CCC.GameStatus, CCC.[ROUND], CCC.Sex,"
...
<% 
  ...
  %>
    <a href="./gamePaper_Excel_GameResult.asp?GameTitleIDX=<%=GameTitleIDX%>&GameDay=<%=GameDay%>&StadiumIDX=<%=StadiumIDX%>&StadiumNumber=<%=StadiumNumber%>&SearchName=<%=SearchName%>&PlayLevelType=<%=PlayLevelType%>">A4 다운하기</a>
    <a href="./gamePaper_Excel_B5_GameResult.asp?GameTitleIDX=<%=GameTitleIDX%>&GameDay=<%=GameDay%>&StadiumIDX=<%=StadiumIDX%>&StadiumNumber=<%=StadiumNumber%>&SearchName=<%=SearchName%>&PlayLevelType=<%=PlayLevelType%>">B5 다운하기</a>
	<%
    ...
    CSQL = GetSQL(DEC_GameDay, DEC_GameTitleIDX, DEC_StadiumIDX,DEC_StadiumNumber, DEC_Searchkeyword,DEC_SearchKey,DEC_PlayLevelType)
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0">
    ...
    <tbody>
      ...
      <span style="color:#000000; font-family:'맑은 고딕'; font-size:13pt">
        <%=Sex & GameTypeNM & " " & TeamGbNM & " " & LevelNM & LevelJooNum & " "%>
        </span>
      </td>
      ...
      <tr class="row6">
      <%
        CSQLTempNum = GetSQLTempNum(DEC_GameDay, DEC_GameTitleIDX, DEC_StadiumIDX,DEC_StadiumNumber, DEC_Searchkeyword,DEC_SearchKey,TempNum, DEC_PlayLevelType)
