	...
	function chk_Submit(valType, valIDX, chkPage){
		...
		switch(valType){
			...
			case 'VIEW':  //참가신청접수현황
				...
				$('form[name=s_frm]').attr('action','./request_receive_E_detail.asp');
				$('form[name=s_frm]').submit();
				break;	
...
<section>
  <div id="content">
    <div class="navigation_box"> 대회정보 &gt; 대회관리 &gt; 참가신청관리 &gt; 신청접수현황(엘리트)</div>
        ...
        <div class="search_top community">
          <div class="search_box">
            <table>
              <tbody>
                <tr>				 	
                  <td id="sel_fnd_GameType"><input type="text" placeholder="신청자, 신청팀" name="fnd_RKeyWord" id="fnd_RKeyWord" class="title_input in_2" /></td>
                  <td><a href="javascript:chk_Submit('FND', '', 1)" class="btn btn_basic">검색</a> <a href="javascript:chk_Submit('ALL', '', 1)" class="btn btn_point">전체보기</a><a href="javascript:chk_Submit('GAME', '', '')" class="btn btn_cta">참가신청관리</a></td>
                </tr>
              </tbody>
            </table>
          </div>
