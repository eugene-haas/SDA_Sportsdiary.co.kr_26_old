...
<% 
  ...
  'Response.Write " gamenum : " & gamenum & "<br/>"
  'Response.Write " SetNum : " & SetNum & "<br/>"
  'Response.Write " TourneyGroupIDX : " & TourneyGroupIDX & "<br/>"


  %>
    <a href="./GamePaperGroup_Excel_A4.asp?GameLevelDtlIdx=<%=GameLevelDtlIdx%>&TeamGameNum=<%=TeamGameNum%>&GameNum=<%=GameNum%>&SetNum=<%=SetNum%>&TourneyGroupIDX=<%=TourneyGroupIDX%>">A4 다운하기</a>
    <a href="./GamePaperGroup_Excel_B5.asp?GameLevelDtlIdx=<%=GameLevelDtlIdx%>&TeamGameNum=<%=TeamGameNum%>&GameNum=<%=GameNum%>&SetNum=<%=SetNum%>&TourneyGroupIDX=<%=TourneyGroupIDX%>">B5 다운하기</a>
	<%
    ...
    'Response.Write " DEC_SetNum : " & DEC_SetNum & "<br/>"
    'Response.Write " DEC_TourneyGroupIDX : " & DEC_TourneyGroupIDX & "<br/>"
  ...
  End If
  LRs.Close
  'Response.Write "LTeam " & LTeam  & "<br/>"
  'Response.Write "LTeamDtl " & LTeamDtl  & "<br/>"
  'Response.Write "RTeam " & RTeam & "<br/>"
  'Response.Write "RTeamDtl " & RTeamDtl & "<br/>"
  'Response.Write "RTeamNM " & RTeamNM & "<br/>"
  'Response.Write "RResultNM " & RResultNM & "<br/>"
  'Response.Write "RTotalPoint " & RTotalPoint & "<br/>"
  'Response.Write "RJumsu " & RJumsu & "<br/>"
  'Response.Write "SexName " & SexName & "<br/>"
  'Response.Write "PlayTypeName " & PlayTypeName & "<br/>"
  'Response.Write "TeamGbName " & TeamGbName & "<br/>"
  'Response.Write "LevelName " & LevelName & "<br/>"
  'Response.Write "LevelJooName " & LevelJooName & "<br/>"
  'Response.Write "LevelJooNum " & LevelJooNum & "<br/>"
  'Response.Write "LevelJooNumDtl " & LevelJooNumDtl & "<br/>"
  'Response.Write "PlayLevelType " & PlayLevelType & "<br/>"
  'Response.Write "GroupGameGbName " & GroupGameGbName & "<br/>"
  'Response.Write "StadiumNum " & StadiumNum & "<br/>"
  'Response.Write "TotRound " & TotRound & "<br/>"
  'Response.Write "GameRound " & GameRound & "<br/>"
  'Response.Write "StadiumName " & StadiumName & "<br/>"
...
%>
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0">
    ...
    <tbody>
      ...
      <td class="column3 style10 s"><span style="font-weight:bold; color:#000000; font-family:'맑은 고딕'; font-size:26pt"><%=Team_StadiumNum%></span><span style="color:#000000; font-family:'맑은 고딕'; font-size:18pt"> 코트</span></td>
      ...
      <td class="column1 style12 s style12" colspan="3"><%=LPlayer1%>  <%IF LPlayer2 <> "" Then Response.Write ", " & LPlayer2 End IF %></td>
      ...
      <td class="column1 style13 s style13" colspan="3"><%=RPlayer1%>  <%IF RPlayer2 <> "" Then Response.Write ", " & RPlayer2 End IF %></td>
