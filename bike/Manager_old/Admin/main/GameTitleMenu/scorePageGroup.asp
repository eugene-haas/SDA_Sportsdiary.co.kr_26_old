	...
	<table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0" style="width: 1200px;border-collapse: collapse;page-break-after: always;">
      ...
      %>   
		  <tr class="row8" style="height: 35pt;">
			...
			<td class="column4 style14 null" style="vertical-align: middle;border-top: none #000000;color: #000000;font-family: '맑은 고딕';font-size: 10pt;background-color: white;border-bottom: 1px solid #000000 !important;border-left: 1px solid #000000 !important;border-right: 1px solid #000000 !important;" align="center"><%=JSON_LJumsu.SetPoint3%></td>
			<td class="column5 style14 null" style="vertical-align: middle;border-top: none #000000;color: #000000;font-family: '맑은 고딕';font-size: 10pt;background-color: white;border-bottom: 1px solid #000000 !important;border-left: 1px solid #000000 !important;border-right: 1px solid #000000 !important;" align="center"><%=JSON_LJumsu.SetPoint2%></td>
			<td class="column6 style14 null" style="vertical-align: middle;border-top: none #000000;color: #000000;font-family: '맑은 고딕';font-size: 10pt;background-color: white;border-bottom: 1px solid #000000 !important;border-left: 1px solid #000000 !important;border-right: 1px solid #000000 !important;" align="center"><%=JSON_LJumsu.SetPoint1%></td>
        ...
        %>				
			...
			<%If LRs("SignData") <> "" AND NOT ISNULL(LRs("SignData")) Then
					If LRs("LResultType") = "WIN" Then
			%>
				<img src="<%=LRs("SignData")%>" width="40" alt="">
			<%
					End If
				End If
			%>
        ...
        %>					
			...
			<td class="column12 style14 null" style="vertical-align: middle;border-top: none #000000;color: #000000;font-family: '맑은 고딕';font-size: 10pt;background-color: white;border-bottom: 1px solid #000000 !important;border-left: 1px solid #000000 !important;border-right: 1px solid #000000 !important;" align="center"><%=JSON_RJumsu.SetPoint1%></td>
			<td class="column13 style14 null" style="vertical-align: middle;border-top: none #000000;color: #000000;font-family: '맑은 고딕';font-size: 10pt;background-color: white;border-bottom: 1px solid #000000 !important;border-left: 1px solid #000000 !important;border-right: 1px solid #000000 !important;" align="center"><%=JSON_RJumsu.SetPoint2%></td>
			<td class="column14 style14 null" style="vertical-align: middle;border-top: none #000000;color: #000000;font-family: '맑은 고딕';font-size: 10pt;background-color: white;border-bottom: 1px solid #000000 !important;border-left: 1px solid #000000 !important;border-right: 1px solid #000000 !important;" align="center"><%=JSON_RJumsu.SetPoint3%></td>
