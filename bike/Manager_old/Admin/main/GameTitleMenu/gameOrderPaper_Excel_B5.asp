  ...
  <table style="font-family: '맑은 고딕';">
    ...
    %>
      ...
      <tr style="height: 42pt;">
        <td style="font-size: 16pt; vertical-align: bottom;">No. <span style="font-weight: bold;font-size: 16pt;"><%=TempNum%></span></td>
        <td style="font-size: 14pt; vertical-align: bottom;"><%=Sex & PlayTypeNM & " " & TeamGbNM & " " & LevelNM & LevelJooNum & " "%></td>
        ...
        <td style="font-size: 14pt; vertical-align: bottom;" colspan="2"><span style="font-size: 14pt;font-weight: bold;"><%=StadiumNum%> 코트
      ...
      <tr style="height: 65.099pt;">
        ...
        <td style="vertical-align: middle;text-align: center; font-size: 20pt;border-bottom: thin solid #000;border-top: none;border-left: thin solid #000;border-right: thin solid #000;"><%=RTeam1%>
        <%
        ...
        <td style="vertical-align: middle;text-align: center; font-size: 20pt;border-bottom: thin solid #000;border-top: none;border-left: thin solid #000;border-right: thin solid #000; width: 100px;"></td>
        <td style="vertical-align: middle;text-align: center; font-size: 20pt;border-bottom: thin solid #000;border-top: none;border-left: thin solid #000;border-right: thin solid #000; width: 100px;"></td>
      </tr>
          ...
          For ar_TempNum = LBound(arrayGamePaperTempNum, 2) To UBound(arrayGamePaperTempNum, 2) 
            ...
            if cdbl(arrayTempNumCnt) = 1 Then
              ...
              Else
                Response.Write "-"
              End If  
              Response.Write  " " & B_LTeam1  & " " &  "(" & B_LPlayer1 & ", " & B_LPlayer2 & ") / " & B_RTeam1 & "(" & " " & B_RPlayer1 & ", " & B_RPlayer2 &  ")  ▷ " & B_StadiumNum & " 코트 "  & B_TeamGameNum & "-" & B_GameNum & "</td>"
              Response.Write "</tr>"
            End IF
