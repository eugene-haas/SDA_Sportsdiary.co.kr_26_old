...
<div class="Game_operation">
  ...
  <div class="search_box" id="DP_SelBox" >
    ...
    <select id="selStadiumNumber" onChange='OnSearchChanged()'>
      ...
      <%
              ...
              LSQL = LSQL & " WHERE DelYN = 'N' "
              LSQL = LSQL & " AND GameTitleIDX = '" & reqGameTitleIdx & "'"
              LSQL = LSQL & " AND GameDay = '" & reqGameDay & "'"
              LSQL = LSQL & " AND StadiumIDX = '" & reqStadiumIDX & "'"
  ...
  <div class="top_btn_list">
    ...
    <a href="javascript:print_GameOrder_list()">
      <i class="fas fa-print"></i>
      <span>경기기록지 출력</span>
    </a>
		<a href="#" data-toggle="modal" data-target=".group_modal">단체전</a>
		<a href="#" data-toggle="modal" data-target=".play_detail_modal">경기상세</a>
  </div>
  <!-- e: 태아불 상단 버튼 -->
  <!-- s: 리스트 table -->
...
<!-- S: play_detail_modal -->
<!-- #include file = "../../include/modal/play_detail_modal.asp" -->
<!-- E: play_detail_modal -->
