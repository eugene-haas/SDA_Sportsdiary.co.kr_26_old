  ...
  <div class="setup-body game-number" id="divGameNumberBody">
    ...
    <div class="top-ctr">
      ...
      <div class="stair clearfix">
          <!--대회 리스트-->
          <select id="selGameTitle" name="selGameTitle" class="sel-ctr" onchange="SelGameNumber()" style="margin-top:20px;">
            <%
      ...
      <!-- S: stair -->
			<div class="search_top ">
				<div class="search_box">
					<span> [장소 리스트]</span>
					<select name="selStadium" id="selStadium" onchange="SelGameNumber()" class="title_select">
        ...
        <table class="table table-arr table-fix-body" id="tableGameLevelList">
          ...
          <%
            ...
            If(cdbl(tGameTitleIDX) > 0) Then
              ...
              iType = "2"                      ' 1:조회, 2:총갯수
              LSQL = "EXEC tblGameNumberLevel_Searched_STR '" & tGameTitleIDX & "','" & tStadiumIdx & "','" & iType & "'"
              
              Set LRs = DBCon.Execute(LSQL)
              If Not (LRs.Eof Or LRs.Bof) Then
                Do Until LRs.Eof
                    tGameLevelCnt= LRs("Cnt")
                  LRs.MoveNext
                Loop
              End If
              LRs.close
              ...
              LSQL = LSQL & " WHERE StadiumNum='" &  tStadiumIdx & "' and GameTitleIDX = '" & tGameTitleIDX & "'"
