...
<script type="text/javascript" src="../../js/GameTitleMenu/GameOrder.js"></script>
...
<div class="Game_operation" id="DP_BODY">
  ...
  <div class="top_btn_list">
    ...
    <label for="checkSearchLive">자동 업데이트</label>
    <label class="switch" onclick="SearchLive();">
      <input type="checkbox" id="checkSearchLive" name="checkSearchLive">
  ...
  <div>
    <table class="match-order" style="width:95%;">
      ...
      <tbody id="tbGameOrder" name="tbGameOrder">
        <tr>
          <td colspan="15">조회 결과가 존재 하지 않습니다.</td>
        </tr>
      </tbody>
      <!--
