...
<%
  Function GetSQL(ByVal DEC_GameDay, ByVal DEC_GameTitleIDX, ByVal DEC_StadiumIDX, ByVal DEC_StadiumNumber, ByVal DEC_Searchkeyword, ByVal DEC_SearchKey )
    ...
    IF DEC_PlayLevelType <> "" Then
      CSQL = CSQL & "     AND C.PlayLevelType = '" & DEC_PlayLevelType & "'"
    End IF
    ...
    CSQL = CSQL & " AND CCC.GameStatus = 'GameEnd'"
  ...
  <table style="font-family: '맑은 고딕';">
    ...
    %>
      ...
      <tr style="height: 42pt;">
        ...
        <td style="font-size: 18pt; vertical-align: bottom;"><%=Sex & GameTypeNM & " " & TeamGbNM & " " & LevelNM & LevelJooNum & " "%></td>
