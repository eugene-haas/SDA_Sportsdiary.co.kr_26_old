...
%>      
        <tr>
            ...
            <td><%=CRs("Sex") & CRs("GameTypeNM") & " " & CRs("TeamGbNM") & " " & CRs("LevelNM") & " " & CRs("LevelJooName") & CRs("LevelJooNum") & " "%> </td>
            ...
            <%
              ...
              ElseIf CRs("PlayLevelType") = "B0100002" Then
                Response.Write " 본선" & "-" & CRs("TeamGameNum")
              Else
                Response.Write "-"
              End If  
            %>
        ...
        %>      
        <td class="team">
          <span class="cut-el"><%=CRs("LTeam1")%></span>
        </td>
        <td>
        ...
        <td class="team">
          <span class="cut-el"><%=CRs("RTeam1")%></span>
        </td>
        <td>
