...
%>
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0">
    ...
    <tbody>
      ...
      <tr class="row1">
      <td class="column0 style9 s" colspan="5">
      <!--No. <span style="font-weight:bold; color:#000000; font-family:'맑은 고딕'; font-size:26pt"><%=TempNum%></span>-->
        <span style="font-weight:bold; color:#000000; font-family:'맑은 고딕'; font-size:18pt">
          <%
            If StadiumNum = "" Or IsNull(StadiumNum) Then
              Response.Write "-"
            Else
              Response.Write StadiumNum
            End If
          %>
        </span>
        <span style="color:#000000; font-family:'맑은 고딕'; font-size:18pt"> 코트</span>
        <span style="font-weight:bold; color:#000000; font-family:'맑은 고딕'; font-size:18pt">
        <%
        ...
        <span style="color:#000000; font-family:'맑은 고딕'; font-size:18pt">
        <%
