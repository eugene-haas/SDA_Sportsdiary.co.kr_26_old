  ...
  <table style="font-family: '맑은 고딕';">
    ...
    %>
      ...
      <tr style="height: 42pt;">
        ...
        <td style="font-size: 14pt; vertical-align: bottom;"><span style="font-size: 14pt;font-weight: bold;"><%=Team_StadiumNum%></span>코트
         <%
            ...
            if cdbl(arrayTempNumCnt) = 1 Then
              Response.Write " <tr style='height: 30pt;'>"
                ...
                if B_LPlayer2 <> "" And B_RPlayer1 <> "" Then
                  Response.Write  " " & B_LTeam1  & " " &  "(" & B_LPlayer1 & ", " & B_LPlayer2 & ") / " & B_RTeam1 & "(" & " " & B_RPlayer1 & ", " & B_RPlayer2 &  ")  ▷ " & Team_StadiumNum & " 코트 "   & B_GameNum & "</td>"
                ELSE
                  Response.Write  " " & B_LTeam1  & " " &  "(" & B_LPlayer1 & ") / " & B_RTeam1 & "(" & " " & B_RPlayer1 &  ")  ▷ " & Team_StadiumNum & " 코트 "   & B_GameNum & "</td>"
                END IF
              Response.Write "</tr>"
            End IF
