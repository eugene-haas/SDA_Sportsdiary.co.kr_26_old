  ...
  <table style="font-family: '맑은 고딕';">
    ...
    %>
      ...
      <tr style="height: 42pt;">
        ...
        <td style="font-size: 18pt; vertical-align: bottom;"><span style="font-size: 26pt;font-weight: bold;"><%=StadiumNum%></span>코트</td>
        <td style="font-size: 18pt; vertical-align: bottom;"><span style="font-size: 26pt;font-weight: bold;"><% Response.Write TeamGameNum &  "-" & GameNum %>
        </span>경기</td>
      </tr>
