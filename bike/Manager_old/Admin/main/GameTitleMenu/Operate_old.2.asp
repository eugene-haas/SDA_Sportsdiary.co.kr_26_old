...
<script>
    ...
    //대회명 SELECT BOX 불러오기
    function sel_GameTitlese(){
        
        var packet = {};

        Url ="./ajax/Game_Select_Tourney.asp"

        packet.CMD = CMD_GameTitleIDX;
        packet.GameTitleIDX = Gameinfo.GameTitleIDX;
    ...
    var sel_LevelDtlListse = function () {
    ...
    function sel_LevelDtlList(){
        ...
        packet.GameTitleIDX = $("#GameTitle").val();
        packet.GroupGameGb = $(":input:radio[name=GroupGameGb]:checked").val();
        packet.PlayType = $("#PlayType").val();
        packet.TeamGb = $("#TeamGb").val();
        packet.Level = $("#Level").val();
    ...
    var cli_RequestLevelDtlse = function (idx) {
    ...
    function cli_RequestLevelDtl(idx){
        ...
        Url ="../../ajax/select/RequestLevelDtl.asp"

        packet.CMD = CMD_RequestLevelDtl;
    ...
    //강별 토너먼트 대진표
    var prc_Tourneyse = function (idx, strrnd) {
    ...
    //대회명 SELECT BOX 불러오기
    function prc_Tourney(ididx, strrndx){
    ...
    ////////////Ajax Receive////////////   
    function OnReceiveAjaxse(CMD, dataType, htmldata, jsondata) {
    switch(CMD) {
        ...
        case CMD_TourneyList:
        {
           
            $("#DP_Tourney").html(htmldata);
