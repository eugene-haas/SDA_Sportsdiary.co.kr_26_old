	...
	<script type="text/javascript">
		...
		function CHK_SUBMIT(valType){
			switch(valType){
				...
				default 		: $('form[name=s_frm]').attr('action','./request_receive_E.asp');
			}
		...
		function INFO_REQUEST(valType){
			var strAjaxUrl = '/Ajax/Request/request_receive_E_detail.asp';    
			$.ajax({
				url: strAjaxUrl,
				type: 'POST',
				dataType: 'html',     
...
<div class="navigation_box"> 대회정보 &gt; 대회관리 &gt; 참가신청관리 &gt; 신청접수현황(엘리트) &gt; 참가신청 상세보기</div>			
        ...
        <div class="row">
          ...
          <div class="write_doc">
            ...
            <div class="btn_list comp_list_btn">
              <a href="javascript:CHK_SUBMIT('GLIST');" class="btn btn_basic">참가신청관리</a>
			  <a href="javascript:CHK_SUBMIT('RLIST');" class="btn btn_basic">신청접수목록</a>
