...
<section>
  <div id="content">
    <div class="navigation_box"> 대회정보 &gt; 대회관리 &gt; 참가신청 현황(엘리트)</div>
      <form name="s_frm" method="post">
        <input type="text" name="CIDX" id="CIDX" value="<%=fInject(request("CIDX"))%>" />
        <input type="text" name="fnd_currPage" id="fnd_currPage" value="<%=fnd_currPage%>" />
        <input type="text" name="currPage" id="currPage" value="<%=currPage%>" />
        <input type="text" name="fnd_EnterType" id="fnd_EnterType" value="<%=fnd_EnterType%>" />
        <input type="text" name="fnd_Year" id="fnd_Year" value="<%=fnd_Year%>" />
        <div class="search_top community">
          <div class="search_box">
            <table>
              <tbody>
                <tr>
                  <td id="sel_fnd_GameType"><select name="fnd_GameType" id="fnd_GameType" class="title_select">
                  ...
                  <td id="sel_fnd_AreaGb"><select name="fnd_AreaGb" id="fnd_AreaGb" class="title_select">
                  ...
                  <td id="sel_fnd_AreaGbDt"><select name="fnd_AreaGbDt" id="fnd_AreaGbDt" class="title_select">
                  ...
                  <td id="sel_fnd_GameGroup"><select name="fnd_GameGroup" id="fnd_GameGroup" class="title_select">
                  ...
                  <td id="sel_fnd_GameLevel"><select name="fnd_GameLevel" id="fnd_GameLevel" class="title_select">
                  ...
                  <td class="divn divn_2 divn_key"><input type="text" placeholder="참가신청한 팀 이름" name="fnd_RKeyWord" id="fnd_RKeyWord" class="title_input in_2" /></td>
                  <td><a href="javascript:chk_Submit('FND', '', 1)" class="btn btn_basic">검색</a> <a href="javascript:chk_Submit('ALL', '', 1)" class="btn btn_point">전체보기</a><a href="javascript:chk_Submit('GAME', '', '')" class="btn btn_cta">대회목록</a></td>
                </tr>
              </tbody>
            </table>
          </div>
