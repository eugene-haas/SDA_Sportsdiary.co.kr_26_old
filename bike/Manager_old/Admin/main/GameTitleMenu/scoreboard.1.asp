...
<%
	...
	If Not rs.EOF Then 
		...
		For i = 0 To rsloopcnt
			...
			'Response.Write "fieldarr(i)" & fieldarr(i) & "<br/>"
		Next
		arrRS = rs.getrows()
	Else
		Response.END
	...
	If IsArray(arrRS) Then
		For ar = LBound(arrRS, 2) To UBound(arrRS, 2) 
				For i=0 To rsloopcnt
					...
					Response.Write "fieldarr(i)" & fieldarr(i) & "<br/>"
					Response.Write "arrRS( i ,ar)" & arrRS( i ,ar) & "<br/>"
...
%>
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0">
    ...
    <tbody>
      ...
      <tr class="row3">
        <td class="column0">&nbsp;</td>
        <td class="column1 style20 s" style="font-size: 11pt;font-family: '맑은 고딕'; height: 34px;">Event:<%=game.Sex%><%=game.TeamGbNM%><%=game.PlayTypeNM%>&nbsp;<%=game.LevelName%>&nbsp;</td>
