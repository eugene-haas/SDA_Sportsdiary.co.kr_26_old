...
<script>
  href_Move = function(hrefMove){
    ...
    ParmmStorage.tGroupGameGb =$("#selGroupGameGb").val();
...
<div class="GameGift" id="DP_BODY">
  ...
  <!-- s: 리스트 table -->
	<div class="h-30"></div>
	<div class="final_ranking_box">
    <a href="javascript:popupOpen('GameLevelScoreTotal_result_popup.asp');" class="red_btn">최종종합순위</a>
	</div>
  ...
  <table cellspacing="0" cellpadding="0" style="width:95%;">
    ...
    <tr>
      ...
      <td>
        <a href="#" class="gray_btn" data-toggle="modal" data-target=".gift_sign_modal">서명하기</a>
      </td>
			<td>
        <label class="switch">
					<input type="checkbox" class="switch-input" checked>
...
<!-- #include file = "../../include/modal/gift_sign.asp" -->
