...
<script type="text/javascript" src="../../js/GameTitleMenu/GameResult.js"></script>
...
<% 'Reuqest 데이터 영역
  ...
  href_Move = function(hrefMove){
    ...
    tTeamGbValue = ParmmStorage.tTeamGb;
    ...
    if (hrefMove == "Operate.asp") {
      post_to_url('./' + hrefMove, { 'GameTitle': tGameTitleIdx,'GroupGameGb': GroupGameGbValue,'TeamGb': tTeamGbValue,'Level': LevelValue, 'PlayType': PlayTypeSexValue, 'GameDay' : GameDay, 'StadiumIDX' : StadiumIDX ,'StadiumNumber' : StadiumNumber, 'SearchName' : SearchName, 'PlayLevelType' : PlayLevelType}); 
    }
    else {
      post_to_url('./' + hrefMove, { 'tGameTitleIdx': tGameTitleIdx,'tGroupGameGb': GroupGameGbValue,'tTeamGb': tTeamGbValue,'tLevel': LevelValue, 'tPlayTypeSex': PlayTypeSexValue, 'GameDay' : GameDay, 'StadiumIDX' : StadiumIDX ,'StadiumNumber' : StadiumNumber, 'SearchName' : SearchName, 'PlayLevelType' : PlayLevelType}); 
    }
  };
</script>
...
<div class="Game_operation" id="DP_BODY">
  ...
  <div class="top_btn_list">
    ...
    <a href="javascript:print_GameOrder_list()" id="DP_Print_Ama">
      <i class="fas fa-print"></i>
      <span>생/체 경기기록지 출력</span>
    </a>

    <a href="javascript:print_EliteOrder_list()" id="DP_Print_Elite">
      <i class="fas fa-print"></i>
      <span>엘리트 기록지 출력</span>
    </a>    


    <a href="javascript:OnSearchClick();" width="30" height="30">
      <img src="../../imgs/refresh.png" width="30" height="30">
    </a>    
  </div>
  <!-- e: 태아불 상단 버튼 -->
  <!-- s: 리스트 table -->
  <div id="DP_GameOrderList">
    ...
    <table cellspacing="0" cellpadding="0" style="width:95%;">
      ...
      <tbody id="tbGameResult" name="tbGameResult">
        <tr>
...
<!-- S: group_modal -->
<!-- #include file = "../../include/modal/group_modal.asp" -->
<!-- E: group_modal -->
