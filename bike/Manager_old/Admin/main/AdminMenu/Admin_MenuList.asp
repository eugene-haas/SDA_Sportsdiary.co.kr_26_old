...
%>
  ...
  <script type="text/javascript">
    ...
    <div id="content" class="admin_menuList">
  ...
  <% if iAuthority = "F" then %>
    ...
    <a href="javascript:;" onclick="javascript:WriteLink('<%=NowPage %>');" class="btn">메뉴 등록</a> 
    ...
    <table class="table-list">
      <caption class="sr-only">메뉴 리스트</caption>
      <thead>
        <tr>
          <th>순번</th>
          <th>메뉴코드</th>
      ...
      <tbody id="gametitlelist">
        ...
        <% end if %>
          ...
          <td><%=LRs("RoleDetailNm") %></td>
          <td class="name"><%=LRs("Link") %></td>
          <td>
