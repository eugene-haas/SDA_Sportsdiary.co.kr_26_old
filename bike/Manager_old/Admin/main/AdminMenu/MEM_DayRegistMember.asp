...
<section>
  <div id="content">
	...
	TableSql = TableSql & "	WHERE A.delyn='N' AND A.SportsType = 'bike'"
	...
	TableSql1 = TableSql1 & "	WHERE A.delyn='N' AND A.SportsType = 'bike'"
	...
	TableSql2 = TableSql2 & "	WHERE A.delyn='N' AND A.SportsType = 'bike' "
	...
	TableSql3 = TableSql3 & "	WHERE A.delyn='N' AND A.SportsType = 'bike'"
