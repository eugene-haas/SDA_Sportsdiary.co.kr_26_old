...
<%
    '===================================================================================================================================
    'PAGE : /Main_HP/association_Notice_write.asp
    'DATE : 2018년 04월 18일
    'DESC : [관리자] 공지사항 수정/입력
    '===================================================================================================================================
    ...
    iDivision = "3"                             ' 현재 페이지 구분값

    ListPage    = "/Main_HP/association_Notice_list.asp"
    ViewPage    = "/Main_HP/association_Notice_write.asp"
    WritePage   = "/Main_HP/association_Notice_write.asp"
    ProcPage    = "/Main_HP/association_Notice_proc.asp"
    ...
    gSql = "SELECT CSeq, Name, Code from CodePropertyName_Tbl WITH(NOLOCK) WHERE DelYN = 'N' AND CType = 'Notice' ORDER BY OrderBy ASC"    
    ...
    Select Case ProcType
        ...
        Case "M"
            ...
            'Response.Write "EXEC Community_Board_R "& NowPage &", "& MSeq &", '"& iLoginID &"'"
...
<!--
	var locationStr = "association_Notice_list.asp"
...
<!-- S : content association_Notice_write -->
<div id="content">
            ...
            <tr class="short-line">
                ...
                <td>
                    <p id="sel_SubType" class="con">
                        <select name="SubType" id="SubType" class="title_select">
                            ...
                            %>
                            <option value="<%=Code%>" <%IF SubType = Code Then response.write "selected" End IF%>><%=Name%></option>
                            <%
                                Next
                            End If
                            %>
...
<!-- E : content association_Notice_write -->
<script type="text/javascript">
<!--
        var oEditors = [];
