...
<script language="javascript">
  ...
  function chk_Submit(chkPage){
    var fnd_Role = '';
    var strAjaxUrl = '../Ajax/User_List_withdraw.asp';    
  ...
  function chk_Withdraw(){
    ...
    if(cntWithdraw==0){
      ...
      if(confirm(cntWithdraw+'명의 회원을 탈퇴처리하시겠습니까?')){
        ...
        var strAjaxUrl = '../Ajax/User_List_withdraw_OK.asp';    
...
<!-- S : content user_list_withdraw -->
  <div id="content" class="user_list_withdraw">
    <!-- S: page_title -->
      <div class="page_title clearfix">
        ...
        <div  class="navigation_box">
          ...
          <ul>
            <li>홈페이지관리</li>
            <li>온라인 회원관리</li>
            <li><a href="./User_List_Withdraw.asp">탈퇴회원 신청 목록</a></li>
          </ul>
        </div>
        <!-- E: 네비게이션 -->
      </div>
    ...
    <form name="s_frm" method="post">
      ...
      <div class="search_top community">
        <div class="search_box">
          ...
          <input type="text" name="fnd_KeyWord" id="fnd_KeyWord" class="ipt-word" style="width: 420px" value="<%=fnd_KeyWord%>" placeholder="키워드 검색 [회원명, 생년월일, 아이디, 전화번호, 이메일]">
          <a href="javascript:chk_Submit();" class="btn btn-search" >검색</a><a href="javascript:chk_Withdraw();;" class="btn">회원탈퇴처리</a>
        </div>
