...
<script type="text/javascript">
    ...
    function WriteLink(i2) {
      post_to_url('./Community_Photo_Write.asp', { 'i2': i2, 'iType': '1', 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue });
    }

    function ReadLink(i1, i2) {
      post_to_url('./Community_Photo_Write.asp', { 'i1': i1, 'i2': i2, 'iType': '2', 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue });
    }
    ...
    txtSearchValue = document.getElementById('txtSearch').value;
      ...
      post_to_url('./Community_Photo_List.asp', { 'i2': 1, 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue });
    }

  </script>
<!-- S: content photo_list -->
<div id="content" class="photo_list">
  <!-- S: page_title -->
  <div class="page_title clearfix">
    ...
    <div  class="navigation_box">
      ...
      <ul>
        <li>홈페이지관리</li>
        <li>커뮤니티</li>
        <li><a href="javascript:;" onclick="./Community_Photo_List.asp">갤러리-사진</a></li>
      </ul>
    </div>
    <!-- E: 네비게이션 -->
...
<div class="search_top community">
  <div class="search_box"> 
    ...
    <input type="text" id="txtSearch" name="txtSearch" class="title_input ipt-word" placeholder="검색할 내용을 입력해 주세요.">
    <a href="javascript:;" id="btnselSearch" name="btnselSearch" onClick="javascript:fn_selSearch();" class="btn btn-search">검색</a>
    <a href="javascript:;" onClick="javascript:WriteLink('<%=NowPage %>');" class="btn btn-add">글쓰기</a> </div>
  ...
  <table class="table-list">
    ...
    <tbody id="gametitlelist">
      ...
      <!--게시판에 데이터가 없는 경우-->
      <tr class="no-data">
        <td colspan="7"><div>등록된 게시물이 없습니다.</div></td>
      </tr>
      <%
          End If
