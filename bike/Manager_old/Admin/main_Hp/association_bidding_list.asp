...
<%
    '===================================================================================================================================
    'PAGE : /Main_HP/association_bidding_list.asp
    'DATE : 2018년 04월 18일
    'DESC : [관리자] 입찰공고 목록
    '===================================================================================================================================
    ...
    iDivision = "6"                             ' 현재 페이지 구분값

    ListPage    = "/Main_HP/association_bidding_list.asp"
    ViewPage    = "/Main_HP/association_bidding_write.asp"
    WritePage   = "/Main_HP/association_bidding_write.asp"
    ...
    With objCmd
        ...
        .Parameters.Append .CreateParameter("@iSearchCol",adVarChar, adParamInput, 5, KeyField2)
...
<!--
	var locationStr = "association_bidding_list.asp"
    ...
    function fn_selSearch() {
        ...
        post_to_url('<%=ListPage%>', {'NowPage': 1, 'KeyField1': KeyField1, 'KeyField2': KeyField2, 'KeyWord': KeyWord});
    }
    ...
    function ReadLink(i1, i2) {
        ...
        post_to_url('<%=ViewPage%>', {idx: i1, 'pType': 'M', 'NowPage': i2, 'KeyField1': KeyField1, 'KeyField2': KeyField2, 'KeyWord': KeyWord});
    }
//-->
</script>
<!-- S : content association_bidding_list -->
<div id="content">
        ...
        <div class="search_top community">
            ...
            <div class="search_box" >
                ...
                <select name="KeyField2" id="KeyField2" class="title_select">
                    ...
                    <option value="S" <%IF KeyField2 = "S" Then response.write "selected" End IF%>>제목</option>
                    <option value="C" <%IF KeyField2 = "C" Then response.write "selected" End IF%>>내용</option>                        
                    <option value="T" <%IF KeyField2 = "T" Then response.write "selected" End IF%>>제목+내용</option>
                </select>
                ...
                <a href="<%=WritePage%>" class="btn btn-add" >입찰공고 등록</a>
            </div>
            <!-- E: search-box -->
        ...
        <div class="community">
            ...
            <div id="board-contents" class="table-list-wrap">
                ...
                <table class="table-list">
                    <caption class="sr-only">입찰공고 리스트</caption>
                    <thead>
                        <tr>
...
<!-- E : content association_bidding_list -->
