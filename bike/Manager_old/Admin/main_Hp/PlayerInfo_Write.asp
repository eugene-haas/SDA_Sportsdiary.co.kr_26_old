...
<script language="javascript">
    ...
    * left-menu 체크
    */
    var locationStr = "PlayerInfo_List.asp";  // 선수
    /* left-menu 체크 */
    ...
    function onSubmit(valType){     
        ...
        var strAjaxUrl = '../Ajax/PlayerInfo_Write.asp';
...
<section>
    <div id="content">
        ...
        <div class="page_title clearfix">
            <h2>선수등록</h2>
            <a href="./PlayerInfo_list.asp" class="btn btn-back"><span class="ic_deco"><i class="fas fa-angle-left"></i></span>뒤로가기</a>
            <!-- S: 네비게이션 -->
