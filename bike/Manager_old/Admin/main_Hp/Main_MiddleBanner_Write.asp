...
<script type="text/javascript">
   ...
   * left-menu 체크
   */
	var locationStr = "Main_MiddleBanner_List"; // 배너관리
  /* left-menu 체크 */
  ...
  function Del_Link(i1, i2) {
    if (confirm("해당 글을 삭제 하시겠습니까?") == true) {
    	post_to_url('./Main_MiddleBanner_Delete_p.asp', { 'i1': i1, 'i2': i2 });
    }
    else {
    }
  }
    ...
    if (i3 == "1") {
      ...
      if (confirm("해당 글을 저장 하시겠습니까?") == true) {
        try {
          ...
          documentForm.action = "./Main_MiddleBanner_Reply_p.asp";
          documentForm.submit();
        } catch (e) { }
      }
      else {
  ...
  function ReplyDel_Link(i1, i2, i3, i4) {
    if (confirm("해당 글을 삭제 하시겠습니까?") == true) {
    	post_to_url('./Main_MiddleBanner_Reply_Delete_p.asp', { 'i1': i1, 'i2': i2, 'i3': i3, 'i4': i4 });
    }
    else {
    }
  }
  ...
  <div id="content" class="qna_write">
    ...
    <div class="page_title clearfix">
      <h2>중단 배너관리 등록/수정</h2>
      <a href="./Main_MiddleBanner_List.asp" class="btn btn-back"><span class="ic_deco"><i class="fas fa-angle-left"></i></span>뒤로가기</a>
      ...
      <div  class="navigation_box">
        ...
        <ul>
          <li>홈페이지관리</li>
          <li>메인</li>
          <li><a href="./Main_MiddleBanner_List.asp">중단 배너관리</a></li>
          <li><a href="./Main_MiddleBanner_Write.asp">중단 배너관리 등록/수정</a></li>
        </ul>
      </div>
      <!-- E: 네비게이션 -->
    ...
    <!-- S : 내용 시작 -->
      <form id="form1" name="form1" action="./Main_MiddleBanner_Write_p.asp" method="post" ENCTYPE="multipart/form-data">
