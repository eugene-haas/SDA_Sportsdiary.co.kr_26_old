...
<%
    ...
    ListPage    = "/Main_HP/Main_MiddleBanner_List.asp"
    ViewPage    = "/Main_HP/Main_MiddleBanner_Write.asp"
    WritePage   = "/Main_HP/Main_MiddleBanner_Write.asp"
    ...
    If Request.Form("iDivision") = "" Then iDivision = "41" Else iDivision = fInject(Trim(Request.Form("iDivision")))
...
<script type="text/javascript">
    var locationStr = "Main_MiddleBanner_List.asp"
    ...
    function WriteLink(i2) {
    	post_to_url('./Main_MiddleBanner_Write.asp', { 'i2': i2, 'iType': '1', 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue });
    }

    function ReadLink(i1, i2) {
    	post_to_url('./Main_MiddleBanner_Write.asp', { 'i1': i1, 'i2': i2, 'iType': '2', 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue });
    }

    function PagingLink(i2) {
    	post_to_url('./Main_MiddleBanner_List.asp', { 'i2': i2, 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue });
    }
    ...
    function fn_selSearch() {
        ...
        post_to_url('./Main_MiddleBanner_List.asp', { 'i2': 1, 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue });
    }

</script>
<!-- S: content MiddleBanner_list -->
<div id="content" class="MiddleBanner_list">
    <!-- S: page_title -->
    <div class="page_title clearfix">
        ...
        <div  class="navigation_box">
            ...
            <ul>
                <li>홈페이지관리</li>
                <li>메인</li>
                <li><a href="<%=ListPage%>">중단 배너관리</a></li>
            </ul>
        </div>
        <!-- E: 네비게이션 -->
    </div>
    ...
    <div class="search_top community">
        ...
        <table class="table-list">
            <caption class="sr-only">중단 배너관리 리스트</caption>
            <colgroup>
                <col width="*" />
                <col width="*" />
                <col width="*" />
