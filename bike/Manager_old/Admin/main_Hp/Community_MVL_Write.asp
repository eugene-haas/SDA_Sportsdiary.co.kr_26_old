...
<script type="text/javascript">
   ...
   * left-menu 체크
   */
	var locationStr = "Community_MVL_List"; // 질문과 답변
  /* left-menu 체크 */
  ...
  function Del_Link(i1, i2) {
    if (confirm("해당 글을 삭제 하시겠습니까?") == true) {
    	post_to_url('./Community_MVL_Delete_p.asp', { 'i1': i1, 'i2': i2 });
    }
    else {
    }
  }
  ...
  function CancelLink(i2) {
  	post_to_url('./Community_MVL_List.asp', { 'i2': i2, 'iSubType': selSearchValue1, 'iNoticeYN': selSearchValue2, 'iDivision': selSearchValue3, 'iSearchCol1': selSearchValue4, 'iSearchCol': selSearchValue, 'iSearchText': txtSearchValue });
  }
    ...
    if (i3 == "1") {
      ...
      if (confirm("해당 글을 저장 하시겠습니까?") == true) {
        try {
          ...
          documentForm.action = "./Community_MVL_Reply_p.asp";
          documentForm.submit();
        } catch (e) { }
      }
      else {
  ...
  function ReplyDel_Link(i1, i2, i3, i4) {
    if (confirm("해당 글을 삭제 하시겠습니까?") == true) {
    	post_to_url('./Community_MVL_Reply_Delete_p.asp', { 'i1': i1, 'i2': i2, 'i3': i3, 'i4': i4 });
    }
    else {
    }
  }
  ...
  <div id="content" class="qna_write">
    ...
    <div class="page_title clearfix">
      <h2>레슨동영상 등록/수정</h2>
      <a href="./Community_MVL_List.asp" class="btn btn-back"><span class="ic_deco"><i class="fas fa-angle-left"></i></span>뒤로가기</a>
      ...
      <div  class="navigation_box">
        ...
        <ul>
          <li>홈페이지관리</li>
          <li>커뮤니티</li>
          <li><a href="javascript:;" onclick="./Community_MVL_List.asp">레슨동영상</a></li>
          <li><a href="javascript:;" onclick="./Community_MVL_Write.asp">레슨동영상 등록/수정</a></li>
        </ul>
      </div>
      <!-- E: 네비게이션 -->
    ...
    <!-- S : 내용 시작 -->
      <form id="form1" name="form1" action="./Community_MVL_Write_p.asp" method="post" ENCTYPE="multipart/form-data">
        <table class="left-head view-table">
          ...
          <tr class="half-line">
            ...
            <td colspan="2">
              <span class="con">
                <input type="text" id="iLink" name="iLink" value="<%=Link %>" />
