...
<%
    '===================================================================================================================================
    'PAGE : /Main_HP/association_relay_list.asp
    'DATE : 2018년 04월 18일
    'DESC : [관리자] 중계일정 목록
    '===================================================================================================================================
    ...
    Dim MSeq, Division, SubType, Name, Subject, FileYN, NoticeYN, ViewCnt, InsDate, relayDate, relayTime, relayChannel, relayDateName
...
<!-- S : content association_relay_list -->
<div id="content">
        ...
        <div class="search_top community">
            ...
            <div class="search_box" >
                <select name="KeyField1" id="KeyField1" class="title_select">
                    ...
                    <option value="C" <%IF KeyField1 = "C" Then response.write "selected" End IF%>>내용</option>                        
                    <option value="T" <%IF KeyField1 = "T" Then response.write "selected" End IF%>>제목+내용</option>
                </select>
                ...
                <a href="<%=WritePage%>" class="btn btn-add" >중계일정 등록</a>
            </div>
            <!-- E: search-box -->
        ...
        <div class="community">
            ...
            <div id="board-contents" class="table-list-wrap">
                ...
                <table class="table-list">
                    <caption class="sr-only">중계일정 리스트</caption>
                    <thead>
                        <tr>
                            <th scope="col" width="60">순번</th>
                            <th scope="col" width="120">날짜</th>
                            <th scope="col" width="100">시간</th>
                            <th scope="col" width="100">채널</th>
                            <th scope="col" width="280">대회명</th>
                            <th scope="col">제목</th>
                    ...
                    <tbody>
                        ...
                        Else
                            For i=0 To Cnt
                                ...
                                relayDate       = Replace(Trim(Buff(9, i)), "-", ".")
                                relayTime       = Trim(Buff(10, i))
                                relayChannel    = Trim(Buff(11, i))
                                relayDateName   = Trim(Buff(12, i))
                                GameTitleIdx    = CDbl(Buff(13, i))
                                GameTitleName   = Trim(Buff(14, i))
                        ...
                        <tr style="cursor:pointer" onClick="javascript:ReadLink('<%=crypt.EncryptStringENC(MSeq) %>','<%=NowPage %>');">
                            <td><%=intNum %></td>
                            <td><%=relayDate %>(<%=relayDateName%>)</td>
                            <td><%=relayTime %></td>
                            <td><%=relayChannel %></td>
                            <td class="name"><%=GameTitleName %></td>
...
<!-- E : content association_relay_list -->
