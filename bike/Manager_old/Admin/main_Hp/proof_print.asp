...
<%
	...
	division			= fInject(Trim(Request.QueryString("division")))		' 발급요청자 1-개인 2-단체
	pl1_name			= fInject(Trim(Request.QueryString("pl1_name")))

	pl1_no1				= fInject(Trim(Request.QueryString("pl1_no1")))
	tm_kname			= fInject(Trim(Request.QueryString("tm_kname")))
	tm_id				= fInject(Trim(Request.QueryString("tm_id")))
	use					= fInject(Trim(Request.QueryString("use")))
	present				= fInject(Trim(Request.QueryString("present")))
	sort				= fInject(Trim(Request.QueryString("sort")))			' 증명서 종류 1-경기실적 2-지도실적	
	witness				= fInject(Trim(Request.QueryString("witness")))
	witness2			= fInject(Trim(Request.QueryString("witness2")))
	start_year			= fInject(Trim(Request.QueryString("start_year")))
	end_year			= fInject(Trim(Request.QueryString("end_year")))
	nono				= fInject(Trim(Request.QueryString("nono")))
	print_count			= fInject(Trim(Request.QueryString("print_count")))
	add					= fInject(Trim(Request.QueryString("add")))
	position			= fInject(Trim(Request.QueryString("position")))
