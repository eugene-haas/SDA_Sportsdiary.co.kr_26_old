...
<%
    '===================================================================================================================================
    'PAGE : /Main_HP/file_down_list.asp
    'DATE : 2018년 04월 18일
    'DESC : [관리자] 파일 다운로드 목록
    '===================================================================================================================================
    ...
    iDivision = "31"                            ' 현재 페이지 구분값

    ListPage    = "/Main_HP/file_down_list.asp"
    ViewPage    = "/Main_HP/file_down_write.asp"
    WritePage   = "/Main_HP/file_down_write.asp"
    ...
    If Request.Form("KeyField") = "" Then KeyField = "" Else KeyField = fInject(Trim(Request.Form("KeyField")))
    ...
    With objCmd
        ...
        .Parameters.Append .CreateParameter("@iSearchCol",adVarChar, adParamInput, 5, KeyField)
...
<!--
	var locationStr = 'file_down_list.asp';
							  
    function PagingLink(i2) {
        var KeyField = $("#KeyField").val();
        var KeyWord = $("#KeyWord").val();

        post_to_url('<%=ListPage%>', {'NowPage': i2, 'KeyField': KeyField, 'KeyWord': KeyWord});
    }
    ...
    function fn_selSearch() {
        ...
        post_to_url('<%=ListPage%>', {'NowPage': 1, 'KeyField': KeyField, 'KeyWord': KeyWord});
    }
    ...
    function ReadLink(i1, i2) {
        ...
        post_to_url('<%=ViewPage%>', {idx: i1, 'pType': 'M', 'NowPage': i2, 'KeyField': KeyField, 'KeyWord': KeyWord});
    }
    ...
    <div class="page_title clearfix">
        ...
        <div  class="navigation_box">
            ...
            <ul>
                <li>홈페이지관리</li>
                <li>온라인서비스</li>
                <li><a href="<%=ListPage%>">파일 다운로드</a></li>
            </ul>
        </div>
        <!-- E: 네비게이션 -->
        ...
        <div class="search_top community">
            ...
            <div class="search_box" >
                <select name="KeyField" id="KeyField" class="title_select">
                    <option value="">:: 선택 ::</option>
                    <option value="S" <%IF KeyField = "S" Then response.write "selected" End IF%>>제목</option>
                    <option value="C" <%IF KeyField = "C" Then response.write "selected" End IF%>>내용</option>                        
                    <option value="T" <%IF KeyField = "T" Then response.write "selected" End IF%>>제목+내용</option>
                </select>
                ...
                <a href="<%=WritePage%>" class="btn btn-add" >파일 다운로드 등록</a>
            </div>
            <!-- E: search-box -->
        ...
        <div class="community">
            ...
            <div id="board-contents" class="table-list-wrap">
                ...
                <table class="table-list">
                    <caption class="sr-only">파일 다운로드 리스트</caption>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        If IsNull(Buff) = True Then 
                            Response.Write "<tr><td colspan=""5"">등록된 게시물이 없습니다.</td></tr>"
                        Else
                            For i=0 To Cnt
