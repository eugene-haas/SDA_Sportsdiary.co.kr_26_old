...
<script>
	...
	function chk_Submit(valType, valIDX, chkPage){
		...
		var strAjaxUrl = '../ajax/NationalTeam_Manage_Leader.asp';    
		...
		if(valType=='VIEW'){
			...
			$('form[name=s_frm]').attr('action','./NationalTeam_write_Leader.asp');
  ...
  <form name="s_frm" method="post">
    ...
    <div class="search_top">
      <div class="search_box">
        ...
        <a href="javascript:chk_Submit('FND','',1);" class="btn btn-search">검색</a><a href="./NationalTeam_write_Leader.asp" class="btn btn-blue">등록하기</a> </div>
      <!-- S : 리스트형 20개씩 노출 -->
