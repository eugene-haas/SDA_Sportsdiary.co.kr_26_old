...
<%
    '===================================================================================================================================
    'PAGE : /Main_HP/settlement_list.asp
    'DATE : 2018년 04월 18일
    'DESC : [관리자] 결산 목록
    '===================================================================================================================================
...
<!--
	var locationStr = "settlement_list.asp"
    ...
    <div class="page_title clearfix">
        ...
        <div class="search_top community">
            ...
            <div class="search_box" >
                ...
                <a href="<%=WritePage%>" class="btn btn-add" >결산 등록</a>
            </div>
            <!-- E: search-box -->
        ...
        <div class="community">
            ...
            <div id="board-contents" class="table-list-wrap">
                ...
                <table class="table-list">
                    <caption class="sr-only">결산 리스트</caption>
                    <thead>
                        <tr>
