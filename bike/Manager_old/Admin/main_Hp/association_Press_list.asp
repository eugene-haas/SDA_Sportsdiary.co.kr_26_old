...
<%
    '===================================================================================================================================
    'PAGE : /Main_HP/association_Press_list.asp
    'DATE : 2018년 04월 18일
    'DESC : [관리자] 보도자료 목록
    '===================================================================================================================================
    ...
    iDivision = "5"                             ' 현재 페이지 구분값

    ListPage    = "/Main_HP/association_Press_list.asp"
    ViewPage    = "/Main_HP/association_Press_write.asp"
    WritePage   = "/Main_HP/association_Press_write.asp"
...
<!--
	var locationStr = "association_Press_list.asp"
...
<!-- S : content association_Press_list -->
<div id="content">
    <div class="page_title clearfix">
        ...
        <div class="search_top community">
            ...
            <div class="search_box" >
                ...
                <a href="<%=WritePage%>" class="btn btn-add" >보도자료 등록</a>
            </div>
            <!-- E: search-box -->
        ...
        <div class="community">
            ...
            <div id="board-contents" class="table-list-wrap">
                ...
                <table class="table-list">
                    <caption class="sr-only">보도자료 리스트</caption>
                    <thead>
                        <tr>
...
<!-- E : content association_Press_list -->
