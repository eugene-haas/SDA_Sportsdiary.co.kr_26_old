...
<%
	'===================================================================================================================================
    'PAGE : /Main_HP/association_Notice_proc.asp
    'DATE : 2018년 04월 18일
    'DESC : [관리자] 공지사항 처리
    '===================================================================================================================================
    ...
    If xTabsInst.Form("KeyField2") = "" Then KeyField2 = "" Else KeyField2 = fInject(Trim(xTabsInst.Form("KeyField2")))
    If xTabsInst.Form("KeyField3") = "" Then KeyField3 = "" Else KeyField3 = fInject(Trim(xTabsInst.Form("KeyField3")))
    ...
    SubType             = fInject(Trim(xTabsInst.Form("SubType")))
    NoticeYN            = fInject(Trim(xTabsInst.Form("NoticeYN")))
    ...
    Contents            = Replace(fInject(Trim(xTabsInst.Form("iContents"))), "'", "&#039;")
