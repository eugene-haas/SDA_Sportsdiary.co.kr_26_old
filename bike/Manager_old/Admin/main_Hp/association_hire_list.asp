...
<%
    '===================================================================================================================================
    'PAGE : /Main_HP/association_hire_list.asp
    'DATE : 2018년 04월 18일
    'DESC : [관리자] 채용공고 목록
    '===================================================================================================================================
...
<!-- S : content association_hire_list -->
<div id="content">
    <div class="page_title clearfix">
        ...
        <div class="search_top community">
            ...
            <div class="search_box" >
                ...
                <a href="<%=WritePage%>" class="btn btn-add" >채용공고 등록</a>
            </div>
            <!-- E: search-box -->
        ...
        <div class="community">
            ...
            <div id="board-contents" class="table-list-wrap">
                ...
                <table class="table-list">
                    <caption class="sr-only">채용공고 리스트</caption>
                    <thead>
                        <tr>
...
<!-- E : content association_hire_list -->
