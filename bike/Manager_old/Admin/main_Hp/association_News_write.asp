...
<%
    '===================================================================================================================================
    'PAGE : /Main_HP/association_News_write.asp
    'DATE : 2018년 04월 18일
    'DESC : [관리자] 협회소식 수정/입력
    '===================================================================================================================================
    ...
    ProcPage    = "/Main_HP/association_News_proc.asp"
    ...
    gSql = "SELECT CSeq, Name, Code from CodePropertyName_Tbl WITH(NOLOCK) WHERE DelYN = 'N' AND CType = 'Association' ORDER BY OrderBy ASC"    
...
<!-- S : content association_News_write -->
<div id="content">
...
<!-- E : content association_News_write -->
<script type="text/javascript">
<!--
        var oEditors = [];
