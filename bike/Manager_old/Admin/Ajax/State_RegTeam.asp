...
<%
	...
	IF fnd_TeamGb <> "" Then CSearch = " AND A.PTeamGb = '"&fnd_TeamGb&"'"
			...
			IF Not(LRs.Eof Or LRs.Bof) Then 
				...
				numrows = ubound(txtData, 2)	'열
   				...
   				FOR i = 0 to numrows	
					...
					response.write " <td>"&txtData(1, i)&"</td>"						'LeaderCnt
					response.write " <td>"&txtData(2, i)&"</td>"     					'PlayerCnt
					response.write " <td>"&txtData(3, i)&"</td>"						'ZipCode	
					response.write " <td>"&txtData(4, i)&" "&txtData(5, i)&"</td>"		'Address
					response.write " <td>"&txtData(6, i)&"</td>"						'LeaderInfo	(감독)
					response.write " <td>"&txtData(7, i)&"</td>"						'LeaderInfo2 (코치)	
					response.write " <td>"&txtData(8, i)&"</td>"						'TeamTel
					response.write " <td>"&txtData(9, i)&"</td>"						'TeamFax
					response.write "</tr>"   
   				NEXT
