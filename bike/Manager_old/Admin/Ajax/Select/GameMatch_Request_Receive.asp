...
<%
	...
	LSQL = LSQL & "						AND ReceptionistIDX = B.ReceptionistIDX"
	LSQL = LSQL & "					)"
	...
	LSQL = LSQL & "	GROUP BY A.GameTitleIDX, A.ReceptionistIDX, C.UserName, C.AthleteCode, E.TeamNm, A.Status, D.PubName, A.PayGroupNum, A.PayOrderNum"
	LSQL = LSQL & ") Z"
  ...
  ' response.write LSQL
    ...
    IF Not(LRs.Eof Or LRs.Bof) Then 
      	...
      	Do Until LRs.eof
        	...
        	cnt = cnt + 1
				...
				RE_DATA = RE_DATA & "  <td><a href=""javascript:chk_Submit('VIEW', '"&crypt.EncryptStringENC(LRs("ReceptionistIDX"))&"', '"&fnd_currPage&"');"" class=""btn btn_default"">상세보기</a></td>"
                RE_DATA = RE_DATA & "</tr>"
        onClick=""""	
        	LRs.Movenext
      	Loop
	Else
      	RE_DATA = RE_DATA & "<tr><td colspan=5>등록된 참가신청 정보가 없습니다.</td></tr>"
    End IF    
    ...
    IF intTemp = 1 Then
      	IF fnd_currPage = 1 Then
        	RE_PAGE = RE_PAGE & "<li class='page-item'><a href='javascript:' class='page-link' title='이전 "&BlockPage&"페이지'><span class='img_box'><img src='../imgs/table/page_prev_10.png' alt='이전 "&BlockPage&"페이지'></span></a></li>"
        	RE_PAGE = RE_PAGE & "<li class='page-item'><a href='javascript:' class='page-link' title='이전페이지'><span class='img_box'><img src='../imgs/table/page_prev.png' alt='이전페이지'></span></a></li>"
      	Else
        	RE_PAGE = RE_PAGE & "<li class='page-item'><a href=""javascript:chk_Submit('LIST','',1);"" class='page-link' title='이전 "&BlockPage&"페이지'><span class='img_box'><img src='../imgs/table/page_prev_10.png' alt='이전 "&BlockPage&"페이지'></span></a></li>"
        	RE_PAGE = RE_PAGE & "<li class='page-item'><a href=""javascript:chk_Submit('LIST','','"&fnd_currPage-1&"');"" class='page-link' title='이전페이지'><span class='img_box'><img src='../imgs/table/page_prev.png' alt='이전페이지'></span></a></li>"
      	End IF
    Else
      	RE_PAGE = RE_PAGE & "<li class='page-item'><a href=""javascript:chk_Submit('LIST','',1);"" class='page-link' title='이전 "&BlockPage&"페이지'><span class='img_box'><img src='../imgs/table/page_prev_10.png' alt='이전 "&BlockPage&"페이지'></span></a></li>"
     	RE_PAGE = RE_PAGE & "<li class='page-item'><a href=""javascript:chk_Submit('LIST','','"&intTemp - BlockPage&"');"" class='page-link' title='이전페이지'><span class='img_box'><img src='../imgs/table/page_prev.png' alt='이전페이지'></span></a></li>"
    End IF
    ...
    IF intTemp > TotalPage Then
      	IF cint(fnd_currPage) < cint(TotalPage) Then
        	RE_PAGE = RE_PAGE & "<li class='page-item'><a class='page-link' href=""javascript:chk_Submit('LIST','','"&fnd_currPage+1&"');"" aria-label='Next' title='다음페이지'><img src='../imgs/table/page_next.png' alt='다음페이지'></a></li>"
        	RE_PAGE = RE_PAGE & "<li class='page-item'><a class='page-link' href=""javascript:chk_Submit('LIST','','"&TotalPage&"');"" aria-label='Next' title='다음 "&BlockPage&"페이지'><img src='../imgs/table/page_next_10.png' alt='다음 "&BlockPage&"페이지'></a></li>"
      	Else
        	RE_PAGE = RE_PAGE & "<li class='page-item'><a class='page-link' href='javascript:' aria-label='Next' title='다음페이지'><img src='../imgs/table/page_next.png' alt='다음페이지'></a></li>"
        	RE_PAGE = RE_PAGE & "<li class='page-item'><a class='page-link' href='javascript:' aria-label='Next' title='다음 "&BlockPage&"페이지'><img src='../imgs/table/page_next_10.png' alt='다음 "&BlockPage&"페이지'></a></li>"
      	End IF
    Else
      	RE_PAGE = RE_PAGE & "<li class='page-item'><a class='page-link' href=""javascript:chk_Submit('LIST','','"&intTemp&"');"" aria-label='Next' title='다음페이지'><img src='../imgs/table/page_next.png' alt='다음페이지'></a></li>"
      	RE_PAGE = RE_PAGE & "<li class='page-item'><a class='page-link' href=""javascript:chk_Submit('LIST','','"&intTemp&"');"" aria-label='Next' title='다음 "&BlockPage&"페이지'><img src='../imgs/table/page_next_10.png' alt='다음 "&BlockPage&"페이지'></a></li>"
    End IF 
