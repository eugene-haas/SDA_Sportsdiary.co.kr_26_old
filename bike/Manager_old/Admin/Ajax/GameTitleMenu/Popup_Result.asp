...
<%
  ...
  LSQL = LSQL & " 	GameDay, LevelJooNum, LevelDtlJooNum, LevelDtlName, LevelJooName, BBB.PlayType, BBB.EnterType,"
  ...
  LSQL = LSQL & " 		AA.TourneyGroupIDX AS Win_TourneyGroupIDX, AA.LGroupJumsu, AA.RGroupJumsu, AA.LDtlJumsu, AA.RDtlJumsu, AA.SignData, AA.EnterType,"
  ...
  LSQL = LSQL & " 		    A.TurnNum, D.GroupGameGb, A.StadiumNum, A.StadiumIDX, A.GameDay, D.LevelJooNum, D.PlayType, C.LevelJooNum AS LevelDtlJooNum, C.LevelDtlName, dbo.FN_NameSch(D.LevelJooName,'Pubcode') AS LevelJooName, C.MaxPoint, G.SignData, C.EnterType,"
  ...
  If GroupGameGb = "B0030002" Then
    ...
    LSQL = "SELECT Top 1 StadiumNum, TeamGameNum"
    ...
    If Not (LRs.Eof Or LRs.Bof) Then
      StadiumNum = LRs("StadiumNum")
      DEC_TeamGameNum = LRs("TeamGameNum")
    End If
         ...
         <!-- S: content-title -->
            ...
            <%
              If GroupGameGb = "B0030001" Then
                Response.Write DEC_GameNum
              Else
                Response.Write DEC_TeamGameNum & "-" & DEC_GameNum
              End If
            %>경기</span>
            <%If EnterType = "E" Then %>
