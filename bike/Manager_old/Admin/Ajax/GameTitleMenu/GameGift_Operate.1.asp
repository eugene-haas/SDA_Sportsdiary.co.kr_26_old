...
REQ = Request("Req")
REQ = "{""CMD"":4,""tGameTitleIDX"":""A0B63180CC3215B403232E31C8E393B4"",""tGameDay"":""2018-06-23"",""tStadiumIDX"":""DBFEA0D74B3E8F60F71FF6132C0DB1AC"",""tSearchName"":"""",""tGroupGameGB"":"""",""tTotalClass"":""""}"
        ...
        <tr>
          ...
          <td>
            <a href="#" 
              ...
              onclick="PopupGiftSign('<%=crypt_GameLevelDtlidx%>','<%=crypt_RequestIDX%>','<%=crypt_GroupGameGb%>','N');" data-toggle="modal" data-target=".play_detail_modal">서명하기</a>
          </td>
          <td>
            <label class="switch">
