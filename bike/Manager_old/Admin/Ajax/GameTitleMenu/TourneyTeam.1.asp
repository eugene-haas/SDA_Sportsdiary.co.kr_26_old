...
LSQL = LSQL & "  ORDER BY TeamGameNum "
					...
					<% End If %>
						<ul class='team clearfix'>
							<li>
								...
								<% End If %>
									<input type='text' id='LGroupJumsu_<%=LRs("TeamGameNum")%>' class='ipt-point' value='<%=LRs("LJumsu")%>'>
									</span>
								<% If LRs("RResultType") = "WIN" Then %>
									<span class='stair winner'><a class='btn chk-win' onclick="cli_TourneyResult('<%=LRs("GameLevelDtlIDX")%>','<%=k%>','<%=LRs("TeamGameNum")%>','WIN','<%=LRs("LTeam")%>','<%=LRs("LTeamDtl")%>','L')">승</a>
								<% Else %>
									<span class='stair'><a class='btn chk-win' onclick="cli_TourneyResult('<%=LRs("GameLevelDtlIDX")%>','<%=k%>','<%=LRs("TeamGameNum")%>','WIN','<%=LRs("LTeam")%>','<%=LRs("LTeamDtl")%>','L')">승</a>
								<% End If %>
								</span>
						...
						<div class='pre-num'><%=LRs("TeamGameNum")%></div>
							...
							<ul class='team clearfix'>
								<li>
									...
									<% If LRs("RResultType") = "WIN" Then %>
										<span class='stair winner'><a class='btn chk-win' onclick="cli_TourneyResult('<%=LRs("GameLevelDtlIDX")%>','<%=k%>','<%=LRs("TeamGameNum")%>','WIN','<%=LRs("RTeam")%>','<%=LRs("RTeamDtl")%>','R')">승</a></span>
									<% Else %>
										<span class='stair'><a class='btn chk-win' onclick="cli_TourneyResult('<%=LRs("GameLevelDtlIDX")%>','<%=k%>','<%=LRs("TeamGameNum")%>','WIN','<%=LRs("RTeam")%>','<%=LRs("RTeamDtl")%>','R')">승</a></span>
									<% End If %>
