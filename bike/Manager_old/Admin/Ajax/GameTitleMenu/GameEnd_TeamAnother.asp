...
REQ = Request("Req")
'REQ = "{""CMD"":9,""GameLevelDtlIDX"":""5DA8B97309D51CE41772A3CCBF968D9B"",""GameRound"":""D3510D3EEF159089CEE3710534553C12"",""TeamGameNum"":""4F0C40AE3DFDC66664FB7AC6C660689A"",""GameNum"":"""",""Anth_Team1"":"""",""Anth_TeamDtl1"":"""",""Anth_Team2"":""29B6C6DDB7F46E80C8B6BA8738CADB71"",""Anth_TeamDtl2"":""BA8A3F4EEB3BD1BC6BDDCE9B834746BD"",""Anth_ResultType"":""233504FABCD7A56DB391510A1249F8A4"",""Anth_ResultTypeDtl"":""E211C5007C3241839974DE53D61E1932""}"
'REQ = "{""CMD"":10,""GameLevelDtlIDX"":""302D502EAE924B6ECED9A480DAE61FDA"",""GameRound"":""D3510D3EEF159089CEE3710534553C12"",""TeamGameNum"":""D3510D3EEF159089CEE3710534553C12"",""GameNum"":"""",""Anth_Team1"":""BA00391"",""Anth_TeamDtl1"":""0"",""Anth_Team2"":"""",""Anth_TeamDtl2"":"""",""Anth_ResultType"":""22D0AA6902FF2AE3481189E704FF022D"",""Anth_ResultTypeDtl"":""C3F5126271DB13B1DECB8A9AD6A8AADF""}"
...
If hasown(oJSONoutput, "Anth_Team1") = "ok" then
    If ISNull(oJSONoutput.Anth_Team1) Or oJSONoutput.Anth_Team1 = "" Then
      Anth_Team1 = ""
      DEC_Anth_Team1 = ""
    Else
      Anth_Team1 = fInject(oJSONoutput.Anth_Team1)
      DEC_Anth_Team1 = fInject(crypt.DecryptStringENC(oJSONoutput.Anth_Team1))    
    End If
  Else  
    Anth_Team1 = ""
    DEC_Anth_Team1 = ""
...
If hasown(oJSONoutput, "Anth_TeamDtl1") = "ok" then
    If ISNull(oJSONoutput.Anth_TeamDtl1) Or oJSONoutput.Anth_TeamDtl1 = "" Then
      Anth_TeamDtl1 = ""
      DEC_Anth_TeamDtl1 = ""
    Else
      Anth_TeamDtl1 = fInject(oJSONoutput.Anth_TeamDtl1)
      DEC_Anth_TeamDtl1 = fInject(crypt.DecryptStringENC(oJSONoutput.Anth_TeamDtl1))    
    End If
  Else  
    Anth_TeamDtl1 = ""
    DEC_Anth_TeamDtl1 = ""
...
If hasown(oJSONoutput, "Anth_Team2") = "ok" then
    If ISNull(oJSONoutput.Anth_Team2) Or oJSONoutput.Anth_Team2 = "" Then
      Anth_Team2 = ""
      DEC_Anth_Team2 = ""
    Else
      Anth_Team2 = fInject(oJSONoutput.Anth_Team2)
      DEC_Anth_Team2 = fInject(crypt.DecryptStringENC(oJSONoutput.Anth_Team2))    
    End If
  Else  
    Anth_Team2 = ""
    DEC_Anth_Team2 = ""
...
If hasown(oJSONoutput, "Anth_TeamDtl2") = "ok" then
    If ISNull(oJSONoutput.Anth_TeamDtl2) Or oJSONoutput.Anth_TeamDtl2 = "" Then
      Anth_TeamDtl2 = ""
      DEC_Anth_TeamDtl2 = ""
    Else
      Anth_TeamDtl2 = fInject(oJSONoutput.Anth_TeamDtl2)
      DEC_Anth_TeamDtl2 = fInject(crypt.DecryptStringENC(oJSONoutput.Anth_TeamDtl2))    
    End If
  Else  
    Anth_TeamDtl2 = ""
    DEC_Anth_TeamDtl2 = ""
...
If hasown(oJSONoutput, "Anth_ResultType") = "ok" then
    If ISNull(oJSONoutput.Anth_ResultType) Or oJSONoutput.Anth_ResultType = "" Then
      Anth_ResultType = ""
      DEC_Anth_ResultType = ""
    Else
      Anth_ResultType = fInject(oJSONoutput.Anth_ResultType)
      DEC_Anth_ResultType = fInject(crypt.DecryptStringENC(oJSONoutput.Anth_ResultType))    
    End If
  Else  
    Anth_ResultType = ""
    DEC_Anth_ResultType = ""
...
If hasown(oJSONoutput, "Anth_ResultTypeDtl") = "ok" then
    If ISNull(oJSONoutput.Anth_ResultTypeDtl) Or oJSONoutput.Anth_ResultTypeDtl = "" Then
      Anth_ResultTypeDtl = ""
      DEC_Anth_ResultTypeDtl = ""
    Else
      Anth_ResultTypeDtl = fInject(oJSONoutput.Anth_ResultTypeDtl)
      DEC_Anth_ResultTypeDtl = fInject(crypt.DecryptStringENC(oJSONoutput.Anth_ResultTypeDtl))    
    End If
  Else  
    Anth_ResultTypeDtl = ""
    DEC_Anth_ResultTypeDtl = ""
...
'좌팀 승
If Anth_Team1 = "" OR ISNULL(Anth_Team1) Then
    ...
    CSQL = CSQL & " Round, Result, Jumsu, TotalPoint, ResultDtl"
    CSQL = CSQL & " )"
    CSQL = CSQL & " VALUES"
    CSQL = CSQL & " ("
    CSQL = CSQL & " '" & DEC_GameLevelDtlIDX & "', '" & GameTitleIDX & "', '" & TeamGb & "', '" & Sex & "', '" & GroupGameGb & "',"
    CSQL = CSQL & " '" & DEC_TeamGameNum & "', '" & DEC_GameNum & "','" & LTeam & "','" & LTeamDtl & "',"
    CSQL = CSQL & " '" & DEC_GameRound & "', KoreaBadminton.dbo.FN_ResultReturn('WIN', '" & DEC_Anth_ResultType & "'), '" & TotalWin_L & "','" & TotalPoint_L & "', '" & DEC_Anth_ResultTypeDtl & "'"
    CSQL = CSQL & " )"
...
Else
    ...
    CSQL = CSQL & " '" & DEC_GameLevelDtlIDX & "', '" & GameTitleIDX & "', '" & TeamGb & "', '" & Sex & "', '" & GroupGameGb & "',"
    CSQL = CSQL & " '" & DEC_TeamGameNum & "', '" & DEC_GameNum & "','" & LTeam & "','" & LTeamDtl & "',"
    CSQL = CSQL & " '" & DEC_GameRound & "', KoreaBadminton.dbo.FN_ResultReturn('LOSE', '" & DEC_Anth_ResultType & "'), '" & TotalWin_L & "','" & TotalPoint_L & "', '" & DEC_Anth_ResultTypeDtl & "'"
    CSQL = CSQL & " )"    
...
'우팀 승
If Anth_Team2 = "" OR ISNULL(Anth_Team2) Then
    ...
    CSQL = CSQL & " '" & DEC_GameRound & "', KoreaBadminton.dbo.FN_ResultReturn('WIN', '" & DEC_Anth_ResultType & "'), '" & TotalWin_R & "','" & TotalPoint_R & "', '" & DEC_Anth_ResultTypeDtl & "'"
    CSQL = CSQL & " )"
...
Else
    ...
    CSQL = CSQL & " '" & DEC_GameLevelDtlIDX & "', '" & GameTitleIDX & "', '" & TeamGb & "', '" & Sex & "', '" & GroupGameGb & "',"
    CSQL = CSQL & " '" & DEC_TeamGameNum & "', '" & DEC_GameNum & "','" & RTeam & "','" & RTeamDtl & "',"
    CSQL = CSQL & " '" & DEC_GameRound & "', KoreaBadminton.dbo.FN_ResultReturn('LOSE', '" & DEC_Anth_ResultType & "'), '" & TotalWin_R & "','" & TotalPoint_R & "', '" & DEC_Anth_ResultTypeDtl & "'"
    CSQL = CSQL & " )"
