...
<%
  ...
  reqLevelJooName = fInject(oJSONoutput.tLevelJooName)
...
%>
		<table cellspacing="0" cellpadding="0">
         ...
         <th>점수</th>
			...
			<%
  iType = 2
  LSQL = "EXEC tblGameTotalRanking_Searched_STR '" & reqGameTitleIdx  & "', '" & reqRanking &  "', '" & reqLevelJooName &  "','" & iType  & "'"
  ...
  If Not (LRs.Eof Or LRs.Bof) Then		
    Do Until LRs.Eof		
      arrnum = arrnum  + 1
      rLevelJooName = LRs("LevelJooName") 
      rLevelJooNameNm= LRs("LevelJooNameNm") 
      rTeam= LRs("Team")
      rTeamNm= LRs("TeamNm")
