...
%>
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0">
    ...
    <tbody>
      ...
      <tr class="row3">
        <td class="column0">&nbsp;</td>
        <td class="column1 style20 s" style="font-size: 11pt;font-family: '맑은 고딕'; height: 34px;">Event:<%=game.TeamGbNM%>&nbsp;<%=game.LevelName%></td>
        ...
        <td class="column11 style21 s style23" colspan="7" style="font-size: 14pt;font-family: '맑은 고딕';font-weight: bold; border-top: 2px solid #000; border-right: 2px solid #000; border-bottom: 1px solid #000;">&nbsp;&nbsp;<%=game.LPlayer1%></td>
        <td class="column18">&nbsp;</td>
        <td class="column19 style67 s style69" colspan="4" style="border-top: 2px solid #000;border-left: 2px solid #000;border-right: 2px solid #000;border-bottom: 1px solid #000;font-size: 12pt;font-weight: bold; mso-number-format:'@'; text-align: center;"><%=tpoint1.SetPoint1%> : <%=tpoint2.SetPoint1%></td>
        <td class="column23">&nbsp;</td>
        <td class="column24 style28 s style30" colspan="7" style="font-size: 14pt;font-family: '맑은 고딕';font-weight: bold; border-left: 2px solid #000; border-top: 2px solid #000; mso-number-format:'@'; background-color: #ddd;">&nbsp;&nbsp;<%=game.RPlayer1%></td>
      ...
      <tr class="row4">
        ...
        <td class="column23">&nbsp;</td>
        <td class="column24 style31 null style33" colspan="7" style="font-size: 14pt;font-family: '맑은 고딕'; font-weight: bold; background-color: #ddd; border-left: 2px solid #000; border-right: 2px solid #000; border-top: 1px solid #000;">&nbsp;&nbsp;<%=game.RPlayer2%></td>
        <td class="column31">&nbsp;</td>
        <td class="column32">&nbsp;</td>
...
<%'###################################################################%>	
        ...
        'Response.Write "setdata : " &  setdata & "<br/>"
			...
			%>
					<tr class="row13">
            <td class="column0">&nbsp;</td>
            <td class="column1 style55 s style57" colspan="5" style="font-size:12pt; font-family: '맑은고딕'; font-weight: bold; border-left:2px solid #000; border-top:2px solid #000; border-right:1px solid #666; border-bottom:1px solid #000;">&nbsp;<%=game.LPlayer1%></td>
					  <%
              left1 = Split(marr(0), ",")
              ...
              For i = 0 To 35
                ...
                Else
                  If i + 35 <= ubound(left1)  then
                    ...
                    rstdtlidxval_1 = rstdtlidx_1(i+35)
                  End if					  
                End if
            ...
            <%If i = 0 then%>
              <td class="column style" style="font-size: 12pt;text-align: center;width: 37px;height: 29px;border-top:2px solid #000; border-right:2px solid #000; border-bottom:1px solid #000;"><%=left1val%></td>
            <%ELSE%>
              <td class="column style" style="font-size: 12pt;text-align: center;width: 37px;height: 29px;border-top:2px solid #000; border-right:1px solid #000; border-bottom:1px solid #000;"><%=left1val%></td>
            <%End If%>
          ...
          <tr class="row14">
            ...
            <td class="column1 style25 null style58" colspan="5" style="font-size: 12pt;font-weight: bold; border-left:2px solid #000; border-right:1px solid #000; border-bottom:2px solid #000; height: 29px;text-align: left;">&nbsp;<%=game.LPlayer2%></td>
					  <%
					 left2 = Split(marr(1), ",")
					 rstdtlidx_2 = Split(marr(4), ",")
					  ...
					  Else
						  If i + 35 <= ubound(left2)  then
							  ...
							  rstdtlidxval_2 = rstdtlidx_2(i+35)
						  End if					  
					  End if
            ...
            <%If i = 0 then%>
              <td class="column style" style="font-size: 12pt;text-align: center;width: 37px;height: 29px;border-top:2px solid #000; border-right:2px solid #000; border-bottom:1px solid #000;"><%=left2val%></td>
            <%ELSE%>
              <td class="column style" style="font-size: 12pt;text-align: center;width: 37px;height: 29px;border-top:2px solid #000; border-right:1px solid #000; border-bottom:1px solid #000;"><%=left2val%></td>
            <%End If%>
            ...
            <td class="column43">&nbsp;</td>
					...
					<tr class="row15">
					  <td class="column0">&nbsp;</td>
            <td class="column1 style59 s style61" colspan="5" style="background-color: #ddd;font-size:12pt; font-family: '맑은고딕'; font-weight: bold; border-left:2px solid #000; border-right:1px solid #000;  border-bottom:1px solid #000;">&nbsp;<%=game.RPlayer1%></td>
					 <%
					 right1 = Split(marr(2), ",")
					 rstdtlidx_3 = Split(marr(4), ",")
					  ...
					  Else
						  If i + 35 <= ubound(right1)  then
							  ...
							  rstdtlidxval_3 = rstdtlidx_3(i+35)
						  End if					  
					  End if
            ...
            <%If i = 0 then%>
              <td class="column style" style="font-size: 12pt;text-align: center;width: 37px;height: 29px;border-top:2px solid #000; border-right:2px solid #000; border-bottom:1px solid #000;"><%=right1val%></td>
            <%ELSE%>
              <td class="column style" style="font-size: 12pt;text-align: center;width: 37px;height: 29px;border-top:2px solid #000; border-right:1px solid #000; border-bottom:1px solid #000;"><%=right1val%></td>
            <%End If%>
          ...
          <tr class="row16">
					  <td class="column0">&nbsp;</td>
            <td class="column1 style62 null style64" colspan="5" style="background-color: #ddd;text-align: left;height: 29px;font-size: 12pt;font-weight: bold; border-left:2px solid #000; border-right:1px solid #000; border-bottom:2px solid #000;">&nbsp;<%=game.RPlayer2%></td>
					 <%
					 right2 = Split(marr(3), ",")
					 rstdtlidx_4 = Split(marr(4), ",")
					  ...
					  Else
						  If i + 35 <= ubound(right2)  then
							  ...
							  rstdtlidxval_4 = rstdtlidx_4(i+35)
						  End if	
					  End if
						Call snedobj.Set( "TourneyGroupIDX",  game.RTourneyGroupIDX )
            ...
            <%If i = 0 then%>
              <td class="column style" style="font-size: 12pt;text-align: center;width: 37px;height: 29px;border-top:2px solid #000; border-right:2px solid #000; border-bottom:1px solid #000;"><%=right2val%></td>
            <%ELSE%>
              <td class="column style" style="font-size: 12pt;text-align: center;width: 37px;height: 29px;border-top:2px solid #000; border-right:1px solid #000; border-bottom:1px solid #000;"><%=right2val%></td>
            <%End If%>
