...
function applyGameNumber() {
  ...
  for(var i = 1 ; i <= totalTourneyCnt ; i ++) {
    ...
    GroupGameGb = $("#GroupGameGb" + i).val();
    GameOrder= $("#txtGameOrder" + i).val();
    TourneyIDX =  $("#GameTourneyIDX" + i).val();
    tourneyString = tourneyString +  GameNumTourneyDtlIDX + "^" + GameNumTourney + "^" + TurnNum + "^" + GameDay + "^" + StadiumNum + "^" + GroupGameGb + "^" + TourneyIDX + "^" + GameOrder + "%"
  }
