   ...
   '=================================================================================
	...
	Function getSqlModPoint(eval_table_idx, association_idx, eval_member_idx, eval_points, item_idxs)
      ...
      strSql = strSql & " Declare @group_cd int          "
         ...
         strSql = strSql & " Update tblEvalValue Set ModDate = GetDate(), Point = I.point*100, PointCalc = Case When EvalTypeCD = 1 Then Round(StandardPoint * (Cast(I.Point As Float) / 5), 2) * 100 Else I.Point* 100 End "
