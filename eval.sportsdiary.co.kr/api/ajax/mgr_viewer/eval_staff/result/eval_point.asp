...
<%
' http://eval_test.sportsdiary.co.kr/api/ajax/mgr_viewer/eval_staff/result/eval_point.asp
%>
...
<%
   ...
   '=================================================================================
	'  평가 지표 결과 - 협회별 평가 점수
	'=================================================================================  
	Function getSqlAssociationPoint(eval_table_idx, association_idx, eval_member_idx)
		Dim strSql, err_no
...
DBOpen()
   ...
   eval_member_idx		   = InjectionChk(JsonObj.get("eval_member_idx"))
	...
	If( err_no <> 1 ) Then 	
		'  ----------------------------------------------------
      '  평가 지표 결과 - 협회별 평가 점수
      strSql = getSqlAssociationPoint(eval_table_idx, association_idx, eval_member_idx)
