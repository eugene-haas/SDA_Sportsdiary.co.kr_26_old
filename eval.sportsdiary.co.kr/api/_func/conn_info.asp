<%
   ...
   '=================================================================================
	'  Connection info 
	'================================================================================= 
   DB_CONN  = "Provider=SQLOLEDB.1;Persist Security Info=True;User ID=eval_rk3%rh4wl*ak;Password=eval_rr$A8%^kv94~*kn7Yh&YB;Initial Catalog=KS_Evaluation;Data Source=49.247.9.88\SQLExpress,1433;"
