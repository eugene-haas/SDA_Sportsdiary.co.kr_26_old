...
<%
'개나리 신인부 업데이트 위치 파악을 위해 tidx 업데이트 
'Response.end
...
Function getPlayerPoint(idx, levelno)
Dim SQL ,rs
...
Response.write  getPlayerPoint(idx, levelno)
...
'Response.write CDbl(rno)

Response.end



SQL = "insert into sd_test (str1,str2) values ('11111111111','2222222222222')"
Call db.execSQLRs(SQL , null, ConStr)


SQL = "insert into sd_test (str1,str2) values ('11111111111','2222222222222','dddd')"
Call db.execSQLRs(SQL , null, ConStr)
'Set rs = db.ExecSQLReturnRS(SQL , null, ConStr)
...
'UserName,UserPhone,openrnkboo,GameTitleName,a.titlecode,dblrnk,chkTIDX
'tableB = "tblPlayer_20180802115032"
'tableB = "tblPlayer"
'strwhere = " gametitleidx > 0 and GameTitleIDX not in( 55, 40) and playeridx <> 6741 and b.DelYN = 'N' and GameYear = '2018' "
'SQL = "select PlayerIDX,GameTitleIDX,chkTIDX from "&tableB&" as a inner join sd_TennisTitle as b on a.titlecode = b.titleCode  where " & strwhere
'Set rs = db.ExecSQLReturnRS(SQL , null, ConStr)
''Call rsdrow(rs)
'
'
'SQL = "select PlayerIDX,GameTitleIDX from "&tableB&" as a inner join sd_TennisTitle as b on a.titlecode = b.titleCode where " & strwhere
'Set rs = db.ExecSQLReturnRS(SQL , null, ConStr)
'
'
'
...
'		pidx = arrRS(0, ar)
'		tidx = arrRS(1, ar)
'		SQL = "update "&tableB&" Set chkTIDX = " & tidx & " where PlayerIDX = " & pidx
