...
'testp = getPlayerPoint("5745","20103003")
'testp = getPlayerPoint("5735","20103003")

'Response.write testp & "<br>"
'Response.write 213 + 482
...
strwhere = " a.GameTitleIDX = 135 and  a.gamekey3 = 20103003 and a.gubun in ( 0, 1) and a.DelYN = 'N' and a.playerIDX > 1 and a.gameMemberIDX > 528660" 
...
Response.write p1point & "<br>"
Response.write p2point & "<br>"
