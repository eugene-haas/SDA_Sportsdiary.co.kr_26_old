<%
	...
	%><input type="hidden" id="e_sortno" value="<%=e_sno%>"><%
	%><input type="hidden" id="e_noidx" value="<%=e_noidx%>"><%
%>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<div class="input-group">
					<input type="number" id="mk_g0" placeholder="순서번호" value="<%=e_gno%>" class="form-control form-control-half" onclick="if (this.value==''){alert('리스트를 먼저 선택해주세요.');}" readonly>
