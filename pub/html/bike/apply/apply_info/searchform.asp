...
<form method="post"  name="sform" action="apply_info.asp">
<input type="hidden" name="p">
    ...
    <ul>
        ...
        <li>
            ...
            <a href="javascript:mx.searchPlayer(<%=page%>, '../findplayerExcel.asp', 'download')" class="navy-btn" >엑셀다운로드</a>
            <a href="javascript:mx.searchPlayer(<%=page%>, '../findplayerExcel.asp', 'rsdrow')" class="navy-btn">리스트화면에 출력</a>
        </li>
