...
<form method="post"  name="sform" action="findcontestplayer_dev.asp">
    ...
    <ul>
        ...
        <li>
            <span class="r-con">
                ...
                <a href="javascript:mx.searchPlayer(<%=page%>);" class="navy-btn">검색</a>
                <%End if%>
            </span>
        </li>
        ...
        <li>
            ...
            <a class="navy-btn" onclick="mx.searchPlayer(<%=page%>, 'findplayerExcel.asp', 'levelList')" style="height:36px;">엑셀다운로드</a>
            <a class="navy-btn" onclick="mx.searchPlayer(<%=page%>, 'findplayerExcel_dev.asp', 'levelList')" style="height:36px;">리스트화면에 출력</a>
        </li>
