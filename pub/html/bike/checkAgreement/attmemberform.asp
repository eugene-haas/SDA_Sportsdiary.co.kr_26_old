                ...
                <ul>
                    <li>
                        <select id="gidx"  class="" onchange="mx.searchPlayer(<%=page%>,'check_Agreement.asp');">
                    ...
                    <li>
                        <select id="fnd_Type" class="" onchange="mx.searchPlayer(<%=page%>,'check_Agreement.asp');">
                    ...
                    <li>
                        ...
                        <select  id="tidx" onchange="mx.searchPlayer(<%=page%>,'check_Agreement.asp');" class="">
                        ...
                        <li>
                            <select id="ridx"  class="" onchange="mx.searchPlayer(<%=page%>,'check_Agreement.asp');">
