						...
						<div class="row">
							<div class="col-md-6" style="width:100%;">
								  <div class="form-group">
									<select id="mk_g0" class="form-control"  onchange="px.goSubmit({'IDX':$('#mk_g0').val()},'gamedraw2.asp')">
									<%
											If IsArray(fr) Then 
					...
					<label>&nbsp;</label>
						<div class="row">
							<div class="col-md-6" style="width:47%;padding-left:10px;padding-right:0px;">
								  <div class="form-group">
										<!-- <input type="text" id="gamedate" placeholder="대회날짜"  class="form-control" value="<%=gamedate%>"> 입력만하는거니 날짜없음-->
								  </div>
							</div>
							<div class="col-md-6" style="width:47%;padding-left:10px;padding-right:0px;">
								  <div class="form-group">
										<!-- <a href="javascript:mx.setGameDate( $('#gamedate').val(), '<%=tidx%>','S');" class="btn btn-primary">대회날짜 등록</a> -->
								  </div>
							</div>
						</div>
