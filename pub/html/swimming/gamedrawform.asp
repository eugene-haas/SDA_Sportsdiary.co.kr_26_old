						...
						<div class="row">
							<div class="col-md-6" style="width:100%;">
								  <div class="form-group" style="text-align:right;">
									...
									<br><br>
									회사내부용 : <a href="#" class="btn  btn-<%If startstr = "예선경기" then%>warning<%else%>default<%End if%> btn-flat"  id="gnx" onclick="mx.setStart(<%=tidx%>,'<%=find_gbidx%>','<%=find_cdc%>','1');" style="margin-right:-10px;">예선시작</a>
									<a href="#" class="btn btn-<%If startstr = "결승경기" then%>warning<%else%>default<%End if%> btn-flat" id="gnx" onclick="mx.setStart(<%=tidx%>,'<%=find_gbidx%>','<%=find_cdc%>','3');" >결승시작</a>&nbsp;&nbsp;
									<%End if%>
