<%
	...
	Else
		...
		'개인단체로 넘어오는것에 따라서
		SQL = "Select  teamgb,teamgbnm,pteamgb  from tblTeamGbInfo where DelYN = 'N' AND cd_type = 1 and  pteamgb = 'D2'  and  teamgb not in ('31','32','33','34','35','41','42')    and cd_mcnt = 'T'  order by orderby asc"
	...
	SQL = " select cd_boo,cd_booNM from tblteamgbinfo where cd_type = 2 and delYN = 'N'  and sexno = '"&e_Sexno&"' and cd_mcnt = 'T'  "
  ...
  SQL = SQL & " where CDA = '"&F1&"' and  gametitleidx = "&reqtidx&" and a.delyn = 'N'  and a.itgubun = 'T'  and cd_mcnt = 'T'  group by cdb,cdbnm order by orderby"
