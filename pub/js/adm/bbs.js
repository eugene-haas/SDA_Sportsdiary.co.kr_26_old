...
mx.ajaxurl = "/pub/ajax/adm/reqBoard.asp";
mx.ajaxtype = "POST";
mx.dataType = "text";
...
mx.ReceivePacket = function( reqcmd, data, sender ){
  ...
  if( jsondata !='' && jsondata != null){
	...
	mx.input_edit = function(num,idx,tid,pn){
		$( "#contest tr").css( "background-color", "white" );
		$( "#titlelist_" + num ).css( "background-color", "#BFBFBF" );
