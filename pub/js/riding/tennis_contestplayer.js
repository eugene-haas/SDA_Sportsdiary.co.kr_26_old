...
mx.ReceivePacket = function( reqcmd, data, sender ){// data는 response string
	...
	case mx.CMD_RACESTATE: return; break;
...
mx.auto_frm = function(tidx,gbidx,pcode,pnm){
	var obj = {};
...
mx.raceCheck = function(idx){
	var obj ={};
	obj.IDX = idx;
   if ( $("#race_"+idx).is(":checked") == true ) {
	   obj.CHK = 'Y';
   }
   else{
		obj.CHK = 'N';
   }
	obj.CMD = mx.CMD_RACESTATE;
	mx.SendPacket('race_'+idx, obj);
};
/////////////////////////////////////////////////
