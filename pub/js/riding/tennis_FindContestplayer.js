...
mx.RankingPoint = function(idx, name,tidx,levelno,title, ptype){
	mx.ajaxurl = "/pub/ajax/" +location.hostname.split(".")[0].toLowerCase().replace('admin','') + "/reqTennisMakePlayer.asp";
	var obj = {};
...
mx.updateMember = function (idx,tidx,levelno){
  mx.ajaxurl = "/pub/ajax/" +location.hostname.split(".")[0].toLowerCase().replace('admin','') + "/reqTennisContestlevel.asp";
  mx.tidx = tidx;
  mx.levelno = levelno;
  var obj ={};
  obj.IDX = idx;
...
mx.sendAcctMsg = function (idx,tidx,levelno){
  mx.ajaxurl = "/pub/ajax/" +location.hostname.split(".")[0].toLowerCase().replace('admin','') + "/reqTennisAcct.asp";
  mx.tidx = tidx;
  mx.levelno = levelno;
  var obj ={};
  obj.IDX = idx;
