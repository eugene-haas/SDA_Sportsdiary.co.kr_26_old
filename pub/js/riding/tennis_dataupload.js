...
mx.SendPacket = function( sender, packet){
  ...
  var url = "/pub/ajax/" +location.hostname.split(".")[0].toLowerCase().replace('admin','') + "/reqTennisDataUpload.asp";
...
mx.OnAppendHTML =  function(cmd, packet, html, sender){
  ...
  if (Number(mx.LASTRS) === Number(packet.NKEY)) { return;}
