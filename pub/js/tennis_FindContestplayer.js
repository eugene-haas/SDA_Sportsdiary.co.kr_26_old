...
////////////////////////////////////////
	...
	mx.CMD_SETBANKNO = 444; //가상계좌 안들어갔을때 발급
////////////////////////////////////////
...
mx.ReceivePacket = function( reqcmd, data, sender ){// data는 response string
	...
	case mx.CMD_SETBANKNO : 	alert('계좌가 발급되었습니다.');location.reload();		break;
...
mx.setBankNo = function(ridx,tidx,levelno){
  if (!confirm("가상계좌를 발급하시겠습니까?")) {
	return;
  }
	var obj = {};
	obj.CMD = mx.CMD_SETBANKNO;
	obj.RIDX = ridx;
	obj.TIDX = tidx;
	obj.LNO= levelno;
...
mx.updateMember = function (idx,tidx,levelno){
  mx.ajaxurl = "/pub/ajax/reqTennisContestlevel.asp";
  mx.tidx = tidx;
  mx.levelno = levelno;
  var obj ={};
  obj.IDX = idx;
