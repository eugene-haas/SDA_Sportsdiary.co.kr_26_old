...
mx.ajaxurl = "/pub/ajax/swim/reqTennisContestPlayer.asp";
    ...
    $( "#p1name" ).autocomplete({
		source : function( request, response ) {
			...
			$.ajax(
				{
						type: 'post',
						url: "/pub/ajax/swim/reqTennisContestPlayerFind.asp",
						dataType: "json",
...
mx.RankingPoint = function(idx, name,tidx,levelno,title, ptype){
	mx.ajaxurl = "/pub/ajax/swim/reqTennisMakePlayer.asp";
	var obj = {};
...
mx.updateMember = function (idx,tidx,levelno){
  mx.ajaxurl = "/pub/ajax/swim/reqTennisContestlevel.asp";
  mx.tidx = tidx;
  mx.levelno = levelno;
  var obj ={};
  obj.IDX = idx;
...
mx.sendAcctMsg = function (idx,tidx,levelno){
  mx.ajaxurl = "/pub/ajax/swim/reqTennisAcct.asp";
  mx.tidx = tidx;
  mx.levelno = levelno;
  var obj ={};
  obj.IDX = idx;
