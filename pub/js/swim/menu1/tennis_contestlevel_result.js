...
sd.ajaxurl = "/pub/ajax/swim/admenu1/REQLevelResult.asp";
...
sd.contestResultTest = function(idx, levelno ,teamnm, areanm){
  if (confirm("대회결과가 바로 처리됩니다. 처리하시겠습니까?")) {
	sd.ajaxurl = "/pub/ajax/swim/admenu1/REQLevelResultTest.asp";
	var obj ={};
	obj.CMD = sd.CMD_PROCESSRESULT;
	obj.IDX = idx;
	obj.TIDX = mx.gameinfo.IDX;
...
sd.setRanker = function(packet){//
	sd.ajaxurl = "/pub/ajax/swim/reqTennisMakePlayer.asp";
