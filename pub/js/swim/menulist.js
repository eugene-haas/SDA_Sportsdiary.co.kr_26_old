...
mn.ajaxurl = "/pub/ajax/swim/reqMenu.asp";
mn.ajaxtype = "POST";
mn.dataType = "text";
...
if($('#'+sender).hasClass('btn-warning')){
	...
	$('#'+sender)[0].className = 'btn btn-block btn-primary';
	$('#'+sender).html('Y');

}
else{

	$('#'+sender)[0].className = 'btn btn-block btn-warning';
	$('#'+sender).html('N');

}

// var btncolor = $('#'+sender).css('background-color');
// 	if(btncolor == "rgb(255, 127, 39)"){
// 		$('#'+sender).css('background-color','');
// 		$('#'+sender).html('N');
// 	}
// 	else{
// 		$('#'+sender).css('background-color','rgb(255, 127, 39)');
// 		$('#'+sender).html('Y');
// 	}
// console.log(classnm);
