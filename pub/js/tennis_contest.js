...
////////////////////////////////////////
	...
	mx.CMD_USERTURNSHOW = 50001;//사용자화면 본선대진 보임 처리
////////////////////////////////////////
...
mx.ReceivePacket = function( reqcmd, data, sender ){// data는 response string
	...
	case mx.CMD_USERTURNSHOW : location.reload(); return; break;
...
mx.turnShow = function(tidx){
	var obj = {};
	obj.CMD = mx.CMD_USERTURNSHOW;
	obj.TIDX = tidx;
...
mx.setRnkInfo = function(titlecode,tidx,teamgb,gameyear,yn){
	var obj = {};
