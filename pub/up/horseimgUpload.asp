...
<%
	...
	global_filepath = "E:\www\upload\sportsdiary\"&sitecode&"\himg\"
	global_filepath_DB = "/"& sitecode &"/himg/"
	...
	pidx = Upload.Form("hpidx")
	imgno = Upload.Form("imgno")
	Set File = Upload.Form("ufile") '여러개 파일폼중에 선택할수 있는 방법으로 만들어서
...
'Response.end
	...
	filename = pidx & "_" & imgno & "." & Split(orgfilenm , "." )(1)
	...
	'디비 업데이트 
	SQL = "Update tblPlayer Set  ProFileIMG" & imgno & " = '" & dbsavefilename & "' where playeridx = " & pidx
