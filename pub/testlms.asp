...
<form id='form2' action='http://biz.moashot.com/EXT/URLASP/mssendutf.asp' method='post'>
	...
	<input type='hidden' name='redirectUrl' id='redirectUrl' value='http://tennis.sportsdiary.co.kr/tennis/tnrequest/write.asp' /><!--전송(접수)후 페이지 이동경로http:// 또는 https:// 를 포함한 풀경로를 입력합니다.-->
</form>
