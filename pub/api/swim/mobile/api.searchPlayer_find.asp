<%
	...
	strSql = "SELECT " & top & " UserName,PlayerIDX,isnull(UserPhone,'')UserPhone,Birthday,Sex,isnull(Team,'')Team,isnull(TeamNm,'')TeamNm,userLevel  from tblPlayer where DelYN = 'N' and UserName like '" & uname & "%' " 
