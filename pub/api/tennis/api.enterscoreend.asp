...
'Response.end
	...
	Case "left"
		...
		'SQL = "UPDATE sd_TennisResult Set  stateno = 1,winIDX="&player1&",winResult='"&winner&"',m1set1="&leftscore&" , m2set1 = "&rightscore&" , m1set = m1set + 1 " & SQLPLUS
		...
		'SQL = "UPDATE sd_TennisResult Set  stateno = 1,winIDX="&player1&",winResult='"&winner&"',m1set = m1set + 1 " & SQLPLUS
