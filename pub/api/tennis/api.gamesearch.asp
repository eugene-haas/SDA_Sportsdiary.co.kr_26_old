<%
  ...
  Set db = new clsDBHelper
	...
	SQL = "select stateNo,tnshowhide from sd_TennisTitle where GameTitleIDX = " & gameidx
	Set rs = db.ExecSQLReturnRS(SQL , null, ConStr)

	'게임상태 0표시전,  3 예선발표 , 4 예선마감, 5 본선발표 , 6 본선마감 , 7 결과발표
	If Not eof then
		gamestate = rs("stateNo")
		tnshowhide = rs("tnshowhide")
	...
	Case "1", "11", "21" '본선 토너먼트#############################
		...
		If tnshowhide = "N" Then '대회 본선 보기 막음
			Call oJSONoutput.Set("result", "10101" )
...
End if
		...
		strtable = " sd_TennisMember "
		strtablesub =" sd_TennisMember_partner "
		strwhere = " a.GameTitleIDX = " & gameidx & " and  a.gamekey3 = '"&strs3& "' and gubun = 3 and a.DelYN='N' " 'gubun  0예선 1예선종료 2 본선대기 3 본선입력완료 4 본선종료 ...
