...
'Response.write sql
	...
	Case "1", "11", "21" '본선 토너먼트#############################
	  ...
	  if Round_s ="" then 
		...
		strtable = " sd_TennisMember "
		strtablesub =" sd_TennisMember_partner "
		strwhere = " a.GameTitleIDX = " & gameidx & " and  a.gamekey3 = " & strs3  & " and gubun = "&checkgubun&" and a.DelYN='N'" 'gubun  0예선 1예선종료 2 본선대기 3 본선입력완료 4 본선종료 ...
...
SQL1 = SQL
		...
		strwhere = " GameTitleIDX = " & gameidx & " and  gamekey3 = " & strs3  & " and gubun = "&checkgubun&" and Round > 1 and DelYN='N'" 'gubun  0예선 1예선종료 2 본선대기 3 본선대진표완료 4 본선종료 ...
...
SQL2 = SQL
		...
		'각결과 및 결과입력 상태값 
			...
			strwhere = " a.GameTitleIDX = " & gameidx & " and a.gamekey3 = " & strs3  & " and a.gubun = "&checkgubun&" and a.DelYN='N' and b.DelYN='N' " 'a.gubun 상태  0예선, 1 예선종료 gubun 2 본선 올라감 3 본선 대진표 설정완료
