...
'request
	...
	'부모동의에 보낼키값 구하기
	SQL = "Select b.attmidx from sd_bikeTitle as a INNER JOIN  v_bikeGame_attm as b ON a.titleIDX = b.titleIDX  where a.delYN = 'N' and a.titleIDX = "&tidx&" and  b.PlayerIDX = " & cbike_pidx & " and b.levelno = "&levelIDX  & " and b.gubun in (0,1) "
	...
	If attmidx <> "" Then
		'정보 업데이트 
		SQL = "update sd_bikeAttMember Set p_nm ='"&m_nm&"',p_phone='"&m_pn&"' , p_relation='"&p_relation&"' where attmidx = " & attmidx
