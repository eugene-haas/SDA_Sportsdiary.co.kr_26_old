...
'#############################################
	...
	Set db = new clsDBHelper 
		...
		strFieldName = " title,place,hostname,subjectnm,sdate,edate,attsdate,attedate" ',  syear,smonth
		...
		For i = 0 To oJSONoutput.PARR.length-1 '받아온 값 기준
			...
			Case 4
				...
				updatefield	= updatefield & ", "&upfieldarr(i)&" =  '"&reqArr.Get(i)&"'  , syear = "&syear&",smonth = "&smonth&" "
