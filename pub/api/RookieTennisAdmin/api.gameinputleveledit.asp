...
'#############################################
	...
	strFieldName = " RGameLevelIdx,a.Level,a.TeamGbNm,GameTime,attmembercnt,a.gametype,b.LevelNm,a.TeamGb,a.teamGbSort,a.GameDay,a.GameTime,a.startscore,a.EndRound,a.gametype,EntryCntGame,courtcnt,a.bigo,a.cfg,a.joocnt,fee,fund,LastRchk,gameprize "
	...
	If Not rs.eof Then
		...
		SQL = "select sex,PTeamGb,PTeamGbNm,TeamGb, TeamGbNm,EnterType from tblTeamGbInfo where  PTeamGb in ('200', '201') and DelYN = 'N' order by Orderby asc"
		Else
		SQL = "select sex,TeamGb,PTeamGbNm,TeamGb, TeamGbNm,EnterType from tblTeamGbInfo where  PTeamGb in ('202') and DelYN = 'N' order by Orderby asc"
		End if
		...
		SQL = "select Level,LevelNm,Orderby  from tblLevelINfo where TeamGb = '"&fstr2&"' and DelYN = 'N' order by Orderby asc"
		Set rs = db.ExecSQLReturnRS(SQL , null, ConStr)
