...
'#############################################
	...
	If hasown(oJSONoutput, "bigo") = "ok" Then '사은품
	...
	If rs.eof Then
		...
		insertfield = " SportsGb,GameTitleIDX,TeamGb,TeamGbNm,TeamGbSort,Level,GameType,GameDay,GameTime,startScore,EndRound,EntryCntGame,courtcnt,gameprize,cfg,JooCnt , fee,fund,LastRchk "
		insertvalue = " 'tennis',"&titleidx&",'"&teamgb&"','"&teamgbnm&"',"&sortno&",'"&levelgb&"','"&versusgb&"','"&gamedate&"','"&gametime&"',"&startsc&","&lastrnd&","&entrycnt&"," & courtcnt&",'"&gameprize&"', '"&cfg&"',"&joocnt& "," & fee & "," & fund & "," & LastRchk& "  "  
