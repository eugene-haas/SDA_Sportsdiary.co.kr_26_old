...
'#############################################
	...
	Set db = new clsDBHelper
		...
		insertfield = insertfield & " ,P1_PlayerIDX,P1_UserName,P1_UserLevel,P1_TeamNm,P1_TeamNm2,P1_UserPhone,P1_Birthday,P1_SEX,P1_rpoint ,P1_ID"
		insertfield = insertfield & " ,P2_PlayerIDX,P2_UserName,P2_UserLevel,P2_TeamNm,P2_TeamNm2,P2_UserPhone,P2_Birthday,P2_SEX,P2_rpoint ,P2_ID"
		insertvalue = " 'tennis',"&titleidx&",'"&levelno&"','A','null','운영자','01000000000','자동생성' "
		insertvalue = insertvalue & " , "&p1idx&",'"&p1name&"','"&p1grade&"','"&p1team1txt&"','"&p1team2txt&"','"&p1phone&"','"&p1_birth&"','"&p1sex&"',"&p1rpoint&" , '"&P1_userid&"'  "
		insertvalue = insertvalue & " , "&p2idx&",'"&p2name&"','"&p2grade&"','"&p2team1txt&"','"&p2team2txt&"','"&p2phone&"','"&p2_birth&"','"&p2sex&"',"&p2rpoint&" , '"&P2_userid&"'  "
...
%>
	<!-- #include virtual = "/pub/html/RookietennisAdmin/gameInfoPlayerList.asp" -->