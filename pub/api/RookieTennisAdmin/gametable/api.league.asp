...
''입금상태 정보가져오기
''#############################
SQL =  "SELECT a.PaymentType,a.P1_PlayerIDX,a.P2_PlayerIDX,p.VACCT_NO,a.requestIDX FROM tblGameRequest as a left join SD_RookieTennis.dbo.TB_RVAS_LIST as p ON '"&Left(sitecode,2)&"' + Cast(a.RequestIDX as varchar)=p.CUST_CD WHERE  a.DelYN = 'N' and a.GameTitleIDX = "&tidx&" and a.Level =" & levelno 
Set rs = db.ExecSQLReturnRS(SQL , null, ConStr)
