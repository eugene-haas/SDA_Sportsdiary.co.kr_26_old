...
'#############################
  strwhere = " a.GameTitleIDX = " & tidx & " and a.gamekey3 = " & levelno  & " and a.gubun >= 2  " 'a.gubun 상태  0예선, 1 예선종료 gubun 2 본선 올라감 3 본선 대진표 설정완료 b.stateno 경기종료
...
'#############################
  ...
  Sub tournInfo_ing(ByVal arrRS , ByVal rd , ByVal sortno, ByVal arrRT, ByVal rdstr , ByVal crs) ' 대진표배열 , 라운드 , 소트, 스코어입력배열, 코트배열
      ...
      <%
          If IsArray(arrT) Then
            ...
            For ar = LBound(arrT, 2) To UBound(arrT, 2)
              ...
              Call tournInfo_ing(arrT, mrd, msortno, arrRS, roundcnt,arrCT) ' 대진표배열 , 라운드 , 소트, 스코어입력배열, 코트배열
              End If
              End if
            Next
