...
'#############################################
	...
	strSql = "SELECT top 1  PlayerIDX,UserName, Sex,Birthday,userLevel,UserPhone,teamNm,team2Nm,Team,Team2,belongBoo,gamestartyymm"
...
Response.write "`##`"
%>
<!-- #include virtual = "/pub/html/RookietennisAdmin/PlayerFormP1.asp" -->