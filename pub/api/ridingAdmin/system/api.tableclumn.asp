	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
		  <div class="modal-header">
			<h4 class="modal-title" id="myModalLabel">(<%=NM%>)컬럼&nbsp;&nbsp;<a href="javascript:mx.copyField('<%=f_str%>')" class="orange-btn" style="pdding:3px;">컬럼복사</a></h4>
		  </div>
		  <div class="modal-body">

<input    id="tablefield"  value = "<%=f_str%>"  style="position:absolute;top:0;left:0;width:1px;height:1px;margin:0;padding:0;border:0;">
    					...
    					<table cellspacing="0" cellpadding="0">
    						...
    						<tr id="contest">
								...
								Do Until rs.eof 
									...
									Response.write "<td style=""width:50%;""><input type='text' value='" &  rs(2) & "'  onblur=""if(this.value !=''){mx.SendPacket(this,{'CMD':mx.CMD_COLUMNCMT,'NM':'"&NM&"','DN':'"&DN&"','CN':'"&rs(0)&"','CMT':this.value, 'MD':"&MD&"})}"" style=""width:100%;""></td>"

									If Not rsData.EOF Then
									%><td style="width:20%;word-break:break-all;"><%=rsData(i)%></td><% 
									End if
									Response.write "</tr>"
								i = i + 1
								rs.movenext
