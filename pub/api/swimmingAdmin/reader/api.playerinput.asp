...
'#############################################
	...
	Set db = new clsDBHelper 
		...
		insertfield = " ksportsno,ksportsnoS,UserName,userNameCn,userNameEn,Birthday,Sex,nation,sidoCode,sido,CDA,CDANM,CDB,CDBNM,TeamNm,userClass,Team "
		...
		SQL = "SET NOCOUNT ON INSERT INTO tblPlayer ( "&insertfield&" ) VALUES " 'confirm 확인여부
