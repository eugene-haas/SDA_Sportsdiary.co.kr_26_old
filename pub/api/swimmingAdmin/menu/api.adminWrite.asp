		...
		<div class="modal-body " id="Modaltestbody">
			<div id="w_form" class="container-fluid">
					...
					<div class="form-group">
						...
						<input type='text' id="ad_pwd" class="form-control" style="ime-mode:inactive;"  placeholder="패스워드"  value="<%If findpwd <> "" then%><%=findpwd%><%else%><%=a_rpwd%><%End if%>" autocomplete="new-password"><!-- 한글사용불가 -->
