<%
	...
	'#################################
		...
		insertfield = "UserID,UserPass,adminName,Authority,USEYN,WriteID,SiteCode,encKey,encPass,KIND_CODE "
		insertvalue = " '"&aid&"','"&apwd&"','"&aname&"','"&aclass&"','N', '"&Cookies_aID&"','"&sitecode&"','"&strKey&"','"&strEncrypt&"' ,'"&kindcode&"' "
