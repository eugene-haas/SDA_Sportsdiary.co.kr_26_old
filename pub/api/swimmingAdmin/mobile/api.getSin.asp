...
'		<option value="6">계영</option>
	...
	SQL = ";with rtbl as (select max(rcidx) as rcidx,cda,cdc,sex from tblRecord where delyn= 'N' and rctype = '"&rccode&"' and  CDCNM like '%"&boonm&"%'   group by cda,cdc,sex) "
	...
	'strWhere = " delyn= 'N' and rctype = '"&rccode&"' and  CDCNM like '%"&boonm&"%' "   
