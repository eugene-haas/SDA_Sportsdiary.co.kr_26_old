...
'#############################################
	...
	Set db = new clsDBHelper 
		...
		insertfield = " titleCode,titlename,gamearea,gameDate,UserName,TeamNm,userClass,gameResult,gameOrder,rctype,CDA,CDANM, gubun,Sex,  CDB,CDBNM,CDC,CDCNM ,kskey,Team, playerIDX, sido,sidoCode "
