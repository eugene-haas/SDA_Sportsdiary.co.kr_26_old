     <%If tabletype ="0" and CMD <>"20003" and CMD <>"20031" and CMD <>"20032" then%>
      <!-- S: color-guide -->
    ...
    <%End if%>
      ...
      <div class="preli">
       ...
       <%'app 
       If  CMD <>"20003" and CMD <>"20031" and CMD <>"20032" then%> 
        <!-- S: btn-list -->
        <ul class="btn-list">
          <li>
	...
	<%If gamestate <> "" Then  	'게임상태 0표시전, 3 예선대진표보임 , 4 예선마감상태, 5 본선대진표보임 , 6 본선마감사태 , 7 결과발표보임%>
      ...
      <div class="preli-table">
        ...
        <thead>
          ...
          <%If  CMD <>"20003" and  cmd <> CMD_GAMESEARCH_Home and CMD <>"20032" then%> 
           <th>경기입력</th>
          <% end if %>
          </tr>
        </thead>
