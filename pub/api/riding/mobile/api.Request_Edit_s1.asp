...
If Not rs.EOF Then
	...
	Do Until rs.eof
		...
		<ul>
            ...
            <li class="m_applicationForm__item">
				...
				<span class="m_applicationForm__inputWrap">
					...
					<input type="text" class="m_applicationForm__input" id="p1team2txt" name="p1team2txt" placeholder=":: 추가소속명을 입력하세요 ::" autocomplete="off" value="<%=rs("P1_TeamNm2") %>" disabled/>
		...
		<!-- s: 파트너정보 -->
		<h4 class="m_applicationForm__tit"> 파트너 정보 </h4>
		<ul class="applicationForm">
			<li class="m_applicationForm__item">
				<span class="m_applicationForm__label">이 름</span>
				<span class="m_applicationForm__inputWrap">
                    <input  type="hidden" name="p2idx" id="p2idx" value="<%=rs("P2_PlayerIDX") %>"/>
					<input type="text" class="m_applicationForm__input" id="p2name" name="p2name" autocomplete="off" placeholder=":: 이름을 입력하세요 ::"    value="<%=rs("P2_UserName") %>" disabled/>
				</span>
			</li>
			<li class="m_applicationForm__item">
				<span class="m_applicationForm__label">기본클럽</span>
				<span class="m_applicationForm__inputWrap">
					...
					<input type="text" class="m_applicationForm__input" id="p2team1txt" name="p2team1txt" placeholder=":: 대표소속명을 입력하세요 ::" autocomplete="off"  value="<%=rs("P2_TeamNm") %>" disabled/>
				</span>
			</li>
            <li class="m_applicationForm__item">
				<span class="m_applicationForm__label">기타클럽</span>
				<span class="m_applicationForm__inputWrap">
					...
					<input type="text" class="m_applicationForm__input" id="p2team2txt" name="p2team2txt"  placeholder=":: 추가소속명을 입력하세요 ::" autocomplete="off"  value="<%=rs("P2_TeamNm2") %>" disabled/>
