...
'#############################################
	...
	strSql = "SELECT top 1  GameTitleName,GameS,GameE, GameArea,EnterType,GameRcvDateS,GameRcvDateE,ViewYN,stateNo,ViewState,cfg,hostname,titlecode,titlegrade,gameprize,chkrange  "
