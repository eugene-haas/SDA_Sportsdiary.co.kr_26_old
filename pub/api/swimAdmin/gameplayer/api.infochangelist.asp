<%
	...
	'/////////////////////////////////////////////
		...
		<br><br><a href="javascript:mx.delOk(<%=seq%>,'info_<%=x%>')" class="btn btn-danger">삭제</a>
		<%
		Else
...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<div id="orderinfo" style="width:98%;margin:auto;height:500px;overflow:auto;">
			<%Call rsDrow_info(rs)%>
			</div>

			<nav>
			<%Call userPagingScript2 (intTotalPage, 10, pageno, "mx.reqInfoChange" )%>
			</nav>
