...
'$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
	...
	Sub updateTSortNo(ByVal arrRS, ByVal rank, ByVal rndno1, ByVal rndno2, ByVal joono, ByVal midx )
      Dim r_orderno , r_sortno, r_joono ,r_abc '순위번호 자리위치, 추첨번호
		...
		If IsArray(arrRND) Then '랜덤번호
			...
			For i = LBound(arrRND, 2) To UBound(arrRND, 2) 
				...
				If CDbl(r_orderno) = 0 Then '부전자리라면
					...
					selectSQL = "Select top 1 "&selectfield&"  from sd_TennisMember where gubun in (0,1) and GameTitleIDX = "&tidx&" and gamekey3= " & levelno
	...
	'빈자리 생성
		...
		For n = 0 To ubound(temsortnoarr)
			...
			Else
					...
					selectfield = "3, 1, GameTitleIDX,'--',gamekey1,gamekey2,gamekey3,TeamGb,key3name, 1, " & temsortnoarr(n)
		...
		'For i = 0 To ubound(temsortnoarr)
		'	Response.write temsortnoarr(i) & "<br>"
		'next
