...
'#############################################
	...
	Set db = new clsDBHelper 
		...
		insertfield = " GameTitleName,GameS,GameE, GameYear, GameArea,EnterType,GameRcvDateS,GameRcvDateE,ViewYN,stateNo,ViewState,cfg,hostname,MatchYN,titlecode,titlegrade,gameprize,chkrange "
		insertvalue = " '"&title&"','"&sdate&"','"&edate&"','"&gyear&"','"&area&"','"&entertype&"','"&rcvs&"','"&rcve&"','"&ViewYN&"','"&MatchYN&"','"&ViewState&"','"&cfg&"','"&hostname&"','"&viewMatchYN&"', "&titlecode&", "&titlegrade&", '" &gameprize& "', "&chkrange&" "
