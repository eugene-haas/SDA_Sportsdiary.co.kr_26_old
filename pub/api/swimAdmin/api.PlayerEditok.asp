...
'#############################################
	...
	'이름 수정빼자
	updatevalue = " UserPhone='"&phone&"',Birthday='"&birth&"',sex='"&sex&"',userLevel='"&grade&"',Team='"&team1&"',TeamNm='"&team1txt&"',Team2='"&team2&"',Team2Nm='"&team2txt&"' ,teamgb='"&bookey&"',belongBoo='" &boo& "' "
