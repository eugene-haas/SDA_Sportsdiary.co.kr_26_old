...
<div class="modal-dialog modal-xl">
	<div class="modal-content">
	  ...
	  <div class='modal-header game-ctr'>
	    ...
	    <h4 class="modal-title" id="myModalLabel">(<%=NM%>)컬럼&nbsp;&nbsp;

				<button class="btn btn-default" onclick="javascript:mx.copyField('<%=f_str%>')">컬럼복사</button>
	  ...
	  <div class="modal-body" id="Modaltestbody">
			...
			<input  type="text"  id="tablefield"  value="<%=f_str%>" style="position:absolute;top:0;left:0;width:1px;height:1px;margin:0;padding:0;border:0;">
			...
			<div class="table-box basic-table-box">
				...
				<table cellspacing="0" cellpadding="0" class="table">
					<thead>
						<tr>
							<!-- <th style="width:20%;">column</th><th style="width:10%;">type</th><th style="width:50%;">comment</th><th style="width:20%;">data</th> -->
							<th>column</th><th>type</th><th style="width:500px;">comment</th><th>data</th>
						</tr>
					</thead>
					<tbody>
						<tr id="contest">
						...
						Do Until rs.eof
							...
							Response.write "<td><input type='text' class='form-control' value='" &  rs(2) & "'  onblur=""if(this.value !=''){mx.SendPacket(this,{'CMD':mx.CMD_COLUMNCMT,'NM':'"&NM&"','DN':'"&DN&"','CN':'"&rs(0)&"','CMT':this.value, 'MD':"&MD&"})}""></td>"
	  ...
	  <div class="modal-footer">
			<button class="btn btn-primary" onclick='mx.SendPacket(this,{"CMD":mx.CMD_TABLELIST,"TN":"<%=NM%>","IDXFIELDNM":"<%=idxfieldNm%>"})'>목록보기</button>
