<%
	...
	'#################################
		...
		SQL = " Update tblAdminMember Set UserID = '"&aid&"',UserPass = '"&apwd&"' ,adminName = '"&aname&"',Authority = '"&aclass&"' ,ModID = '"&Cookies_aID&"' ,encKey='"&strKey&"',encPass='"&strEncrypt&"' , ModDate = getdate(),changeflag = 'Y' where AdminMemberIDX = " & seq
