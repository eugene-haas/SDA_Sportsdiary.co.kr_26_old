...
<!-- #include virtual = "/pub/api/sms/reqAjaxSmsRookies.asp" -->
<%
'#############################################
' 랭크 포인트 조회
'#############################################
...
SQL ="selecT GameTitleIDX,GameTitleName  from sd_TennisTitle  where DelYN='N'  and SportsGb ='tennis' and ISNULL(GameYear,'')='"&GameYears&"' "
Set rs = db.ExecSQLReturnRS(SQL , null, ConStr)
