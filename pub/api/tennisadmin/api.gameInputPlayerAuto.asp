...
'#############################################
	...
	strSql = "SELECT top 2 PlayerIDX,UserName,userLevel,TeamNm,Team2Nm,UserPhone,Birthday,Sex  from tblPlayer where SportsGb = 'tennis' and DelYN = 'N' " & subSql & " ORDER BY NEWID() "
...
'PlayerIDX,UserName,userLevel,UserPhone,Birthday,Sex,TeamNm,Team2Nm
		If IsArray(arrRS) Then
			...
			insertfield = " gubun, GameTitleIDX,PlayerIDX,userName,gamekey1,gamekey2,gamekey3,TeamGb,key3name,TeamANa,TeamBNa,rankpoint "
			insertvalue = " 0, "&titleidx&", "&p1idx&", '"&p1nm&"', '"&gamekey1&"',"&Left(levelno,3)&","&levelno&","&Left(levelno,5)&",'"&Split(teamgbnm,"(")(0)&"','"&p1t1&"','"&p1t2&"',"&p1rpoint&"   "
