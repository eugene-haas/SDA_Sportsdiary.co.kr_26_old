...
'#############################################
	...
	'Else
	'SQL = "select sex,PTeamGb,PTeamGbNm,TeamGb, TeamGbNm,EnterType from tblTeamGbInfo where SportsGb = 'tennis'  and PTeamGb in ('202') and DelYN = 'N' order by Orderby asc"
	'End if
