...
'#############################################
	...
	Set db = new clsDBHelper
		...
		'정보업데이트
		updatevalue = " P1_PlayerIDX = "&p1idx&",P1_UserName='"&p1name&"',P1_UserLevel='"&p1grade&"',P1_TeamNm='"&p1team1txt&"',P1_TeamNm2='"&p1team2txt&"',P1_UserPhone='"&p1phone&"',P1_Birthday='"&p1_birth&"',P1_SEX='"&p1sex&"' , P1_rpoint = "&p1rpoint&" "
		updatevalue = updatevalue & " ,P2_PlayerIDX = "&p2idx&",P2_UserName='"&p2name&"',P2_UserLevel='"&p2grade&"',P2_TeamNm='"&p2team2txt&"',P2_TeamNm2='"&p2team2txt&"',P2_UserPhone='"&p2phone&"',P2_Birthday='"&p2_birth&"',P2_SEX='"&p2sex&"' , P2_rpoint = "&p2rpoint&" "
