		    ...
		    <%'If CDbl(ADGRADE) <= 500 then%>
			  <div class="chk_state">
				<%
				  ...
				  SQL =  "SELECT top 1 a.PaymentType,p.VACCT_NO FROM tblGameRequest as a left join TB_RVAS_LIST as p ON a.RequestIDX=p.CUST_CD WHERE  a.P1_PlayerIDX ="&rPlayerIDX&" and a.P2_PlayerIDX ="&rPlayerIDXSUB&" and a.DelYN = 'N' and a.GameTitleIDX = "&tidx&" and a.Level =" & levelkey 				  
				  Set rs = db.ExecSQLReturnRS(SQL , null, ConStr)
