...
'#############################################
	...
	If rs.eof Then
		...
		insertfield = " SportsGb,PlayerGb,UserName,UserPhone,Birthday,Sex,Level,EnterType,Team,TeamNm,Team2,Team2Nm,userLevel,PersonCode,belongBoo "
		insertvalue = " 'tennis','te045001','"&name&"','"&phone&"','"&birth&"','"&sex&"','null','A','"&team1&"','"&team1txt&"','"&team2&"','"&team2txt&"','"&grade&"','"&pcode& "','"&boo&"' "
