...
'Response.write changelist & "<br>"
	...
	SQL = "update sd_tennisMember Set PlayerIDX = "&pidx&" where PlayerIDX in (" & w_pidx & ")"
	Call db.execSQLRs(SQL , null, ConStr)

	SQL = "update sd_tennisMember_partner Set PlayerIDX = "&pidx&" where PlayerIDX in (" & w_pidx & ")"
	Call db.execSQLRs(SQL , null, ConStr)
