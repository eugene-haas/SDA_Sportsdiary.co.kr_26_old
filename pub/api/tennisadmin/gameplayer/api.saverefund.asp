...
'#############################################
	...
	'환불계좌 정보 입력
	SQL = "Update TB_RVAS_LIST Set  recustnm = '"&uname&"' , rebanknm='"&ubank&"', refund = '"& inbankacc &"',tidx='"&tidx&"',levelno='"&levelno&"',refunddate=getdate() where CUST_CD = '" & ridx & "' and STAT_CD = '0' "
