...
'############################################
	...
	Case CMD_TOURN
		%><!-- #include virtual = "/pub/api/tennisadmin/gametable/api.Tourn_ing.asp" --><%
	Response.End

	Case CMD_TOURNEND
		%><!-- #include virtual = "/pub/api/tennisadmin/gametable/api.Tourn_ingend.asp" --><%
	Response.end


	Case CMD_TOURNWAITCOURT
		%><!-- #include virtual = "/pub/api/tennisadmin/gametable/api.tourn_waitcourt.asp" --><%
	Response.End
	Case CMD_TOURNCOURT
		%><!-- #include virtual = "/pub/api/tennisadmin/gametable/api.tourn_court.asp" --><%
	Response.End
	Case CMD_TOURNWIN
		%><!-- #include virtual = "/pub/api/tennisadmin/gametable/api.tourn_win.asp" --><%
	Response.End
	End Select
%>
