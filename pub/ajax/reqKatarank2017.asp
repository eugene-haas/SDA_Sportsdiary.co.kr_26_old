...
'############################################
	...
	Case CMD_SHEETSHOW
		%><!-- #include virtual = "/pub/api/tennisadmin/api.selectSheet.asp" --><%
	Response.end	

	Case CMD_SETGAME
		%>
		<%'<!-- #include virtual = "/pub/api/tennisadmin/api.setkata2017rank.asp" -->%>
		<%'<!-- #include virtual = "/pub/api/tennisadmin/api.setkata2017boo.asp" -->%>
		<!-- #include virtual = "/pub/api/tennisadmin/api.setkata2017team.asp" -->
		<%
	Response.end	
