...
'	REQ ="{""CMD"":30002,""IDX"":1}"
	...
	Case CMD_GAMEINPUT
		%><!-- #include virtual = "/pub/api/tennisadmin/gamehost/api.codeINPUT.asp" --><%
	Response.end	
	Case CMD_GAMEINPUTEDIT
		%><!-- #include virtual = "/pub/api/tennisadmin/gamehost/api.codeEdit.asp" --><%
	Response.end	
	Case CMD_GAMEINPUTEDITOK
		%><!-- #include virtual = "/pub/api/tennisadmin/gamehost/api.codeEditok.asp" --><%
	Response.end	
	Case CMD_GAMEINPUTDEL
		%><!-- #include virtual = "/pub/api/tennisadmin/gamehost/api.codeDel.asp" --><%
	Response.end	
	End select
%>