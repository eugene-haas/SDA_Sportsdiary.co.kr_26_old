...
'############################################
	If request("test") = "t" Then
		 REQ = "{""CMD"":40001,""MIDX"":1,""LEVELNO"":20101004,""TIDX"":123,""SNO"":416065}"
	...
	Case CMD_RESETRANK
		%><!-- #include virtual = "/pub/api/tennisadmin/gameresult/api.resetRank.asp" --><%
	Response.end	

	Case CMD_SETRANK '2019 3 2 예선랭킹반영 수정
		%><!-- #include virtual = "/pub/api/tennisadmin/gameresult/api.setRank_new.asp" --><%
	Response.end	
	...
	Case CMD_SETGAME
		%><!-- #include virtual = "/pub/api/tennisadmin/gameresult/api.setGame.asp" --><%
	Response.end	


	Case CMD_SETRANKER
		%><!-- #include virtual = "/pub/api/tennisadmin/gameresult/api.setGameRanker.asp" --><%
	Response.end	

	Case CMD_DELRANKER
		%><!-- #include virtual = "/pub/api/tennisadmin/gameresult/api.delGameRanker.asp" --><%
	Response.end	


	Case CMD_CHANGERANK
		%><!-- #include virtual = "/pub/api/tennisadmin/gameresult/api.changeRank.asp" --><%
	Response.end	

	Case CMD_CHANGEPOINT
		%><!-- #include virtual = "/pub/api/tennisadmin/gameresult/api.changePoint.asp" --><%
	Response.end	
