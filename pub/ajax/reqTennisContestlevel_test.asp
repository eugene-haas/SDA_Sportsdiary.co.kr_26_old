...
'############################################
	If request("test") = "t" Then
	    REQ = "{""CMD"":30008,""IDX"":567,""TitleIDX"":142,""Title"":""김정연테스트대회"",""TeamNM"":""개나리부"",""AreaNM"":""구리"",""ONEMORE"":""notok"",""roundSel"":"""",""RESET"":""notok""}"
	...
	Response.End
	Case CMD_TOURN
		%><!-- #include virtual = "/pub/api/tennisadmin/gametable/api.tourn새로올려서테스트할거.asp" --><%
	Response.End
