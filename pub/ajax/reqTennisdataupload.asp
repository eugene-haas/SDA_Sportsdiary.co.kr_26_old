...
'############################################
	...
	Case CMD_FIND1
		%><!-- #include virtual = "/pub/api/tennisadmin/api.upgameFind1.asp" --><%
	Response.end	
	Case CMD_SHEETSHOW
	...
	Case CMD_SETGAME
		%><!-- #include virtual = "/pub/api/tennisadmin/api.setGame.asp" --><%
	Response.end	

	Case CMD_DELGAME
		%><!-- #include virtual = "/pub/api/tennisadmin/api.delGame.asp" --><%
	Response.end	
