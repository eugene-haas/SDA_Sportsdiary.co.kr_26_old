...
'############################################
	...
	Case CMD_CONTESTAPPEND
		%><!-- #include virtual = "/pub/api/swimadmin/operator/api.operatorMore.asp" --><%
	Response.End
	Case CMD_GAMEINPUT
		%><!-- #include virtual = "/pub/api/swimadmin/operator/api.operatorINPUT.asp" --><%
	Response.end	
	Case CMD_GAMEINPUTEDIT
		%><!-- #include virtual = "/pub/api/swimadmin/operator/api.operatorEdit.asp" --><%
	Response.end	
	Case CMD_GAMEINPUTEDITOK
		%><!-- #include virtual = "/pub/api/swimadmin/operator/api.operatorEditok.asp" --><%
	Response.end	
	Case CMD_GAMEINPUTDEL
		%><!-- #include virtual = "/pub/api/swimadmin/operator/api.operatorDel.asp" --><%
	Response.end	
	End select
%>