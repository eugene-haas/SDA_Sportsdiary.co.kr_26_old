...
'############################################
	...
	Case CMD_REFUNDWIN
	%><!-- #include virtual = "/pub/api/swimadmin/vacct/api.refundwin.asp" --><%
	Response.End

	Case CMD_ACCTMSGSEND
	%><!-- #include virtual = "/pub/api/swimadmin/vacct/api.AcctMsgSend.asp" --><%
	Response.End
	
	Case CMD_ACCTMSG
	%><!-- #include virtual = "/pub/api/swimadmin/vacct/api.AcctMsg.asp" --><%
	Response.End
	
	Case CMD_ACCTINFO
	%><!-- #include virtual = "/pub/api/swimadmin/vacct/api.VAcctInfo.asp" --><%
	Response.End
	End Select
%>