...
'############################################
	...
	Case CMD_LEAGUEJOO
		%><!-- #include virtual = "/pub/api/swimadmin/gametable/api.league_ing.asp" --><%
	Response.End
	Case CMD_LEAGUEWIN
		%><!-- #include virtual = "/pub/api/swimadmin/gametable/api.league_win.asp" --><%
	Response.End
	Case CMD_LEAGUECOURT
		%><!-- #include virtual = "/pub/api/swimadmin/gametable/api.league_court.asp" --><%
	Response.End
	End Select
%>