...
'############################################
	...
	Case CMD_MERGETABLE
		%><!-- #include virtual = "/pub/api/swimadmin/tool/api.mergetable.asp" --><%
	Response.end	

	Case CMD_COPYPHONENO
		%><!-- #include virtual = "/pub/api/swimadmin/tool/api.copyPhoneNo.asp" --><%
	Response.end	

	Case CMD_DELPN
		%><!-- #include virtual = "/pub/api/swimadmin/tool/api.delpn.asp" --><%
	Response.end	

	Case CMD_SETPLYER
		%><!-- #include virtual = "/pub/api/swimadmin/tool/api.setPlayer.asp" --><%
	Response.end	
