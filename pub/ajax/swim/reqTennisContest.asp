...
'############################################
	...
	Case CMD_MAKEGOODS
		%><!-- #include virtual = "/pub/api/swimadmin/api.goodsForm.asp" --><%
	Response.end	
	Case CMD_INSERTDEP1
		%><!-- #include virtual = "/pub/api/swimadmin/api.goodsFormOK.asp" --><%
	Response.end	


	Case CMD_RNKLIST,CMD_SETRNKINFO
		%><!-- #include virtual = "/pub/api/swimadmin/api.rnklist.asp" --><%
	Response.End

	Case CMD_VACCRESET
	%><!-- #include virtual = "/pub/api/swimadmin/api.vaccreset.asp" --><%
	Response.End

	Case CMD_EDITOR
		%><!-- #include virtual = "/pub/api/swimadmin/api.editor.asp" --><%
	Response.End
	Case CMD_EDITOROK
		%><!-- #include virtual = "/pub/api/swimadmin/api.editorOK.asp" --><%
	Response.End

	Case CMD_GAMEGRADEPERSONAPPEND
		%><!-- #include virtual = "/pub/api/swimadmin/api.contestmore.asp" --><%
	Response.End
	Case CMD_GAMEINPUT
		%><!-- #include virtual = "/pub/api/swimadmin/api.gameinput.asp" --><%
	Response.end	
	Case CMD_GAMEINPUTEDIT
		%><!-- #include virtual = "/pub/api/swimadmin/api.gameinputedit.asp" --><%
	Response.end	
	Case CMD_GAMEINPUTEDITOK
		%><!-- #include virtual = "/pub/api/swimadmin/api.gameinputeditok.asp" --><%
	Response.end	
	Case CMD_GAMEINPUTDEL
		%><!-- #include virtual = "/pub/api/swimadmin/api.gameinputdel.asp" --><%
	Response.end
	End select
%>