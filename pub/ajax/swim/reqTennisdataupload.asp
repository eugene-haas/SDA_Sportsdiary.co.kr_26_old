...
'############################################
	...
	Case CMD_FIND1
		%><!-- #include virtual = "/pub/api/swimadmin/api.upgameFind1.asp" --><%
	Response.end	
	Case CMD_SHEETSHOW
	...
	Case CMD_SETGAME
		%><!-- #include virtual = "/pub/api/swimadmin/api.setGame.asp" --><%
	Response.end	

	Case CMD_DELGAME
		%><!-- #include virtual = "/pub/api/swimadmin/api.delGame.asp" --><%
	Response.end	
