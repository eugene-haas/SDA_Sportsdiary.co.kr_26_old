...
'############################################
	...
	Case CMD_INITLAKET
		%><!-- #include virtual = "/pub/api/tennisadmin/gametable/api.laket.asp" --><%
	Response.End


	Case CMD_INITCOURT
		%><!-- #include virtual = "/pub/api/tennisadmin/bbs/api.makecourt.asp" --><%
	Response.End

	Case CMD_HTML01
		%><!-- #include virtual = "/pub/api/tennisadmin/bbs/api.textarea.asp" --><%
	Response.End

	Case CMD_HTML01OK
		%><!-- #include virtual = "/pub/api/tennisadmin/bbs/api.textareaOK.asp" --><%
	Response.End
	End Select
%>