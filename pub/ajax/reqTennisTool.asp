...
'############################################
	...
	Case CMD_MERGETABLE
		%><!-- #include virtual = "/pub/api/tennisadmin/tool/api.mergetable.asp" --><%
	Response.end	

	Case CMD_COPYPHONENO
		%><!-- #include virtual = "/pub/api/tennisadmin/tool/api.copyPhoneNo.asp" --><%
	Response.end	

	Case CMD_DELPN
		%><!-- #include virtual = "/pub/api/tennisadmin/tool/api.delpn.asp" --><%
	Response.end	

	Case CMD_SETPLYER
		%><!-- #include virtual = "/pub/api/tennisadmin/tool/api.setPlayer.asp" --><%
	Response.end	
