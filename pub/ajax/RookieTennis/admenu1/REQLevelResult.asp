...
'############################################
	If request("test") = "t" Then
		 REQ = "{""CMD"":20000,""IDX"":577,""TIDX"":135,""TITLE"":""4차대회) 2019 원카 SD랭킹 루키테니스챔피언십"",""LEVELNO"":""20104013"",""TeamNM"":""남자부★"",""AreaNM"":""인천송도""}"
	...
	Case CMD_RESETRANK
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gameresult/api.resetRank.asp" --><%
	Response.end	

	Case CMD_SETRANK
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gameresult/api.setRank.asp" --><%
	Response.end	
	...
	Case CMD_SETGAME
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gameresult/api.setGame.asp" --><%
	Response.end	


	Case CMD_SETRANKER
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gameresult/api.setGameRanker.asp" --><%
	Response.end	

	Case CMD_DELRANKER
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gameresult/api.delGameRanker.asp" --><%
	Response.end	


	Case CMD_CHANGERANK
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gameresult/api.changeRank.asp" --><%
	Response.end	

	Case CMD_CHANGEPOINT
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gameresult/api.changePoint.asp" --><%
	Response.end	
