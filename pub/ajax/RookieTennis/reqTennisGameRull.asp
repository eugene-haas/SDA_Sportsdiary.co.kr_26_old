...
'############################################
	...
	Case CMD_FIND1
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.gameRullFind1.asp" --><%
	Response.end	

	Case CMD_FIND2
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.gameRullFind2.asp" --><%
	Response.end

	Case CMD_SETGAME
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.makerull.asp" --><%
	Response.end	
      	

	Case CMD_SAVETrJoono
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.makeRullupdate.asp" --><%
	Response.end
	
	Case CMD_SAVEGAME
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.gameRullSave.asp" --><%
	Response.end	

	Case CMD_Delete
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.gameRulldelete.asp" --><%
	Response.end	

	Case CMD_RullUpdate
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.gameRullupdate.asp" --><%
	Response.end	
