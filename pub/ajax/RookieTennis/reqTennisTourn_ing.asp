...
'############################################
    ...
    REQ = "{""CMD"":40003,""IDX"":568,""TitleIDX"":133,""Title"":""테니스테스트최종"",""TeamNM"":""남자부★"",""AreaNM"":""인천송도"",""ONEMORE"":""notok"",""roundSel"":""0"",""RESET"":""notok"",""COURTAREA"":0,""T_M1IDX"":414439,""T_M2IDX"":414437,""T_SORTNO"":28,""T_RD"":1,""S3KEY"":""20104013"",""RIDX"":0,""NOWCTNO"":0,""COURTNO"":""5215""}"
	...
	Case CMD_TOURN
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gametable/api.Tourn_ing.asp" --><%
	Response.End

	Case CMD_TOURNEND
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gametable/api.Tourn_ingend.asp" --><%
	Response.end


	Case CMD_TOURNWAITCOURT
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gametable/api.tourn_waitcourt.asp" --><%
	Response.End
	Case CMD_TOURNCOURT
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gametable/api.tourn_court.asp" --><%
	Response.End
	Case CMD_TOURNWIN
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/gametable/api.tourn_win.asp" --><%
	Response.End
	End Select
%>
