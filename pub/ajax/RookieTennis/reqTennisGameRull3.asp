...
'############################################
	...
	Case CMD_FIND1
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.gameRullFind1free.asp" --><%
	Response.end	

	Case CMD_FIND2
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.gameRullFind2free.asp" --><%
	Response.end

	Case CMD_SETGAME '폼을 부르고 내용을 부른다...
		%><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.makerullform3.asp" --><%
	Response.end	
