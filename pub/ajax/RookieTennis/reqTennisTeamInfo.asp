...
'############################################
   ...
   ' REQ ="{""CMD"":30008,""findTYPE"":""s_team"",""findSido"":"""",""fndSTR"":""대구"",""PAGENO"":""1""}"
	...
	Select Case CDbl(CMD)
	    Case CMD_FINDPLAYER
		    %><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.TeamInfomore.asp" --><%
	    Response.End
	    ...
	    Case CMD_GAMEINPUT
		    %><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.TeamInfoinput.asp" --><%
	    Response.end	

	    Case CMD_GAMEINPUTEDIT
		    %><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.TeamInfoinputedit.asp" --><%
	    Response.end	

	    Case CMD_GAMEINPUTEDITOK
		    %><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.TeamInfoinputeditok.asp" --><%
	    Response.end	

	    Case CMD_GAMEINPUTDEL
		    %><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.TeamInfoinputdel.asp" --><%
	    Response.end	

	    Case CMD_GAMEAUTO
            %><!-- #include virtual = "/pub/api/RookieTennisAdmin/api.TeamInfoInputAuto.asp" --><% 
	    Response.end
