...
'############################################
	...
	If request("test") = "t" Then
		REQ ="{""CMD"":51000,""TIDX"":35,""FNM"":""/RDN01/2019/notice/111[3].txt""}"
	Else
		REQ = request("REQ")
	End if
  ...
  CMD_GAMEINPUT = 30001
	...
	Case CMD_EDITOR
		%><!-- #include virtual = "/pub/api/RidingAdmin/api.editor.asp" --><%
	Response.End
	Case CMD_EDITOROK
		%><!-- #include virtual = "/pub/api/RidingAdmin/api.editorOK.asp" --><%
	Response.End
