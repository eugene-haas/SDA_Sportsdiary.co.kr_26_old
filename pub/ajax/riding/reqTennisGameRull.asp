...
'############################################
	...
	Case CMD_FIND1
		%><!-- #include virtual = "/pub/api/RidingAdmin/api.gameRullFind1.asp" --><%
	Response.end	

	Case CMD_FIND2
		%><!-- #include virtual = "/pub/api/RidingAdmin/api.gameRullFind2.asp" --><%
	Response.end

	Case CMD_SETGAME
		%><!-- #include virtual = "/pub/api/RidingAdmin/api.makerull.asp" --><%
	Response.end	
	...
	Case CMD_RullUpdate
		%><!-- #include virtual = "/pub/api/RidingAdmin/api.gameRullupdate.asp" --><%
	Response.end	
