...
'출처: http://mindopener.tistory.com/entry/asp-header-추가하기Access-Control-Allow-Origin [Developer`s Tea Time ~~]
%>
<!DOCTYPE html>
<html>
<head>
...
<section data-role="page" id="03" class="eventPage" data-next="01" data-prev="02" data-dom-cache="true">
