			...
			'한국기록, 대회기록 비교S
				Function checkSin(cdc,titlecode,levelno,itgubun,sexno)
					...
					If codepre = "nr" Then '대회신기록 체크 페스
						...
						'대회신기록
						strWhere = " titlecode = '"&titlecode&"' and  levelno = '"&levelno&"'  and delyn = 'N'  and rctype in ('R01','R02','R03','R04','R05','R06')  and gameResult > 0 and sex = '"&sexno&"'   and gameResult < 'a' "
						SQL = "select min(gameresult) from tblrecord where "&strWhere
						Set rs = db.ExecSQLReturnRS(SQL , null, ConStr)
