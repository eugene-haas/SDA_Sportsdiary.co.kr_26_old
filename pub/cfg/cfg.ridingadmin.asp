<%
	...
	'승마
	ConStr = "Provider=SQLOLEDB.1;Persist Security Info=True;User ID="&DB_ID&";Password="&DB_PW&";Initial Catalog=SD_Riding;Data Source=" & DB_IP & ";"
	...
	CONST_UPHTTP = "http://upload.sportsdiary.co.kr/sportsdiary"
	...
	'문자전송에 사용할 값들
	CONST_GROUPNAME = "대한승마협회"
	CONST_SENDPHONENO = "18000523"
%>
